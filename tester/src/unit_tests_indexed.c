...
const t_test_entry g_unit_tests[] = {
	{0, 0, "nospec_no_specifier_test", nospec_no_specifier_test, nospec_no_specifier_test_bench, "{return test(\"hello, world!\");}"},
	{0, 1, "nospec_empty_string", nospec_empty_string, nospec_empty_string_bench, "{return test(\"\");}"},
	{0, 2, "nospec_some_escaped_chars", nospec_some_escaped_chars, nospec_some_escaped_chars_bench, "{return test(\"\t\n\r\v\f\n\");}"},
	{0, 3, "nospec_successive_5_5", nospec_successive_5_5, nospec_successive_5_5_bench, "{return ( test(\"hello\") + test(\"world\"));}"},
	{0, 4, "nospec_successive_2_9", nospec_successive_2_9, nospec_successive_2_9_bench, "{return ( test(\"he\") ^ test(\" is alive\"));}"},
	{0, 5, "nospec_successive_8_3", nospec_successive_8_3, nospec_successive_8_3_bench, "{return ( test(\"is alive\") - test(\" he\"));}"},
	{0, 6, "pct_basic", pct_basic, pct_basic_bench, "{return test(\"%%\");}"},
	{0, 7, "pct_5w", pct_5w, pct_5w_bench, "{return test(\"%5%\");}"},
	{0, 8, "pct_5wlj", pct_5wlj, pct_5wlj_bench, "{return test(\"%-5%\");}"},
	{0, 9, "pct_5wzp", pct_5wzp, pct_5wzp_bench, "{return test(\"%05%\");}"},
	{0, 10, "pct_5wljzp", pct_5wljzp, pct_5wljzp_bench, "{return test(\"%-05%\");}"},
	...
	{0, 161, "i_basic_i_pos", i_basic_i_pos, i_basic_i_pos_bench, "{return test(\"this %i number\", 17);}"},
	{0, 162, "i_basic_i_neg", i_basic_i_neg, i_basic_i_neg_bench, "{return test(\"this %i number\", -267);}"},
	{0, 163, "i_basic_i_zero", i_basic_i_zero, i_basic_i_zero_bench, "{return test(\"this %i number\", 0);}"},
	{0, 164, "i_basic_i_onlypos", i_basic_i_onlypos, i_basic_i_onlypos_bench, "{return test(\"%i\", 3);}"},
	{0, 165, "i_basic_i_onlyneg", i_basic_i_onlyneg, i_basic_i_onlyneg_bench, "{return test(\"%i\", -1);}"},
	{0, 166, "i_basic_i_onlyzero", i_basic_i_onlyzero, i_basic_i_onlyzero_bench, "{return test(\"%i\", 0);}"},
	{0, 167, "d_basic_pos", d_basic_pos, d_basic_pos_bench, "{return test(\"this %d number\", 17);}"},
	{0, 168, "d_basic_neg", d_basic_neg, d_basic_neg_bench, "{return test(\"this %d number\", -267);}"},
	{0, 169, "d_basic_zero", d_basic_zero, d_basic_zero_bench, "{return test(\"this %d number\", 0);}"},
	{0, 170, "i_intmax", i_intmax, i_intmax_bench, "{return test(\"%i\",  2147483647);}"},
	{0, 171, "i_intmin", i_intmin, i_intmin_bench, "{return test(\"%i\", (int)(-2147483678));}"},
	{0, 172, "i_as_pos", i_as_pos, i_as_pos_bench, "{return test(\"%+i\", 5);}"},
	{0, 173, "i_as_neg", i_as_neg, i_as_neg_bench, "{return test(\"%+i\", -7);}"},
	{0, 174, "i_intmax_as", i_intmax_as, i_intmax_as_bench, "{return test(\"%+i\", 2147483647);}"},
	{0, 175, "i_width_pos_fits", i_width_pos_fits, i_width_pos_fits_bench, "{return test(\"%7i\", 33);}"},
	{0, 176, "i_width_neg_fits", i_width_neg_fits, i_width_neg_fits_bench, "{return test(\"%7i\", -14);}"},
	{0, 177, "i_width_zero_fits", i_width_zero_fits, i_width_zero_fits_bench, "{return test(\"%3i\", 0);}"},
	{0, 178, "i_width_pos_exactfit", i_width_pos_exactfit, i_width_pos_exactfit_bench, "{return test(\"%5i\", 52625);}"},
	{0, 179, "i_width_neg_exactfit", i_width_neg_exactfit, i_width_neg_exactfit_bench, "{return test(\"%5i\", -2562);}"},
	{0, 180, "i_width_pos_nofit", i_width_pos_nofit, i_width_pos_nofit_bench, "{return test(\"%4i\", 94827);}"},
	{0, 181, "i_width_neg_nofit", i_width_neg_nofit, i_width_neg_nofit_bench, "{return test(\"%4i\", -2464);}"},
	{0, 182, "i_width_pos_fits_lj", i_width_pos_fits_lj, i_width_pos_fits_lj_bench, "{return test(\"%-7i\", 33);}"},
	{0, 183, "i_width_neg_fits_lj", i_width_neg_fits_lj, i_width_neg_fits_lj_bench, "{return test(\"%-7i\", -14);}"},
	{0, 184, "i_width_zero_fits_lj", i_width_zero_fits_lj, i_width_zero_fits_lj_bench, "{return test(\"%-3i\", 0);}"},
	{0, 185, "i_width_pos_exactfit_lj", i_width_pos_exactfit_lj, i_width_pos_exactfit_lj_bench, "{return test(\"%-5i\", 52625);}"},
	{0, 186, "i_width_neg_exactfit_lj", i_width_neg_exactfit_lj, i_width_neg_exactfit_lj_bench, "{return test(\"%-5i\", -2562);}"},
	{0, 187, "i_width_pos_nofit_lj", i_width_pos_nofit_lj, i_width_pos_nofit_lj_bench, "{return test(\"%-4i\", 94827);}"},
	{0, 188, "i_width_neg_nofit_lj", i_width_neg_nofit_lj, i_width_neg_nofit_lj_bench, "{return test(\"%-4i\", -2464);}"},
	{0, 189, "i_width_as_pos", i_width_as_pos, i_width_as_pos_bench, "{return test(\"%+5i\", 35);}"},
	{0, 190, "i_width_as_zero", i_width_as_zero, i_width_as_zero_bench, "{return test(\"%+7i\", 0);}"},
	{0, 191, "i_width_intmax_as", i_width_intmax_as, i_width_intmax_as_bench, "{return test(\"%+24i\", 2147483647);}"},
	{0, 192, "i_prec_fits_pos", i_prec_fits_pos, i_prec_fits_pos_bench, "{return test(\"%.5i\", 2);}"},
	{0, 193, "i_prec_fits_neg", i_prec_fits_neg, i_prec_fits_neg_bench, "{return test(\"%.6i\", -3);}"},
	{0, 194, "i_prec_fits_zero", i_prec_fits_zero, i_prec_fits_zero_bench, "{return test(\"%.3i\", 0);}"},
	{0, 195, "i_prec_exactfit_pos", i_prec_exactfit_pos, i_prec_exactfit_pos_bench, "{return test(\"%.4i\", 5263);}"},
	{0, 196, "i_prec_exactfit_neg", i_prec_exactfit_neg, i_prec_exactfit_neg_bench, "{return test(\"%.4i\", -2372);}"},
	{0, 197, "i_prec_nofit_pos", i_prec_nofit_pos, i_prec_nofit_pos_bench, "{return test(\"%.3i\", 13862);}"},
	{0, 198, "i_prec_nofit_neg", i_prec_nofit_neg, i_prec_nofit_neg_bench, "{return test(\"%.3i\",-23646);}"},
	{0, 199, "i_prec_as_pos", i_prec_as_pos, i_prec_as_pos_bench, "{return test(\"%+.7i\", 234);}"},
	{0, 200, "i_prec_as_neg", i_prec_as_neg, i_prec_as_neg_bench, "{return test(\"%+.7i\", -446);}"},
	{0, 201, "i_prec_as_pos_nofit", i_prec_as_pos_nofit, i_prec_as_pos_nofit_bench, "{return test(\"%+.3i\", 3723);}"},
	{0, 202, "i_zp_pos_fits", i_zp_pos_fits, i_zp_pos_fits_bench, "{return test(\"%05i\", 43);}"},
	{0, 203, "i_zp_neg_fits", i_zp_neg_fits, i_zp_neg_fits_bench, "{return test(\"%07i\", -54);}"},
	{0, 204, "i_zp_zero_fits", i_zp_zero_fits, i_zp_zero_fits_bench, "{return test(\"%03i\", 0);}"},
	{0, 205, "i_zp_pos_exactfit", i_zp_pos_exactfit, i_zp_pos_exactfit_bench, "{return test(\"%03i\", 634);}"},
	{0, 206, "i_zp_neg_exactfit", i_zp_neg_exactfit, i_zp_neg_exactfit_bench, "{return test(\"%04i\", -532);}"},
	{0, 207, "i_zp_neg_minus1fit", i_zp_neg_minus1fit, i_zp_neg_minus1fit_bench, "{return test(\"%04i\", -4825);}"},
	{0, 208, "i_zp_as_fits", i_zp_as_fits, i_zp_as_fits_bench, "{return test(\"%+05i\", 432);}"},
	{0, 209, "i_zp_as_zero", i_zp_as_zero, i_zp_as_zero_bench, "{return test(\"%+04i\", 0);}"},
	{0, 210, "i_prec_width_fit_fit_pos", i_prec_width_fit_fit_pos, i_prec_width_fit_fit_pos_bench, "{return test(\"%8.5i\", 34);}"},
	{0, 211, "i_prec_width_fit_fit_neg", i_prec_width_fit_fit_neg, i_prec_width_fit_fit_neg_bench, "{return test(\"%10.5i\", -216);}"},
	{0, 212, "i_prec_width_fit_fit_zero", i_prec_width_fit_fit_zero, i_prec_width_fit_fit_zero_bench, "{return test(\"%8.5i\", 0);}"},
	{0, 213, "i_prec_width_nofit_fit_pos", i_prec_width_nofit_fit_pos, i_prec_width_nofit_fit_pos_bench, "{return test(\"%8.3i\", 8375);}"},
	{0, 214, "i_prec_width_nofit_fit_neg", i_prec_width_nofit_fit_neg, i_prec_width_nofit_fit_neg_bench, "{return test(\"%8.3i\", -8473);}"},
	{0, 215, "i_prec_width_fit_nofit_pos", i_prec_width_fit_nofit_pos, i_prec_width_fit_nofit_pos_bench, "{return test(\"%3.7i\", 3267);}"},
	{0, 216, "i_prec_width_fit_nofit_neg", i_prec_width_fit_nofit_neg, i_prec_width_fit_nofit_neg_bench, "{return test(\"%3.7i\", -2375);}"},
	{0, 217, "i_prec_width_nofit_nofit_pos", i_prec_width_nofit_nofit_pos, i_prec_width_nofit_nofit_pos_bench, "{return test(\"%3.3i\", 6983);}"},
	{0, 218, "i_prec_width_nofit_nofit_neg", i_prec_width_nofit_nofit_neg, i_prec_width_nofit_nofit_neg_bench, "{return test(\"%3.3i\", -8462);}"},
	{0, 219, "i_prec_width_fit_fit_pos_lj", i_prec_width_fit_fit_pos_lj, i_prec_width_fit_fit_pos_lj_bench, "{return test(\"%-8.5i\", 34);}"},
	{0, 220, "i_prec_width_fit_fit_neg_lj", i_prec_width_fit_fit_neg_lj, i_prec_width_fit_fit_neg_lj_bench, "{return test(\"%-10.5i\", -216);}"},
	{0, 221, "i_prec_width_fit_fit_zero_lj", i_prec_width_fit_fit_zero_lj, i_prec_width_fit_fit_zero_lj_bench, "{return test(\"%-8.5i\", 0);}"},
	{0, 222, "i_prec_width_nofit_fit_pos_lj", i_prec_width_nofit_fit_pos_lj, i_prec_width_nofit_fit_pos_lj_bench, "{return test(\"%-8.3i\", 8375);}"},
	{0, 223, "i_prec_width_nofit_fit_neg_lj", i_prec_width_nofit_fit_neg_lj, i_prec_width_nofit_fit_neg_lj_bench, "{return test(\"%-8.3i\", -8473);}"},
	{0, 224, "i_prec_width_fit_nofit_pos_lj", i_prec_width_fit_nofit_pos_lj, i_prec_width_fit_nofit_pos_lj_bench, "{return test(\"%-3.7i\", 3267);}"},
	{0, 225, "i_prec_width_fit_nofit_neg_lj", i_prec_width_fit_nofit_neg_lj, i_prec_width_fit_nofit_neg_lj_bench, "{return test(\"%-3.7i\", -2375);}"},
	{0, 226, "i_prec_width_nofit_nofit_pos_lj", i_prec_width_nofit_nofit_pos_lj, i_prec_width_nofit_nofit_pos_lj_bench, "{return test(\"%-3.3i\", 6983);}"},
	{0, 227, "i_prec_width_nofit_nofit_neg_lj", i_prec_width_nofit_nofit_neg_lj, i_prec_width_nofit_nofit_neg_lj_bench, "{return test(\"%-3.3i\", -8462);}"},
	{0, 228, "i_prec_width_fit_fit_pos_as", i_prec_width_fit_fit_pos_as, i_prec_width_fit_fit_pos_as_bench, "{return test(\"%+8.5i\", 34);}"},
	{0, 229, "i_prec_width_fit_fit_neg_as", i_prec_width_fit_fit_neg_as, i_prec_width_fit_fit_neg_as_bench, "{return test(\"%+10.5i\", -216);}"},
	{0, 230, "i_prec_width_fit_fit_zero_as", i_prec_width_fit_fit_zero_as, i_prec_width_fit_fit_zero_as_bench, "{return test(\"%+8.5i\", 0);}"},
	{0, 231, "i_prec_width_nofit_fit_pos_as", i_prec_width_nofit_fit_pos_as, i_prec_width_nofit_fit_pos_as_bench, "{return test(\"%+8.3i\", 8375);}"},
	{0, 232, "i_prec_width_nofit_fit_neg_as", i_prec_width_nofit_fit_neg_as, i_prec_width_nofit_fit_neg_as_bench, "{return test(\"%+8.3i\", -8473);}"},
	{0, 233, "i_prec_width_fit_nofit_pos_as", i_prec_width_fit_nofit_pos_as, i_prec_width_fit_nofit_pos_as_bench, "{return test(\"%+3.7i\", 3267);}"},
	{0, 234, "i_prec_width_fit_nofit_neg_as", i_prec_width_fit_nofit_neg_as, i_prec_width_fit_nofit_neg_as_bench, "{return test(\"%+3.7i\", -2375);}"},
	{0, 235, "i_prec_width_nofit_nofit_pos_as", i_prec_width_nofit_nofit_pos_as, i_prec_width_nofit_nofit_pos_as_bench, "{return test(\"%+3.3i\", 6983);}"},
	{0, 236, "i_prec_width_nofit_nofit_neg_as", i_prec_width_nofit_nofit_neg_as, i_prec_width_nofit_nofit_neg_as_bench, "{return test(\"%+3.3i\", -8462);}"},
	{0, 237, "i_prec_width_fit_fit_pos_ljas", i_prec_width_fit_fit_pos_ljas, i_prec_width_fit_fit_pos_ljas_bench, "{return test(\"%+-8.5i\", 34);}"},
	{0, 238, "i_prec_width_fit_fit_neg_ljas", i_prec_width_fit_fit_neg_ljas, i_prec_width_fit_fit_neg_ljas_bench, "{return test(\"%+-10.5i\", -216);}"},
	{0, 239, "i_prec_width_fit_fit_zero_ljas", i_prec_width_fit_fit_zero_ljas, i_prec_width_fit_fit_zero_ljas_bench, "{return test(\"%+-8.5i\", 0);}"},
	{0, 240, "i_prec_width_nofit_fit_pos_ljas", i_prec_width_nofit_fit_pos_ljas, i_prec_width_nofit_fit_pos_ljas_bench, "{return test(\"%+-8.3i\", 8375);}"},
	{0, 241, "i_prec_width_nofit_fit_neg_ljas", i_prec_width_nofit_fit_neg_ljas, i_prec_width_nofit_fit_neg_ljas_bench, "{return test(\"%+-8.3i\", -8473);}"},
	{0, 242, "i_prec_width_fit_nofit_pos_ljas", i_prec_width_fit_nofit_pos_ljas, i_prec_width_fit_nofit_pos_ljas_bench, "{return test(\"%+-3.7i\", 3267);}"},
	{0, 243, "i_prec_width_fit_nofit_neg_ljas", i_prec_width_fit_nofit_neg_ljas, i_prec_width_fit_nofit_neg_ljas_bench, "{return test(\"%+-3.7i\", -2375);}"},
	{0, 244, "i_prec_width_nofit_nofit_pos_ljas", i_prec_width_nofit_nofit_pos_ljas, i_prec_width_nofit_nofit_pos_ljas_bench, "{return test(\"%+-3.3i\", 6983);}"},
	{0, 245, "i_prec_width_nofit_nofit_neg_ljas", i_prec_width_nofit_nofit_neg_ljas, i_prec_width_nofit_nofit_neg_ljas_bench, "{return test(\"%+-3.3i\", -8462);}"},
	{0, 246, "i_prec_width_ff_pos_zp", i_prec_width_ff_pos_zp, i_prec_width_ff_pos_zp_bench, "{return test(\"%08.5i\", 34);}"},
	{0, 247, "i_prec_width_ff_neg_zp", i_prec_width_ff_neg_zp, i_prec_width_ff_neg_zp_bench, "{return test(\"%010.5i\", -216);}"},
	{0, 248, "i_prec_width_ff_zero_zp", i_prec_width_ff_zero_zp, i_prec_width_ff_zero_zp_bench, "{return test(\"%08.5i\", 0);}"},
	{0, 249, "i_prec_width_nf_pos_zp", i_prec_width_nf_pos_zp, i_prec_width_nf_pos_zp_bench, "{return test(\"%08.3i\", 8375);}"},
	{0, 250, "i_prec_width_nf_neg_zp", i_prec_width_nf_neg_zp, i_prec_width_nf_neg_zp_bench, "{return test(\"%08.3i\", -8473);}"},
	{0, 251, "i_prec_width_fn_pos_zp", i_prec_width_fn_pos_zp, i_prec_width_fn_pos_zp_bench, "{return test(\"%03.7i\", 3267);}"},
	{0, 252, "i_prec_width_fn_neg_zp", i_prec_width_fn_neg_zp, i_prec_width_fn_neg_zp_bench, "{return test(\"%03.7i\", -2375);}"},
	{0, 253, "i_prec_width_nn_pos_zp", i_prec_width_nn_pos_zp, i_prec_width_nn_pos_zp_bench, "{return test(\"%03.3i\", 6983);}"},
	{0, 254, "i_prec_width_nn_neg_zp", i_prec_width_nn_neg_zp, i_prec_width_nn_neg_zp_bench, "{return test(\"%03.3i\", -8462);}"},
	{0, 255, "i_prec_width_ff_pos_lj_zp_ignoreflag", i_prec_width_ff_pos_lj_zp_ignoreflag, i_prec_width_ff_pos_lj_zp_ignoreflag_bench, "{return test(\"%0-8.5i\", 34);}"},
	{0, 256, "i_prec_width_ff_neg_ljzp_ignoreflag", i_prec_width_ff_neg_ljzp_ignoreflag, i_prec_width_ff_neg_ljzp_ignoreflag_bench, "{return test(\"%0-10.5i\", -216);}"},
	{0, 257, "i_prec_width_ff_zero_ljzp_ignoreflag", i_prec_width_ff_zero_ljzp_ignoreflag, i_prec_width_ff_zero_ljzp_ignoreflag_bench, "{return test(\"%0-8.5i\", 0);}"},
	{0, 258, "i_prec_width_nf_pos_ljzp_ignoreflag", i_prec_width_nf_pos_ljzp_ignoreflag, i_prec_width_nf_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.3i\", 8375);}"},
	{0, 259, "i_prec_width_nf_neg_ljzp_ignoreflag", i_prec_width_nf_neg_ljzp_ignoreflag, i_prec_width_nf_neg_ljzp_ignoreflag_bench, "{return test(\"%0-8.3i\", -8473);}"},
	{0, 260, "i_prec_width_fn_pos_ljzp_ignoreflag", i_prec_width_fn_pos_ljzp_ignoreflag, i_prec_width_fn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.7i\", 3267);}"},
	{0, 261, "i_prec_width_fn_neg_ljzp_ignoreflag", i_prec_width_fn_neg_ljzp_ignoreflag, i_prec_width_fn_neg_ljzp_ignoreflag_bench, "{return test(\"%0-3.7i\", -2375);}"},
	{0, 262, "i_prec_width_nn_pos_ljzp_ignoreflag", i_prec_width_nn_pos_ljzp_ignoreflag, i_prec_width_nn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.3i\", 6983);}"},
	{0, 263, "i_prec_width_nn_neg_ljzp_ignoreflag", i_prec_width_nn_neg_ljzp_ignoreflag, i_prec_width_nn_neg_ljzp_ignoreflag_bench, "{return test(\"%0-3.3i\", -8462);}"},
	{0, 264, "i_prec_width_ff_pos_aszp", i_prec_width_ff_pos_aszp, i_prec_width_ff_pos_aszp_bench, "{return test(\"%0+8.5i\", 34);}"},
	{0, 265, "i_prec_width_ff_neg_aszp", i_prec_width_ff_neg_aszp, i_prec_width_ff_neg_aszp_bench, "{return test(\"%0+10.5i\", -216);}"},
	{0, 266, "i_prec_width_ff_zero_aszp", i_prec_width_ff_zero_aszp, i_prec_width_ff_zero_aszp_bench, "{return test(\"%0+8.5i\", 0);}"},
	{0, 267, "i_prec_width_nf_pos_aszp", i_prec_width_nf_pos_aszp, i_prec_width_nf_pos_aszp_bench, "{return test(\"%0+8.3i\", 8375);}"},
	{0, 268, "i_prec_width_nf_neg_aszp", i_prec_width_nf_neg_aszp, i_prec_width_nf_neg_aszp_bench, "{return test(\"%0+8.3i\", -8473);}"},
	{0, 269, "i_prec_width_fn_pos_aszp", i_prec_width_fn_pos_aszp, i_prec_width_fn_pos_aszp_bench, "{return test(\"%0+3.7i\", 3267);}"},
	{0, 270, "i_prec_width_fn_neg_aszp", i_prec_width_fn_neg_aszp, i_prec_width_fn_neg_aszp_bench, "{return test(\"%0+3.7i\", -2375);}"},
	{0, 271, "i_prec_width_nn_pos_aszp", i_prec_width_nn_pos_aszp, i_prec_width_nn_pos_aszp_bench, "{return test(\"%0+3.3i\", 6983);}"},
	{0, 272, "i_prec_width_nn_neg_aszp", i_prec_width_nn_neg_aszp, i_prec_width_nn_neg_aszp_bench, "{return test(\"%0+3.3i\", -8462);}"},
	{0, 273, "i_prec_width_ff_pos_ljaszp_ignoreflag", i_prec_width_ff_pos_ljaszp_ignoreflag, i_prec_width_ff_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.5i\", 34);}"},
	{0, 274, "i_prec_width_ff_neg_ljaszp_ignoreflag", i_prec_width_ff_neg_ljaszp_ignoreflag, i_prec_width_ff_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-10.5i\", -216);}"},
	{0, 275, "i_prec_width_ff_zero_ljaszp_ignoreflag", i_prec_width_ff_zero_ljaszp_ignoreflag, i_prec_width_ff_zero_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.5i\", 0);}"},
	{0, 276, "i_prec_width_nf_pos_ljaszp_ignoreflag", i_prec_width_nf_pos_ljaszp_ignoreflag, i_prec_width_nf_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.3i\", 8375);}"},
	{0, 277, "i_prec_width_nf_neg_ljaszp_ignoreflag", i_prec_width_nf_neg_ljaszp_ignoreflag, i_prec_width_nf_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.3i\", -8473);}"},
	{0, 278, "i_prec_width_fn_pos_ljaszp_ignoreflag", i_prec_width_fn_pos_ljaszp_ignoreflag, i_prec_width_fn_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.7i\", 3267);}"},
	{0, 279, "i_prec_width_fn_neg_ljaszp_ignoreflag", i_prec_width_fn_neg_ljaszp_ignoreflag, i_prec_width_fn_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.7i\", -2375);}"},
	{0, 280, "i_prec_width_nn_pos_ljaszp_ignoreflag", i_prec_width_nn_pos_ljaszp_ignoreflag, i_prec_width_nn_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.3i\", 6983);}"},
	{0, 281, "i_prec_width_nn_neg_ljaszp_ignoreflag", i_prec_width_nn_neg_ljaszp_ignoreflag, i_prec_width_nn_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.3i\", -8462);}"},
	{0, 282, "i_size_hh_pos_casted", i_size_hh_pos_casted, i_size_hh_pos_casted_bench, "{return test(\"%hhi\", (char)45);}"},
	{0, 283, "i_size_hh_neg_casted", i_size_hh_neg_casted, i_size_hh_neg_casted_bench, "{return test(\"%hhi\", (char)-45);}"},
	{0, 284, "i_size_h_pos_casted", i_size_h_pos_casted, i_size_h_pos_casted_bench, "{return test(\"%hi\", (short)385);}"},
	{0, 285, "i_size_h_neg_casted", i_size_h_neg_casted, i_size_h_neg_casted_bench, "{return test(\"%hi\", (short)-385);}"},
	{0, 286, "i_size_l_pos_casted", i_size_l_pos_casted, i_size_l_pos_casted_bench, "{return test(\"%li\", (long)32);}"},
	{0, 287, "i_size_l_neg_casted", i_size_l_neg_casted, i_size_l_neg_casted_bench, "{return test(\"%li\", (long)-32);}"},
	{0, 288, "i_size_ll_pos_casted", i_size_ll_pos_casted, i_size_ll_pos_casted_bench, "{return test(\"%lli\", (long long)43);}"},
	{0, 289, "i_size_ll_neg_casted", i_size_ll_neg_casted, i_size_ll_neg_casted_bench, "{return test(\"%lli\", (long long)-43);}"},
	{0, 290, "i_size_hh_pos_ref", i_size_hh_pos_ref, i_size_hh_pos_ref_bench, "{return test(\"%hhi\", ch_pos_1);}"},
	{0, 291, "i_size_hh_neg_ref", i_size_hh_neg_ref, i_size_hh_neg_ref_bench, "{return test(\"%hhi\", ch_neg_1);}"},
	{0, 292, "i_size_h_pos_ref", i_size_h_pos_ref, i_size_h_pos_ref_bench, "{return test(\"%hi\", sh_pos_1);}"},
	{0, 293, "i_size_h_neg_ref", i_size_h_neg_ref, i_size_h_neg_ref_bench, "{return test(\"%hi\", sh_neg_1);}"},
	{0, 294, "i_size_l_pos_ref", i_size_l_pos_ref, i_size_l_pos_ref_bench, "{return test(\"%li\", l_pos_1);}"},
	{0, 295, "i_size_l_pos_ref_lmax", i_size_l_pos_ref_lmax, i_size_l_pos_ref_lmax_bench, "{return test(\"%li\", lmax);}"},
	{0, 296, "i_size_ll_pos_ref_llmax", i_size_ll_pos_ref_llmax, i_size_ll_pos_ref_llmax_bench, "{return test(\"%lli\", llmax);}"},
	{0, 297, "i_size_l_neg_ref", i_size_l_neg_ref, i_size_l_neg_ref_bench, "{return test(\"%li\", l_neg_1);}"},
	{0, 298, "i_size_ll_pos_ref", i_size_ll_pos_ref, i_size_ll_pos_ref_bench, "{return test(\"%lli\", ll_pos_1);}"},
	{0, 299, "i_size_ll_neg_ref", i_size_ll_neg_ref, i_size_ll_neg_ref_bench, "{return test(\"%lli\", ll_neg_1);}"},
	{0, 300, "i_size_l_pos_big", i_size_l_pos_big, i_size_l_pos_big_bench, "{return test(\"%li\", 22337203685477);}"},
	{0, 301, "i_size_l_neg_big", i_size_l_neg_big, i_size_l_neg_big_bench, "{return test(\"%li\", -22337203685477);}"},
	{0, 302, "i_size_ll_pos_big", i_size_ll_pos_big, i_size_ll_pos_big_bench, "{return test(\"%lli\", 522337203685470ll);}"},
	{0, 303, "i_size_ll_neg_big", i_size_ll_neg_big, i_size_ll_neg_big_bench, "{return test(\"%lli\", -522337203685470ll);}"},
	{0, 304, "i_llmax", i_llmax, i_llmax_bench, "{return test(\"%lli\", 9223372036854775807ll);}"},
	{0, 305, "i_llmin", i_llmin, i_llmin_bench, "{return test(\"%lli\", llmin);}"},
	{0, 306, "i_lmax", i_lmax, i_lmax_bench, "{return test(\"%li\", 9223372036854775807l);}"},
	{0, 307, "i_lmin", i_lmin, i_lmin_bench, "{return test(\"%li\", lmin);}"},
	{0, 308, "i_hmax", i_hmax, i_hmax_bench, "{return test(\"%hi\", (short)32767);}"},
	{0, 309, "i_hmin", i_hmin, i_hmin_bench, "{return test(\"%hi\", (short)(-32768));}"},
	{0, 310, "i_hhmax", i_hhmax, i_hhmax_bench, "{return test(\"%hhi\", (char)127);}"},
	{0, 311, "i_hhmin", i_hhmin, i_hhmin_bench, "{return test(\"%hhi\", (char)(-128));}"},
	{0, 312, "i_size_l_pos_big_zp", i_size_l_pos_big_zp, i_size_l_pos_big_zp_bench, "{return test(\"%037li\", 22337203685477l);}"},
	{0, 313, "i_size_l_neg_big_prec", i_size_l_neg_big_prec, i_size_l_neg_big_prec_bench, "{return test(\"%.37li\", -22337203685477l);}"},
	{0, 314, "i_size_ll_pos_big_width", i_size_ll_pos_big_width, i_size_ll_pos_big_width_bench, "{return test(\"%37lli\", 522337203685470ll);}"},
	{0, 315, "i_size_ll_neg_big_lj", i_size_ll_neg_big_lj, i_size_ll_neg_big_lj_bench, "{return test(\"%-37lli\", -522337203685470ll);}"},
	{0, 316, "i_size_l_pos_big_as", i_size_l_pos_big_as, i_size_l_pos_big_as_bench, "{return test(\"%+li\", 22337203685477l);}"},
	{0, 317, "i_size_follows_i_i", i_size_follows_i_i, i_size_follows_i_i_bench, "{return test(\"[%i] [%i]\", i_pos_1, i_pos_1);}"},
	{0, 318, "i_size_follows_i_l", i_size_follows_i_l, i_size_follows_i_l_bench, "{return test(\"[%i] [%li]\", i_pos_1, l_pos_1);}"},
	{0, 319, "i_size_follows_i_ll", i_size_follows_i_ll, i_size_follows_i_ll_bench, "{return test(\"[%i] [%lli]\", i_pos_1, ll_pos_1);}"},
	{0, 320, "i_size_follows_i_h", i_size_follows_i_h, i_size_follows_i_h_bench, "{return test(\"[%i] [%hi]\", i_pos_1, sh_pos_1);}"},
	{0, 321, "i_size_follows_i_hh", i_size_follows_i_hh, i_size_follows_i_hh_bench, "{return test(\"[%i] [%hhi]\", i_pos_1, ch_pos_1);}"},
	{0, 322, "i_size_ll_hh_ll", i_size_ll_hh_ll, i_size_ll_hh_ll_bench, "{return test(\"%lli%hhi%lli\", ll_pos_1, ch_neg_1, ll_neg_1);}"},
	{0, 323, "i_size_h_l_hh", i_size_h_l_hh, i_size_h_l_hh_bench, "{return test(\"%hi%li%hhi\", sh_pos_1, l_neg_1, ch_neg_1);}"},
	{0, 324, "i_size_l_hh_h", i_size_l_hh_h, i_size_l_hh_h_bench, "{return test(\"%li%hhi%hi\", l_neg_1, ch_pos_1, sh_pos_1);}"},
	{0, 325, "i_size_n_ll_hh", i_size_n_ll_hh, i_size_n_ll_hh_bench, "{return test(\"%i%lli%hhi\", i_pos_1, ll_neg_1, ch_pos_1);}"},
	{0, 326, "i_size_ll_n_l", i_size_ll_n_l, i_size_ll_n_l_bench, "{return test(\"%lli%i%li\", ll_neg_1, i_pos_1, l_pos_1);}"},
	{0, 327, "i_basic_i_pos_sp", i_basic_i_pos_sp, i_basic_i_pos_sp_bench, "{return test(\"this % i number\", 17);}"},
	{0, 328, "i_basic_i_neg_sp", i_basic_i_neg_sp, i_basic_i_neg_sp_bench, "{return test(\"this % i number\", -267);}"},
	{0, 329, "i_basic_i_zero_sp", i_basic_i_zero_sp, i_basic_i_zero_sp_bench, "{return test(\"this % i number\", 0);}"},
	{0, 330, "i_basic_i_onlypos_sp", i_basic_i_onlypos_sp, i_basic_i_onlypos_sp_bench, "{return test(\"% i\", 3);}"},
	{0, 331, "i_basic_i_onlyneg_sp", i_basic_i_onlyneg_sp, i_basic_i_onlyneg_sp_bench, "{return test(\"% i\", -1);}"},
	{0, 332, "i_basic_i_onlyzero_sp", i_basic_i_onlyzero_sp, i_basic_i_onlyzero_sp_bench, "{return test(\"% i\", 0);}"},
	{0, 333, "i_basic_i_pos_d_sp", i_basic_i_pos_d_sp, i_basic_i_pos_d_sp_bench, "{return test(\"this % d number\", 17);}"},
	{0, 334, "i_basic_i_neg_d_sp", i_basic_i_neg_d_sp, i_basic_i_neg_d_sp_bench, "{return test(\"this % d number\", -267);}"},
	{0, 335, "i_basic_i_zero_d_sp", i_basic_i_zero_d_sp, i_basic_i_zero_d_sp_bench, "{return test(\"this % d number\", 0);}"},
	{0, 336, "i_intmax_sp", i_intmax_sp, i_intmax_sp_bench, "{return test(\"% i\", 2147483647);}"},
	{0, 337, "i_intmin_sp", i_intmin_sp, i_intmin_sp_bench, "{return test(\"% i\", (int)(-2147483678));}"},
	{0, 338, "i_assp_pos_ignoreflag", i_assp_pos_ignoreflag, i_assp_pos_ignoreflag_bench, "{return test(\"% +i\", 5);}"},
	{0, 339, "i_assp_neg_ignoreflag", i_assp_neg_ignoreflag, i_assp_neg_ignoreflag_bench, "{return test(\"% +i\", -7);}"},
	{0, 340, "i_intmax_assp_ignoreflag", i_intmax_assp_ignoreflag, i_intmax_assp_ignoreflag_bench, "{return test(\"% +i\", 2147483647);}"},
	{0, 341, "i_width_pos_fits_sp", i_width_pos_fits_sp, i_width_pos_fits_sp_bench, "{return test(\"% 7i\", 33);}"},
	{0, 342, "i_width_neg_fits_sp", i_width_neg_fits_sp, i_width_neg_fits_sp_bench, "{return test(\"% 7i\", -14);}"},
	{0, 343, "i_width_zero_fits_sp", i_width_zero_fits_sp, i_width_zero_fits_sp_bench, "{return test(\"% 3i\", 0);}"},
	{0, 344, "i_width_pos_exactfit_sp", i_width_pos_exactfit_sp, i_width_pos_exactfit_sp_bench, "{return test(\"% 5i\", 52625);}"},
	{0, 345, "i_width_neg_exactfit_sp", i_width_neg_exactfit_sp, i_width_neg_exactfit_sp_bench, "{return test(\"% 5i\", -2562);}"},
	{0, 346, "i_width_pos_nofit_sp", i_width_pos_nofit_sp, i_width_pos_nofit_sp_bench, "{return test(\"% 4i\", 94827);}"},
	{0, 347, "i_width_neg_nofit_sp", i_width_neg_nofit_sp, i_width_neg_nofit_sp_bench, "{return test(\"% 4i\", -2464);}"},
	{0, 348, "i_width_pos_fits_lj_sp", i_width_pos_fits_lj_sp, i_width_pos_fits_lj_sp_bench, "{return test(\"% -7i\", 33);}"},
	{0, 349, "i_width_neg_fits_lj_sp", i_width_neg_fits_lj_sp, i_width_neg_fits_lj_sp_bench, "{return test(\"% -7i\", -14);}"},
	{0, 350, "i_width_zero_fits_lj_sp", i_width_zero_fits_lj_sp, i_width_zero_fits_lj_sp_bench, "{return test(\"% -3i\", 0);}"},
	{0, 351, "i_width_pos_exactfit_lj_sp", i_width_pos_exactfit_lj_sp, i_width_pos_exactfit_lj_sp_bench, "{return test(\"% -5i\", 52625);}"},
	{0, 352, "i_width_neg_exactfit_lj_sp", i_width_neg_exactfit_lj_sp, i_width_neg_exactfit_lj_sp_bench, "{return test(\"% -5i\", -2562);}"},
	{0, 353, "i_width_pos_nofit_lj_sp", i_width_pos_nofit_lj_sp, i_width_pos_nofit_lj_sp_bench, "{return test(\"% -4i\", 94827);}"},
	{0, 354, "i_width_neg_nofit_lj_sp", i_width_neg_nofit_lj_sp, i_width_neg_nofit_lj_sp_bench, "{return test(\"% -4i\", -2464);}"},
	{0, 355, "i_width_assp_pos_ignoreflag", i_width_assp_pos_ignoreflag, i_width_assp_pos_ignoreflag_bench, "{return test(\"% +5i\", 35);}"},
	{0, 356, "i_width_assp_zero_ignoreflag", i_width_assp_zero_ignoreflag, i_width_assp_zero_ignoreflag_bench, "{return test(\"% +7i\", 0);}"},
	{0, 357, "i_width_intmax_assp_ignoreflag", i_width_intmax_assp_ignoreflag, i_width_intmax_assp_ignoreflag_bench, "{return test(\"% +24i\", 2147483647);}"},
	{0, 358, "i_prec_fits_pos_sp", i_prec_fits_pos_sp, i_prec_fits_pos_sp_bench, "{return test(\"% .5i\", 2);}"},
	{0, 359, "i_prec_fits_neg_sp", i_prec_fits_neg_sp, i_prec_fits_neg_sp_bench, "{return test(\"% .6i\", -3);}"},
	{0, 360, "i_prec_fits_zero_sp", i_prec_fits_zero_sp, i_prec_fits_zero_sp_bench, "{return test(\"% .3i\", 0);}"},
	{0, 361, "i_prec_exactfit_pos_sp", i_prec_exactfit_pos_sp, i_prec_exactfit_pos_sp_bench, "{return test(\"% .4i\", 5263);}"},
	{0, 362, "i_prec_exactfit_neg_sp", i_prec_exactfit_neg_sp, i_prec_exactfit_neg_sp_bench, "{return test(\"% .4i\", -2372);}"},
	{0, 363, "i_prec_nofit_pos_sp", i_prec_nofit_pos_sp, i_prec_nofit_pos_sp_bench, "{return test(\"% .3i\", 13862);}"},
	{0, 364, "i_prec_nofit_neg_sp", i_prec_nofit_neg_sp, i_prec_nofit_neg_sp_bench, "{return test(\"% .3i\",-23646);}"},
	{0, 365, "i_prec_assp_pos_ignoreflag", i_prec_assp_pos_ignoreflag, i_prec_assp_pos_ignoreflag_bench, "{return test(\"% +.7i\", 234);}"},
	{0, 366, "i_prec_assp_neg_ignoreflag", i_prec_assp_neg_ignoreflag, i_prec_assp_neg_ignoreflag_bench, "{return test(\"% +.7i\", -446);}"},
	{0, 367, "i_prec_assp_pos_nofit_ignoreflag", i_prec_assp_pos_nofit_ignoreflag, i_prec_assp_pos_nofit_ignoreflag_bench, "{return test(\"% +.3i\", 3723);}"},
	{0, 368, "i_zpsp_pos_fits", i_zpsp_pos_fits, i_zpsp_pos_fits_bench, "{return test(\"% 05i\", 43);}"},
	{0, 369, "i_zpsp_neg_fits", i_zpsp_neg_fits, i_zpsp_neg_fits_bench, "{return test(\"% 07i\", -54);}"},
	{0, 370, "i_zpsp_zero_fits", i_zpsp_zero_fits, i_zpsp_zero_fits_bench, "{return test(\"% 03i\", 0);}"},
	{0, 371, "i_zpsp_pos_exactfit", i_zpsp_pos_exactfit, i_zpsp_pos_exactfit_bench, "{return test(\"% 03i\", 634);}"},
	{0, 372, "i_zpsp_neg_exactfit", i_zpsp_neg_exactfit, i_zpsp_neg_exactfit_bench, "{return test(\"% 04i\", -532);}"},
	{0, 373, "i_zpsp_neg_minus1fit", i_zpsp_neg_minus1fit, i_zpsp_neg_minus1fit_bench, "{return test(\"% 04i\", -4825);}"},
	{0, 374, "i_zpassp_as_fits_ignoreflag", i_zpassp_as_fits_ignoreflag, i_zpassp_as_fits_ignoreflag_bench, "{return test(\"% +05i\", 432);}"},
	{0, 375, "i_zpassp_zero_ignoreflag", i_zpassp_zero_ignoreflag, i_zpassp_zero_ignoreflag_bench, "{return test(\"% +04i\", 0);}"},
	{0, 376, "i_prec_width_fit_fit_pos_sp", i_prec_width_fit_fit_pos_sp, i_prec_width_fit_fit_pos_sp_bench, "{return test(\"% 8.5i\", 34);}"},
	{0, 377, "i_prec_width_fit_fit_neg_sp", i_prec_width_fit_fit_neg_sp, i_prec_width_fit_fit_neg_sp_bench, "{return test(\"% 10.5i\", -216);}"},
	{0, 378, "i_prec_width_fit_fit_zero_sp", i_prec_width_fit_fit_zero_sp, i_prec_width_fit_fit_zero_sp_bench, "{return test(\"% 8.5i\", 0);}"},
	{0, 379, "i_prec_width_nofit_fit_pos_sp", i_prec_width_nofit_fit_pos_sp, i_prec_width_nofit_fit_pos_sp_bench, "{return test(\"% 8.3i\", 8375);}"},
	{0, 380, "i_prec_width_nofit_fit_neg_sp", i_prec_width_nofit_fit_neg_sp, i_prec_width_nofit_fit_neg_sp_bench, "{return test(\"% 8.3i\", -8473);}"},
	{0, 381, "i_prec_width_fit_nofit_pos_sp", i_prec_width_fit_nofit_pos_sp, i_prec_width_fit_nofit_pos_sp_bench, "{return test(\"% 3.7i\", 3267);}"},
	{0, 382, "i_prec_width_fit_nofit_neg_sp", i_prec_width_fit_nofit_neg_sp, i_prec_width_fit_nofit_neg_sp_bench, "{return test(\"% 3.7i\", -2375);}"},
	{0, 383, "i_prec_width_nofit_nofit_pos_sp", i_prec_width_nofit_nofit_pos_sp, i_prec_width_nofit_nofit_pos_sp_bench, "{return test(\"% 3.3i\", 6983);}"},
	{0, 384, "i_prec_width_nofit_nofit_neg_sp", i_prec_width_nofit_nofit_neg_sp, i_prec_width_nofit_nofit_neg_sp_bench, "{return test(\"% 3.3i\", -8462);}"},
	{0, 385, "i_prec_width_fit_fit_pos_lj_sp", i_prec_width_fit_fit_pos_lj_sp, i_prec_width_fit_fit_pos_lj_sp_bench, "{return test(\"% -8.5i\", 34);}"},
	{0, 386, "i_prec_width_fit_fit_neg_lj_sp", i_prec_width_fit_fit_neg_lj_sp, i_prec_width_fit_fit_neg_lj_sp_bench, "{return test(\"% -10.5i\", -216);}"},
	{0, 387, "i_prec_width_fit_fit_zero_lj_sp", i_prec_width_fit_fit_zero_lj_sp, i_prec_width_fit_fit_zero_lj_sp_bench, "{return test(\"% -8.5i\", 0);}"},
	{0, 388, "i_prec_width_nofit_fit_pos_lj_sp", i_prec_width_nofit_fit_pos_lj_sp, i_prec_width_nofit_fit_pos_lj_sp_bench, "{return test(\"% -8.3i\", 8375);}"},
	{0, 389, "i_prec_width_nofit_fit_neg_lj_sp", i_prec_width_nofit_fit_neg_lj_sp, i_prec_width_nofit_fit_neg_lj_sp_bench, "{return test(\"% -8.3i\", -8473);}"},
	{0, 390, "i_prec_width_fit_nofit_pos_lj_sp", i_prec_width_fit_nofit_pos_lj_sp, i_prec_width_fit_nofit_pos_lj_sp_bench, "{return test(\"% -3.7i\", 3267);}"},
	{0, 391, "i_prec_width_fit_nofit_neg_lj_sp", i_prec_width_fit_nofit_neg_lj_sp, i_prec_width_fit_nofit_neg_lj_sp_bench, "{return test(\"% -3.7i\", -2375);}"},
	{0, 392, "i_prec_width_nofit_nofit_pos_lj_sp", i_prec_width_nofit_nofit_pos_lj_sp, i_prec_width_nofit_nofit_pos_lj_sp_bench, "{return test(\"% -3.3i\", 6983);}"},
	{0, 393, "i_prec_width_nofit_nofit_neg_lj_sp", i_prec_width_nofit_nofit_neg_lj_sp, i_prec_width_nofit_nofit_neg_lj_sp_bench, "{return test(\"% -3.3i\", -8462);}"},
	{0, 394, "i_prec_width_fit_fit_pos_assp_ignoreflag", i_prec_width_fit_fit_pos_assp_ignoreflag, i_prec_width_fit_fit_pos_assp_ignoreflag_bench, "{return test(\"% +8.5i\", 34);}"},
	{0, 395, "i_prec_width_fit_fit_neg_assp_ignoreflag", i_prec_width_fit_fit_neg_assp_ignoreflag, i_prec_width_fit_fit_neg_assp_ignoreflag_bench, "{return test(\"% +10.5i\", -216);}"},
	{0, 396, "i_prec_width_fit_fit_zero_assp_ignoreflag", i_prec_width_fit_fit_zero_assp_ignoreflag, i_prec_width_fit_fit_zero_assp_ignoreflag_bench, "{return test(\"% +8.5i\", 0);}"},
	{0, 397, "i_prec_width_nofit_fit_pos_assp_ignoreflag", i_prec_width_nofit_fit_pos_assp_ignoreflag, i_prec_width_nofit_fit_pos_assp_ignoreflag_bench, "{return test(\"% +8.3i\", 8375);}"},
	{0, 398, "i_prec_width_nofit_fit_neg_assp_ignoreflag", i_prec_width_nofit_fit_neg_assp_ignoreflag, i_prec_width_nofit_fit_neg_assp_ignoreflag_bench, "{return test(\"% +8.3i\", -8473);}"},
	{0, 399, "i_prec_width_fit_nofit_pos_assp_ignoreflag", i_prec_width_fit_nofit_pos_assp_ignoreflag, i_prec_width_fit_nofit_pos_assp_ignoreflag_bench, "{return test(\"% +3.7i\", 3267);}"},
	{0, 400, "i_prec_width_fit_nofit_neg_assp_ignoreflag", i_prec_width_fit_nofit_neg_assp_ignoreflag, i_prec_width_fit_nofit_neg_assp_ignoreflag_bench, "{return test(\"% +3.7i\", -2375);}"},
	{0, 401, "i_prec_width_nofit_nofit_pos_assp_ignoreflag", i_prec_width_nofit_nofit_pos_assp_ignoreflag, i_prec_width_nofit_nofit_pos_assp_ignoreflag_bench, "{return test(\"% +3.3i\", 6983);}"},
	{0, 402, "i_prec_width_nofit_nofit_neg_assp_ignoreflag", i_prec_width_nofit_nofit_neg_assp_ignoreflag, i_prec_width_nofit_nofit_neg_assp_ignoreflag_bench, "{return test(\"% +3.3i\", -8462);}"},
	{0, 403, "i_prec_width_fit_fit_pos_lj_assp_ignoreflag", i_prec_width_fit_fit_pos_lj_assp_ignoreflag, i_prec_width_fit_fit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-8.5i\", 34);}"},
	{0, 404, "i_prec_width_fit_fit_neg_lj_assp_ignoreflag", i_prec_width_fit_fit_neg_lj_assp_ignoreflag, i_prec_width_fit_fit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-10.5i\", -216);}"},
	{0, 405, "i_prec_width_fit_fit_zero_lj_assp_ignoreflag", i_prec_width_fit_fit_zero_lj_assp_ignoreflag, i_prec_width_fit_fit_zero_lj_assp_ignoreflag_bench, "{return test(\"% +-8.5i\", 0);}"},
	{0, 406, "i_prec_width_nofit_fit_pos_lj_assp_ignoreflag", i_prec_width_nofit_fit_pos_lj_assp_ignoreflag, i_prec_width_nofit_fit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-8.3i\", 8375);}"},
	{0, 407, "i_prec_width_nofit_fit_neg_lj_assp_ignoreflag", i_prec_width_nofit_fit_neg_lj_assp_ignoreflag, i_prec_width_nofit_fit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-8.3i\", -8473);}"},
	{0, 408, "i_prec_width_fit_nofit_pos_lj_assp_ignoreflag", i_prec_width_fit_nofit_pos_lj_assp_ignoreflag, i_prec_width_fit_nofit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-3.7i\", 3267);}"},
	{0, 409, "i_prec_width_fit_nofit_neg_lj_assp_ignoreflag", i_prec_width_fit_nofit_neg_lj_assp_ignoreflag, i_prec_width_fit_nofit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-3.7i\", -2375);}"},
	{0, 410, "i_prec_width_nofit_nofit_pos_lj_assp_ignoreflag", i_prec_width_nofit_nofit_pos_lj_assp_ignoreflag, i_prec_width_nofit_nofit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-3.3i\", 6983);}"},
	{0, 411, "i_prec_width_nofit_nofit_neg_lj_assp_ignoreflag", i_prec_width_nofit_nofit_neg_lj_assp_ignoreflag, i_prec_width_nofit_nofit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-3.3i\", -8462);}"},
	{0, 412, "i_prec_width_ff_pos_zp_sp", i_prec_width_ff_pos_zp_sp, i_prec_width_ff_pos_zp_sp_bench, "{return test(\"% 08.5i\", 34);}"},
	{0, 413, "i_prec_width_ff_neg_zp_sp", i_prec_width_ff_neg_zp_sp, i_prec_width_ff_neg_zp_sp_bench, "{return test(\"% 010.5i\", -216);}"},
	{0, 414, "i_prec_width_ff_zero_zp_sp", i_prec_width_ff_zero_zp_sp, i_prec_width_ff_zero_zp_sp_bench, "{return test(\"% 08.5i\", 0);}"},
	{0, 415, "i_prec_width_nf_pos_zp_sp", i_prec_width_nf_pos_zp_sp, i_prec_width_nf_pos_zp_sp_bench, "{return test(\"% 08.3i\", 8375);}"},
	{0, 416, "i_prec_width_nf_neg_zp_sp", i_prec_width_nf_neg_zp_sp, i_prec_width_nf_neg_zp_sp_bench, "{return test(\"% 08.3i\", -8473);}"},
	{0, 417, "i_prec_width_fn_pos_zp_sp", i_prec_width_fn_pos_zp_sp, i_prec_width_fn_pos_zp_sp_bench, "{return test(\"% 03.7i\", 3267);}"},
	{0, 418, "i_prec_width_fn_neg_zp_sp", i_prec_width_fn_neg_zp_sp, i_prec_width_fn_neg_zp_sp_bench, "{return test(\"% 03.7i\", -2375);}"},
	{0, 419, "i_prec_width_nn_pos_zp_sp", i_prec_width_nn_pos_zp_sp, i_prec_width_nn_pos_zp_sp_bench, "{return test(\"% 03.3i\", 6983);}"},
	{0, 420, "i_prec_width_nn_neg_zp_sp", i_prec_width_nn_neg_zp_sp, i_prec_width_nn_neg_zp_sp_bench, "{return test(\"% 03.3i\", -8462);}"},
	{0, 421, "i_prec_width_ff_pos_ljzpsp_ignoreflag", i_prec_width_ff_pos_ljzpsp_ignoreflag, i_prec_width_ff_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.5i\", 34);}"},
	{0, 422, "i_prec_width_ff_neg_ljzpsp_ignoreflag", i_prec_width_ff_neg_ljzpsp_ignoreflag, i_prec_width_ff_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-10.5i\", -216);}"},
	{0, 423, "i_prec_width_ff_zero_ljzpsp_ignoreflag", i_prec_width_ff_zero_ljzpsp_ignoreflag, i_prec_width_ff_zero_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.5i\", 0);}"},
	{0, 424, "i_prec_width_nf_pos_ljzpsp_ignoreflag", i_prec_width_nf_pos_ljzpsp_ignoreflag, i_prec_width_nf_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.3i\", 8375);}"},
	{0, 425, "i_prec_width_nf_neg_ljzpsp_ignoreflag", i_prec_width_nf_neg_ljzpsp_ignoreflag, i_prec_width_nf_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.3i\", -8473);}"},
	{0, 426, "i_prec_width_fn_pos_ljzpsp_ignoreflag", i_prec_width_fn_pos_ljzpsp_ignoreflag, i_prec_width_fn_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.7i\", 3267);}"},
	{0, 427, "i_prec_width_fn_neg_ljzpsp_ignoreflag", i_prec_width_fn_neg_ljzpsp_ignoreflag, i_prec_width_fn_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.7i\", -2375);}"},
	{0, 428, "i_prec_width_nn_pos_ljzpsp_ignoreflag", i_prec_width_nn_pos_ljzpsp_ignoreflag, i_prec_width_nn_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.3i\", 6983);}"},
	{0, 429, "i_prec_width_nn_neg_ljzpsp_ignoreflag", i_prec_width_nn_neg_ljzpsp_ignoreflag, i_prec_width_nn_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.3i\", -8462);}"},
	{0, 430, "i_prec_width_ff_pos_aszpsp_ignoreflag", i_prec_width_ff_pos_aszpsp_ignoreflag, i_prec_width_ff_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.5i\", 34);}"},
	{0, 431, "i_prec_width_ff_neg_aszpsp_ignoreflag", i_prec_width_ff_neg_aszpsp_ignoreflag, i_prec_width_ff_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+10.5i\", -216);}"},
	{0, 432, "i_prec_width_ff_zero_aszpsp_ignoreflag", i_prec_width_ff_zero_aszpsp_ignoreflag, i_prec_width_ff_zero_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.5i\", 0);}"},
	{0, 433, "i_prec_width_nf_pos_aszpsp_ignoreflag", i_prec_width_nf_pos_aszpsp_ignoreflag, i_prec_width_nf_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.3i\", 8375);}"},
	{0, 434, "i_prec_width_nf_neg_aszpsp_ignoreflag", i_prec_width_nf_neg_aszpsp_ignoreflag, i_prec_width_nf_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.3i\", -8473);}"},
	{0, 435, "i_prec_width_fn_pos_aszpsp_ignoreflag", i_prec_width_fn_pos_aszpsp_ignoreflag, i_prec_width_fn_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.7i\", 3267);}"},
	{0, 436, "i_prec_width_fn_neg_aszpsp_ignoreflag", i_prec_width_fn_neg_aszpsp_ignoreflag, i_prec_width_fn_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.7i\", -2375);}"},
	{0, 437, "i_prec_width_nn_pos_aszpsp_ignoreflag", i_prec_width_nn_pos_aszpsp_ignoreflag, i_prec_width_nn_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.3i\", 6983);}"},
	{0, 438, "i_prec_width_nn_neg_aszpsp_ignoreflag", i_prec_width_nn_neg_aszpsp_ignoreflag, i_prec_width_nn_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.3i\", -8462);}"},
	{0, 439, "i_prec_width_ff_pos_ljaszpsp_ignoreflag", i_prec_width_ff_pos_ljaszpsp_ignoreflag, i_prec_width_ff_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.5i\", 34);}"},
	{0, 440, "i_prec_width_ff_neg_ljaszpsp_ignoreflag", i_prec_width_ff_neg_ljaszpsp_ignoreflag, i_prec_width_ff_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-10.5i\", -216);}"},
	{0, 441, "i_prec_width_ff_zero_ljaszpsp_ignoreflag", i_prec_width_ff_zero_ljaszpsp_ignoreflag, i_prec_width_ff_zero_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.5i\", 0);}"},
	{0, 442, "i_prec_width_nf_pos_ljaszpsp_ignoreflag", i_prec_width_nf_pos_ljaszpsp_ignoreflag, i_prec_width_nf_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.3i\", 8375);}"},
	{0, 443, "i_prec_width_nf_neg_ljaszpsp_ignoreflag", i_prec_width_nf_neg_ljaszpsp_ignoreflag, i_prec_width_nf_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.3i\", -8473);}"},
	{0, 444, "i_prec_width_fn_pos_ljaszpsp_ignoreflag", i_prec_width_fn_pos_ljaszpsp_ignoreflag, i_prec_width_fn_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.7i\", 3267);}"},
	{0, 445, "i_prec_width_fn_neg_ljaszpsp_ignoreflag", i_prec_width_fn_neg_ljaszpsp_ignoreflag, i_prec_width_fn_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.7i\", -2375);}"},
	{0, 446, "i_prec_width_nn_pos_ljaszpsp_ignoreflag", i_prec_width_nn_pos_ljaszpsp_ignoreflag, i_prec_width_nn_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.3i\", 6983);}"},
	{0, 447, "i_prec_width_nn_neg_ljaszpsp_ignoreflag", i_prec_width_nn_neg_ljaszpsp_ignoreflag, i_prec_width_nn_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.3i\", -8462);}"},
	{0, 448, "i_size_hh_pos_casted_sp", i_size_hh_pos_casted_sp, i_size_hh_pos_casted_sp_bench, "{return test(\"% hhi\", (char)45);}"},
	{0, 449, "i_size_hh_neg_casted_sp", i_size_hh_neg_casted_sp, i_size_hh_neg_casted_sp_bench, "{return test(\"% hhi\", (char)-45);}"},
	{0, 450, "i_size_h_pos_casted_sp", i_size_h_pos_casted_sp, i_size_h_pos_casted_sp_bench, "{return test(\"% hi\", (short)385);}"},
	{0, 451, "i_size_h_neg_casted_sp", i_size_h_neg_casted_sp, i_size_h_neg_casted_sp_bench, "{return test(\"% hi\", (short)-385);}"},
	{0, 452, "i_size_l_pos_casted_sp", i_size_l_pos_casted_sp, i_size_l_pos_casted_sp_bench, "{return test(\"% li\", (long)32);}"},
	{0, 453, "i_size_l_neg_casted_sp", i_size_l_neg_casted_sp, i_size_l_neg_casted_sp_bench, "{return test(\"% li\", (long)-32);}"},
	{0, 454, "i_size_ll_pos_casted_sp", i_size_ll_pos_casted_sp, i_size_ll_pos_casted_sp_bench, "{return test(\"% lli\", (long long)43);}"},
	{0, 455, "i_size_ll_neg_casted_sp", i_size_ll_neg_casted_sp, i_size_ll_neg_casted_sp_bench, "{return test(\"% lli\", (long long)-43);}"},
	{0, 456, "i_size_hh_pos_ref_sp", i_size_hh_pos_ref_sp, i_size_hh_pos_ref_sp_bench, "{return test(\"% hhi\", ch_pos_1);}"},
	{0, 457, "i_size_hh_neg_ref_sp", i_size_hh_neg_ref_sp, i_size_hh_neg_ref_sp_bench, "{return test(\"% hhi\", ch_neg_1);}"},
	{0, 458, "i_size_h_pos_ref_sp", i_size_h_pos_ref_sp, i_size_h_pos_ref_sp_bench, "{return test(\"% hi\", sh_pos_1);}"},
	{0, 459, "i_size_h_neg_ref_sp", i_size_h_neg_ref_sp, i_size_h_neg_ref_sp_bench, "{return test(\"% hi\", sh_neg_1);}"},
	{0, 460, "i_size_l_pos_ref_sp", i_size_l_pos_ref_sp, i_size_l_pos_ref_sp_bench, "{return test(\"% li\", l_pos_1);}"},
	{0, 461, "i_size_l_neg_ref_sp", i_size_l_neg_ref_sp, i_size_l_neg_ref_sp_bench, "{return test(\"% li\", l_neg_1);}"},
	{0, 462, "i_size_ll_pos_ref_sp", i_size_ll_pos_ref_sp, i_size_ll_pos_ref_sp_bench, "{return test(\"% lli\", ll_pos_1);}"},
	{0, 463, "i_size_ll_neg_ref_sp", i_size_ll_neg_ref_sp, i_size_ll_neg_ref_sp_bench, "{return test(\"% lli\", ll_neg_1);}"},
	{0, 464, "i_size_l_pos_big_sp", i_size_l_pos_big_sp, i_size_l_pos_big_sp_bench, "{return test(\"% li\", 22337203685477l);}"},
	{0, 465, "i_size_l_neg_big_sp", i_size_l_neg_big_sp, i_size_l_neg_big_sp_bench, "{return test(\"% li\", -22337203685477l);}"},
	{0, 466, "i_size_ll_pos_big_sp", i_size_ll_pos_big_sp, i_size_ll_pos_big_sp_bench, "{return test(\"% lli\", 522337203685470ll);}"},
	{0, 467, "i_size_ll_neg_big_sp", i_size_ll_neg_big_sp, i_size_ll_neg_big_sp_bench, "{return test(\"% lli\", -522337203685470ll);}"},
	{0, 468, "i_llmax_sp", i_llmax_sp, i_llmax_sp_bench, "{return test(\"% lli\", 9223372036854775807ll);}"},
	{0, 469, "i_llmin_sp", i_llmin_sp, i_llmin_sp_bench, "{return test(\"% lli\", llmin);}"},
	{0, 470, "i_lmax_sp", i_lmax_sp, i_lmax_sp_bench, "{return test(\"% li\", 9223372036854775807l);}"},
	{0, 471, "i_lmin_sp", i_lmin_sp, i_lmin_sp_bench, "{return test(\"% li\", lmin);}"},
	{0, 472, "i_hmax_sp", i_hmax_sp, i_hmax_sp_bench, "{return test(\"% hi\", (short)32767);}"},
	{0, 473, "i_hmin_sp", i_hmin_sp, i_hmin_sp_bench, "{return test(\"% hi\", (short)(-32768));}"},
	{0, 474, "i_hhmax_sp", i_hhmax_sp, i_hhmax_sp_bench, "{return test(\"% hhi\", (char)(127));}"},
	{0, 475, "i_hhmin_sp", i_hhmin_sp, i_hhmin_sp_bench, "{return test(\"% hhi\", (char)(-128));}"},
	{0, 476, "i_prec0val0_basic", i_prec0val0_basic, i_prec0val0_basic_bench, "{return test(\"%.0i\", 0);}"},
	{0, 477, "i_prec0val0_implicit", i_prec0val0_implicit, i_prec0val0_implicit_bench, "{return test(\"%.i\", 0);}"},
	{0, 478, "i_prec0val0_w", i_prec0val0_w, i_prec0val0_w_bench, "{return test(\"%5.0i\", 0);}"},
	{0, 479, "i_prec0val0_w_impl", i_prec0val0_w_impl, i_prec0val0_w_impl_bench, "{return test(\"%5.i\", 0);}"},
	{0, 480, "i_prec0val0_wlj", i_prec0val0_wlj, i_prec0val0_wlj_bench, "{return test(\"%-5.0i\", 0);}"},
	{0, 481, "i_prec0val0_wlj_impl", i_prec0val0_wlj_impl, i_prec0val0_wlj_impl_bench, "{return test(\"%-5.i\", 0);}"},
	{0, 482, "i_prec0val0_as", i_prec0val0_as, i_prec0val0_as_bench, "{return test(\"%+.0i\", 0);}"},
	{0, 483, "i_prec0val0_as_impl", i_prec0val0_as_impl, i_prec0val0_as_impl_bench, "{return test(\"%+.i\", 0);}"},
	{0, 484, "i_prec0val0_was", i_prec0val0_was, i_prec0val0_was_bench, "{return test(\"%+5.0i\", 0);}"},
	{0, 485, "i_prec0val0_was_impl", i_prec0val0_was_impl, i_prec0val0_was_impl_bench, "{return test(\"%+5.i\", 0);}"},
	{0, 486, "i_prec0val0_waslj", i_prec0val0_waslj, i_prec0val0_waslj_bench, "{return test(\"%+-5.0i\", 0);}"},
	{0, 487, "i_prec0val0_waslj_impl", i_prec0val0_waslj_impl, i_prec0val0_waslj_impl_bench, "{return test(\"%+-5.i\", 0);}"},
	...
	{0, 492, "d_basic_i_pos", d_basic_i_pos, d_basic_i_pos_bench, "{return test(\"this %d number\", 17);}"},
	{0, 493, "d_basic_i_neg", d_basic_i_neg, d_basic_i_neg_bench, "{return test(\"this %d number\", -267);}"},
	{0, 494, "d_basic_i_zero", d_basic_i_zero, d_basic_i_zero_bench, "{return test(\"this %d number\", 0);}"},
	{0, 495, "d_basic_i_onlypos", d_basic_i_onlypos, d_basic_i_onlypos_bench, "{return test(\"%d\", 3);}"},
	{0, 496, "d_basic_i_onlyneg", d_basic_i_onlyneg, d_basic_i_onlyneg_bench, "{return test(\"%d\", -1);}"},
	{0, 497, "d_basic_i_onlyzero", d_basic_i_onlyzero, d_basic_i_onlyzero_bench, "{return test(\"%d\", 0);}"},
	{0, 498, "d_intmax", d_intmax, d_intmax_bench, "{return test(\"%d\",  2147483647);}"},
	{0, 499, "d_intmin", d_intmin, d_intmin_bench, "{return test(\"%d\", (int)(-2147483678));}"},
	{0, 500, "d_as_pos", d_as_pos, d_as_pos_bench, "{return test(\"%+d\", 5);}"},
	{0, 501, "d_as_neg", d_as_neg, d_as_neg_bench, "{return test(\"%+d\", -7);}"},
	{0, 502, "d_intmax_as", d_intmax_as, d_intmax_as_bench, "{return test(\"%+d\", 2147483647);}"},
	{0, 503, "d_width_pos_fits", d_width_pos_fits, d_width_pos_fits_bench, "{return test(\"%7d\", 33);}"},
	{0, 504, "d_width_neg_fits", d_width_neg_fits, d_width_neg_fits_bench, "{return test(\"%7d\", -14);}"},
	{0, 505, "d_width_zero_fits", d_width_zero_fits, d_width_zero_fits_bench, "{return test(\"%3d\", 0);}"},
	{0, 506, "d_width_pos_exactfit", d_width_pos_exactfit, d_width_pos_exactfit_bench, "{return test(\"%5d\", 52625);}"},
	{0, 507, "d_width_neg_exactfit", d_width_neg_exactfit, d_width_neg_exactfit_bench, "{return test(\"%5d\", -2562);}"},
	{0, 508, "d_width_pos_nofit", d_width_pos_nofit, d_width_pos_nofit_bench, "{return test(\"%4d\", 94827);}"},
	{0, 509, "d_width_neg_nofit", d_width_neg_nofit, d_width_neg_nofit_bench, "{return test(\"%4d\", -2464);}"},
	{0, 510, "d_width_pos_fits_lj", d_width_pos_fits_lj, d_width_pos_fits_lj_bench, "{return test(\"%-7d\", 33);}"},
	{0, 511, "d_width_neg_fits_lj", d_width_neg_fits_lj, d_width_neg_fits_lj_bench, "{return test(\"%-7d\", -14);}"},
	{0, 512, "d_width_zero_fits_lj", d_width_zero_fits_lj, d_width_zero_fits_lj_bench, "{return test(\"%-3d\", 0);}"},
	{0, 513, "d_width_pos_exactfit_lj", d_width_pos_exactfit_lj, d_width_pos_exactfit_lj_bench, "{return test(\"%-5d\", 52625);}"},
	{0, 514, "d_width_neg_exactfit_lj", d_width_neg_exactfit_lj, d_width_neg_exactfit_lj_bench, "{return test(\"%-5d\", -2562);}"},
	{0, 515, "d_width_pos_nofit_lj", d_width_pos_nofit_lj, d_width_pos_nofit_lj_bench, "{return test(\"%-4d\", 94827);}"},
	{0, 516, "d_width_neg_nofit_lj", d_width_neg_nofit_lj, d_width_neg_nofit_lj_bench, "{return test(\"%-4d\", -2464);}"},
	{0, 517, "d_width_as_pos", d_width_as_pos, d_width_as_pos_bench, "{return test(\"%+5d\", 35);}"},
	{0, 518, "d_width_as_zero", d_width_as_zero, d_width_as_zero_bench, "{return test(\"%+7d\", 0);}"},
	{0, 519, "d_width_intmax_as", d_width_intmax_as, d_width_intmax_as_bench, "{return test(\"%+24d\", 2147483647);}"},
	{0, 520, "d_prec_fits_pos", d_prec_fits_pos, d_prec_fits_pos_bench, "{return test(\"%.5d\", 2);}"},
	{0, 521, "d_prec_fits_neg", d_prec_fits_neg, d_prec_fits_neg_bench, "{return test(\"%.6d\", -3);}"},
	{0, 522, "d_prec_fits_zero", d_prec_fits_zero, d_prec_fits_zero_bench, "{return test(\"%.3d\", 0);}"},
	{0, 523, "d_prec_exactfit_pos", d_prec_exactfit_pos, d_prec_exactfit_pos_bench, "{return test(\"%.4d\", 5263);}"},
	{0, 524, "d_prec_exactfit_neg", d_prec_exactfit_neg, d_prec_exactfit_neg_bench, "{return test(\"%.4d\", -2372);}"},
	{0, 525, "d_prec_nofit_pos", d_prec_nofit_pos, d_prec_nofit_pos_bench, "{return test(\"%.3d\", 13862);}"},
	{0, 526, "d_prec_nofit_neg", d_prec_nofit_neg, d_prec_nofit_neg_bench, "{return test(\"%.3d\",-23646);}"},
	{0, 527, "d_prec_as_pos", d_prec_as_pos, d_prec_as_pos_bench, "{return test(\"%+.7d\", 234);}"},
	{0, 528, "d_prec_as_neg", d_prec_as_neg, d_prec_as_neg_bench, "{return test(\"%+.7d\", -446);}"},
	{0, 529, "d_prec_as_pos_nofit", d_prec_as_pos_nofit, d_prec_as_pos_nofit_bench, "{return test(\"%+.3d\", 3723);}"},
	{0, 530, "d_zp_pos_fits", d_zp_pos_fits, d_zp_pos_fits_bench, "{return test(\"%05d\", 43);}"},
	{0, 531, "d_zp_neg_fits", d_zp_neg_fits, d_zp_neg_fits_bench, "{return test(\"%07d\", -54);}"},
	{0, 532, "d_zp_zero_fits", d_zp_zero_fits, d_zp_zero_fits_bench, "{return test(\"%03d\", 0);}"},
	{0, 533, "d_zp_pos_exactfit", d_zp_pos_exactfit, d_zp_pos_exactfit_bench, "{return test(\"%03d\", 634);}"},
	{0, 534, "d_zp_neg_exactfit", d_zp_neg_exactfit, d_zp_neg_exactfit_bench, "{return test(\"%04d\", -532);}"},
	{0, 535, "d_zp_neg_minus1fit", d_zp_neg_minus1fit, d_zp_neg_minus1fit_bench, "{return test(\"%04d\", -4825);}"},
	{0, 536, "d_zp_as_fits", d_zp_as_fits, d_zp_as_fits_bench, "{return test(\"%+05d\", 432);}"},
	{0, 537, "d_zp_as_zero", d_zp_as_zero, d_zp_as_zero_bench, "{return test(\"%+04d\", 0);}"},
	{0, 538, "d_prec_width_fit_fit_pos", d_prec_width_fit_fit_pos, d_prec_width_fit_fit_pos_bench, "{return test(\"%8.5d\", 34);}"},
	{0, 539, "d_prec_width_fit_fit_neg", d_prec_width_fit_fit_neg, d_prec_width_fit_fit_neg_bench, "{return test(\"%10.5d\", -216);}"},
	{0, 540, "d_prec_width_fit_fit_zero", d_prec_width_fit_fit_zero, d_prec_width_fit_fit_zero_bench, "{return test(\"%8.5d\", 0);}"},
	{0, 541, "d_prec_width_nofit_fit_pos", d_prec_width_nofit_fit_pos, d_prec_width_nofit_fit_pos_bench, "{return test(\"%8.3d\", 8375);}"},
	{0, 542, "d_prec_width_nofit_fit_neg", d_prec_width_nofit_fit_neg, d_prec_width_nofit_fit_neg_bench, "{return test(\"%8.3d\", -8473);}"},
	{0, 543, "d_prec_width_fit_nofit_pos", d_prec_width_fit_nofit_pos, d_prec_width_fit_nofit_pos_bench, "{return test(\"%3.7d\", 3267);}"},
	{0, 544, "d_prec_width_fit_nofit_neg", d_prec_width_fit_nofit_neg, d_prec_width_fit_nofit_neg_bench, "{return test(\"%3.7d\", -2375);}"},
	{0, 545, "d_prec_width_nofit_nofit_pos", d_prec_width_nofit_nofit_pos, d_prec_width_nofit_nofit_pos_bench, "{return test(\"%3.3d\", 6983);}"},
	{0, 546, "d_prec_width_nofit_nofit_neg", d_prec_width_nofit_nofit_neg, d_prec_width_nofit_nofit_neg_bench, "{return test(\"%3.3d\", -8462);}"},
	{0, 547, "d_prec_width_fit_fit_pos_lj", d_prec_width_fit_fit_pos_lj, d_prec_width_fit_fit_pos_lj_bench, "{return test(\"%-8.5d\", 34);}"},
	{0, 548, "d_prec_width_fit_fit_neg_lj", d_prec_width_fit_fit_neg_lj, d_prec_width_fit_fit_neg_lj_bench, "{return test(\"%-10.5d\", -216);}"},
	{0, 549, "d_prec_width_fit_fit_zero_lj", d_prec_width_fit_fit_zero_lj, d_prec_width_fit_fit_zero_lj_bench, "{return test(\"%-8.5d\", 0);}"},
	{0, 550, "d_prec_width_nofit_fit_pos_lj", d_prec_width_nofit_fit_pos_lj, d_prec_width_nofit_fit_pos_lj_bench, "{return test(\"%-8.3d\", 8375);}"},
	{0, 551, "d_prec_width_nofit_fit_neg_lj", d_prec_width_nofit_fit_neg_lj, d_prec_width_nofit_fit_neg_lj_bench, "{return test(\"%-8.3d\", -8473);}"},
	{0, 552, "d_prec_width_fit_nofit_pos_lj", d_prec_width_fit_nofit_pos_lj, d_prec_width_fit_nofit_pos_lj_bench, "{return test(\"%-3.7d\", 3267);}"},
	{0, 553, "d_prec_width_fit_nofit_neg_lj", d_prec_width_fit_nofit_neg_lj, d_prec_width_fit_nofit_neg_lj_bench, "{return test(\"%-3.7d\", -2375);}"},
	{0, 554, "d_prec_width_nofit_nofit_pos_lj", d_prec_width_nofit_nofit_pos_lj, d_prec_width_nofit_nofit_pos_lj_bench, "{return test(\"%-3.3d\", 6983);}"},
	{0, 555, "d_prec_width_nofit_nofit_neg_lj", d_prec_width_nofit_nofit_neg_lj, d_prec_width_nofit_nofit_neg_lj_bench, "{return test(\"%-3.3d\", -8462);}"},
	{0, 556, "d_prec_width_fit_fit_pos_as", d_prec_width_fit_fit_pos_as, d_prec_width_fit_fit_pos_as_bench, "{return test(\"%+8.5d\", 34);}"},
	{0, 557, "d_prec_width_fit_fit_neg_as", d_prec_width_fit_fit_neg_as, d_prec_width_fit_fit_neg_as_bench, "{return test(\"%+10.5d\", -216);}"},
	{0, 558, "d_prec_width_fit_fit_zero_as", d_prec_width_fit_fit_zero_as, d_prec_width_fit_fit_zero_as_bench, "{return test(\"%+8.5d\", 0);}"},
	{0, 559, "d_prec_width_nofit_fit_pos_as", d_prec_width_nofit_fit_pos_as, d_prec_width_nofit_fit_pos_as_bench, "{return test(\"%+8.3d\", 8375);}"},
	{0, 560, "d_prec_width_nofit_fit_neg_as", d_prec_width_nofit_fit_neg_as, d_prec_width_nofit_fit_neg_as_bench, "{return test(\"%+8.3d\", -8473);}"},
	{0, 561, "d_prec_width_fit_nofit_pos_as", d_prec_width_fit_nofit_pos_as, d_prec_width_fit_nofit_pos_as_bench, "{return test(\"%+3.7d\", 3267);}"},
	{0, 562, "d_prec_width_fit_nofit_neg_as", d_prec_width_fit_nofit_neg_as, d_prec_width_fit_nofit_neg_as_bench, "{return test(\"%+3.7d\", -2375);}"},
	{0, 563, "d_prec_width_nofit_nofit_pos_as", d_prec_width_nofit_nofit_pos_as, d_prec_width_nofit_nofit_pos_as_bench, "{return test(\"%+3.3d\", 6983);}"},
	{0, 564, "d_prec_width_nofit_nofit_neg_as", d_prec_width_nofit_nofit_neg_as, d_prec_width_nofit_nofit_neg_as_bench, "{return test(\"%+3.3d\", -8462);}"},
	{0, 565, "d_prec_width_fit_fit_pos_ljas", d_prec_width_fit_fit_pos_ljas, d_prec_width_fit_fit_pos_ljas_bench, "{return test(\"%+-8.5d\", 34);}"},
	{0, 566, "d_prec_width_fit_fit_neg_ljas", d_prec_width_fit_fit_neg_ljas, d_prec_width_fit_fit_neg_ljas_bench, "{return test(\"%+-10.5d\", -216);}"},
	{0, 567, "d_prec_width_fit_fit_zero_ljas", d_prec_width_fit_fit_zero_ljas, d_prec_width_fit_fit_zero_ljas_bench, "{return test(\"%+-8.5d\", 0);}"},
	{0, 568, "d_prec_width_nofit_fit_pos_ljas", d_prec_width_nofit_fit_pos_ljas, d_prec_width_nofit_fit_pos_ljas_bench, "{return test(\"%+-8.3d\", 8375);}"},
	{0, 569, "d_prec_width_nofit_fit_neg_ljas", d_prec_width_nofit_fit_neg_ljas, d_prec_width_nofit_fit_neg_ljas_bench, "{return test(\"%+-8.3d\", -8473);}"},
	{0, 570, "d_prec_width_fit_nofit_pos_ljas", d_prec_width_fit_nofit_pos_ljas, d_prec_width_fit_nofit_pos_ljas_bench, "{return test(\"%+-3.7d\", 3267);}"},
	{0, 571, "d_prec_width_fit_nofit_neg_ljas", d_prec_width_fit_nofit_neg_ljas, d_prec_width_fit_nofit_neg_ljas_bench, "{return test(\"%+-3.7d\", -2375);}"},
	{0, 572, "d_prec_width_nofit_nofit_pos_ljas", d_prec_width_nofit_nofit_pos_ljas, d_prec_width_nofit_nofit_pos_ljas_bench, "{return test(\"%+-3.3d\", 6983);}"},
	{0, 573, "d_prec_width_nofit_nofit_neg_ljas", d_prec_width_nofit_nofit_neg_ljas, d_prec_width_nofit_nofit_neg_ljas_bench, "{return test(\"%+-3.3d\", -8462);}"},
	{0, 574, "d_prec_width_ff_pos_zp", d_prec_width_ff_pos_zp, d_prec_width_ff_pos_zp_bench, "{return test(\"%08.5d\", 34);}"},
	{0, 575, "d_prec_width_ff_neg_zp", d_prec_width_ff_neg_zp, d_prec_width_ff_neg_zp_bench, "{return test(\"%010.5d\", -216);}"},
	{0, 576, "d_prec_width_ff_zero_zp", d_prec_width_ff_zero_zp, d_prec_width_ff_zero_zp_bench, "{return test(\"%08.5d\", 0);}"},
	{0, 577, "d_prec_width_nf_pos_zp", d_prec_width_nf_pos_zp, d_prec_width_nf_pos_zp_bench, "{return test(\"%08.3d\", 8375);}"},
	{0, 578, "d_prec_width_nf_neg_zp", d_prec_width_nf_neg_zp, d_prec_width_nf_neg_zp_bench, "{return test(\"%08.3d\", -8473);}"},
	{0, 579, "d_prec_width_fn_pos_zp", d_prec_width_fn_pos_zp, d_prec_width_fn_pos_zp_bench, "{return test(\"%03.7d\", 3267);}"},
	{0, 580, "d_prec_width_fn_neg_zp", d_prec_width_fn_neg_zp, d_prec_width_fn_neg_zp_bench, "{return test(\"%03.7d\", -2375);}"},
	{0, 581, "d_prec_width_nn_pos_zp", d_prec_width_nn_pos_zp, d_prec_width_nn_pos_zp_bench, "{return test(\"%03.3d\", 6983);}"},
	{0, 582, "d_prec_width_nn_neg_zp", d_prec_width_nn_neg_zp, d_prec_width_nn_neg_zp_bench, "{return test(\"%03.3d\", -8462);}"},
	{0, 583, "d_prec_width_ff_pos_lj_zp_ignoreflag", d_prec_width_ff_pos_lj_zp_ignoreflag, d_prec_width_ff_pos_lj_zp_ignoreflag_bench, "{return test(\"%0-8.5d\", 34);}"},
	{0, 584, "d_prec_width_ff_neg_ljzp_ignoreflag", d_prec_width_ff_neg_ljzp_ignoreflag, d_prec_width_ff_neg_ljzp_ignoreflag_bench, "{return test(\"%0-10.5d\", -216);}"},
	{0, 585, "d_prec_width_ff_zero_ljzp_ignoreflag", d_prec_width_ff_zero_ljzp_ignoreflag, d_prec_width_ff_zero_ljzp_ignoreflag_bench, "{return test(\"%0-8.5d\", 0);}"},
	{0, 586, "d_prec_width_nf_pos_ljzp_ignoreflag", d_prec_width_nf_pos_ljzp_ignoreflag, d_prec_width_nf_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.3d\", 8375);}"},
	{0, 587, "d_prec_width_nf_neg_ljzp_ignoreflag", d_prec_width_nf_neg_ljzp_ignoreflag, d_prec_width_nf_neg_ljzp_ignoreflag_bench, "{return test(\"%0-8.3d\", -8473);}"},
	{0, 588, "d_prec_width_fn_pos_ljzp_ignoreflag", d_prec_width_fn_pos_ljzp_ignoreflag, d_prec_width_fn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.7d\", 3267);}"},
	{0, 589, "d_prec_width_fn_neg_ljzp_ignoreflag", d_prec_width_fn_neg_ljzp_ignoreflag, d_prec_width_fn_neg_ljzp_ignoreflag_bench, "{return test(\"%0-3.7d\", -2375);}"},
	{0, 590, "d_prec_width_nn_pos_ljzp_ignoreflag", d_prec_width_nn_pos_ljzp_ignoreflag, d_prec_width_nn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.3d\", 6983);}"},
	{0, 591, "d_prec_width_nn_neg_ljzp_ignoreflag", d_prec_width_nn_neg_ljzp_ignoreflag, d_prec_width_nn_neg_ljzp_ignoreflag_bench, "{return test(\"%0-3.3d\", -8462);}"},
	{0, 592, "d_prec_width_ff_pos_aszp", d_prec_width_ff_pos_aszp, d_prec_width_ff_pos_aszp_bench, "{return test(\"%0+8.5d\", 34);}"},
	{0, 593, "d_prec_width_ff_neg_aszp", d_prec_width_ff_neg_aszp, d_prec_width_ff_neg_aszp_bench, "{return test(\"%0+10.5d\", -216);}"},
	{0, 594, "d_prec_width_ff_zero_aszp", d_prec_width_ff_zero_aszp, d_prec_width_ff_zero_aszp_bench, "{return test(\"%0+8.5d\", 0);}"},
	{0, 595, "d_prec_width_nf_pos_aszp", d_prec_width_nf_pos_aszp, d_prec_width_nf_pos_aszp_bench, "{return test(\"%0+8.3d\", 8375);}"},
	{0, 596, "d_prec_width_nf_neg_aszp", d_prec_width_nf_neg_aszp, d_prec_width_nf_neg_aszp_bench, "{return test(\"%0+8.3d\", -8473);}"},
	{0, 597, "d_prec_width_fn_pos_aszp", d_prec_width_fn_pos_aszp, d_prec_width_fn_pos_aszp_bench, "{return test(\"%0+3.7d\", 3267);}"},
	{0, 598, "d_prec_width_fn_neg_aszp", d_prec_width_fn_neg_aszp, d_prec_width_fn_neg_aszp_bench, "{return test(\"%0+3.7d\", -2375);}"},
	{0, 599, "d_prec_width_nn_pos_aszp", d_prec_width_nn_pos_aszp, d_prec_width_nn_pos_aszp_bench, "{return test(\"%0+3.3d\", 6983);}"},
	{0, 600, "d_prec_width_nn_neg_aszp", d_prec_width_nn_neg_aszp, d_prec_width_nn_neg_aszp_bench, "{return test(\"%0+3.3d\", -8462);}"},
	{0, 601, "d_prec_width_ff_pos_ljaszp_ignoreflag", d_prec_width_ff_pos_ljaszp_ignoreflag, d_prec_width_ff_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.5d\", 34);}"},
	{0, 602, "d_prec_width_ff_neg_ljaszp_ignoreflag", d_prec_width_ff_neg_ljaszp_ignoreflag, d_prec_width_ff_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-10.5d\", -216);}"},
	{0, 603, "d_prec_width_ff_zero_ljaszp_ignoreflag", d_prec_width_ff_zero_ljaszp_ignoreflag, d_prec_width_ff_zero_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.5d\", 0);}"},
	{0, 604, "d_prec_width_nf_pos_ljaszp_ignoreflag", d_prec_width_nf_pos_ljaszp_ignoreflag, d_prec_width_nf_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.3d\", 8375);}"},
	{0, 605, "d_prec_width_nf_neg_ljaszp_ignoreflag", d_prec_width_nf_neg_ljaszp_ignoreflag, d_prec_width_nf_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-8.3d\", -8473);}"},
	{0, 606, "d_prec_width_fn_pos_ljaszp_ignoreflag", d_prec_width_fn_pos_ljaszp_ignoreflag, d_prec_width_fn_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.7d\", 3267);}"},
	{0, 607, "d_prec_width_fn_neg_ljaszp_ignoreflag", d_prec_width_fn_neg_ljaszp_ignoreflag, d_prec_width_fn_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.7d\", -2375);}"},
	{0, 608, "d_prec_width_nn_pos_ljaszp_ignoreflag", d_prec_width_nn_pos_ljaszp_ignoreflag, d_prec_width_nn_pos_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.3d\", 6983);}"},
	{0, 609, "d_prec_width_nn_neg_ljaszp_ignoreflag", d_prec_width_nn_neg_ljaszp_ignoreflag, d_prec_width_nn_neg_ljaszp_ignoreflag_bench, "{return test(\"%0+-3.3d\", -8462);}"},
	{0, 610, "d_size_hh_pos_casted", d_size_hh_pos_casted, d_size_hh_pos_casted_bench, "{return test(\"%hhd\", (char)45);}"},
	{0, 611, "d_size_hh_neg_casted", d_size_hh_neg_casted, d_size_hh_neg_casted_bench, "{return test(\"%hhd\", (char)-45);}"},
	{0, 612, "d_size_h_pos_casted", d_size_h_pos_casted, d_size_h_pos_casted_bench, "{return test(\"%hd\", (short)385);}"},
	{0, 613, "d_size_h_neg_casted", d_size_h_neg_casted, d_size_h_neg_casted_bench, "{return test(\"%hd\", (short)-385);}"},
	{0, 614, "d_size_l_pos_casted", d_size_l_pos_casted, d_size_l_pos_casted_bench, "{return test(\"%ld\", (long)32);}"},
	{0, 615, "d_size_l_neg_casted", d_size_l_neg_casted, d_size_l_neg_casted_bench, "{return test(\"%ld\", (long)-32);}"},
	{0, 616, "d_size_ll_pos_casted", d_size_ll_pos_casted, d_size_ll_pos_casted_bench, "{return test(\"%lld\", (long long)43);}"},
	{0, 617, "d_size_ll_neg_casted", d_size_ll_neg_casted, d_size_ll_neg_casted_bench, "{return test(\"%lld\", (long long)-43);}"},
	{0, 618, "d_size_hh_pos_ref", d_size_hh_pos_ref, d_size_hh_pos_ref_bench, "{return test(\"%hhd\", ch_pos_1);}"},
	{0, 619, "d_size_hh_neg_ref", d_size_hh_neg_ref, d_size_hh_neg_ref_bench, "{return test(\"%hhd\", ch_neg_1);}"},
	{0, 620, "d_size_h_pos_ref", d_size_h_pos_ref, d_size_h_pos_ref_bench, "{return test(\"%hd\", sh_pos_1);}"},
	{0, 621, "d_size_h_neg_ref", d_size_h_neg_ref, d_size_h_neg_ref_bench, "{return test(\"%hd\", sh_neg_1);}"},
	{0, 622, "d_size_l_pos_ref", d_size_l_pos_ref, d_size_l_pos_ref_bench, "{return test(\"%ld\", l_pos_1);}"},
	{0, 623, "d_size_l_pos_ref_lmax", d_size_l_pos_ref_lmax, d_size_l_pos_ref_lmax_bench, "{return test(\"%ld\", lmax);}"},
	{0, 624, "d_size_ll_pos_ref_llmax", d_size_ll_pos_ref_llmax, d_size_ll_pos_ref_llmax_bench, "{return test(\"%lld\", llmax);}"},
	{0, 625, "d_size_l_neg_ref", d_size_l_neg_ref, d_size_l_neg_ref_bench, "{return test(\"%ld\", l_neg_1);}"},
	{0, 626, "d_size_ll_pos_ref", d_size_ll_pos_ref, d_size_ll_pos_ref_bench, "{return test(\"%lld\", ll_pos_1);}"},
	{0, 627, "d_size_ll_neg_ref", d_size_ll_neg_ref, d_size_ll_neg_ref_bench, "{return test(\"%lld\", ll_neg_1);}"},
	{0, 628, "d_size_l_pos_big", d_size_l_pos_big, d_size_l_pos_big_bench, "{return test(\"%ld\", 22337203685477);}"},
	{0, 629, "d_size_l_neg_big", d_size_l_neg_big, d_size_l_neg_big_bench, "{return test(\"%ld\", -22337203685477);}"},
	{0, 630, "d_size_ll_pos_big", d_size_ll_pos_big, d_size_ll_pos_big_bench, "{return test(\"%lld\", 522337203685470ll);}"},
	{0, 631, "d_size_ll_neg_big", d_size_ll_neg_big, d_size_ll_neg_big_bench, "{return test(\"%lld\", -522337203685470ll);}"},
	{0, 632, "d_llmax", d_llmax, d_llmax_bench, "{return test(\"%lld\", 9223372036854775807ll);}"},
	{0, 633, "d_llmin", d_llmin, d_llmin_bench, "{return test(\"%lld\", llmin);}"},
	{0, 634, "d_lmax", d_lmax, d_lmax_bench, "{return test(\"%ld\", 9223372036854775807l);}"},
	{0, 635, "d_lmin", d_lmin, d_lmin_bench, "{return test(\"%ld\", lmin);}"},
	{0, 636, "d_hmax", d_hmax, d_hmax_bench, "{return test(\"%hd\", (short)32767);}"},
	{0, 637, "d_hmin", d_hmin, d_hmin_bench, "{return test(\"%hd\", (short)(-32768));}"},
	{0, 638, "d_hhmax", d_hhmax, d_hhmax_bench, "{return test(\"%hhd\", (char)127);}"},
	{0, 639, "d_hhmin", d_hhmin, d_hhmin_bench, "{return test(\"%hhd\", (char)(-128));}"},
	{0, 640, "d_size_l_pos_big_zp", d_size_l_pos_big_zp, d_size_l_pos_big_zp_bench, "{return test(\"%037ld\", 22337203685477l);}"},
	{0, 641, "d_size_l_neg_big_prec", d_size_l_neg_big_prec, d_size_l_neg_big_prec_bench, "{return test(\"%.37ld\", -22337203685477l);}"},
	{0, 642, "d_size_ll_pos_big_width", d_size_ll_pos_big_width, d_size_ll_pos_big_width_bench, "{return test(\"%37lld\", 522337203685470ll);}"},
	{0, 643, "d_size_ll_neg_big_lj", d_size_ll_neg_big_lj, d_size_ll_neg_big_lj_bench, "{return test(\"%-37lld\", -522337203685470ll);}"},
	{0, 644, "d_size_l_pos_big_as", d_size_l_pos_big_as, d_size_l_pos_big_as_bench, "{return test(\"%+ld\", 22337203685477l);}"},
	{0, 645, "d_size_follows_i_i", d_size_follows_i_i, d_size_follows_i_i_bench, "{return test(\"[%d] [%d]\", i_pos_1, i_pos_1);}"},
	{0, 646, "d_size_follows_i_l", d_size_follows_i_l, d_size_follows_i_l_bench, "{return test(\"[%d] [%ld]\", i_pos_1, l_pos_1);}"},
	{0, 647, "d_size_follows_i_ll", d_size_follows_i_ll, d_size_follows_i_ll_bench, "{return test(\"[%d] [%lld]\", i_pos_1, ll_pos_1);}"},
	{0, 648, "d_size_follows_i_h", d_size_follows_i_h, d_size_follows_i_h_bench, "{return test(\"[%d] [%hd]\", i_pos_1, sh_pos_1);}"},
	{0, 649, "d_size_follows_i_hh", d_size_follows_i_hh, d_size_follows_i_hh_bench, "{return test(\"[%d] [%hhd]\", i_pos_1, ch_pos_1);}"},
	{0, 650, "d_size_ll_hh_ll", d_size_ll_hh_ll, d_size_ll_hh_ll_bench, "{return test(\"%lld%hhd%lld\", ll_pos_1, ch_neg_1, ll_neg_1);}"},
	{0, 651, "d_size_h_l_hh", d_size_h_l_hh, d_size_h_l_hh_bench, "{return test(\"%hd%ld%hhd\", sh_pos_1, l_neg_1, ch_neg_1);}"},
	{0, 652, "d_size_l_hh_h", d_size_l_hh_h, d_size_l_hh_h_bench, "{return test(\"%ld%hhd%hd\", l_neg_1, ch_pos_1, sh_pos_1);}"},
	{0, 653, "d_size_n_ll_hh", d_size_n_ll_hh, d_size_n_ll_hh_bench, "{return test(\"%d%lld%hhd\", i_pos_1, ll_neg_1, ch_pos_1);}"},
	{0, 654, "d_size_ll_n_l", d_size_ll_n_l, d_size_ll_n_l_bench, "{return test(\"%lli%d%ld\", ll_neg_1, i_pos_1, l_pos_1);}"},
	{0, 655, "d_basic_i_pos_sp", d_basic_i_pos_sp, d_basic_i_pos_sp_bench, "{return test(\"this % d number\", 17);}"},
	{0, 656, "d_basic_i_neg_sp", d_basic_i_neg_sp, d_basic_i_neg_sp_bench, "{return test(\"this % d number\", -267);}"},
	{0, 657, "d_basic_i_zero_sp", d_basic_i_zero_sp, d_basic_i_zero_sp_bench, "{return test(\"this % d number\", 0);}"},
	{0, 658, "d_basic_i_onlypos_sp", d_basic_i_onlypos_sp, d_basic_i_onlypos_sp_bench, "{return test(\"% d\", 3);}"},
	{0, 659, "d_basic_i_onlyneg_sp", d_basic_i_onlyneg_sp, d_basic_i_onlyneg_sp_bench, "{return test(\"% d\", -1);}"},
	{0, 660, "d_basic_i_onlyzero_sp", d_basic_i_onlyzero_sp, d_basic_i_onlyzero_sp_bench, "{return test(\"% d\", 0);}"},
	{0, 661, "d_basic_i_pos_d_sp", d_basic_i_pos_d_sp, d_basic_i_pos_d_sp_bench, "{return test(\"this % d number\", 17);}"},
	{0, 662, "d_basic_i_neg_d_sp", d_basic_i_neg_d_sp, d_basic_i_neg_d_sp_bench, "{return test(\"this % d number\", -267);}"},
	{0, 663, "d_basic_i_zero_d_sp", d_basic_i_zero_d_sp, d_basic_i_zero_d_sp_bench, "{return test(\"this % d number\", 0);}"},
	{0, 664, "d_intmax_sp", d_intmax_sp, d_intmax_sp_bench, "{return test(\"% d\", 2147483647);}"},
	{0, 665, "d_intmin_sp", d_intmin_sp, d_intmin_sp_bench, "{return test(\"% d\", (int)(-2147483678));}"},
	{0, 666, "d_assp_pos_ignoreflag", d_assp_pos_ignoreflag, d_assp_pos_ignoreflag_bench, "{return test(\"% +d\", 5);}"},
	{0, 667, "d_assp_neg_ignoreflag", d_assp_neg_ignoreflag, d_assp_neg_ignoreflag_bench, "{return test(\"% +d\", -7);}"},
	{0, 668, "d_intmax_assp_ignoreflag", d_intmax_assp_ignoreflag, d_intmax_assp_ignoreflag_bench, "{return test(\"% +d\", 2147483647);}"},
	{0, 669, "d_width_pos_fits_sp", d_width_pos_fits_sp, d_width_pos_fits_sp_bench, "{return test(\"% 7d\", 33);}"},
	{0, 670, "d_width_neg_fits_sp", d_width_neg_fits_sp, d_width_neg_fits_sp_bench, "{return test(\"% 7d\", -14);}"},
	{0, 671, "d_width_zero_fits_sp", d_width_zero_fits_sp, d_width_zero_fits_sp_bench, "{return test(\"% 3d\", 0);}"},
	{0, 672, "d_width_pos_exactfit_sp", d_width_pos_exactfit_sp, d_width_pos_exactfit_sp_bench, "{return test(\"% 5d\", 52625);}"},
	{0, 673, "d_width_neg_exactfit_sp", d_width_neg_exactfit_sp, d_width_neg_exactfit_sp_bench, "{return test(\"% 5d\", -2562);}"},
	{0, 674, "d_width_pos_nofit_sp", d_width_pos_nofit_sp, d_width_pos_nofit_sp_bench, "{return test(\"% 4d\", 94827);}"},
	{0, 675, "d_width_neg_nofit_sp", d_width_neg_nofit_sp, d_width_neg_nofit_sp_bench, "{return test(\"% 4d\", -2464);}"},
	{0, 676, "d_width_pos_fits_lj_sp", d_width_pos_fits_lj_sp, d_width_pos_fits_lj_sp_bench, "{return test(\"% -7d\", 33);}"},
	{0, 677, "d_width_neg_fits_lj_sp", d_width_neg_fits_lj_sp, d_width_neg_fits_lj_sp_bench, "{return test(\"% -7d\", -14);}"},
	{0, 678, "d_width_zero_fits_lj_sp", d_width_zero_fits_lj_sp, d_width_zero_fits_lj_sp_bench, "{return test(\"% -3d\", 0);}"},
	{0, 679, "d_width_pos_exactfit_lj_sp", d_width_pos_exactfit_lj_sp, d_width_pos_exactfit_lj_sp_bench, "{return test(\"% -5d\", 52625);}"},
	{0, 680, "d_width_neg_exactfit_lj_sp", d_width_neg_exactfit_lj_sp, d_width_neg_exactfit_lj_sp_bench, "{return test(\"% -5d\", -2562);}"},
	{0, 681, "d_width_pos_nofit_lj_sp", d_width_pos_nofit_lj_sp, d_width_pos_nofit_lj_sp_bench, "{return test(\"% -4d\", 94827);}"},
	{0, 682, "d_width_neg_nofit_lj_sp", d_width_neg_nofit_lj_sp, d_width_neg_nofit_lj_sp_bench, "{return test(\"% -4d\", -2464);}"},
	{0, 683, "d_width_assp_pos_ignoreflag", d_width_assp_pos_ignoreflag, d_width_assp_pos_ignoreflag_bench, "{return test(\"% +5d\", 35);}"},
	{0, 684, "d_width_assp_zero_ignoreflag", d_width_assp_zero_ignoreflag, d_width_assp_zero_ignoreflag_bench, "{return test(\"% +7d\", 0);}"},
	{0, 685, "d_width_intmax_assp_ignoreflag", d_width_intmax_assp_ignoreflag, d_width_intmax_assp_ignoreflag_bench, "{return test(\"% +24d\", 2147483647);}"},
	{0, 686, "d_prec_fits_pos_sp", d_prec_fits_pos_sp, d_prec_fits_pos_sp_bench, "{return test(\"% .5d\", 2);}"},
	{0, 687, "d_prec_fits_neg_sp", d_prec_fits_neg_sp, d_prec_fits_neg_sp_bench, "{return test(\"% .6d\", -3);}"},
	{0, 688, "d_prec_fits_zero_sp", d_prec_fits_zero_sp, d_prec_fits_zero_sp_bench, "{return test(\"% .3d\", 0);}"},
	{0, 689, "d_prec_exactfit_pos_sp", d_prec_exactfit_pos_sp, d_prec_exactfit_pos_sp_bench, "{return test(\"% .4d\", 5263);}"},
	{0, 690, "d_prec_exactfit_neg_sp", d_prec_exactfit_neg_sp, d_prec_exactfit_neg_sp_bench, "{return test(\"% .4d\", -2372);}"},
	{0, 691, "d_prec_nofit_pos_sp", d_prec_nofit_pos_sp, d_prec_nofit_pos_sp_bench, "{return test(\"% .3d\", 13862);}"},
	{0, 692, "d_prec_nofit_neg_sp", d_prec_nofit_neg_sp, d_prec_nofit_neg_sp_bench, "{return test(\"% .3d\",-23646);}"},
	{0, 693, "d_prec_assp_pos_ignoreflag", d_prec_assp_pos_ignoreflag, d_prec_assp_pos_ignoreflag_bench, "{return test(\"% +.7d\", 234);}"},
	{0, 694, "d_prec_assp_neg_ignoreflag", d_prec_assp_neg_ignoreflag, d_prec_assp_neg_ignoreflag_bench, "{return test(\"% +.7d\", -446);}"},
	{0, 695, "d_prec_assp_pos_nofit_ignoreflag", d_prec_assp_pos_nofit_ignoreflag, d_prec_assp_pos_nofit_ignoreflag_bench, "{return test(\"% +.3d\", 3723);}"},
	{0, 696, "d_zpsp_pos_fits", d_zpsp_pos_fits, d_zpsp_pos_fits_bench, "{return test(\"% 05d\", 43);}"},
	{0, 697, "d_zpsp_neg_fits", d_zpsp_neg_fits, d_zpsp_neg_fits_bench, "{return test(\"% 07d\", -54);}"},
	{0, 698, "d_zpsp_zero_fits", d_zpsp_zero_fits, d_zpsp_zero_fits_bench, "{return test(\"% 03d\", 0);}"},
	{0, 699, "d_zpsp_pos_exactfit", d_zpsp_pos_exactfit, d_zpsp_pos_exactfit_bench, "{return test(\"% 03d\", 634);}"},
	{0, 700, "d_zpsp_neg_exactfit", d_zpsp_neg_exactfit, d_zpsp_neg_exactfit_bench, "{return test(\"% 04d\", -532);}"},
	{0, 701, "d_zpsp_neg_minus1fit", d_zpsp_neg_minus1fit, d_zpsp_neg_minus1fit_bench, "{return test(\"% 04d\", -4825);}"},
	{0, 702, "d_zpassp_as_fits_ignoreflag", d_zpassp_as_fits_ignoreflag, d_zpassp_as_fits_ignoreflag_bench, "{return test(\"% +05d\", 432);}"},
	{0, 703, "d_zpassp_zero_ignoreflag", d_zpassp_zero_ignoreflag, d_zpassp_zero_ignoreflag_bench, "{return test(\"% +04d\", 0);}"},
	{0, 704, "d_prec_width_fit_fit_pos_sp", d_prec_width_fit_fit_pos_sp, d_prec_width_fit_fit_pos_sp_bench, "{return test(\"% 8.5d\", 34);}"},
	{0, 705, "d_prec_width_fit_fit_neg_sp", d_prec_width_fit_fit_neg_sp, d_prec_width_fit_fit_neg_sp_bench, "{return test(\"% 10.5d\", -216);}"},
	{0, 706, "d_prec_width_fit_fit_zero_sp", d_prec_width_fit_fit_zero_sp, d_prec_width_fit_fit_zero_sp_bench, "{return test(\"% 8.5d\", 0);}"},
	{0, 707, "d_prec_width_nofit_fit_pos_sp", d_prec_width_nofit_fit_pos_sp, d_prec_width_nofit_fit_pos_sp_bench, "{return test(\"% 8.3d\", 8375);}"},
	{0, 708, "d_prec_width_nofit_fit_neg_sp", d_prec_width_nofit_fit_neg_sp, d_prec_width_nofit_fit_neg_sp_bench, "{return test(\"% 8.3d\", -8473);}"},
	{0, 709, "d_prec_width_fit_nofit_pos_sp", d_prec_width_fit_nofit_pos_sp, d_prec_width_fit_nofit_pos_sp_bench, "{return test(\"% 3.7d\", 3267);}"},
	{0, 710, "d_prec_width_fit_nofit_neg_sp", d_prec_width_fit_nofit_neg_sp, d_prec_width_fit_nofit_neg_sp_bench, "{return test(\"% 3.7d\", -2375);}"},
	{0, 711, "d_prec_width_nofit_nofit_pos_sp", d_prec_width_nofit_nofit_pos_sp, d_prec_width_nofit_nofit_pos_sp_bench, "{return test(\"% 3.3d\", 6983);}"},
	{0, 712, "d_prec_width_nofit_nofit_neg_sp", d_prec_width_nofit_nofit_neg_sp, d_prec_width_nofit_nofit_neg_sp_bench, "{return test(\"% 3.3d\", -8462);}"},
	{0, 713, "d_prec_width_fit_fit_pos_lj_sp", d_prec_width_fit_fit_pos_lj_sp, d_prec_width_fit_fit_pos_lj_sp_bench, "{return test(\"% -8.5d\", 34);}"},
	{0, 714, "d_prec_width_fit_fit_neg_lj_sp", d_prec_width_fit_fit_neg_lj_sp, d_prec_width_fit_fit_neg_lj_sp_bench, "{return test(\"% -10.5d\", -216);}"},
	{0, 715, "d_prec_width_fit_fit_zero_lj_sp", d_prec_width_fit_fit_zero_lj_sp, d_prec_width_fit_fit_zero_lj_sp_bench, "{return test(\"% -8.5d\", 0);}"},
	{0, 716, "d_prec_width_nofit_fit_pos_lj_sp", d_prec_width_nofit_fit_pos_lj_sp, d_prec_width_nofit_fit_pos_lj_sp_bench, "{return test(\"% -8.3d\", 8375);}"},
	{0, 717, "d_prec_width_nofit_fit_neg_lj_sp", d_prec_width_nofit_fit_neg_lj_sp, d_prec_width_nofit_fit_neg_lj_sp_bench, "{return test(\"% -8.3d\", -8473);}"},
	{0, 718, "d_prec_width_fit_nofit_pos_lj_sp", d_prec_width_fit_nofit_pos_lj_sp, d_prec_width_fit_nofit_pos_lj_sp_bench, "{return test(\"% -3.7d\", 3267);}"},
	{0, 719, "d_prec_width_fit_nofit_neg_lj_sp", d_prec_width_fit_nofit_neg_lj_sp, d_prec_width_fit_nofit_neg_lj_sp_bench, "{return test(\"% -3.7d\", -2375);}"},
	{0, 720, "d_prec_width_nofit_nofit_pos_lj_sp", d_prec_width_nofit_nofit_pos_lj_sp, d_prec_width_nofit_nofit_pos_lj_sp_bench, "{return test(\"% -3.3d\", 6983);}"},
	{0, 721, "d_prec_width_nofit_nofit_neg_lj_sp", d_prec_width_nofit_nofit_neg_lj_sp, d_prec_width_nofit_nofit_neg_lj_sp_bench, "{return test(\"% -3.3d\", -8462);}"},
	{0, 722, "d_prec_width_fit_fit_pos_assp_ignoreflag", d_prec_width_fit_fit_pos_assp_ignoreflag, d_prec_width_fit_fit_pos_assp_ignoreflag_bench, "{return test(\"% +8.5d\", 34);}"},
	{0, 723, "d_prec_width_fit_fit_neg_assp_ignoreflag", d_prec_width_fit_fit_neg_assp_ignoreflag, d_prec_width_fit_fit_neg_assp_ignoreflag_bench, "{return test(\"% +10.5d\", -216);}"},
	{0, 724, "d_prec_width_fit_fit_zero_assp_ignoreflag", d_prec_width_fit_fit_zero_assp_ignoreflag, d_prec_width_fit_fit_zero_assp_ignoreflag_bench, "{return test(\"% +8.5d\", 0);}"},
	{0, 725, "d_prec_width_nofit_fit_pos_assp_ignoreflag", d_prec_width_nofit_fit_pos_assp_ignoreflag, d_prec_width_nofit_fit_pos_assp_ignoreflag_bench, "{return test(\"% +8.3d\", 8375);}"},
	{0, 726, "d_prec_width_nofit_fit_neg_assp_ignoreflag", d_prec_width_nofit_fit_neg_assp_ignoreflag, d_prec_width_nofit_fit_neg_assp_ignoreflag_bench, "{return test(\"% +8.3d\", -8473);}"},
	{0, 727, "d_prec_width_fit_nofit_pos_assp_ignoreflag", d_prec_width_fit_nofit_pos_assp_ignoreflag, d_prec_width_fit_nofit_pos_assp_ignoreflag_bench, "{return test(\"% +3.7d\", 3267);}"},
	{0, 728, "d_prec_width_fit_nofit_neg_assp_ignoreflag", d_prec_width_fit_nofit_neg_assp_ignoreflag, d_prec_width_fit_nofit_neg_assp_ignoreflag_bench, "{return test(\"% +3.7d\", -2375);}"},
	{0, 729, "d_prec_width_nofit_nofit_pos_assp_ignoreflag", d_prec_width_nofit_nofit_pos_assp_ignoreflag, d_prec_width_nofit_nofit_pos_assp_ignoreflag_bench, "{return test(\"% +3.3d\", 6983);}"},
	{0, 730, "d_prec_width_nofit_nofit_neg_assp_ignoreflag", d_prec_width_nofit_nofit_neg_assp_ignoreflag, d_prec_width_nofit_nofit_neg_assp_ignoreflag_bench, "{return test(\"% +3.3d\", -8462);}"},
	{0, 731, "d_prec_width_fit_fit_pos_lj_assp_ignoreflag", d_prec_width_fit_fit_pos_lj_assp_ignoreflag, d_prec_width_fit_fit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-8.5d\", 34);}"},
	{0, 732, "d_prec_width_fit_fit_neg_lj_assp_ignoreflag", d_prec_width_fit_fit_neg_lj_assp_ignoreflag, d_prec_width_fit_fit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-10.5d\", -216);}"},
	{0, 733, "d_prec_width_fit_fit_zero_lj_assp_ignoreflag", d_prec_width_fit_fit_zero_lj_assp_ignoreflag, d_prec_width_fit_fit_zero_lj_assp_ignoreflag_bench, "{return test(\"% +-8.5d\", 0);}"},
	{0, 734, "d_prec_width_nofit_fit_pos_lj_assp_ignoreflag", d_prec_width_nofit_fit_pos_lj_assp_ignoreflag, d_prec_width_nofit_fit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-8.3d\", 8375);}"},
	{0, 735, "d_prec_width_nofit_fit_neg_lj_assp_ignoreflag", d_prec_width_nofit_fit_neg_lj_assp_ignoreflag, d_prec_width_nofit_fit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-8.3d\", -8473);}"},
	{0, 736, "d_prec_width_fit_nofit_pos_lj_assp_ignoreflag", d_prec_width_fit_nofit_pos_lj_assp_ignoreflag, d_prec_width_fit_nofit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-3.7d\", 3267);}"},
	{0, 737, "d_prec_width_fit_nofit_neg_lj_assp_ignoreflag", d_prec_width_fit_nofit_neg_lj_assp_ignoreflag, d_prec_width_fit_nofit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-3.7d\", -2375);}"},
	{0, 738, "d_prec_width_nofit_nofit_pos_lj_assp_ignoreflag", d_prec_width_nofit_nofit_pos_lj_assp_ignoreflag, d_prec_width_nofit_nofit_pos_lj_assp_ignoreflag_bench, "{return test(\"% +-3.3d\", 6983);}"},
	{0, 739, "d_prec_width_nofit_nofit_neg_lj_assp_ignoreflag", d_prec_width_nofit_nofit_neg_lj_assp_ignoreflag, d_prec_width_nofit_nofit_neg_lj_assp_ignoreflag_bench, "{return test(\"% +-3.3d\", -8462);}"},
	{0, 740, "d_prec_width_ff_pos_zp_sp", d_prec_width_ff_pos_zp_sp, d_prec_width_ff_pos_zp_sp_bench, "{return test(\"% 08.5d\", 34);}"},
	{0, 741, "d_prec_width_ff_neg_zp_sp", d_prec_width_ff_neg_zp_sp, d_prec_width_ff_neg_zp_sp_bench, "{return test(\"% 010.5d\", -216);}"},
	{0, 742, "d_prec_width_ff_zero_zp_sp", d_prec_width_ff_zero_zp_sp, d_prec_width_ff_zero_zp_sp_bench, "{return test(\"% 08.5d\", 0);}"},
	{0, 743, "d_prec_width_nf_pos_zp_sp", d_prec_width_nf_pos_zp_sp, d_prec_width_nf_pos_zp_sp_bench, "{return test(\"% 08.3d\", 8375);}"},
	{0, 744, "d_prec_width_nf_neg_zp_sp", d_prec_width_nf_neg_zp_sp, d_prec_width_nf_neg_zp_sp_bench, "{return test(\"% 08.3d\", -8473);}"},
	{0, 745, "d_prec_width_fn_pos_zp_sp", d_prec_width_fn_pos_zp_sp, d_prec_width_fn_pos_zp_sp_bench, "{return test(\"% 03.7d\", 3267);}"},
	{0, 746, "d_prec_width_fn_neg_zp_sp", d_prec_width_fn_neg_zp_sp, d_prec_width_fn_neg_zp_sp_bench, "{return test(\"% 03.7d\", -2375);}"},
	{0, 747, "d_prec_width_nn_pos_zp_sp", d_prec_width_nn_pos_zp_sp, d_prec_width_nn_pos_zp_sp_bench, "{return test(\"% 03.3d\", 6983);}"},
	{0, 748, "d_prec_width_nn_neg_zp_sp", d_prec_width_nn_neg_zp_sp, d_prec_width_nn_neg_zp_sp_bench, "{return test(\"% 03.3d\", -8462);}"},
	{0, 749, "d_prec_width_ff_pos_ljzpsp_ignoreflag", d_prec_width_ff_pos_ljzpsp_ignoreflag, d_prec_width_ff_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.5d\", 34);}"},
	{0, 750, "d_prec_width_ff_neg_ljzpsp_ignoreflag", d_prec_width_ff_neg_ljzpsp_ignoreflag, d_prec_width_ff_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-10.5d\", -216);}"},
	{0, 751, "d_prec_width_ff_zero_ljzpsp_ignoreflag", d_prec_width_ff_zero_ljzpsp_ignoreflag, d_prec_width_ff_zero_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.5d\", 0);}"},
	{0, 752, "d_prec_width_nf_pos_ljzpsp_ignoreflag", d_prec_width_nf_pos_ljzpsp_ignoreflag, d_prec_width_nf_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.3d\", 8375);}"},
	{0, 753, "d_prec_width_nf_neg_ljzpsp_ignoreflag", d_prec_width_nf_neg_ljzpsp_ignoreflag, d_prec_width_nf_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-8.3d\", -8473);}"},
	{0, 754, "d_prec_width_fn_pos_ljzpsp_ignoreflag", d_prec_width_fn_pos_ljzpsp_ignoreflag, d_prec_width_fn_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.7d\", 3267);}"},
	{0, 755, "d_prec_width_fn_neg_ljzpsp_ignoreflag", d_prec_width_fn_neg_ljzpsp_ignoreflag, d_prec_width_fn_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.7d\", -2375);}"},
	{0, 756, "d_prec_width_nn_pos_ljzpsp_ignoreflag", d_prec_width_nn_pos_ljzpsp_ignoreflag, d_prec_width_nn_pos_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.3d\", 6983);}"},
	{0, 757, "d_prec_width_nn_neg_ljzpsp_ignoreflag", d_prec_width_nn_neg_ljzpsp_ignoreflag, d_prec_width_nn_neg_ljzpsp_ignoreflag_bench, "{return test(\"% 0-3.3d\", -8462);}"},
	{0, 758, "d_prec_width_ff_pos_aszpsp_ignoreflag", d_prec_width_ff_pos_aszpsp_ignoreflag, d_prec_width_ff_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.5d\", 34);}"},
	{0, 759, "d_prec_width_ff_neg_aszpsp_ignoreflag", d_prec_width_ff_neg_aszpsp_ignoreflag, d_prec_width_ff_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+10.5d\", -216);}"},
	{0, 760, "d_prec_width_ff_zero_aszpsp_ignoreflag", d_prec_width_ff_zero_aszpsp_ignoreflag, d_prec_width_ff_zero_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.5d\", 0);}"},
	{0, 761, "d_prec_width_nf_pos_aszpsp_ignoreflag", d_prec_width_nf_pos_aszpsp_ignoreflag, d_prec_width_nf_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.3d\", 8375);}"},
	{0, 762, "d_prec_width_nf_neg_aszpsp_ignoreflag", d_prec_width_nf_neg_aszpsp_ignoreflag, d_prec_width_nf_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+8.3d\", -8473);}"},
	{0, 763, "d_prec_width_fn_pos_aszpsp_ignoreflag", d_prec_width_fn_pos_aszpsp_ignoreflag, d_prec_width_fn_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.7d\", 3267);}"},
	{0, 764, "d_prec_width_fn_neg_aszpsp_ignoreflag", d_prec_width_fn_neg_aszpsp_ignoreflag, d_prec_width_fn_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.7d\", -2375);}"},
	{0, 765, "d_prec_width_nn_pos_aszpsp_ignoreflag", d_prec_width_nn_pos_aszpsp_ignoreflag, d_prec_width_nn_pos_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.3d\", 6983);}"},
	{0, 766, "d_prec_width_nn_neg_aszpsp_ignoreflag", d_prec_width_nn_neg_aszpsp_ignoreflag, d_prec_width_nn_neg_aszpsp_ignoreflag_bench, "{return test(\"% 0+3.3d\", -8462);}"},
	{0, 767, "d_prec_width_ff_pos_ljaszpsp_ignoreflag", d_prec_width_ff_pos_ljaszpsp_ignoreflag, d_prec_width_ff_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.5d\", 34);}"},
	{0, 768, "d_prec_width_ff_neg_ljaszpsp_ignoreflag", d_prec_width_ff_neg_ljaszpsp_ignoreflag, d_prec_width_ff_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-10.5d\", -216);}"},
	{0, 769, "d_prec_width_ff_zero_ljaszpsp_ignoreflag", d_prec_width_ff_zero_ljaszpsp_ignoreflag, d_prec_width_ff_zero_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.5d\", 0);}"},
	{0, 770, "d_prec_width_nf_pos_ljaszpsp_ignoreflag", d_prec_width_nf_pos_ljaszpsp_ignoreflag, d_prec_width_nf_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.3d\", 8375);}"},
	{0, 771, "d_prec_width_nf_neg_ljaszpsp_ignoreflag", d_prec_width_nf_neg_ljaszpsp_ignoreflag, d_prec_width_nf_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-8.3d\", -8473);}"},
	{0, 772, "d_prec_width_fn_pos_ljaszpsp_ignoreflag", d_prec_width_fn_pos_ljaszpsp_ignoreflag, d_prec_width_fn_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.7d\", 3267);}"},
	{0, 773, "d_prec_width_fn_neg_ljaszpsp_ignoreflag", d_prec_width_fn_neg_ljaszpsp_ignoreflag, d_prec_width_fn_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.7d\", -2375);}"},
	{0, 774, "d_prec_width_nn_pos_ljaszpsp_ignoreflag", d_prec_width_nn_pos_ljaszpsp_ignoreflag, d_prec_width_nn_pos_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.3d\", 6983);}"},
	{0, 775, "d_prec_width_nn_neg_ljaszpsp_ignoreflag", d_prec_width_nn_neg_ljaszpsp_ignoreflag, d_prec_width_nn_neg_ljaszpsp_ignoreflag_bench, "{return test(\"% 0+-3.3d\", -8462);}"},
	{0, 776, "d_size_hh_pos_casted_sp", d_size_hh_pos_casted_sp, d_size_hh_pos_casted_sp_bench, "{return test(\"% hhd\", (char)45);}"},
	{0, 777, "d_size_hh_neg_casted_sp", d_size_hh_neg_casted_sp, d_size_hh_neg_casted_sp_bench, "{return test(\"% hhd\", (char)-45);}"},
	{0, 778, "d_size_h_pos_casted_sp", d_size_h_pos_casted_sp, d_size_h_pos_casted_sp_bench, "{return test(\"% hd\", (short)385);}"},
	{0, 779, "d_size_h_neg_casted_sp", d_size_h_neg_casted_sp, d_size_h_neg_casted_sp_bench, "{return test(\"% hd\", (short)-385);}"},
	{0, 780, "d_size_l_pos_casted_sp", d_size_l_pos_casted_sp, d_size_l_pos_casted_sp_bench, "{return test(\"% ld\", (long)32);}"},
	{0, 781, "d_size_l_neg_casted_sp", d_size_l_neg_casted_sp, d_size_l_neg_casted_sp_bench, "{return test(\"% ld\", (long)-32);}"},
	{0, 782, "d_size_ll_pos_casted_sp", d_size_ll_pos_casted_sp, d_size_ll_pos_casted_sp_bench, "{return test(\"% lld\", (long long)43);}"},
	{0, 783, "d_size_ll_neg_casted_sp", d_size_ll_neg_casted_sp, d_size_ll_neg_casted_sp_bench, "{return test(\"% lld\", (long long)-43);}"},
	{0, 784, "d_size_hh_pos_ref_sp", d_size_hh_pos_ref_sp, d_size_hh_pos_ref_sp_bench, "{return test(\"% hhd\", ch_pos_1);}"},
	{0, 785, "d_size_hh_neg_ref_sp", d_size_hh_neg_ref_sp, d_size_hh_neg_ref_sp_bench, "{return test(\"% hhd\", ch_neg_1);}"},
	{0, 786, "d_size_h_pos_ref_sp", d_size_h_pos_ref_sp, d_size_h_pos_ref_sp_bench, "{return test(\"% hd\", sh_pos_1);}"},
	{0, 787, "d_size_h_neg_ref_sp", d_size_h_neg_ref_sp, d_size_h_neg_ref_sp_bench, "{return test(\"% hd\", sh_neg_1);}"},
	{0, 788, "d_size_l_pos_ref_sp", d_size_l_pos_ref_sp, d_size_l_pos_ref_sp_bench, "{return test(\"% ld\", l_pos_1);}"},
	{0, 789, "d_size_l_neg_ref_sp", d_size_l_neg_ref_sp, d_size_l_neg_ref_sp_bench, "{return test(\"% ld\", l_neg_1);}"},
	{0, 790, "d_size_ll_pos_ref_sp", d_size_ll_pos_ref_sp, d_size_ll_pos_ref_sp_bench, "{return test(\"% lld\", ll_pos_1);}"},
	{0, 791, "d_size_ll_neg_ref_sp", d_size_ll_neg_ref_sp, d_size_ll_neg_ref_sp_bench, "{return test(\"% lld\", ll_neg_1);}"},
	{0, 792, "d_size_l_pos_big_sp", d_size_l_pos_big_sp, d_size_l_pos_big_sp_bench, "{return test(\"% ld\", 22337203685477l);}"},
	{0, 793, "d_size_l_neg_big_sp", d_size_l_neg_big_sp, d_size_l_neg_big_sp_bench, "{return test(\"% ld\", -22337203685477l);}"},
	{0, 794, "d_size_ll_pos_big_sp", d_size_ll_pos_big_sp, d_size_ll_pos_big_sp_bench, "{return test(\"% lld\", 522337203685470ll);}"},
	{0, 795, "d_size_ll_neg_big_sp", d_size_ll_neg_big_sp, d_size_ll_neg_big_sp_bench, "{return test(\"% lld\", -522337203685470ll);}"},
	{0, 796, "d_llmax_sp", d_llmax_sp, d_llmax_sp_bench, "{return test(\"% lld\", 9223372036854775807ll);}"},
	{0, 797, "d_llmin_sp", d_llmin_sp, d_llmin_sp_bench, "{return test(\"% lld\", llmin);}"},
	{0, 798, "d_lmax_sp", d_lmax_sp, d_lmax_sp_bench, "{return test(\"% ld\", 9223372036854775807l);}"},
	{0, 799, "d_lmin_sp", d_lmin_sp, d_lmin_sp_bench, "{return test(\"% ld\", lmin);}"},
	{0, 800, "d_hmax_sp", d_hmax_sp, d_hmax_sp_bench, "{return test(\"% hd\", (short)32767);}"},
	{0, 801, "d_hmin_sp", d_hmin_sp, d_hmin_sp_bench, "{return test(\"% hd\", (short)(-32768));}"},
	{0, 802, "d_hhmax_sp", d_hhmax_sp, d_hhmax_sp_bench, "{return test(\"% hhd\", (char)(127));}"},
	{0, 803, "d_hhmin_sp", d_hhmin_sp, d_hhmin_sp_bench, "{return test(\"% hhd\", (char)(-128));}"},
	{0, 804, "d_prec0val0_basic", d_prec0val0_basic, d_prec0val0_basic_bench, "{return test(\"%.0d\", 0);}"},
	{0, 805, "d_prec0val0_implicit", d_prec0val0_implicit, d_prec0val0_implicit_bench, "{return test(\"%.d\", 0);}"},
	{0, 806, "d_prec0val0_w", d_prec0val0_w, d_prec0val0_w_bench, "{return test(\"%5.0d\", 0);}"},
	{0, 807, "d_prec0val0_w_impl", d_prec0val0_w_impl, d_prec0val0_w_impl_bench, "{return test(\"%5.d\", 0);}"},
	{0, 808, "d_prec0val0_wlj", d_prec0val0_wlj, d_prec0val0_wlj_bench, "{return test(\"%-5.0d\", 0);}"},
	{0, 809, "d_prec0val0_wlj_impl", d_prec0val0_wlj_impl, d_prec0val0_wlj_impl_bench, "{return test(\"%-5.d\", 0);}"},
	{0, 810, "d_prec0val0_as", d_prec0val0_as, d_prec0val0_as_bench, "{return test(\"%+.0d\", 0);}"},
	{0, 811, "d_prec0val0_as_impl", d_prec0val0_as_impl, d_prec0val0_as_impl_bench, "{return test(\"%+.d\", 0);}"},
	{0, 812, "d_prec0val0_was", d_prec0val0_was, d_prec0val0_was_bench, "{return test(\"%+5.0d\", 0);}"},
	{0, 813, "d_prec0val0_was_impl", d_prec0val0_was_impl, d_prec0val0_was_impl_bench, "{return test(\"%+5.d\", 0);}"},
	{0, 814, "d_prec0val0_waslj", d_prec0val0_waslj, d_prec0val0_waslj_bench, "{return test(\"%+-5.0d\", 0);}"},
	{0, 815, "d_prec0val0_waslj_impl", d_prec0val0_waslj_impl, d_prec0val0_waslj_impl_bench, "{return test(\"%+-5.d\", 0);}"},
	{0, 816, "mix_hhi_str_lli_str", mix_hhi_str_lli_str, mix_hhi_str_lli_str_bench, "{return test(\"%hhi%s%lli%s\", ch_pos_1, str_3, ll_neg_1, str_2);}"},
	{0, 817, "mix_str_hi_str_li", mix_str_hi_str_li, mix_str_hi_str_li_bench, "{return test(\"%s%hi%s%li\", str_1, sh_neg_1, str_3, l_neg_1);}"},
	{0, 818, "mix_str_hi_str_li_emptystr", mix_str_hi_str_li_emptystr, mix_str_hi_str_li_emptystr_bench, "{return test(\"%s%hi%s%li\", str_empty, sh_neg_1, str_3, l_neg_1);}"},
	{0, 819, "u_basic_u_pos", u_basic_u_pos, u_basic_u_pos_bench, "{return test(\"this %u number\", 17);}"},
	{0, 820, "u_basic_u_zero", u_basic_u_zero, u_basic_u_zero_bench, "{return test(\"this %u number\", 0);}"},
	{0, 821, "u_basic_u_onlypos", u_basic_u_onlypos, u_basic_u_onlypos_bench, "{return test(\"%u\", 3);}"},
	{0, 822, "u_uintmax", u_uintmax, u_uintmax_bench, "{return test(\"%u\", 4294967295u);}"},
	{0, 823, "u_width_pos_fits", u_width_pos_fits, u_width_pos_fits_bench, "{return test(\"%7u\", 33);}"},
	{0, 824, "u_width_zero_fits", u_width_zero_fits, u_width_zero_fits_bench, "{return test(\"%3u\", 0);}"},
	{0, 825, "u_width_pos_exactfit", u_width_pos_exactfit, u_width_pos_exactfit_bench, "{return test(\"%5u\", 52625);}"},
	{0, 826, "u_width_pos_nofit", u_width_pos_nofit, u_width_pos_nofit_bench, "{return test(\"%4u\", 94827);}"},
	{0, 827, "u_width_pos_fits_lj", u_width_pos_fits_lj, u_width_pos_fits_lj_bench, "{return test(\"%-7u\", 33);}"},
	{0, 828, "u_width_zero_fits_lj", u_width_zero_fits_lj, u_width_zero_fits_lj_bench, "{return test(\"%-3u\", 0);}"},
	{0, 829, "u_width_pos_exactfit_lj", u_width_pos_exactfit_lj, u_width_pos_exactfit_lj_bench, "{return test(\"%-5u\", 52625);}"},
	{0, 830, "u_width_pos_nofit_lj", u_width_pos_nofit_lj, u_width_pos_nofit_lj_bench, "{return test(\"%-4u\", 94827);}"},
	{0, 831, "u_prec_fits_pos", u_prec_fits_pos, u_prec_fits_pos_bench, "{return test(\"%.5u\", 2);}"},
	{0, 832, "u_prec_fits_zero", u_prec_fits_zero, u_prec_fits_zero_bench, "{return test(\"%.3u\", 0);}"},
	{0, 833, "u_prec_exactfit_pos", u_prec_exactfit_pos, u_prec_exactfit_pos_bench, "{return test(\"%.4u\", 5263);}"},
	{0, 834, "u_prec_nofit_pos", u_prec_nofit_pos, u_prec_nofit_pos_bench, "{return test(\"%.3u\", 13862);}"},
	{0, 835, "u_zp_pos_fits", u_zp_pos_fits, u_zp_pos_fits_bench, "{return test(\"%05u\", 43);}"},
	{0, 836, "u_zp_zero_fits", u_zp_zero_fits, u_zp_zero_fits_bench, "{return test(\"%03u\", 0);}"},
	{0, 837, "u_zp_pos_exactfit", u_zp_pos_exactfit, u_zp_pos_exactfit_bench, "{return test(\"%03u\", 634);}"},
	{0, 838, "u_prec_width_fit_fit_pos", u_prec_width_fit_fit_pos, u_prec_width_fit_fit_pos_bench, "{return test(\"%8.5u\", 34);}"},
	{0, 839, "u_prec_width_fit_fit_zero", u_prec_width_fit_fit_zero, u_prec_width_fit_fit_zero_bench, "{return test(\"%8.5u\", 0);}"},
	{0, 840, "u_prec_width_nofit_fit_pos", u_prec_width_nofit_fit_pos, u_prec_width_nofit_fit_pos_bench, "{return test(\"%8.3u\", 8375);}"},
	{0, 841, "u_prec_width_fit_nofit_pos", u_prec_width_fit_nofit_pos, u_prec_width_fit_nofit_pos_bench, "{return test(\"%3.7u\", 3267);}"},
	{0, 842, "u_prec_width_nofit_nofit_pos", u_prec_width_nofit_nofit_pos, u_prec_width_nofit_nofit_pos_bench, "{return test(\"%3.3u\", 6983);}"},
	{0, 843, "u_prec_width_fit_fit_pos_lj", u_prec_width_fit_fit_pos_lj, u_prec_width_fit_fit_pos_lj_bench, "{return test(\"%-8.5u\", 34);}"},
	{0, 844, "u_prec_width_fit_fit_zero_lj", u_prec_width_fit_fit_zero_lj, u_prec_width_fit_fit_zero_lj_bench, "{return test(\"%-8.5u\", 0);}"},
	{0, 845, "u_prec_width_nofit_fit_pos_lj", u_prec_width_nofit_fit_pos_lj, u_prec_width_nofit_fit_pos_lj_bench, "{return test(\"%-8.3u\", 8375);}"},
	{0, 846, "u_prec_width_fit_nofit_pos_lj", u_prec_width_fit_nofit_pos_lj, u_prec_width_fit_nofit_pos_lj_bench, "{return test(\"%-3.7u\", 3267);}"},
	{0, 847, "u_prec_width_nofit_nofit_pos_lj", u_prec_width_nofit_nofit_pos_lj, u_prec_width_nofit_nofit_pos_lj_bench, "{return test(\"%-3.3u\", 6983);}"},
	{0, 848, "u_prec_width_ff_pos_zp", u_prec_width_ff_pos_zp, u_prec_width_ff_pos_zp_bench, "{return test(\"%08.5u\", 34);}"},
	{0, 849, "u_prec_width_ff_zero_zp", u_prec_width_ff_zero_zp, u_prec_width_ff_zero_zp_bench, "{return test(\"%08.5u\", 0);}"},
	{0, 850, "u_prec_width_nf_pos_zp", u_prec_width_nf_pos_zp, u_prec_width_nf_pos_zp_bench, "{return test(\"%08.3u\", 8375);}"},
	{0, 851, "u_prec_width_fn_pos_zp", u_prec_width_fn_pos_zp, u_prec_width_fn_pos_zp_bench, "{return test(\"%03.7u\", 3267);}"},
	{0, 852, "u_prec_width_nn_pos_zp", u_prec_width_nn_pos_zp, u_prec_width_nn_pos_zp_bench, "{return test(\"%03.3u\", 6983);}"},
	{0, 853, "u_prec_width_ff_pos_ljzp_ignoreflag", u_prec_width_ff_pos_ljzp_ignoreflag, u_prec_width_ff_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.5u\", 34);}"},
	{0, 854, "u_prec_width_ff_zero_ljzp_ignoreflag", u_prec_width_ff_zero_ljzp_ignoreflag, u_prec_width_ff_zero_ljzp_ignoreflag_bench, "{return test(\"%0-8.5u\", 0);}"},
	{0, 855, "u_prec_width_nf_pos_ljzp_ignoreflag", u_prec_width_nf_pos_ljzp_ignoreflag, u_prec_width_nf_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.3u\", 8375);}"},
	{0, 856, "u_prec_width_fn_pos_ljzp_ignoreflag", u_prec_width_fn_pos_ljzp_ignoreflag, u_prec_width_fn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.7u\", 3267);}"},
	{0, 857, "u_prec_width_nn_pos_ljzp_ignoreflag", u_prec_width_nn_pos_ljzp_ignoreflag, u_prec_width_nn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.3u\", 6983);}"},
	{0, 858, "u_size_hh_pos_casted", u_size_hh_pos_casted, u_size_hh_pos_casted_bench, "{return test(\"%hhu\", (unsigned char)45);}"},
	{0, 859, "u_size_h_pos_casted", u_size_h_pos_casted, u_size_h_pos_casted_bench, "{return test(\"%hu\", (unsigned short)385);}"},
	{0, 860, "u_size_l_pos_casted", u_size_l_pos_casted, u_size_l_pos_casted_bench, "{return test(\"%lu\", (unsigned long)32);}"},
	{0, 861, "u_size_ll_pos_casted", u_size_ll_pos_casted, u_size_ll_pos_casted_bench, "{return test(\"%llu\", (unsigned long long)43);}"},
	{0, 862, "u_size_hh_pos_ref", u_size_hh_pos_ref, u_size_hh_pos_ref_bench, "{return test(\"%hhu\", uch_pos_1);}"},
	{0, 863, "u_size_h_pos_ref", u_size_h_pos_ref, u_size_h_pos_ref_bench, "{return test(\"%hu\", ush_pos_1);}"},
	{0, 864, "u_size_l_pos_ref", u_size_l_pos_ref, u_size_l_pos_ref_bench, "{return test(\"%lu\", ul_pos_1);}"},
	{0, 865, "u_size_ll_pos_ref", u_size_ll_pos_ref, u_size_ll_pos_ref_bench, "{return test(\"%llu\", ull_pos_1);}"},
	{0, 866, "u_size_l_pos_big", u_size_l_pos_big, u_size_l_pos_big_bench, "{return test(\"%lu\", 22337203685477ul);}"},
	{0, 867, "u_size_ll_pos_big", u_size_ll_pos_big, u_size_ll_pos_big_bench, "{return test(\"%llu\", 522337203685470ull);}"},
	{0, 868, "u_ullmax", u_ullmax, u_ullmax_bench, "{return test(\"%llu\", ullmax);}"},
	{0, 869, "u_ulmax", u_ulmax, u_ulmax_bench, "{return test(\"%lu\", ulmax);}"},
	{0, 870, "u_uhmax", u_uhmax, u_uhmax_bench, "{return test(\"%hu\", (unsigned short)65535);}"},
	{0, 871, "u_uhhmax", u_uhhmax, u_uhhmax_bench, "{return test(\"%hhu\", (unsigned char)255);}"},
	{0, 872, "u_size_l_pos_big_zp", u_size_l_pos_big_zp, u_size_l_pos_big_zp_bench, "{return test(\"%037lu\", 22337203685477ul);}"},
	{0, 873, "u_size_ll_pos_big_width", u_size_ll_pos_big_width, u_size_ll_pos_big_width_bench, "{return test(\"%37llu\", 522337203685470ull);}"},
	{0, 874, "u_size_ll_hh_ll", u_size_ll_hh_ll, u_size_ll_hh_ll_bench, "{return test(\"%llu%hhu%llu\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 875, "u_size_h_l_hh", u_size_h_l_hh, u_size_h_l_hh_bench, "{return test(\"%hu%lu%hhu\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 876, "u_size_l_hh_h", u_size_l_hh_h, u_size_l_hh_h_bench, "{return test(\"%lu%hhu%hu\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 877, "u_size_n_ll_hh", u_size_n_ll_hh, u_size_n_ll_hh_bench, "{return test(\"%u%llu%hhu\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 878, "u_size_ll_n_l", u_size_ll_n_l, u_size_ll_n_l_bench, "{return test(\"%llu%u%lu\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 879, "u_prec0val0_basic", u_prec0val0_basic, u_prec0val0_basic_bench, "{return test(\"%.0u\", 0);}"},
	{0, 880, "u_prec0val0_implicit", u_prec0val0_implicit, u_prec0val0_implicit_bench, "{return test(\"%.u\", 0);}"},
	{0, 881, "u_prec0val0_w", u_prec0val0_w, u_prec0val0_w_bench, "{return test(\"%5.0u\", 0);}"},
	{0, 882, "u_prec0val0_w_impl", u_prec0val0_w_impl, u_prec0val0_w_impl_bench, "{return test(\"%5.u\", 0);}"},
	{0, 883, "u_prec0val0_wlj", u_prec0val0_wlj, u_prec0val0_wlj_bench, "{return test(\"%-5.0u\", 0);}"},
	{0, 884, "u_prec0val0_wlj_impl", u_prec0val0_wlj_impl, u_prec0val0_wlj_impl_bench, "{return test(\"%-5.u\", 0);}"},
	{0, 885, "mix_hhu_str_llu_str", mix_hhu_str_llu_str, mix_hhu_str_llu_str_bench, "{return test(\"%hhu%s%llu%s\", uch_pos_1, str_3, ull_pos_1, str_2);}"},
	{0, 886, "mix_str_hu_str_lu", mix_str_hu_str_lu, mix_str_hu_str_lu_bench, "{return test(\"%s%hu%s%lu\", str_1, ush_pos_1, str_3, ul_pos_1);}"},
	{0, 887, "mixed_test_0001", mixed_test_0001, mixed_test_0001_bench, "{return test("},
	{0, 888, "x_basic_pos", x_basic_pos, x_basic_pos_bench, "{return test(\"this %x number\", 17);}"},
	{0, 889, "x_basic_zero", x_basic_zero, x_basic_zero_bench, "{return test(\"this %x number\", 0);}"},
	{0, 890, "x_basic_onlypos", x_basic_onlypos, x_basic_onlypos_bench, "{return test(\"%x\", 3);}"},
	{0, 891, "x_hexlmax", x_hexlmax, x_hexlmax_bench, "{return test(\"%x\", 4294967295u);}"},
	{0, 892, "x_width_pos_fits", x_width_pos_fits, x_width_pos_fits_bench, "{return test(\"%7x\", 33);}"},
	{0, 893, "x_width_zero_fits", x_width_zero_fits, x_width_zero_fits_bench, "{return test(\"%3x\", 0);}"},
	{0, 894, "x_width_pos_exactfit", x_width_pos_exactfit, x_width_pos_exactfit_bench, "{return test(\"%5x\", 52625);}"},
	{0, 895, "x_width_pos_nofit", x_width_pos_nofit, x_width_pos_nofit_bench, "{return test(\"%2x\", 94827);}"},
	{0, 896, "x_width_pos_fits_lj", x_width_pos_fits_lj, x_width_pos_fits_lj_bench, "{return test(\"%-7x\", 33);}"},
	{0, 897, "x_width_zero_fits_lj", x_width_zero_fits_lj, x_width_zero_fits_lj_bench, "{return test(\"%-3x\", 0);}"},
	{0, 898, "x_width_pos_exactfit_lj", x_width_pos_exactfit_lj, x_width_pos_exactfit_lj_bench, "{return test(\"%-5x\", 52625);}"},
	{0, 899, "x_width_pos_nofit_lj", x_width_pos_nofit_lj, x_width_pos_nofit_lj_bench, "{return test(\"%-4x\", 9648627);}"},
	{0, 900, "x_prec_fits_pos", x_prec_fits_pos, x_prec_fits_pos_bench, "{return test(\"%.5x\", 21);}"},
	{0, 901, "x_prec_fits_zero", x_prec_fits_zero, x_prec_fits_zero_bench, "{return test(\"%.3x\", 0);}"},
	{0, 902, "x_prec_exactfit_pos", x_prec_exactfit_pos, x_prec_exactfit_pos_bench, "{return test(\"%.4x\", 5263);}"},
	{0, 903, "x_prec_nofit_pos", x_prec_nofit_pos, x_prec_nofit_pos_bench, "{return test(\"%.3x\", 938862);}"},
	{0, 904, "x_zp_pos_fits", x_zp_pos_fits, x_zp_pos_fits_bench, "{return test(\"%05x\", 43);}"},
	{0, 905, "x_zp_zero_fits", x_zp_zero_fits, x_zp_zero_fits_bench, "{return test(\"%03x\", 0);}"},
	{0, 906, "x_zp_pos_exactfit", x_zp_pos_exactfit, x_zp_pos_exactfit_bench, "{return test(\"%03x\", 698334);}"},
	{0, 907, "x_prec_width_fit_fit_pos", x_prec_width_fit_fit_pos, x_prec_width_fit_fit_pos_bench, "{return test(\"%8.5x\", 34);}"},
	{0, 908, "x_prec_width_fit_fit_zero", x_prec_width_fit_fit_zero, x_prec_width_fit_fit_zero_bench, "{return test(\"%8.5x\", 0);}"},
	{0, 909, "x_prec_width_nofit_fit_pos", x_prec_width_nofit_fit_pos, x_prec_width_nofit_fit_pos_bench, "{return test(\"%8.3x\", 8375);}"},
	{0, 910, "x_prec_width_fit_nofit_pos", x_prec_width_fit_nofit_pos, x_prec_width_fit_nofit_pos_bench, "{return test(\"%2.7x\", 3267);}"},
	{0, 911, "x_prec_width_nofit_nofit_pos", x_prec_width_nofit_nofit_pos, x_prec_width_nofit_nofit_pos_bench, "{return test(\"%3.3x\", 6983);}"},
	{0, 912, "x_prec_width_fit_fit_pos_lj", x_prec_width_fit_fit_pos_lj, x_prec_width_fit_fit_pos_lj_bench, "{return test(\"%-8.5x\", 34);}"},
	{0, 913, "x_prec_width_fit_fit_zero_lj", x_prec_width_fit_fit_zero_lj, x_prec_width_fit_fit_zero_lj_bench, "{return test(\"%-8.5x\", 0);}"},
	{0, 914, "x_prec_width_nofit_fit_pos_lj", x_prec_width_nofit_fit_pos_lj, x_prec_width_nofit_fit_pos_lj_bench, "{return test(\"%-8.3x\", 8375);}"},
	{0, 915, "x_prec_width_fit_nofit_pos_lj", x_prec_width_fit_nofit_pos_lj, x_prec_width_fit_nofit_pos_lj_bench, "{return test(\"%-2.7x\", 3267);}"},
	{0, 916, "x_prec_width_nofit_nofit_pos_lj", x_prec_width_nofit_nofit_pos_lj, x_prec_width_nofit_nofit_pos_lj_bench, "{return test(\"%-3.3x\", 6983);}"},
	{0, 917, "x_prec_width_ff_pos_zp", x_prec_width_ff_pos_zp, x_prec_width_ff_pos_zp_bench, "{return test(\"%08.5x\", 34);}"},
	{0, 918, "x_prec_width_ff_zero_zp", x_prec_width_ff_zero_zp, x_prec_width_ff_zero_zp_bench, "{return test(\"%08.5x\", 0);}"},
	{0, 919, "x_prec_width_nf_pos_zp", x_prec_width_nf_pos_zp, x_prec_width_nf_pos_zp_bench, "{return test(\"%08.3x\", 8375);}"},
	{0, 920, "x_prec_width_fn_pos_zp", x_prec_width_fn_pos_zp, x_prec_width_fn_pos_zp_bench, "{return test(\"%02.7x\", 3267);}"},
	{0, 921, "x_prec_width_nn_pos_zp", x_prec_width_nn_pos_zp, x_prec_width_nn_pos_zp_bench, "{return test(\"%03.3x\", 6983);}"},
	{0, 922, "x_prec_width_ff_pos_ljzp_ignoreflag", x_prec_width_ff_pos_ljzp_ignoreflag, x_prec_width_ff_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.5x\", 34);}"},
	{0, 923, "x_prec_width_ff_zero_ljzp_ignoreflag", x_prec_width_ff_zero_ljzp_ignoreflag, x_prec_width_ff_zero_ljzp_ignoreflag_bench, "{return test(\"%0-8.5x\", 0);}"},
	{0, 924, "x_prec_width_nf_pos_ljzp_ignoreflag", x_prec_width_nf_pos_ljzp_ignoreflag, x_prec_width_nf_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.3x\", 8375);}"},
	{0, 925, "x_prec_width_fn_pos_ljzp_ignoreflag", x_prec_width_fn_pos_ljzp_ignoreflag, x_prec_width_fn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-2.7x\", 3267);}"},
	{0, 926, "x_prec_width_nn_pos_ljzp_ignoreflag", x_prec_width_nn_pos_ljzp_ignoreflag, x_prec_width_nn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.3x\", 6983);}"},
	{0, 927, "x_size_hh_pos_casted", x_size_hh_pos_casted, x_size_hh_pos_casted_bench, "{return test(\"%hhx\", (unsigned char)45);}"},
	{0, 928, "x_size_h_pos_casted", x_size_h_pos_casted, x_size_h_pos_casted_bench, "{return test(\"%hx\", (unsigned short)385);}"},
	{0, 929, "x_size_l_pos_casted", x_size_l_pos_casted, x_size_l_pos_casted_bench, "{return test(\"%lx\", (unsigned long)32);}"},
	{0, 930, "x_size_ll_pos_casted", x_size_ll_pos_casted, x_size_ll_pos_casted_bench, "{return test(\"%llx\", (long long)43);}"},
	{0, 931, "x_size_hh_pos_ref", x_size_hh_pos_ref, x_size_hh_pos_ref_bench, "{return test(\"%hhx\", uch_pos_1);}"},
	{0, 932, "x_size_h_pos_ref", x_size_h_pos_ref, x_size_h_pos_ref_bench, "{return test(\"%hx\", ush_pos_1);}"},
	{0, 933, "x_size_l_pos_ref", x_size_l_pos_ref, x_size_l_pos_ref_bench, "{return test(\"%lx\", ul_pos_1);}"},
	{0, 934, "x_size_ll_pos_ref", x_size_ll_pos_ref, x_size_ll_pos_ref_bench, "{return test(\"%llx\", ull_pos_1);}"},
	{0, 935, "x_size_l_pos_big", x_size_l_pos_big, x_size_l_pos_big_bench, "{return test(\"%lx\", 22337203685477ul);}"},
	{0, 936, "x_size_ll_pos_big", x_size_ll_pos_big, x_size_ll_pos_big_bench, "{return test(\"%llx\", 522337203685470ull);}"},
	{0, 937, "x_ullmax", x_ullmax, x_ullmax_bench, "{return test(\"%llx\", ullmax);}"},
	{0, 938, "x_ulmax", x_ulmax, x_ulmax_bench, "{return test(\"%lx\", ulmax);}"},
	{0, 939, "x_uhmax", x_uhmax, x_uhmax_bench, "{return test(\"%hx\", (unsigned short)65535);}"},
	{0, 940, "x_uhhmax", x_uhhmax, x_uhhmax_bench, "{return test(\"%hhx\", (unsigned char)255);}"},
	{0, 941, "x_size_l_pos_big_zp", x_size_l_pos_big_zp, x_size_l_pos_big_zp_bench, "{return test(\"%037lx\", 22337203685477ul);}"},
	{0, 942, "x_size_ll_pos_big_width", x_size_ll_pos_big_width, x_size_ll_pos_big_width_bench, "{return test(\"%37llx\", 522337203685470ull);}"},
	{0, 943, "x_size_ll_hh_ll", x_size_ll_hh_ll, x_size_ll_hh_ll_bench, "{return test(\"%llu%hhu%llx\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 944, "x_size_h_l_hh", x_size_h_l_hh, x_size_h_l_hh_bench, "{return test(\"%hu%lu%hhx\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 945, "x_size_l_hh_h", x_size_l_hh_h, x_size_l_hh_h_bench, "{return test(\"%lu%hhu%hx\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 946, "x_size_n_ll_hh", x_size_n_ll_hh, x_size_n_ll_hh_bench, "{return test(\"%u%llu%hhx\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 947, "x_size_ll_n_l", x_size_ll_n_l, x_size_ll_n_l_bench, "{return test(\"%llu%u%lx\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 948, "x_basic_pos_af", x_basic_pos_af, x_basic_pos_af_bench, "{return test(\"this %#x number\", 17);}"},
	{0, 949, "x_basic_zero_af", x_basic_zero_af, x_basic_zero_af_bench, "{return test(\"this %#x number\", 0);}"},
	{0, 950, "x_basic_onlypos_af", x_basic_onlypos_af, x_basic_onlypos_af_bench, "{return test(\"%#x\", 3);}"},
	{0, 951, "x_hexlmax_af", x_hexlmax_af, x_hexlmax_af_bench, "{return test(\"%#x\", 4294967295u);}"},
	{0, 952, "x_width_pos_fits_af", x_width_pos_fits_af, x_width_pos_fits_af_bench, "{return test(\"%#7x\", 33);}"},
	{0, 953, "x_width_zero_fits_af", x_width_zero_fits_af, x_width_zero_fits_af_bench, "{return test(\"%#3x\", 0);}"},
	{0, 954, "x_width_pos_exactfit_af", x_width_pos_exactfit_af, x_width_pos_exactfit_af_bench, "{return test(\"%#5x\", 52625);}"},
	{0, 955, "x_width_pos_nofit_af", x_width_pos_nofit_af, x_width_pos_nofit_af_bench, "{return test(\"%#2x\", 94827);}"},
	{0, 956, "x_width_pos_fits_lj_af", x_width_pos_fits_lj_af, x_width_pos_fits_lj_af_bench, "{return test(\"%#-7x\", 33);}"},
	{0, 957, "x_width_zero_fits_lj_af", x_width_zero_fits_lj_af, x_width_zero_fits_lj_af_bench, "{return test(\"%#-3x\", 0);}"},
	{0, 958, "x_width_pos_exactfit_lj_af", x_width_pos_exactfit_lj_af, x_width_pos_exactfit_lj_af_bench, "{return test(\"%#-5x\", 52625);}"},
	{0, 959, "x_width_pos_nofit_lj_af", x_width_pos_nofit_lj_af, x_width_pos_nofit_lj_af_bench, "{return test(\"%#-4x\", 9648627);}"},
	{0, 960, "x_prec_fits_pos_af", x_prec_fits_pos_af, x_prec_fits_pos_af_bench, "{return test(\"%#.5x\", 21);}"},
	{0, 961, "x_prec_fits_zero_af", x_prec_fits_zero_af, x_prec_fits_zero_af_bench, "{return test(\"%#.3x\", 0);}"},
	{0, 962, "x_prec_exactfit_pos_af", x_prec_exactfit_pos_af, x_prec_exactfit_pos_af_bench, "{return test(\"%#.4x\", 5263);}"},
	{0, 963, "x_prec_nofit_pos_af", x_prec_nofit_pos_af, x_prec_nofit_pos_af_bench, "{return test(\"%#.3x\", 938862);}"},
	{0, 964, "x_zp_pos_fits_af", x_zp_pos_fits_af, x_zp_pos_fits_af_bench, "{return test(\"%#05x\", 43);}"},
	{0, 965, "x_zp_zero_fits_af", x_zp_zero_fits_af, x_zp_zero_fits_af_bench, "{return test(\"%#03x\", 0);}"},
	{0, 966, "x_zp_pos_exactfit_af", x_zp_pos_exactfit_af, x_zp_pos_exactfit_af_bench, "{return test(\"%#03x\", 698334);}"},
	{0, 967, "x_prec_width_fit_fit_pos_af", x_prec_width_fit_fit_pos_af, x_prec_width_fit_fit_pos_af_bench, "{return test(\"%#8.5x\", 34);}"},
	{0, 968, "x_prec_width_fit_fit_zero_af", x_prec_width_fit_fit_zero_af, x_prec_width_fit_fit_zero_af_bench, "{return test(\"%#8.5x\", 0);}"},
	{0, 969, "x_prec_width_nofit_fit_pos_af", x_prec_width_nofit_fit_pos_af, x_prec_width_nofit_fit_pos_af_bench, "{return test(\"%#8.3x\", 8375);}"},
	{0, 970, "x_prec_width_fit_nofit_pos_af", x_prec_width_fit_nofit_pos_af, x_prec_width_fit_nofit_pos_af_bench, "{return test(\"%#2.7x\", 3267);}"},
	{0, 971, "x_prec_width_nofit_nofit_pos_af", x_prec_width_nofit_nofit_pos_af, x_prec_width_nofit_nofit_pos_af_bench, "{return test(\"%#3.3x\", 6983);}"},
	{0, 972, "x_prec_width_fit_fit_pos_lj_af", x_prec_width_fit_fit_pos_lj_af, x_prec_width_fit_fit_pos_lj_af_bench, "{return test(\"%#-8.5x\", 34);}"},
	{0, 973, "x_prec_width_fit_fit_zero_lj_af", x_prec_width_fit_fit_zero_lj_af, x_prec_width_fit_fit_zero_lj_af_bench, "{return test(\"%#-8.5x\", 0);}"},
	{0, 974, "x_prec_width_nofit_fit_pos_lj_af", x_prec_width_nofit_fit_pos_lj_af, x_prec_width_nofit_fit_pos_lj_af_bench, "{return test(\"%#-8.3x\", 8375);}"},
	{0, 975, "x_prec_width_fit_nofit_pos_lj_af", x_prec_width_fit_nofit_pos_lj_af, x_prec_width_fit_nofit_pos_lj_af_bench, "{return test(\"%#-2.7x\", 3267);}"},
	{0, 976, "x_prec_width_nofit_nofit_pos_lj_af", x_prec_width_nofit_nofit_pos_lj_af, x_prec_width_nofit_nofit_pos_lj_af_bench, "{return test(\"%#-3.3x\", 6983);}"},
	{0, 977, "x_prec_width_ff_pos_zp_af", x_prec_width_ff_pos_zp_af, x_prec_width_ff_pos_zp_af_bench, "{return test(\"%#08.5x\", 34);}"},
	{0, 978, "x_prec_width_ff_zero_zp_af", x_prec_width_ff_zero_zp_af, x_prec_width_ff_zero_zp_af_bench, "{return test(\"%#08.5x\", 0);}"},
	{0, 979, "x_prec_width_nf_pos_zp_af", x_prec_width_nf_pos_zp_af, x_prec_width_nf_pos_zp_af_bench, "{return test(\"%#08.3x\", 8375);}"},
	{0, 980, "x_prec_width_fn_pos_zp_af", x_prec_width_fn_pos_zp_af, x_prec_width_fn_pos_zp_af_bench, "{return test(\"%#02.7x\", 3267);}"},
	{0, 981, "x_prec_width_nn_pos_zp_af", x_prec_width_nn_pos_zp_af, x_prec_width_nn_pos_zp_af_bench, "{return test(\"%#03.3x\", 6983);}"},
	{0, 982, "x_prec_width_ff_pos_ljzpaf_ignoreflag", x_prec_width_ff_pos_ljzpaf_ignoreflag, x_prec_width_ff_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.5x\", 34);}"},
	{0, 983, "x_prec_width_ff_zero_ljzpaf_ignoreflag", x_prec_width_ff_zero_ljzpaf_ignoreflag, x_prec_width_ff_zero_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.5x\", 0);}"},
	{0, 984, "x_prec_width_nf_pos_ljzpaf_ignoreflag", x_prec_width_nf_pos_ljzpaf_ignoreflag, x_prec_width_nf_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.3x\", 8375);}"},
	{0, 985, "x_prec_width_fn_pos_ljzpaf_ignoreflag", x_prec_width_fn_pos_ljzpaf_ignoreflag, x_prec_width_fn_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-2.7x\", 3267);}"},
	{0, 986, "x_prec_width_nn_pos_ljzpaf_ignoreflag", x_prec_width_nn_pos_ljzpaf_ignoreflag, x_prec_width_nn_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-3.3x\", 6983);}"},
	{0, 987, "x_size_hh_pos_casted_af", x_size_hh_pos_casted_af, x_size_hh_pos_casted_af_bench, "{return test(\"%#hhx\", (unsigned char)45);}"},
	{0, 988, "x_size_h_pos_casted_af", x_size_h_pos_casted_af, x_size_h_pos_casted_af_bench, "{return test(\"%#hx\", (unsigned short)385);}"},
	{0, 989, "x_size_l_pos_casted_af", x_size_l_pos_casted_af, x_size_l_pos_casted_af_bench, "{return test(\"%#lx\", (unsigned long)32);}"},
	{0, 990, "x_size_ll_pos_casted_af", x_size_ll_pos_casted_af, x_size_ll_pos_casted_af_bench, "{return test(\"%#llx\", (long long)43);}"},
	{0, 991, "x_size_hh_pos_ref_af", x_size_hh_pos_ref_af, x_size_hh_pos_ref_af_bench, "{return test(\"%#hhx\", uch_pos_1);}"},
	{0, 992, "x_size_h_pos_ref_af", x_size_h_pos_ref_af, x_size_h_pos_ref_af_bench, "{return test(\"%#hx\", ush_pos_1);}"},
	{0, 993, "x_size_l_pos_ref_af", x_size_l_pos_ref_af, x_size_l_pos_ref_af_bench, "{return test(\"%#lx\", ul_pos_1);}"},
	{0, 994, "x_size_ll_pos_ref_af", x_size_ll_pos_ref_af, x_size_ll_pos_ref_af_bench, "{return test(\"%#llx\", ull_pos_1);}"},
	{0, 995, "x_size_l_pos_big_af", x_size_l_pos_big_af, x_size_l_pos_big_af_bench, "{return test(\"%#lx\", 22337203685477lu);}"},
	{0, 996, "x_size_ll_pos_big_af", x_size_ll_pos_big_af, x_size_ll_pos_big_af_bench, "{return test(\"%#llx\", 522337203685470llu);}"},
	{0, 997, "x_ullmax_af", x_ullmax_af, x_ullmax_af_bench, "{return test(\"%#llx\", ullmax);}"},
	{0, 998, "x_ulmax_af", x_ulmax_af, x_ulmax_af_bench, "{return test(\"%#lx\", ulmax);}"},
	{0, 999, "x_uhmax_af", x_uhmax_af, x_uhmax_af_bench, "{return test(\"%#hx\", (unsigned short)65535);}"},
	{0, 1000, "x_uhhmax_af", x_uhhmax_af, x_uhhmax_af_bench, "{return test(\"%#hhx\", (unsigned char)255);}"},
	{0, 1001, "x_size_l_pos_big_zp_af", x_size_l_pos_big_zp_af, x_size_l_pos_big_zp_af_bench, "{return test(\"%#037lx\", 22337203685477ul);}"},
	{0, 1002, "x_size_ll_pos_big_width_af", x_size_ll_pos_big_width_af, x_size_ll_pos_big_width_af_bench, "{return test(\"%#37llx\", 522337203685470ull);}"},
	{0, 1003, "x_size_ll_hh_ll_af", x_size_ll_hh_ll_af, x_size_ll_hh_ll_af_bench, "{return test(\"%llu%hhu%#llx\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 1004, "x_size_h_l_hh_af", x_size_h_l_hh_af, x_size_h_l_hh_af_bench, "{return test(\"%hu%#lx%hhx\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 1005, "x_size_l_hh_h_af", x_size_l_hh_h_af, x_size_l_hh_h_af_bench, "{return test(\"%lu%hhu%#hx\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 1006, "x_size_n_ll_hh_af", x_size_n_ll_hh_af, x_size_n_ll_hh_af_bench, "{return test(\"%#x%llu%hhx\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 1007, "x_size_ll_n_l_af", x_size_ll_n_l_af, x_size_ll_n_l_af_bench, "{return test(\"%llu%u%#lx\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 1008, "x_prec0val0_basic", x_prec0val0_basic, x_prec0val0_basic_bench, "{return test(\"%.0x\", 0);}"},
	{0, 1009, "x_prec0val0_implicit", x_prec0val0_implicit, x_prec0val0_implicit_bench, "{return test(\"%.x\", 0);}"},
	{0, 1010, "x_prec0val0_w", x_prec0val0_w, x_prec0val0_w_bench, "{return test(\"%5.0x\", 0);}"},
	{0, 1011, "x_prec0val0_w_impl", x_prec0val0_w_impl, x_prec0val0_w_impl_bench, "{return test(\"%5.x\", 0);}"},
	{0, 1012, "x_prec0val0_wlj", x_prec0val0_wlj, x_prec0val0_wlj_bench, "{return test(\"%-5.0x\", 0);}"},
	{0, 1013, "x_prec0val0_wlj_impl", x_prec0val0_wlj_impl, x_prec0val0_wlj_impl_bench, "{return test(\"%-5.x\", 0);}"},
	{0, 1014, "x_prec0val0_af", x_prec0val0_af, x_prec0val0_af_bench, "{return test(\"%#.0x\", 0);}"},
	{0, 1015, "x_prec0val0_af_impl", x_prec0val0_af_impl, x_prec0val0_af_impl_bench, "{return test(\"%#.x\", 0);}"},
	{0, 1016, "x_prec0val0_waf", x_prec0val0_waf, x_prec0val0_waf_bench, "{return test(\"%#5.0x\", 0);}"},
	{0, 1017, "x_prec0val0_waf_impl", x_prec0val0_waf_impl, x_prec0val0_waf_impl_bench, "{return test(\"%#5.x\", 0);}"},
	{0, 1018, "x_prec0val0_waflj", x_prec0val0_waflj, x_prec0val0_waflj_bench, "{return test(\"%#-5.0x\", 0);}"},
	{0, 1019, "x_prec0val0_waflj_impl", x_prec0val0_waflj_impl, x_prec0val0_waflj_impl_bench, "{return test(\"%#-5.x\", 0);}"},
	{0, 1020, "X_basic_hexu_pos", X_basic_hexu_pos, X_basic_hexu_pos_bench, "{return test(\"this %X number\", 17);}"},
	{0, 1021, "X_basic_hexu_zero", X_basic_hexu_zero, X_basic_hexu_zero_bench, "{return test(\"this %X number\", 0);}"},
	{0, 1022, "X_basic_hexu_onlypos", X_basic_hexu_onlypos, X_basic_hexu_onlypos_bench, "{return test(\"%X\", 3);}"},
	{0, 1023, "X_hexumax", X_hexumax, X_hexumax_bench, "{return test(\"%X\", 4294967295u);}"},
	{0, 1024, "X_width_pos_fits", X_width_pos_fits, X_width_pos_fits_bench, "{return test(\"%7X\", 33);}"},
	{0, 1025, "X_width_zero_fits", X_width_zero_fits, X_width_zero_fits_bench, "{return test(\"%3X\", 0);}"},
	{0, 1026, "X_width_pos_exactfit", X_width_pos_exactfit, X_width_pos_exactfit_bench, "{return test(\"%5X\", 52625);}"},
	{0, 1027, "X_width_pos_nofit", X_width_pos_nofit, X_width_pos_nofit_bench, "{return test(\"%2X\", 94827);}"},
	{0, 1028, "X_width_pos_fits_lj", X_width_pos_fits_lj, X_width_pos_fits_lj_bench, "{return test(\"%-7X\", 33);}"},
	{0, 1029, "X_width_zero_fits_lj", X_width_zero_fits_lj, X_width_zero_fits_lj_bench, "{return test(\"%-3X\", 0);}"},
	{0, 1030, "X_width_pos_exactfit_lj", X_width_pos_exactfit_lj, X_width_pos_exactfit_lj_bench, "{return test(\"%-5X\", 52625);}"},
	{0, 1031, "X_width_pos_nofit_lj", X_width_pos_nofit_lj, X_width_pos_nofit_lj_bench, "{return test(\"%-4X\", 9648627);}"},
	{0, 1032, "X_prec_fits_pos", X_prec_fits_pos, X_prec_fits_pos_bench, "{return test(\"%.5X\", 21);}"},
	{0, 1033, "X_prec_fits_zero", X_prec_fits_zero, X_prec_fits_zero_bench, "{return test(\"%.3X\", 0);}"},
	{0, 1034, "X_prec_exactfit_pos", X_prec_exactfit_pos, X_prec_exactfit_pos_bench, "{return test(\"%.4X\", 5263);}"},
	{0, 1035, "X_prec_nofit_pos", X_prec_nofit_pos, X_prec_nofit_pos_bench, "{return test(\"%.3X\", 938862);}"},
	{0, 1036, "X_zp_pos_fits", X_zp_pos_fits, X_zp_pos_fits_bench, "{return test(\"%05X\", 43);}"},
	{0, 1037, "X_zp_zero_fits", X_zp_zero_fits, X_zp_zero_fits_bench, "{return test(\"%03X\", 0);}"},
	{0, 1038, "X_zp_pos_exactfit", X_zp_pos_exactfit, X_zp_pos_exactfit_bench, "{return test(\"%03X\", 698334);}"},
	{0, 1039, "X_prec_width_fit_fit_pos", X_prec_width_fit_fit_pos, X_prec_width_fit_fit_pos_bench, "{return test(\"%8.5X\", 34);}"},
	{0, 1040, "X_prec_width_fit_fit_zero", X_prec_width_fit_fit_zero, X_prec_width_fit_fit_zero_bench, "{return test(\"%8.5X\", 0);}"},
	{0, 1041, "X_prec_width_nofit_fit_pos", X_prec_width_nofit_fit_pos, X_prec_width_nofit_fit_pos_bench, "{return test(\"%8.3X\", 8375);}"},
	{0, 1042, "X_prec_width_fit_nofit_pos", X_prec_width_fit_nofit_pos, X_prec_width_fit_nofit_pos_bench, "{return test(\"%2.7X\", 3267);}"},
	{0, 1043, "X_prec_width_nofit_nofit_pos", X_prec_width_nofit_nofit_pos, X_prec_width_nofit_nofit_pos_bench, "{return test(\"%3.3X\", 6983);}"},
	{0, 1044, "X_prec_width_fit_fit_pos_lj", X_prec_width_fit_fit_pos_lj, X_prec_width_fit_fit_pos_lj_bench, "{return test(\"%-8.5X\", 34);}"},
	{0, 1045, "X_prec_width_fit_fit_zero_lj", X_prec_width_fit_fit_zero_lj, X_prec_width_fit_fit_zero_lj_bench, "{return test(\"%-8.5X\", 0);}"},
	{0, 1046, "X_prec_width_nofit_fit_pos_lj", X_prec_width_nofit_fit_pos_lj, X_prec_width_nofit_fit_pos_lj_bench, "{return test(\"%-8.3X\", 8375);}"},
	{0, 1047, "X_prec_width_fit_nofit_pos_lj", X_prec_width_fit_nofit_pos_lj, X_prec_width_fit_nofit_pos_lj_bench, "{return test(\"%-2.7X\", 3267);}"},
	{0, 1048, "X_prec_width_nofit_nofit_pos_lj", X_prec_width_nofit_nofit_pos_lj, X_prec_width_nofit_nofit_pos_lj_bench, "{return test(\"%-3.3X\", 6983);}"},
	{0, 1049, "X_prec_width_ff_pos_zp", X_prec_width_ff_pos_zp, X_prec_width_ff_pos_zp_bench, "{return test(\"%08.5X\", 34);}"},
	{0, 1050, "X_prec_width_ff_zero_zp", X_prec_width_ff_zero_zp, X_prec_width_ff_zero_zp_bench, "{return test(\"%08.5X\", 0);}"},
	{0, 1051, "X_prec_width_nf_pos_zp", X_prec_width_nf_pos_zp, X_prec_width_nf_pos_zp_bench, "{return test(\"%08.3X\", 8375);}"},
	{0, 1052, "X_prec_width_fn_pos_zp", X_prec_width_fn_pos_zp, X_prec_width_fn_pos_zp_bench, "{return test(\"%02.7X\", 3267);}"},
	{0, 1053, "X_prec_width_nn_pos_zp", X_prec_width_nn_pos_zp, X_prec_width_nn_pos_zp_bench, "{return test(\"%03.3X\", 6983);}"},
	{0, 1054, "X_prec_width_ff_pos_ljzp_ignoreflag", X_prec_width_ff_pos_ljzp_ignoreflag, X_prec_width_ff_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.5X\", 34);}"},
	{0, 1055, "X_prec_width_ff_zero_ljzp_ignoreflag", X_prec_width_ff_zero_ljzp_ignoreflag, X_prec_width_ff_zero_ljzp_ignoreflag_bench, "{return test(\"%0-8.5X\", 0);}"},
	{0, 1056, "X_prec_width_nf_pos_ljzp_ignoreflag", X_prec_width_nf_pos_ljzp_ignoreflag, X_prec_width_nf_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.3X\", 8375);}"},
	{0, 1057, "X_prec_width_fn_pos_ljzp_ignoreflag", X_prec_width_fn_pos_ljzp_ignoreflag, X_prec_width_fn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-2.7X\", 3267);}"},
	{0, 1058, "X_prec_width_nn_pos_ljzp_ignoreflag", X_prec_width_nn_pos_ljzp_ignoreflag, X_prec_width_nn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.3X\", 6983);}"},
	{0, 1059, "X_size_hh_pos_casted", X_size_hh_pos_casted, X_size_hh_pos_casted_bench, "{return test(\"%hhX\", (unsigned char)45);}"},
	{0, 1060, "X_size_h_pos_casted", X_size_h_pos_casted, X_size_h_pos_casted_bench, "{return test(\"%hX\", (unsigned short)385);}"},
	{0, 1061, "X_size_l_pos_casted", X_size_l_pos_casted, X_size_l_pos_casted_bench, "{return test(\"%lX\", (unsigned long)32);}"},
	{0, 1062, "X_size_ll_pos_casted", X_size_ll_pos_casted, X_size_ll_pos_casted_bench, "{return test(\"%llX\", (long long)43);}"},
	{0, 1063, "X_size_hh_pos_ref", X_size_hh_pos_ref, X_size_hh_pos_ref_bench, "{return test(\"%hhX\", uch_pos_1);}"},
	{0, 1064, "X_size_h_pos_ref", X_size_h_pos_ref, X_size_h_pos_ref_bench, "{return test(\"%hX\", ush_pos_1);}"},
	{0, 1065, "X_size_l_pos_ref", X_size_l_pos_ref, X_size_l_pos_ref_bench, "{return test(\"%lX\", ul_pos_1);}"},
	{0, 1066, "X_size_ll_pos_ref", X_size_ll_pos_ref, X_size_ll_pos_ref_bench, "{return test(\"%llX\", ull_pos_1);}"},
	{0, 1067, "X_size_l_pos_big", X_size_l_pos_big, X_size_l_pos_big_bench, "{return test(\"%lX\", 22337203685477ul);}"},
	{0, 1068, "X_size_ll_pos_big", X_size_ll_pos_big, X_size_ll_pos_big_bench, "{return test(\"%llX\", 522337203685470ull);}"},
	{0, 1069, "X_ullmax", X_ullmax, X_ullmax_bench, "{return test(\"%llX\", ullmax);}"},
	{0, 1070, "X_ulmax", X_ulmax, X_ulmax_bench, "{return test(\"%lX\", ulmax);}"},
	{0, 1071, "X_uhmax", X_uhmax, X_uhmax_bench, "{return test(\"%hX\", (unsigned short)65535);}"},
	{0, 1072, "X_uhhmax", X_uhhmax, X_uhhmax_bench, "{return test(\"%hhX\", (unsigned char)255);}"},
	{0, 1073, "X_size_l_pos_big_zp", X_size_l_pos_big_zp, X_size_l_pos_big_zp_bench, "{return test(\"%037lX\", 22337203685477ul);}"},
	{0, 1074, "X_size_ll_pos_big_width", X_size_ll_pos_big_width, X_size_ll_pos_big_width_bench, "{return test(\"%37llX\", 522337203685470ull);}"},
	{0, 1075, "X_size_ll_hh_ll", X_size_ll_hh_ll, X_size_ll_hh_ll_bench, "{return test(\"%llu%hhu%llX\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 1076, "X_size_h_l_hh", X_size_h_l_hh, X_size_h_l_hh_bench, "{return test(\"%hu%lu%hhX\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 1077, "X_size_l_hh_h", X_size_l_hh_h, X_size_l_hh_h_bench, "{return test(\"%lu%hhu%hX\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 1078, "X_size_n_ll_hh", X_size_n_ll_hh, X_size_n_ll_hh_bench, "{return test(\"%u%llu%hhX\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 1079, "X_size_ll_n_l", X_size_ll_n_l, X_size_ll_n_l_bench, "{return test(\"%llu%u%lX\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 1080, "X_basic_hexu_pos_af", X_basic_hexu_pos_af, X_basic_hexu_pos_af_bench, "{return test(\"this %#X number\", 17);}"},
	{0, 1081, "X_basic_hexu_zero_af", X_basic_hexu_zero_af, X_basic_hexu_zero_af_bench, "{return test(\"this %#X number\", 0);}"},
	{0, 1082, "X_basic_hexu_onlypos_af", X_basic_hexu_onlypos_af, X_basic_hexu_onlypos_af_bench, "{return test(\"%#X\", 3);}"},
	{0, 1083, "X_hexumax_af", X_hexumax_af, X_hexumax_af_bench, "{return test(\"%#X\", 4294967295u);}"},
	{0, 1084, "X_width_pos_fits_af", X_width_pos_fits_af, X_width_pos_fits_af_bench, "{return test(\"%#7X\", 33);}"},
	{0, 1085, "X_width_zero_fits_af", X_width_zero_fits_af, X_width_zero_fits_af_bench, "{return test(\"%#3X\", 0);}"},
	{0, 1086, "X_width_pos_exactfit_af", X_width_pos_exactfit_af, X_width_pos_exactfit_af_bench, "{return test(\"%#7X\", 52625);}"},
	{0, 1087, "X_width_pos_nofit_af", X_width_pos_nofit_af, X_width_pos_nofit_af_bench, "{return test(\"%#2X\", 94827);}"},
	{0, 1088, "X_width_pos_fits_lj_af", X_width_pos_fits_lj_af, X_width_pos_fits_lj_af_bench, "{return test(\"%#-7X\", 33);}"},
	{0, 1089, "X_width_zero_fits_lj_af", X_width_zero_fits_lj_af, X_width_zero_fits_lj_af_bench, "{return test(\"%#-3X\", 0);}"},
	{0, 1090, "X_width_pos_exactfit_lj_af", X_width_pos_exactfit_lj_af, X_width_pos_exactfit_lj_af_bench, "{return test(\"%#-7X\", 52625);}"},
	{0, 1091, "X_width_pos_nofit_lj_af", X_width_pos_nofit_lj_af, X_width_pos_nofit_lj_af_bench, "{return test(\"%#-4X\", 9648627);}"},
	{0, 1092, "X_prec_fits_pos_af", X_prec_fits_pos_af, X_prec_fits_pos_af_bench, "{return test(\"%#.5X\", 21);}"},
	{0, 1093, "X_prec_fits_zero_af", X_prec_fits_zero_af, X_prec_fits_zero_af_bench, "{return test(\"%#.3X\", 0);}"},
	{0, 1094, "X_prec_exactfit_pos_af", X_prec_exactfit_pos_af, X_prec_exactfit_pos_af_bench, "{return test(\"%#.4X\", 5263);}"},
	{0, 1095, "X_prec_nofit_pos_af", X_prec_nofit_pos_af, X_prec_nofit_pos_af_bench, "{return test(\"%#.3X\", 938862);}"},
	{0, 1096, "X_zp_pos_fits_af", X_zp_pos_fits_af, X_zp_pos_fits_af_bench, "{return test(\"%#05X\", 43);}"},
	{0, 1097, "X_zp_zero_fits_af", X_zp_zero_fits_af, X_zp_zero_fits_af_bench, "{return test(\"%#03X\", 0);}"},
	{0, 1098, "X_zp_pos_exactfit_af", X_zp_pos_exactfit_af, X_zp_pos_exactfit_af_bench, "{return test(\"%#03X\", 698334);}"},
	{0, 1099, "X_prec_width_fit_fit_pos_af", X_prec_width_fit_fit_pos_af, X_prec_width_fit_fit_pos_af_bench, "{return test(\"%#8.5X\", 34);}"},
	{0, 1100, "X_prec_width_fit_fit_zero_af", X_prec_width_fit_fit_zero_af, X_prec_width_fit_fit_zero_af_bench, "{return test(\"%#8.5X\", 0);}"},
	{0, 1101, "X_prec_width_nofit_fit_pos_af", X_prec_width_nofit_fit_pos_af, X_prec_width_nofit_fit_pos_af_bench, "{return test(\"%#8.3X\", 8375);}"},
	{0, 1102, "X_prec_width_fit_nofit_pos_af", X_prec_width_fit_nofit_pos_af, X_prec_width_fit_nofit_pos_af_bench, "{return test(\"%#2.7X\", 3267);}"},
	{0, 1103, "X_prec_width_nofit_nofit_pos_af", X_prec_width_nofit_nofit_pos_af, X_prec_width_nofit_nofit_pos_af_bench, "{return test(\"%#3.3X\", 6983);}"},
	{0, 1104, "X_prec_width_fit_fit_pos_lj_af", X_prec_width_fit_fit_pos_lj_af, X_prec_width_fit_fit_pos_lj_af_bench, "{return test(\"%#-8.5X\", 34);}"},
	{0, 1105, "X_prec_width_fit_fit_zero_lj_af", X_prec_width_fit_fit_zero_lj_af, X_prec_width_fit_fit_zero_lj_af_bench, "{return test(\"%#-8.5X\", 0);}"},
	{0, 1106, "X_prec_width_nofit_fit_pos_lj_af", X_prec_width_nofit_fit_pos_lj_af, X_prec_width_nofit_fit_pos_lj_af_bench, "{return test(\"%#-8.3X\", 8375);}"},
	{0, 1107, "X_prec_width_fit_nofit_pos_lj_af", X_prec_width_fit_nofit_pos_lj_af, X_prec_width_fit_nofit_pos_lj_af_bench, "{return test(\"%#-2.7X\", 3267);}"},
	{0, 1108, "X_prec_width_nofit_nofit_pos_lj_af", X_prec_width_nofit_nofit_pos_lj_af, X_prec_width_nofit_nofit_pos_lj_af_bench, "{return test(\"%#-3.3X\", 6983);}"},
	{0, 1109, "X_prec_width_ff_pos_zp_af", X_prec_width_ff_pos_zp_af, X_prec_width_ff_pos_zp_af_bench, "{return test(\"%#08.5X\", 34);}"},
	{0, 1110, "X_prec_width_ff_zero_zp_af", X_prec_width_ff_zero_zp_af, X_prec_width_ff_zero_zp_af_bench, "{return test(\"%#08.5X\", 0);}"},
	{0, 1111, "X_prec_width_nf_pos_zp_af", X_prec_width_nf_pos_zp_af, X_prec_width_nf_pos_zp_af_bench, "{return test(\"%#08.3X\", 8375);}"},
	{0, 1112, "X_prec_width_fn_pos_zp_af", X_prec_width_fn_pos_zp_af, X_prec_width_fn_pos_zp_af_bench, "{return test(\"%#02.7X\", 3267);}"},
	{0, 1113, "X_prec_width_nn_pos_zp_af", X_prec_width_nn_pos_zp_af, X_prec_width_nn_pos_zp_af_bench, "{return test(\"%#03.3X\", 6983);}"},
	{0, 1114, "X_prec_width_ff_pos_ljzpaf_ignoreflag", X_prec_width_ff_pos_ljzpaf_ignoreflag, X_prec_width_ff_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.5X\", 34);}"},
	{0, 1115, "X_prec_width_ff_zero_ljzpaf_ignoreflag", X_prec_width_ff_zero_ljzpaf_ignoreflag, X_prec_width_ff_zero_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.5X\", 0);}"},
	{0, 1116, "X_prec_width_nf_pos_ljzpaf_ignoreflag", X_prec_width_nf_pos_ljzpaf_ignoreflag, X_prec_width_nf_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.3X\", 8375);}"},
	{0, 1117, "X_prec_width_fn_pos_ljzpaf_ignoreflag", X_prec_width_fn_pos_ljzpaf_ignoreflag, X_prec_width_fn_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-2.7X\", 3267);}"},
	{0, 1118, "X_prec_width_nn_pos_ljzpaf_ignoreflag", X_prec_width_nn_pos_ljzpaf_ignoreflag, X_prec_width_nn_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-3.3X\", 6983);}"},
	{0, 1119, "X_size_hh_pos_casted_af", X_size_hh_pos_casted_af, X_size_hh_pos_casted_af_bench, "{return test(\"%#hhX\", (unsigned char)45);}"},
	{0, 1120, "X_size_h_pos_casted_af", X_size_h_pos_casted_af, X_size_h_pos_casted_af_bench, "{return test(\"%#hX\", (unsigned short)385);}"},
	{0, 1121, "X_size_l_pos_casted_af", X_size_l_pos_casted_af, X_size_l_pos_casted_af_bench, "{return test(\"%#lX\", (unsigned long)32);}"},
	{0, 1122, "X_size_ll_pos_casted_af", X_size_ll_pos_casted_af, X_size_ll_pos_casted_af_bench, "{return test(\"%#llX\", (long long)43);}"},
	{0, 1123, "X_size_hh_pos_ref_af", X_size_hh_pos_ref_af, X_size_hh_pos_ref_af_bench, "{return test(\"%#hhX\", uch_pos_1);}"},
	{0, 1124, "X_size_h_pos_ref_af", X_size_h_pos_ref_af, X_size_h_pos_ref_af_bench, "{return test(\"%#hX\", ush_pos_1);}"},
	{0, 1125, "X_size_l_pos_ref_af", X_size_l_pos_ref_af, X_size_l_pos_ref_af_bench, "{return test(\"%#lX\", ul_pos_1);}"},
	{0, 1126, "X_size_ll_pos_ref_af", X_size_ll_pos_ref_af, X_size_ll_pos_ref_af_bench, "{return test(\"%#llX\", ull_pos_1);}"},
	{0, 1127, "X_size_l_pos_big_af", X_size_l_pos_big_af, X_size_l_pos_big_af_bench, "{return test(\"%#lX\", 22337203685477ul);}"},
	{0, 1128, "X_size_ll_pos_big_af", X_size_ll_pos_big_af, X_size_ll_pos_big_af_bench, "{return test(\"%#llX\", 522337203685470ull);}"},
	{0, 1129, "X_ullmax_af", X_ullmax_af, X_ullmax_af_bench, "{return test(\"%#llX\", ullmax);}"},
	{0, 1130, "X_ulmax_af", X_ulmax_af, X_ulmax_af_bench, "{return test(\"%#lX\", ulmax);}"},
	{0, 1131, "X_uhmax_af", X_uhmax_af, X_uhmax_af_bench, "{return test(\"%#hX\", (unsigned short)65535);}"},
	{0, 1132, "X_uhhmax_af", X_uhhmax_af, X_uhhmax_af_bench, "{return test(\"%#hhX\", (unsigned char)255);}"},
	{0, 1133, "X_size_l_pos_big_zp_af", X_size_l_pos_big_zp_af, X_size_l_pos_big_zp_af_bench, "{return test(\"%#037lX\", 22337203685477ul);}"},
	{0, 1134, "X_size_ll_pos_big_width_af", X_size_ll_pos_big_width_af, X_size_ll_pos_big_width_af_bench, "{return test(\"%#37llX\", 522337203685470ull);}"},
	{0, 1135, "X_size_ll_hh_ll_af", X_size_ll_hh_ll_af, X_size_ll_hh_ll_af_bench, "{return test(\"%llu%hhu%#llX\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 1136, "X_size_h_l_hh_af", X_size_h_l_hh_af, X_size_h_l_hh_af_bench, "{return test(\"%#hx%lu%#hhX\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 1137, "X_size_l_hh_h_af", X_size_l_hh_h_af, X_size_l_hh_h_af_bench, "{return test(\"%lu%hhu%#hX\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 1138, "X_size_n_ll_hh_af", X_size_n_ll_hh_af, X_size_n_ll_hh_af_bench, "{return test(\"%#x%llu%#hhX\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 1139, "X_size_ll_n_l_af", X_size_ll_n_l_af, X_size_ll_n_l_af_bench, "{return test(\"%#llx%u%#lX\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 1140, "X_prec0val0_basic", X_prec0val0_basic, X_prec0val0_basic_bench, "{return test(\"%.0X\", 0);}"},
	{0, 1141, "X_prec0val0_implicit", X_prec0val0_implicit, X_prec0val0_implicit_bench, "{return test(\"%.X\", 0);}"},
	{0, 1142, "X_prec0val0_w", X_prec0val0_w, X_prec0val0_w_bench, "{return test(\"%5.0X\", 0);}"},
	{0, 1143, "X_prec0val0_w_impl", X_prec0val0_w_impl, X_prec0val0_w_impl_bench, "{return test(\"%5.X\", 0);}"},
	{0, 1144, "X_prec0val0_wlj", X_prec0val0_wlj, X_prec0val0_wlj_bench, "{return test(\"%-5.0X\", 0);}"},
	{0, 1145, "X_prec0val0_wlj_impl", X_prec0val0_wlj_impl, X_prec0val0_wlj_impl_bench, "{return test(\"%-5.X\", 0);}"},
	{0, 1146, "X_prec0val0_af", X_prec0val0_af, X_prec0val0_af_bench, "{return test(\"%#.0X\", 0);}"},
	{0, 1147, "X_prec0val0_af_impl", X_prec0val0_af_impl, X_prec0val0_af_impl_bench, "{return test(\"%#.X\", 0);}"},
	{0, 1148, "X_prec0val0_waf", X_prec0val0_waf, X_prec0val0_waf_bench, "{return test(\"%#5.0X\", 0);}"},
	{0, 1149, "X_prec0val0_waf_impl", X_prec0val0_waf_impl, X_prec0val0_waf_impl_bench, "{return test(\"%#5.X\", 0);}"},
	{0, 1150, "X_prec0val0_waflj", X_prec0val0_waflj, X_prec0val0_waflj_bench, "{return test(\"%#-5.0X\", 0);}"},
	{0, 1151, "X_prec0val0_waflj_impl", X_prec0val0_waflj_impl, X_prec0val0_waflj_impl_bench, "{return test(\"%#-5.X\", 0);}"},
	{0, 1152, "o_basic_octl_pos", o_basic_octl_pos, o_basic_octl_pos_bench, "{return test(\"this %o number\", 17);}"},
	{0, 1153, "o_basic_octl_zero", o_basic_octl_zero, o_basic_octl_zero_bench, "{return test(\"this %o number\", 0);}"},
	{0, 1154, "o_basic_octl_onlypos", o_basic_octl_onlypos, o_basic_octl_onlypos_bench, "{return test(\"%o\", 3);}"},
	{0, 1155, "o_octlmax", o_octlmax, o_octlmax_bench, "{return test(\"%o\", 4294967295u);}"},
	{0, 1156, "o_width_pos_fits", o_width_pos_fits, o_width_pos_fits_bench, "{return test(\"%7o\", 33);}"},
	{0, 1157, "o_width_zero_fits", o_width_zero_fits, o_width_zero_fits_bench, "{return test(\"%3o\", 0);}"},
	{0, 1158, "o_width_pos_exactfit", o_width_pos_exactfit, o_width_pos_exactfit_bench, "{return test(\"%6o\", 52625);}"},
	{0, 1159, "o_width_pos_nofit", o_width_pos_nofit, o_width_pos_nofit_bench, "{return test(\"%2o\", 94827);}"},
	{0, 1160, "o_width_pos_fits_lj", o_width_pos_fits_lj, o_width_pos_fits_lj_bench, "{return test(\"%-7o\", 33);}"},
	{0, 1161, "o_width_zero_fits_lj", o_width_zero_fits_lj, o_width_zero_fits_lj_bench, "{return test(\"%-3o\", 0);}"},
	{0, 1162, "o_width_pos_exactfit_lj", o_width_pos_exactfit_lj, o_width_pos_exactfit_lj_bench, "{return test(\"%-6o\", 52625);}"},
	{0, 1163, "o_width_pos_nofit_lj", o_width_pos_nofit_lj, o_width_pos_nofit_lj_bench, "{return test(\"%-4o\", 9648627);}"},
	{0, 1164, "o_prec_fits_pos", o_prec_fits_pos, o_prec_fits_pos_bench, "{return test(\"%.5o\", 21);}"},
	{0, 1165, "o_prec_fits_zero", o_prec_fits_zero, o_prec_fits_zero_bench, "{return test(\"%.3o\", 0);}"},
	{0, 1166, "o_prec_exactfit_pos", o_prec_exactfit_pos, o_prec_exactfit_pos_bench, "{return test(\"%.5o\", 5263);}"},
	{0, 1167, "o_prec_nofit_pos", o_prec_nofit_pos, o_prec_nofit_pos_bench, "{return test(\"%.3o\", 938862);}"},
	{0, 1168, "o_zp_pos_fits", o_zp_pos_fits, o_zp_pos_fits_bench, "{return test(\"%05o\", 43);}"},
	{0, 1169, "o_zp_zero_fits", o_zp_zero_fits, o_zp_zero_fits_bench, "{return test(\"%03o\", 0);}"},
	{0, 1170, "o_zp_pos_exactfit", o_zp_pos_exactfit, o_zp_pos_exactfit_bench, "{return test(\"%07o\", 698334);}"},
	{0, 1171, "o_prec_width_fit_fit_pos", o_prec_width_fit_fit_pos, o_prec_width_fit_fit_pos_bench, "{return test(\"%8.5o\", 34);}"},
	{0, 1172, "o_prec_width_fit_fit_zero", o_prec_width_fit_fit_zero, o_prec_width_fit_fit_zero_bench, "{return test(\"%8.5o\", 0);}"},
	{0, 1173, "o_prec_width_nofit_fit_pos", o_prec_width_nofit_fit_pos, o_prec_width_nofit_fit_pos_bench, "{return test(\"%8.3o\", 8375);}"},
	{0, 1174, "o_prec_width_fit_nofit_pos", o_prec_width_fit_nofit_pos, o_prec_width_fit_nofit_pos_bench, "{return test(\"%2.7o\", 3267);}"},
	{0, 1175, "o_prec_width_nofit_nofit_pos", o_prec_width_nofit_nofit_pos, o_prec_width_nofit_nofit_pos_bench, "{return test(\"%3.3o\", 6983);}"},
	{0, 1176, "o_prec_width_fit_fit_pos_lj", o_prec_width_fit_fit_pos_lj, o_prec_width_fit_fit_pos_lj_bench, "{return test(\"%-8.5o\", 34);}"},
	{0, 1177, "o_prec_width_fit_fit_zero_lj", o_prec_width_fit_fit_zero_lj, o_prec_width_fit_fit_zero_lj_bench, "{return test(\"%-8.5o\", 0);}"},
	{0, 1178, "o_prec_width_nofit_fit_pos_lj", o_prec_width_nofit_fit_pos_lj, o_prec_width_nofit_fit_pos_lj_bench, "{return test(\"%-8.3o\", 8375);}"},
	{0, 1179, "o_prec_width_fit_nofit_pos_lj", o_prec_width_fit_nofit_pos_lj, o_prec_width_fit_nofit_pos_lj_bench, "{return test(\"%-2.7o\", 3267);}"},
	{0, 1180, "o_prec_width_nofit_nofit_pos_lj", o_prec_width_nofit_nofit_pos_lj, o_prec_width_nofit_nofit_pos_lj_bench, "{return test(\"%-3.3o\", 6983);}"},
	{0, 1181, "o_prec_width_ff_pos_zp", o_prec_width_ff_pos_zp, o_prec_width_ff_pos_zp_bench, "{return test(\"%08.5o\", 34);}"},
	{0, 1182, "o_prec_width_ff_zero_zp", o_prec_width_ff_zero_zp, o_prec_width_ff_zero_zp_bench, "{return test(\"%08.5o\", 0);}"},
	{0, 1183, "o_prec_width_nf_pos_zp", o_prec_width_nf_pos_zp, o_prec_width_nf_pos_zp_bench, "{return test(\"%08.3o\", 8375);}"},
	{0, 1184, "o_prec_width_fn_pos_zp", o_prec_width_fn_pos_zp, o_prec_width_fn_pos_zp_bench, "{return test(\"%02.7o\", 3267);}"},
	{0, 1185, "o_prec_width_nn_pos_zp", o_prec_width_nn_pos_zp, o_prec_width_nn_pos_zp_bench, "{return test(\"%03.3o\", 6983);}"},
	{0, 1186, "o_prec_width_ff_pos_ljzp_ignoreflag", o_prec_width_ff_pos_ljzp_ignoreflag, o_prec_width_ff_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.5o\", 34);}"},
	{0, 1187, "o_prec_width_ff_zero_ljzp_ignoreflag", o_prec_width_ff_zero_ljzp_ignoreflag, o_prec_width_ff_zero_ljzp_ignoreflag_bench, "{return test(\"%0-8.5o\", 0);}"},
	{0, 1188, "o_prec_width_nf_pos_ljzp_ignoreflag", o_prec_width_nf_pos_ljzp_ignoreflag, o_prec_width_nf_pos_ljzp_ignoreflag_bench, "{return test(\"%0-8.3o\", 8375);}"},
	{0, 1189, "o_prec_width_fn_pos_ljzp_ignoreflag", o_prec_width_fn_pos_ljzp_ignoreflag, o_prec_width_fn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-2.7o\", 3267);}"},
	{0, 1190, "o_prec_width_nn_pos_ljzp_ignoreflag", o_prec_width_nn_pos_ljzp_ignoreflag, o_prec_width_nn_pos_ljzp_ignoreflag_bench, "{return test(\"%0-3.3o\", 6983);}"},
	{0, 1191, "o_size_hh_pos_casted", o_size_hh_pos_casted, o_size_hh_pos_casted_bench, "{return test(\"%hho\", (unsigned char)45);}"},
	{0, 1192, "o_size_h_pos_casted", o_size_h_pos_casted, o_size_h_pos_casted_bench, "{return test(\"%ho\", (unsigned short)385);}"},
	{0, 1193, "o_size_l_pos_casted", o_size_l_pos_casted, o_size_l_pos_casted_bench, "{return test(\"%lo\", (unsigned long)32);}"},
	{0, 1194, "o_size_ll_pos_casted", o_size_ll_pos_casted, o_size_ll_pos_casted_bench, "{return test(\"%llo\", (long long)43);}"},
	{0, 1195, "o_size_hh_pos_ref", o_size_hh_pos_ref, o_size_hh_pos_ref_bench, "{return test(\"%hho\", uch_pos_1);}"},
	{0, 1196, "o_size_h_pos_ref", o_size_h_pos_ref, o_size_h_pos_ref_bench, "{return test(\"%ho\", ush_pos_1);}"},
	{0, 1197, "o_size_l_pos_ref", o_size_l_pos_ref, o_size_l_pos_ref_bench, "{return test(\"%lo\", ul_pos_1);}"},
	{0, 1198, "o_size_ll_pos_ref", o_size_ll_pos_ref, o_size_ll_pos_ref_bench, "{return test(\"%llo\", ull_pos_1);}"},
	{0, 1199, "o_size_l_pos_big", o_size_l_pos_big, o_size_l_pos_big_bench, "{return test(\"%lo\", 22337203685477ul);}"},
	{0, 1200, "o_size_ll_pos_big", o_size_ll_pos_big, o_size_ll_pos_big_bench, "{return test(\"%llo\", 522337203685470ull);}"},
	{0, 1201, "o_ullmax", o_ullmax, o_ullmax_bench, "{return test(\"%llo\", ullmax);}"},
	{0, 1202, "o_ulmax", o_ulmax, o_ulmax_bench, "{return test(\"%lo\", ulmax);}"},
	{0, 1203, "o_uhmax", o_uhmax, o_uhmax_bench, "{return test(\"%ho\", (unsigned short)65535);}"},
	{0, 1204, "o_uhhmax", o_uhhmax, o_uhhmax_bench, "{return test(\"%hho\", (unsigned char)255);}"},
	{0, 1205, "o_size_l_pos_big_zp", o_size_l_pos_big_zp, o_size_l_pos_big_zp_bench, "{return test(\"%037lo\", 22337203685477ul);}"},
	{0, 1206, "o_size_ll_pos_big_width", o_size_ll_pos_big_width, o_size_ll_pos_big_width_bench, "{return test(\"%37llo\", 522337203685470ull);}"},
	{0, 1207, "o_size_ll_hh_ll", o_size_ll_hh_ll, o_size_ll_hh_ll_bench, "{return test(\"%llu%hhu%llo\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 1208, "o_size_h_l_hh", o_size_h_l_hh, o_size_h_l_hh_bench, "{return test(\"%hu%lu%hho\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 1209, "o_size_l_hh_h", o_size_l_hh_h, o_size_l_hh_h_bench, "{return test(\"%lu%hhu%ho\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 1210, "o_size_n_ll_hh", o_size_n_ll_hh, o_size_n_ll_hh_bench, "{return test(\"%u%llu%hho\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 1211, "o_size_ll_n_l", o_size_ll_n_l, o_size_ll_n_l_bench, "{return test(\"%llu%u%lo\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 1212, "o_basic_octl_pos_af", o_basic_octl_pos_af, o_basic_octl_pos_af_bench, "{return test(\"this %#o number\", 17);}"},
	{0, 1213, "o_basic_octl_zero_af", o_basic_octl_zero_af, o_basic_octl_zero_af_bench, "{return test(\"this %#o number\", 0);}"},
	{0, 1214, "o_basic_octl_onlypos_af", o_basic_octl_onlypos_af, o_basic_octl_onlypos_af_bench, "{return test(\"%#o\", 3);}"},
	{0, 1215, "o_octlmax_af", o_octlmax_af, o_octlmax_af_bench, "{return test(\"%#o\", 4294967295u);}"},
	{0, 1216, "o_width_pos_fits_af", o_width_pos_fits_af, o_width_pos_fits_af_bench, "{return test(\"%#7o\", 33);}"},
	{0, 1217, "o_width_zero_fits_af", o_width_zero_fits_af, o_width_zero_fits_af_bench, "{return test(\"%#3o\", 0);}"},
	{0, 1218, "o_width_pos_exactfit_af", o_width_pos_exactfit_af, o_width_pos_exactfit_af_bench, "{return test(\"%#6o\", 52625);}"},
	{0, 1219, "o_width_pos_nofit_af", o_width_pos_nofit_af, o_width_pos_nofit_af_bench, "{return test(\"%#2o\", 94827);}"},
	{0, 1220, "o_width_pos_fits_lj_af", o_width_pos_fits_lj_af, o_width_pos_fits_lj_af_bench, "{return test(\"%#-7o\", 33);}"},
	{0, 1221, "o_width_zero_fits_lj_af", o_width_zero_fits_lj_af, o_width_zero_fits_lj_af_bench, "{return test(\"%#-3o\", 0);}"},
	{0, 1222, "o_width_pos_exactfit_lj_af", o_width_pos_exactfit_lj_af, o_width_pos_exactfit_lj_af_bench, "{return test(\"%#-6o\", 52625);}"},
	{0, 1223, "o_width_pos_nofit_lj_af", o_width_pos_nofit_lj_af, o_width_pos_nofit_lj_af_bench, "{return test(\"%#-4o\", 9648627);}"},
	{0, 1224, "o_prec_fits_pos_af", o_prec_fits_pos_af, o_prec_fits_pos_af_bench, "{return test(\"%#.5o\", 21);}"},
	{0, 1225, "o_prec_fits_zero_af", o_prec_fits_zero_af, o_prec_fits_zero_af_bench, "{return test(\"%#.3o\", 0);}"},
	{0, 1226, "o_prec_exactfit_pos_af", o_prec_exactfit_pos_af, o_prec_exactfit_pos_af_bench, "{return test(\"%#.5o\", 5263);}"},
	{0, 1227, "o_prec_nofit_pos_af", o_prec_nofit_pos_af, o_prec_nofit_pos_af_bench, "{return test(\"%#.3o\", 938862);}"},
	{0, 1228, "o_zp_pos_fits_af", o_zp_pos_fits_af, o_zp_pos_fits_af_bench, "{return test(\"%#05o\", 43);}"},
	{0, 1229, "o_zp_zero_fits_af", o_zp_zero_fits_af, o_zp_zero_fits_af_bench, "{return test(\"%#03o\", 0);}"},
	{0, 1230, "o_zp_pos_exactfit_af", o_zp_pos_exactfit_af, o_zp_pos_exactfit_af_bench, "{return test(\"%#07o\", 698334);}"},
	{0, 1231, "o_prec_width_fit_fit_pos_af", o_prec_width_fit_fit_pos_af, o_prec_width_fit_fit_pos_af_bench, "{return test(\"%#8.5o\", 34);}"},
	{0, 1232, "o_prec_width_fit_fit_zero_af", o_prec_width_fit_fit_zero_af, o_prec_width_fit_fit_zero_af_bench, "{return test(\"%#8.5o\", 0);}"},
	{0, 1233, "o_prec_width_nofit_fit_pos_af", o_prec_width_nofit_fit_pos_af, o_prec_width_nofit_fit_pos_af_bench, "{return test(\"%#8.3o\", 8375);}"},
	{0, 1234, "o_prec_width_fit_nofit_pos_af", o_prec_width_fit_nofit_pos_af, o_prec_width_fit_nofit_pos_af_bench, "{return test(\"%#2.7o\", 3267);}"},
	{0, 1235, "o_prec_width_nofit_nofit_pos_af", o_prec_width_nofit_nofit_pos_af, o_prec_width_nofit_nofit_pos_af_bench, "{return test(\"%#3.3o\", 6983);}"},
	{0, 1236, "o_prec_width_fit_fit_pos_lj_af", o_prec_width_fit_fit_pos_lj_af, o_prec_width_fit_fit_pos_lj_af_bench, "{return test(\"%#-8.5o\", 34);}"},
	{0, 1237, "o_prec_width_fit_fit_zero_lj_af", o_prec_width_fit_fit_zero_lj_af, o_prec_width_fit_fit_zero_lj_af_bench, "{return test(\"%#-8.5o\", 0);}"},
	{0, 1238, "o_prec_width_nofit_fit_pos_lj_af", o_prec_width_nofit_fit_pos_lj_af, o_prec_width_nofit_fit_pos_lj_af_bench, "{return test(\"%#-8.3o\", 8375);}"},
	{0, 1239, "o_prec_width_fit_nofit_pos_lj_af", o_prec_width_fit_nofit_pos_lj_af, o_prec_width_fit_nofit_pos_lj_af_bench, "{return test(\"%#-2.7o\", 3267);}"},
	{0, 1240, "o_prec_width_nofit_nofit_pos_lj_af", o_prec_width_nofit_nofit_pos_lj_af, o_prec_width_nofit_nofit_pos_lj_af_bench, "{return test(\"%#-3.3o\", 6983);}"},
	{0, 1241, "o_prec_width_ff_pos_zp_af", o_prec_width_ff_pos_zp_af, o_prec_width_ff_pos_zp_af_bench, "{return test(\"%#08.5o\", 34);}"},
	{0, 1242, "o_prec_width_ff_zero_zp_af", o_prec_width_ff_zero_zp_af, o_prec_width_ff_zero_zp_af_bench, "{return test(\"%#08.5o\", 0);}"},
	{0, 1243, "o_prec_width_nf_pos_zp_af", o_prec_width_nf_pos_zp_af, o_prec_width_nf_pos_zp_af_bench, "{return test(\"%#08.3o\", 8375);}"},
	{0, 1244, "o_prec_width_fn_pos_zp_af", o_prec_width_fn_pos_zp_af, o_prec_width_fn_pos_zp_af_bench, "{return test(\"%#02.7o\", 3267);}"},
	{0, 1245, "o_prec_width_nn_pos_zp_af", o_prec_width_nn_pos_zp_af, o_prec_width_nn_pos_zp_af_bench, "{return test(\"%#03.3o\", 6983);}"},
	{0, 1246, "o_prec_width_ff_pos_ljzpaf_ignoreflag", o_prec_width_ff_pos_ljzpaf_ignoreflag, o_prec_width_ff_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.5o\", 34);}"},
	{0, 1247, "o_prec_width_ff_zero_ljzpaf_ignoreflag", o_prec_width_ff_zero_ljzpaf_ignoreflag, o_prec_width_ff_zero_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.5o\", 0);}"},
	{0, 1248, "o_prec_width_nf_pos_ljzpaf_ignoreflag", o_prec_width_nf_pos_ljzpaf_ignoreflag, o_prec_width_nf_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-8.3o\", 8375);}"},
	{0, 1249, "o_prec_width_fn_pos_ljzpaf_ignoreflag", o_prec_width_fn_pos_ljzpaf_ignoreflag, o_prec_width_fn_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-2.7o\", 3267);}"},
	{0, 1250, "o_prec_width_nn_pos_ljzpaf_ignoreflag", o_prec_width_nn_pos_ljzpaf_ignoreflag, o_prec_width_nn_pos_ljzpaf_ignoreflag_bench, "{return test(\"%#0-3.3o\", 6983);}"},
	{0, 1251, "o_size_hh_pos_casted_af", o_size_hh_pos_casted_af, o_size_hh_pos_casted_af_bench, "{return test(\"%#hho\", (unsigned char)45);}"},
	{0, 1252, "o_size_h_pos_casted_af", o_size_h_pos_casted_af, o_size_h_pos_casted_af_bench, "{return test(\"%#ho\", (unsigned short)385);}"},
	{0, 1253, "o_size_l_pos_casted_af", o_size_l_pos_casted_af, o_size_l_pos_casted_af_bench, "{return test(\"%#lo\", (unsigned long)32);}"},
	{0, 1254, "o_size_ll_pos_casted_af", o_size_ll_pos_casted_af, o_size_ll_pos_casted_af_bench, "{return test(\"%#llo\", (long long)43);}"},
	{0, 1255, "o_size_hh_pos_ref_af", o_size_hh_pos_ref_af, o_size_hh_pos_ref_af_bench, "{return test(\"%#hho\", uch_pos_1);}"},
	{0, 1256, "o_size_h_pos_ref_af", o_size_h_pos_ref_af, o_size_h_pos_ref_af_bench, "{return test(\"%#ho\", ush_pos_1);}"},
	{0, 1257, "o_size_l_pos_ref_af", o_size_l_pos_ref_af, o_size_l_pos_ref_af_bench, "{return test(\"%#lo\", ul_pos_1);}"},
	{0, 1258, "o_size_ll_pos_ref_af", o_size_ll_pos_ref_af, o_size_ll_pos_ref_af_bench, "{return test(\"%#llo\", ull_pos_1);}"},
	{0, 1259, "o_size_l_pos_big_af", o_size_l_pos_big_af, o_size_l_pos_big_af_bench, "{return test(\"%#lo\", 22337203685477ul);}"},
	{0, 1260, "o_size_ll_pos_big_af", o_size_ll_pos_big_af, o_size_ll_pos_big_af_bench, "{return test(\"%#llo\", 522337203685470ull);}"},
	{0, 1261, "o_ullmax_af", o_ullmax_af, o_ullmax_af_bench, "{return test(\"%#llo\", ullmax);}"},
	{0, 1262, "o_ulmax_af", o_ulmax_af, o_ulmax_af_bench, "{return test(\"%#lo\", ulmax);}"},
	{0, 1263, "o_uhmax_af", o_uhmax_af, o_uhmax_af_bench, "{return test(\"%#ho\", (unsigned short)65535);}"},
	{0, 1264, "o_uhhmax_af", o_uhhmax_af, o_uhhmax_af_bench, "{return test(\"%#hho\", (unsigned char)255);}"},
	{0, 1265, "o_size_l_pos_big_zp_af", o_size_l_pos_big_zp_af, o_size_l_pos_big_zp_af_bench, "{return test(\"%#037lo\", 22337203685477ul);}"},
	{0, 1266, "o_size_ll_pos_big_width_af", o_size_ll_pos_big_width_af, o_size_ll_pos_big_width_af_bench, "{return test(\"%#37llo\", 522337203685470ull);}"},
	{0, 1267, "o_size_ll_hh_ll_af", o_size_ll_hh_ll_af, o_size_ll_hh_ll_af_bench, "{return test(\"%llu%hhu%#llo\", ull_pos_1, uch_pos_1, ull_pos_1);}"},
	{0, 1268, "o_size_h_l_hh_af", o_size_h_l_hh_af, o_size_h_l_hh_af_bench, "{return test(\"%hu%lu%#hho\", ush_pos_1, ul_pos_1, uch_pos_1);}"},
	{0, 1269, "o_size_l_hh_h_af", o_size_l_hh_h_af, o_size_l_hh_h_af_bench, "{return test(\"%#lo%hhu%#ho\", ul_pos_1, uch_pos_1, ush_pos_1);}"},
	{0, 1270, "o_size_n_ll_hh_af", o_size_n_ll_hh_af, o_size_n_ll_hh_af_bench, "{return test(\"%#o%llu%hho\", ui_pos_1, ull_pos_1, uch_pos_1);}"},
	{0, 1271, "o_size_ll_n_l_af", o_size_ll_n_l_af, o_size_ll_n_l_af_bench, "{return test(\"%#llo%u%#lo\", ull_pos_1, ui_pos_1, ul_pos_1);}"},
	{0, 1272, "o_prec0val0_basic", o_prec0val0_basic, o_prec0val0_basic_bench, "{return test(\"%.0o\", 0);}"},
	{0, 1273, "o_prec0val0_implicit", o_prec0val0_implicit, o_prec0val0_implicit_bench, "{return test(\"%.o\", 0);}"},
	{0, 1274, "o_prec0val0_w", o_prec0val0_w, o_prec0val0_w_bench, "{return test(\"%5.0o\", 0);}"},
	{0, 1275, "o_prec0val0_w_impl", o_prec0val0_w_impl, o_prec0val0_w_impl_bench, "{return test(\"%5.o\", 0);}"},
	{0, 1276, "o_prec0val0_wlj", o_prec0val0_wlj, o_prec0val0_wlj_bench, "{return test(\"%-5.0o\", 0);}"},
	{0, 1277, "o_prec0val0_wlj_impl", o_prec0val0_wlj_impl, o_prec0val0_wlj_impl_bench, "{return test(\"%-5.o\", 0);}"},
	{0, 1278, "o_prec0val0_af", o_prec0val0_af, o_prec0val0_af_bench, "{return test(\"%#.0o\", 0);}"},
	{0, 1279, "o_prec0val0_af_impl", o_prec0val0_af_impl, o_prec0val0_af_impl_bench, "{return test(\"%#.o\", 0);}"},
	{0, 1280, "o_prec0val0_waf", o_prec0val0_waf, o_prec0val0_waf_bench, "{return test(\"%#5.0o\", 0);}"},
	{0, 1281, "o_prec0val0_waf_impl", o_prec0val0_waf_impl, o_prec0val0_waf_impl_bench, "{return test(\"%#5.o\", 0);}"},
	{0, 1282, "o_prec0val0_waflj", o_prec0val0_waflj, o_prec0val0_waflj_bench, "{return test(\"%#-5.0o\", 0);}"},
	{0, 1283, "o_prec0val0_waflj_impl", o_prec0val0_waflj_impl, o_prec0val0_waflj_impl_bench, "{return test(\"%#-5.o\", 0);}"},
	{0, 1284, "p_null", p_null, p_null_bench, "{return test(\"%p\", NULL);}"},
	...
	{0, 1289, "p_ftfc_5w_throwswarning", p_ftfc_5w_throwswarning, p_ftfc_5w_throwswarning_bench, "{return test(\"%5p\", 0);}"},
	{0, 1290, "p_basic", p_basic, p_basic_bench, "{return test(\"%p%p%p%p%p%p%p%p%p%p%p%p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1291, "p_width_fit", p_width_fit, p_width_fit_bench, "{return test(\"%70p%70p%70p%70p%70p%70p%70p%70p%70p%70p%70p%70p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1292, "p_width_nofit", p_width_nofit, p_width_nofit_bench, "{return test(\"%5p%5p%5p%5p%5p%5p%5p%5p%5p%5p%5p%5p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1293, "p_width_16", p_width_16, p_width_16_bench, "{return test(\"%16p%16p%16p%16p%16p%16p%16p%16p%16p%16p%16p%16p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1294, "p_width_8", p_width_8, p_width_8_bench, "{return test(\"%8p%8p%8p%8p%8p%8p%8p%8p%8p%8p%8p%8p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1295, "p_width_32", p_width_32, p_width_32_bench, "{return test(\"%32p%32p%32p%32p%32p%32p%32p%32p%32p%32p%32p%32p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1296, "p_width_fit_lj", p_width_fit_lj, p_width_fit_lj_bench, "{return test(\"%-70p%-70p%-70p%-70p%-70p%-70p%-70p%-70p%-70p%-70p%-70p%-70p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1297, "p_width_nofit_lj", p_width_nofit_lj, p_width_nofit_lj_bench, "{return test(\"%-5p%-5p%-5p%-5p%-5p%-5p%-5p%-5p%-5p%-5p%-5p%-5p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1298, "p_width_16_lj", p_width_16_lj, p_width_16_lj_bench, "{return test(\"%-16p%-16p%-16p%-16p%-16p%-16p%-16p%-16p%-16p%-16p%-16p%-16p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1299, "p_width_8_lj", p_width_8_lj, p_width_8_lj_bench, "{return test(\"%-8p%-8p%-8p%-8p%-8p%-8p%-8p%-8p%-8p%-8p%-8p%-8p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	{0, 1300, "p_width_32_lj", p_width_32_lj, p_width_32_lj_bench, "{return test(\"%-32p%-32p%-32p%-32p%-32p%-32p%-32p%-32p%-32p%-32p%-32p%-32p\",&a01,&a02,&a03,&a04,&a05,&a06,&a07,&a08,&a09,&a10,&a11,&a12);}"},
	...
	{0, 1313, "f_basic_1", f_basic_1, f_basic_1_bench, "{return test(\"this %f float\", 1.5);}"},
	{0, 1314, "f_basic_fltonly", f_basic_fltonly, f_basic_fltonly_bench, "{return test(\"%f\", 7.5);}"},
	{0, 1315, "f_basic_whole", f_basic_whole, f_basic_whole_bench, "{return test(\"%f\", 1.0);}"},
	{0, 1316, "f_basic_negative", f_basic_negative, f_basic_negative_bench, "{return test(\"%f\", -3.85);}"},
	{0, 1317, "f_basic_positive_3_3", f_basic_positive_3_3, f_basic_positive_3_3_bench, "{return test(\"%f\", 573.924);}"},
	{0, 1318, "f_basic_negative_3_3", f_basic_negative_3_3, f_basic_negative_3_3_bench, "{return test(\"%f\", -958.125);}"},
	{0, 1319, "f_basic_positive_smallfpart", f_basic_positive_smallfpart, f_basic_positive_smallfpart_bench, "{return test(\"%f\", 23.00041);}"},
	{0, 1320, "f_basic_positive_allsmall", f_basic_positive_allsmall, f_basic_positive_allsmall_bench, "{return test(\"%f\", 0.000039);}"},
	{0, 1321, "f_basic_negative_smallfpart", f_basic_negative_smallfpart, f_basic_negative_smallfpart_bench, "{return test(\"%f\", -7.00036);}"},
	{0, 1322, "f_basic_negative_allsmall", f_basic_negative_allsmall, f_basic_negative_allsmall_bench, "{return test(\"%f\", -0.00032);}"},
	{0, 1323, "f_basic_limits_allsmall_pos", f_basic_limits_allsmall_pos, f_basic_limits_allsmall_pos_bench, "{return test(\"%f\", 0.000001);}"},
	{0, 1324, "f_basic_limits_allsmall_neg", f_basic_limits_allsmall_neg, f_basic_limits_allsmall_neg_bench, "{return test(\"%f\", -0.000001);}"},
	{0, 1325, "f_basic_limits_smallfpart_pos", f_basic_limits_smallfpart_pos, f_basic_limits_smallfpart_pos_bench, "{return test(\"%f\", 9873.000001);}"},
	{0, 1326, "f_basic_limits_smallfpart_neg", f_basic_limits_smallfpart_neg, f_basic_limits_smallfpart_neg_bench, "{return test(\"%f\", -875.000001);}"},
	{0, 1327, "f_basic_limits_allbig_pos", f_basic_limits_allbig_pos, f_basic_limits_allbig_pos_bench, "{return test(\"%f\", 999.999999);}"},
	{0, 1328, "f_basic_limits_allbig_neg", f_basic_limits_allbig_neg, f_basic_limits_allbig_neg_bench, "{return test(\"%f\", -99.999999);}"},
	{0, 1329, "f_basic_limits_bigfpart_pos", f_basic_limits_bigfpart_pos, f_basic_limits_bigfpart_pos_bench, "{return test(\"%f\", 0.999999);}"},
	{0, 1330, "f_basic_limits_bigfpart_neg", f_basic_limits_bigfpart_neg, f_basic_limits_bigfpart_neg_bench, "{return test(\"%f\", -0.999999);}"},
	{0, 1331, "f_rndd_pos", f_rndd_pos, f_rndd_pos_bench, "{return test(\"%f\", 23.375094499);}"},
	{0, 1332, "f_rndd_neg", f_rndd_neg, f_rndd_neg_bench, "{return test(\"%f\", -985.765426499);}"},
	{0, 1333, "f_rndu_pos", f_rndu_pos, f_rndu_pos_bench, "{return test(\"%f\", 0.0894255);}"},
	{0, 1334, "f_rndu_neg", f_rndu_neg, f_rndu_neg_bench, "{return test(\"%f\", -56.2012685);}"},
	{0, 1335, "f_rndu_multidigit_pos", f_rndu_multidigit_pos, f_rndu_multidigit_pos_bench, "{return test(\"%f\", 43.4399999);}"},
	{0, 1336, "f_rndu_multidigit_neg", f_rndu_multidigit_neg, f_rndu_multidigit_neg_bench, "{return test(\"%f\", -5.0299999);}"},
	{0, 1337, "f_rndd_multidigit_pos", f_rndd_multidigit_pos, f_rndd_multidigit_pos_bench, "{return test(\"%f\", 43.43999949);}"},
	{0, 1338, "f_rndd_multidigit_neg", f_rndd_multidigit_neg, f_rndd_multidigit_neg_bench, "{return test(\"%f\", -5.02999949);}"},
	{0, 1339, "f_rndd_wholnobump_pos", f_rndd_wholnobump_pos, f_rndd_wholnobump_pos_bench, "{return test(\"%f\", 1.99999949);}"},
	{0, 1340, "f_rndd_wholnobump_neg", f_rndd_wholnobump_neg, f_rndd_wholnobump_neg_bench, "{return test(\"%f\", -0.99999949);}"},
	{0, 1341, "f_rndu_bumpwhole_pos", f_rndu_bumpwhole_pos, f_rndu_bumpwhole_pos_bench, "{return test(\"%f\", 3.9999999);}"},
	{0, 1342, "f_rndu_bumpwhole_neg", f_rndu_bumpwhole_neg, f_rndu_bumpwhole_neg_bench, "{return test(\"%f\", -5.9999999);}"},
	{0, 1343, "f_prec0_1", f_prec0_1, f_prec0_1_bench, "{return test(\"this %.0f float\", 1.6);}"},
	{0, 1344, "f_prec0_fltonly", f_prec0_fltonly, f_prec0_fltonly_bench, "{return test(\"%.0f\", 7.4);}"},
	{0, 1345, "f_prec0_whole", f_prec0_whole, f_prec0_whole_bench, "{return test(\"%.0f\", 1.0);}"},
	{0, 1346, "f_prec0_negative", f_prec0_negative, f_prec0_negative_bench, "{return test(\"%.0f\", -3.85);}"},
	{0, 1347, "f_prec0_positive_3_3", f_prec0_positive_3_3, f_prec0_positive_3_3_bench, "{return test(\"%.0f\", 573.924);}"},
	{0, 1348, "f_prec0_negative_3_3", f_prec0_negative_3_3, f_prec0_negative_3_3_bench, "{return test(\"%.0f\", -958.125);}"},
	{0, 1349, "f_prec0_positive_smallfpart", f_prec0_positive_smallfpart, f_prec0_positive_smallfpart_bench, "{return test(\"%.0f\", 23.00041);}"},
	{0, 1350, "f_prec0_positive_allsmall", f_prec0_positive_allsmall, f_prec0_positive_allsmall_bench, "{return test(\"%.0f\", 0.000039);}"},
	{0, 1351, "f_prec0_negative_smallfpart", f_prec0_negative_smallfpart, f_prec0_negative_smallfpart_bench, "{return test(\"%.0f\", -7.00036);}"},
	{0, 1352, "f_prec0_negative_allsmall", f_prec0_negative_allsmall, f_prec0_negative_allsmall_bench, "{return test(\"%.0f\", -0.00032);}"},
	{0, 1353, "f_prec1_1", f_prec1_1, f_prec1_1_bench, "{return test(\"this %.1f float\", 1.5);}"},
	{0, 1354, "f_prec1_fltonly", f_prec1_fltonly, f_prec1_fltonly_bench, "{return test(\"%.1f\", 7.5);}"},
	{0, 1355, "f_prec1_whole", f_prec1_whole, f_prec1_whole_bench, "{return test(\"%.1f\", 1.0);}"},
	{0, 1356, "f_prec1_negative", f_prec1_negative, f_prec1_negative_bench, "{return test(\"%.1f\", -3.85);}"},
	{0, 1357, "f_prec1_positive_3_3", f_prec1_positive_3_3, f_prec1_positive_3_3_bench, "{return test(\"%.1f\", 573.924);}"},
	{0, 1358, "f_prec1_negative_3_3", f_prec1_negative_3_3, f_prec1_negative_3_3_bench, "{return test(\"%.1f\", -958.125);}"},
	{0, 1359, "f_prec1_positive_smallfpart", f_prec1_positive_smallfpart, f_prec1_positive_smallfpart_bench, "{return test(\"%.1f\", 23.00041);}"},
	{0, 1360, "f_prec1_positive_allsmall", f_prec1_positive_allsmall, f_prec1_positive_allsmall_bench, "{return test(\"%.1f\", 0.000039);}"},
	{0, 1361, "f_prec1_negative_smallfpart", f_prec1_negative_smallfpart, f_prec1_negative_smallfpart_bench, "{return test(\"%.1f\", -7.00036);}"},
	{0, 1362, "f_prec1_negative_allsmall", f_prec1_negative_allsmall, f_prec1_negative_allsmall_bench, "{return test(\"%.1f\", -0.00032);}"},
	{0, 1363, "f_prec3_1", f_prec3_1, f_prec3_1_bench, "{return test(\"this %.3f float\", 1.5);}"},
	{0, 1364, "f_prec3_fltonly", f_prec3_fltonly, f_prec3_fltonly_bench, "{return test(\"%.3f\", 7.5);}"},
	{0, 1365, "f_prec3_whole", f_prec3_whole, f_prec3_whole_bench, "{return test(\"%.3f\", 1.0);}"},
	{0, 1366, "f_prec3_negative", f_prec3_negative, f_prec3_negative_bench, "{return test(\"%.3f\", -3.85);}"},
	{0, 1367, "f_prec3_positive_3_3", f_prec3_positive_3_3, f_prec3_positive_3_3_bench, "{return test(\"%.3f\", 573.924);}"},
	{0, 1368, "f_prec3_negative_3_3", f_prec3_negative_3_3, f_prec3_negative_3_3_bench, "{return test(\"%.3f\", -958.125);}"},
	{0, 1369, "f_prec3_positive_smallfpart", f_prec3_positive_smallfpart, f_prec3_positive_smallfpart_bench, "{return test(\"%.3f\", 23.00041);}"},
	{0, 1370, "f_prec3_positive_allsmall", f_prec3_positive_allsmall, f_prec3_positive_allsmall_bench, "{return test(\"%.3f\", 0.000039);}"},
	{0, 1371, "f_prec3_negative_smallfpart", f_prec3_negative_smallfpart, f_prec3_negative_smallfpart_bench, "{return test(\"%.3f\", -7.00036);}"},
	{0, 1372, "f_prec3_negative_allsmall", f_prec3_negative_allsmall, f_prec3_negative_allsmall_bench, "{return test(\"%.3f\", -0.00032);}"},
	{0, 1373, "f_prec7_1", f_prec7_1, f_prec7_1_bench, "{return test(\"this %.7f float\", 1.5);}"},
	{0, 1374, "f_prec7_fltonly", f_prec7_fltonly, f_prec7_fltonly_bench, "{return test(\"%.7f\", 7.5);}"},
	{0, 1375, "f_prec7_whole", f_prec7_whole, f_prec7_whole_bench, "{return test(\"%.7f\", 1.0);}"},
	{0, 1376, "f_prec7_negative", f_prec7_negative, f_prec7_negative_bench, "{return test(\"%.7f\", -3.85);}"},
	{0, 1377, "f_prec7_positive_3_3", f_prec7_positive_3_3, f_prec7_positive_3_3_bench, "{return test(\"%.7f\", 573.924);}"},
	{0, 1378, "f_prec7_negative_3_3", f_prec7_negative_3_3, f_prec7_negative_3_3_bench, "{return test(\"%.7f\", -958.125);}"},
	{0, 1379, "f_prec7_positive_smallfpart", f_prec7_positive_smallfpart, f_prec7_positive_smallfpart_bench, "{return test(\"%.7f\", 23.00041);}"},
	{0, 1380, "f_prec7_positive_allsmall", f_prec7_positive_allsmall, f_prec7_positive_allsmall_bench, "{return test(\"%.7f\", 0.0000039);}"},
	{0, 1381, "f_prec7_negative_smallfpart", f_prec7_negative_smallfpart, f_prec7_negative_smallfpart_bench, "{return test(\"%.7f\", -7.00036);}"},
	{0, 1382, "f_prec7_negative_allsmall", f_prec7_negative_allsmall, f_prec7_negative_allsmall_bench, "{return test(\"%.7f\", -0.000032);}"},
	{0, 1383, "f_prec7_limits_allsmall_pos", f_prec7_limits_allsmall_pos, f_prec7_limits_allsmall_pos_bench, "{return test(\"%.7f\", 0.0000001);}"},
	{0, 1384, "f_prec7_limits_allsmall_neg", f_prec7_limits_allsmall_neg, f_prec7_limits_allsmall_neg_bench, "{return test(\"%.7f\", -0.0000001);}"},
	{0, 1385, "f_prec7_limits_smallfpart_pos", f_prec7_limits_smallfpart_pos, f_prec7_limits_smallfpart_pos_bench, "{return test(\"%.7f\", 9873.000001);}"},
	{0, 1386, "f_prec7_limits_smallfpart_neg", f_prec7_limits_smallfpart_neg, f_prec7_limits_smallfpart_neg_bench, "{return test(\"%.7f\", -875.000001);}"},
	{0, 1387, "f_prec7_limits_allbig_pos", f_prec7_limits_allbig_pos, f_prec7_limits_allbig_pos_bench, "{return test(\"%.7f\", 999.9999999);}"},
	{0, 1388, "f_prec7_limits_allbig_neg", f_prec7_limits_allbig_neg, f_prec7_limits_allbig_neg_bench, "{return test(\"%.7f\", -99.9999999);}"},
	{0, 1389, "f_prec7_limits_bigfpart_pos", f_prec7_limits_bigfpart_pos, f_prec7_limits_bigfpart_pos_bench, "{return test(\"%.7f\", 0.999999);}"},
	{0, 1390, "f_prec7_limits_bigfpart_neg", f_prec7_limits_bigfpart_neg, f_prec7_limits_bigfpart_neg_bench, "{return test(\"%.7f\", -0.999999);}"},
	{0, 1391, "f_rnd_prec7_rndd_pos", f_rnd_prec7_rndd_pos, f_rnd_prec7_rndd_pos_bench, "{return test(\"%.7f\", 23.375094499);}"},
	{0, 1392, "f_rnd_prec7_rndd_neg", f_rnd_prec7_rndd_neg, f_rnd_prec7_rndd_neg_bench, "{return test(\"%.7f\", -985.765426499);}"},
	{0, 1393, "f_rnd_prec7_rndu_pos", f_rnd_prec7_rndu_pos, f_rnd_prec7_rndu_pos_bench, "{return test(\"%.7f\", 0.0894255);}"},
	{0, 1394, "f_rnd_prec7_rndu_neg", f_rnd_prec7_rndu_neg, f_rnd_prec7_rndu_neg_bench, "{return test(\"%.7f\", -56.2012685);}"},
	{0, 1395, "f_rnd_prec7_rndu_multidigit_pos", f_rnd_prec7_rndu_multidigit_pos, f_rnd_prec7_rndu_multidigit_pos_bench, "{return test(\"%.7f\", 43.4399999);}"},
	{0, 1396, "f_rnd_prec7_rndu_multidigit_neg", f_rnd_prec7_rndu_multidigit_neg, f_rnd_prec7_rndu_multidigit_neg_bench, "{return test(\"%.7f\", -5.0299999);}"},
	{0, 1397, "f_rnd_prec7_rndd_multidigit_pos", f_rnd_prec7_rndd_multidigit_pos, f_rnd_prec7_rndd_multidigit_pos_bench, "{return test(\"%.7f\", 43.43999949);}"},
	{0, 1398, "f_rnd_prec7_rndd_multidigit_neg", f_rnd_prec7_rndd_multidigit_neg, f_rnd_prec7_rndd_multidigit_neg_bench, "{return test(\"%.7f\", -5.02999949);}"},
	{0, 1399, "f_rnd_prec7_rndd_wholnobump_pos", f_rnd_prec7_rndd_wholnobump_pos, f_rnd_prec7_rndd_wholnobump_pos_bench, "{return test(\"%.7f\", 1.99999949);}"},
	{0, 1400, "f_rnd_prec7_rndd_wholnobump_neg", f_rnd_prec7_rndd_wholnobump_neg, f_rnd_prec7_rndd_wholnobump_neg_bench, "{return test(\"%.7f\", -0.99999949);}"},
	{0, 1401, "f_rnd_prec7_rndu_bumpwhole_pos", f_rnd_prec7_rndu_bumpwhole_pos, f_rnd_prec7_rndu_bumpwhole_pos_bench, "{return test(\"%.7f\", 3.9999999);}"},
	{0, 1402, "f_prec8_1", f_prec8_1, f_prec8_1_bench, "{return test(\"this %.8f float\", 1.5);}"},
	{0, 1403, "f_prec8_fltonly", f_prec8_fltonly, f_prec8_fltonly_bench, "{return test(\"%.8f\", 7.5);}"},
	{0, 1404, "f_prec8_whole", f_prec8_whole, f_prec8_whole_bench, "{return test(\"%.8f\", 1.0);}"},
	{0, 1405, "f_prec8_negative", f_prec8_negative, f_prec8_negative_bench, "{return test(\"%.8f\", -3.85);}"},
	{0, 1406, "f_prec8_positive_3_3", f_prec8_positive_3_3, f_prec8_positive_3_3_bench, "{return test(\"%.8f\", 573.924);}"},
	{0, 1407, "f_prec8_negative_3_3", f_prec8_negative_3_3, f_prec8_negative_3_3_bench, "{return test(\"%.8f\", -958.125);}"},
	{0, 1408, "f_prec8_positive_smallfpart", f_prec8_positive_smallfpart, f_prec8_positive_smallfpart_bench, "{return test(\"%.8f\", 23.00041);}"},
	{0, 1409, "f_prec8_positive_allsmall", f_prec8_positive_allsmall, f_prec8_positive_allsmall_bench, "{return test(\"%.8f\", 0.00000039);}"},
	{0, 1410, "f_prec8_negative_smallfpart", f_prec8_negative_smallfpart, f_prec8_negative_smallfpart_bench, "{return test(\"%.8f\", -7.00036);}"},
	{0, 1411, "f_prec8_negative_allsmall", f_prec8_negative_allsmall, f_prec8_negative_allsmall_bench, "{return test(\"%.8f\", -0.0000032);}"},
	{0, 1412, "f_prec8_limits_allsmall_pos", f_prec8_limits_allsmall_pos, f_prec8_limits_allsmall_pos_bench, "{return test(\"%.8f\", 0.00000001);}"},
	{0, 1413, "f_prec8_limits_allsmall_neg", f_prec8_limits_allsmall_neg, f_prec8_limits_allsmall_neg_bench, "{return test(\"%.8f\", -0.00000001);}"},
	{0, 1414, "f_prec8_limits_smallfpart_pos", f_prec8_limits_smallfpart_pos, f_prec8_limits_smallfpart_pos_bench, "{return test(\"%.8f\", 9873.000001);}"},
	{0, 1415, "f_prec8_limits_smallfpart_neg", f_prec8_limits_smallfpart_neg, f_prec8_limits_smallfpart_neg_bench, "{return test(\"%.8f\", -875.000001);}"},
	{0, 1416, "f_prec8_limits_allbig_pos", f_prec8_limits_allbig_pos, f_prec8_limits_allbig_pos_bench, "{return test(\"%.8f\", 999.9999999);}"},
	{0, 1417, "f_prec8_limits_allbig_neg", f_prec8_limits_allbig_neg, f_prec8_limits_allbig_neg_bench, "{return test(\"%.8f\", -99.99999999);}"},
	{0, 1418, "f_prec8_limits_bigfpart_pos", f_prec8_limits_bigfpart_pos, f_prec8_limits_bigfpart_pos_bench, "{return test(\"%.8f\", 0.999999);}"},
	{0, 1419, "f_prec8_limits_bigfpart_neg", f_prec8_limits_bigfpart_neg, f_prec8_limits_bigfpart_neg_bench, "{return test(\"%.8f\", -0.999999);}"},
	{0, 1420, "f_rnd_prec8_rndd_pos", f_rnd_prec8_rndd_pos, f_rnd_prec8_rndd_pos_bench, "{return test(\"%.8f\", 23.375094499);}"},
	{0, 1421, "f_rnd_prec8_rndd_neg", f_rnd_prec8_rndd_neg, f_rnd_prec8_rndd_neg_bench, "{return test(\"%.8f\", -985.765426499);}"},
	{0, 1422, "f_rnd_prec8_rndu_pos", f_rnd_prec8_rndu_pos, f_rnd_prec8_rndu_pos_bench, "{return test(\"%.8f\", 0.0894255);}"},
	{0, 1423, "f_rnd_prec8_rndu_neg", f_rnd_prec8_rndu_neg, f_rnd_prec8_rndu_neg_bench, "{return test(\"%.8f\", -56.2012685);}"},
	{0, 1424, "f_rnd_prec8_rndu_multidigit_pos", f_rnd_prec8_rndu_multidigit_pos, f_rnd_prec8_rndu_multidigit_pos_bench, "{return test(\"%.8f\", 43.4399999);}"},
	{0, 1425, "f_rnd_prec8_rndu_multidigit_neg", f_rnd_prec8_rndu_multidigit_neg, f_rnd_prec8_rndu_multidigit_neg_bench, "{return test(\"%.8f\", -5.0299999);}"},
	{0, 1426, "f_rnd_prec8_rndd_multidigit_pos", f_rnd_prec8_rndd_multidigit_pos, f_rnd_prec8_rndd_multidigit_pos_bench, "{return test(\"%.8f\", 43.43999949);}"},
	{0, 1427, "f_rnd_prec8_rndd_multidigit_neg", f_rnd_prec8_rndd_multidigit_neg, f_rnd_prec8_rndd_multidigit_neg_bench, "{return test(\"%.8f\", -5.02999949);}"},
	{0, 1428, "f_rnd_prec8_rndd_wholnobump_pos", f_rnd_prec8_rndd_wholnobump_pos, f_rnd_prec8_rndd_wholnobump_pos_bench, "{return test(\"%.8f\", 1.99999949);}"},
	{0, 1429, "f_rnd_prec8_rndd_wholnobump_neg", f_rnd_prec8_rndd_wholnobump_neg, f_rnd_prec8_rndd_wholnobump_neg_bench, "{return test(\"%.8f\", -0.99999949);}"},
	{0, 1430, "f_rnd_prec8_rndu_bumpwhole_pos", f_rnd_prec8_rndu_bumpwhole_pos, f_rnd_prec8_rndu_bumpwhole_pos_bench, "{return test(\"%.8f\", 3.9999999);}"},
	{0, 1431, "f_stress_prec9_1", f_stress_prec9_1, f_stress_prec9_1_bench, "{return test(\"this %.9f float\", 1.5);}"},
	{0, 1432, "f_stress_prec9_fltonly", f_stress_prec9_fltonly, f_stress_prec9_fltonly_bench, "{return test(\"%.9f\", 7.5);}"},
	{0, 1433, "f_stress_prec9_whole", f_stress_prec9_whole, f_stress_prec9_whole_bench, "{return test(\"%.9f\", 1.0);}"},
	{0, 1434, "f_stress_prec9_negative", f_stress_prec9_negative, f_stress_prec9_negative_bench, "{return test(\"%.9f\", -3.85);}"},
	{0, 1435, "f_stress_prec9_positive_3_3", f_stress_prec9_positive_3_3, f_stress_prec9_positive_3_3_bench, "{return test(\"%.9f\", 573.924);}"},
	{0, 1436, "f_stress_prec9_negative_3_3", f_stress_prec9_negative_3_3, f_stress_prec9_negative_3_3_bench, "{return test(\"%.9f\", -958.125);}"},
	{0, 1437, "f_stress_prec9_positive_smallfpart", f_stress_prec9_positive_smallfpart, f_stress_prec9_positive_smallfpart_bench, "{return test(\"%.9f\", 23.00041);}"},
	{0, 1438, "f_stress_prec9_positive_allsmall", f_stress_prec9_positive_allsmall, f_stress_prec9_positive_allsmall_bench, "{return test(\"%.9f\", 0.00000039);}"},
	{0, 1439, "f_stress_prec9_negative_smallfpart", f_stress_prec9_negative_smallfpart, f_stress_prec9_negative_smallfpart_bench, "{return test(\"%.9f\", -7.00036);}"},
	{0, 1440, "f_stress_prec9_negative_allsmall", f_stress_prec9_negative_allsmall, f_stress_prec9_negative_allsmall_bench, "{return test(\"%.9f\", -0.0000032);}"},
	{0, 1441, "f_stress_prec9_limits_allsmall_pos", f_stress_prec9_limits_allsmall_pos, f_stress_prec9_limits_allsmall_pos_bench, "{return test(\"%.9f\", 0.00000001);}"},
	{0, 1442, "f_stress_prec9_limits_allsmall_neg", f_stress_prec9_limits_allsmall_neg, f_stress_prec9_limits_allsmall_neg_bench, "{return test(\"%.9f\", -0.00000001);}"},
	{0, 1443, "f_stress_prec9_limits_smallfpart_pos", f_stress_prec9_limits_smallfpart_pos, f_stress_prec9_limits_smallfpart_pos_bench, "{return test(\"%.9f\", 9873.000001);}"},
	{0, 1444, "f_stress_prec9_limits_smallfpart_neg", f_stress_prec9_limits_smallfpart_neg, f_stress_prec9_limits_smallfpart_neg_bench, "{return test(\"%.9f\", -875.000001);}"},
	{0, 1445, "f_stress_prec9_limits_allbig_pos", f_stress_prec9_limits_allbig_pos, f_stress_prec9_limits_allbig_pos_bench, "{return test(\"%.9f\", 999.99999999);}"},
	{0, 1446, "f_stress_prec9_limits_allbig_neg", f_stress_prec9_limits_allbig_neg, f_stress_prec9_limits_allbig_neg_bench, "{return test(\"%.9f\", -99.99999999);}"},
	{0, 1447, "f_stress_prec9_limits_bigfpart_pos", f_stress_prec9_limits_bigfpart_pos, f_stress_prec9_limits_bigfpart_pos_bench, "{return test(\"%.9f\", 0.999999);}"},
	{0, 1448, "f_stress_prec9_limits_bigfpart_neg", f_stress_prec9_limits_bigfpart_neg, f_stress_prec9_limits_bigfpart_neg_bench, "{return test(\"%.9f\", -0.999999);}"},
	{0, 1449, "f_stress_prec9_rndd_pos", f_stress_prec9_rndd_pos, f_stress_prec9_rndd_pos_bench, "{return test(\"%.9f\", 23.375094499);}"},
	{0, 1450, "f_stress_prec9_rndd_neg", f_stress_prec9_rndd_neg, f_stress_prec9_rndd_neg_bench, "{return test(\"%.9f\", -985.765426499);}"},
	{0, 1451, "f_stress_prec9_rndu_pos", f_stress_prec9_rndu_pos, f_stress_prec9_rndu_pos_bench, "{return test(\"%.9f\", 0.0894255);}"},
	{0, 1452, "f_stress_prec9_rndu_neg", f_stress_prec9_rndu_neg, f_stress_prec9_rndu_neg_bench, "{return test(\"%.9f\", -56.2012685);}"},
	{0, 1453, "f_stress_prec9_rndu_multidigit_pos", f_stress_prec9_rndu_multidigit_pos, f_stress_prec9_rndu_multidigit_pos_bench, "{return test(\"%.9f\", 43.4399999);}"},
	{0, 1454, "f_stress_prec9_rndu_multidigit_neg", f_stress_prec9_rndu_multidigit_neg, f_stress_prec9_rndu_multidigit_neg_bench, "{return test(\"%.9f\", -5.0299999);}"},
	{0, 1455, "f_stress_prec9_rndd_multidigit_pos", f_stress_prec9_rndd_multidigit_pos, f_stress_prec9_rndd_multidigit_pos_bench, "{return test(\"%.9f\", 43.43999949);}"},
	{0, 1456, "f_stress_prec9_rndd_multidigit_neg", f_stress_prec9_rndd_multidigit_neg, f_stress_prec9_rndd_multidigit_neg_bench, "{return test(\"%.9f\", -5.02999949);}"},
	{0, 1457, "f_stress_prec9_rndd_wholnobump_pos", f_stress_prec9_rndd_wholnobump_pos, f_stress_prec9_rndd_wholnobump_pos_bench, "{return test(\"%.9f\", 1.99999949);}"},
	{0, 1458, "f_stress_prec9_rndd_wholnobump_neg", f_stress_prec9_rndd_wholnobump_neg, f_stress_prec9_rndd_wholnobump_neg_bench, "{return test(\"%.9f\", -0.99999949);}"},
	{0, 1459, "f_stress_prec9_rndu_bumpwhole_pos", f_stress_prec9_rndu_bumpwhole_pos, f_stress_prec9_rndu_bumpwhole_pos_bench, "{return test(\"%.9f\", 3.9999999);}"},
	{0, 1460, "f_stress_prec10_1", f_stress_prec10_1, f_stress_prec10_1_bench, "{return test(\"this %.10f float\", 1.5);}"},
	{0, 1461, "f_stress_prec10_fltonly", f_stress_prec10_fltonly, f_stress_prec10_fltonly_bench, "{return test(\"%.10f\", 7.5);}"},
	{0, 1462, "f_stress_prec10_whole", f_stress_prec10_whole, f_stress_prec10_whole_bench, "{return test(\"%.10f\", 1.0);}"},
	{0, 1463, "f_stress_prec10_negative", f_stress_prec10_negative, f_stress_prec10_negative_bench, "{return test(\"%.10f\", -3.85);}"},
	{0, 1464, "f_stress_prec10_positive_3_10", f_stress_prec10_positive_3_10, f_stress_prec10_positive_3_10_bench, "{return test(\"%.10f\", 573.924);}"},
	{0, 1465, "f_stress_prec10_negative_3_10", f_stress_prec10_negative_3_10, f_stress_prec10_negative_3_10_bench, "{return test(\"%.10f\", -958.125);}"},
	{0, 1466, "f_stress_prec10_pos", f_stress_prec10_pos, f_stress_prec10_pos_bench, "{return test(\"%.10f\", 23.8341375094);}"},
	{0, 1467, "f_stress_prec10_neg", f_stress_prec10_neg, f_stress_prec10_neg_bench, "{return test(\"%.10f\", -985.2459765426);}"},
	{0, 1468, "f_stress_prec10_rndd_pos", f_stress_prec10_rndd_pos, f_stress_prec10_rndd_pos_bench, "{return test(\"%.10f\", 23.8341375094499);}"},
	{0, 1469, "f_stress_prec10_rndd_neg", f_stress_prec10_rndd_neg, f_stress_prec10_rndd_neg_bench, "{return test(\"%.10f\", -985.2459765426499);}"},
	{0, 1470, "f_stress_prec10_rndu_pos", f_stress_prec10_rndu_pos, f_stress_prec10_rndu_pos_bench, "{return test(\"%.10f\", 0.87650894255);}"},
	{0, 1471, "f_stress_prec10_rndu_neg", f_stress_prec10_rndu_neg, f_stress_prec10_rndu_neg_bench, "{return test(\"%.10f\", -56.47852012685);}"},
	{0, 1472, "f_stress_prec10_positive_smallfpart", f_stress_prec10_positive_smallfpart, f_stress_prec10_positive_smallfpart_bench, "{return test(\"%.10f\", 23.000000041);}"},
	{0, 1473, "f_stress_prec10_positive_allsmall", f_stress_prec10_positive_allsmall, f_stress_prec10_positive_allsmall_bench, "{return test(\"%.10f\", 0.0000000039);}"},
	{0, 1474, "f_stress_prec10_negative_smallfpart", f_stress_prec10_negative_smallfpart, f_stress_prec10_negative_smallfpart_bench, "{return test(\"%.10f\", -7.000000036);}"},
	{0, 1475, "f_stress_prec10_negative_allsmall", f_stress_prec10_negative_allsmall, f_stress_prec10_negative_allsmall_bench, "{return test(\"%.10f\", -0.000000032);}"},
	{0, 1476, "f_stress_prec10_limits_allsmall_pos", f_stress_prec10_limits_allsmall_pos, f_stress_prec10_limits_allsmall_pos_bench, "{return test(\"%.10f\", 0.0000000001);}"},
	{0, 1477, "f_stress_prec10_limits_allsmall_neg", f_stress_prec10_limits_allsmall_neg, f_stress_prec10_limits_allsmall_neg_bench, "{return test(\"%.10f\", -0.0000000001);}"},
	{0, 1478, "f_stress_prec10_limits_smallfpart_pos", f_stress_prec10_limits_smallfpart_pos, f_stress_prec10_limits_smallfpart_pos_bench, "{return test(\"%.10f\", 9873.0000000001);}"},
	{0, 1479, "f_stress_prec10_limits_smallfpart_neg", f_stress_prec10_limits_smallfpart_neg, f_stress_prec10_limits_smallfpart_neg_bench, "{return test(\"%.10f\", -875.0000000001);}"},
	{0, 1480, "f_stress_prec10_limits_allbig_pos", f_stress_prec10_limits_allbig_pos, f_stress_prec10_limits_allbig_pos_bench, "{return test(\"%.10f\", 999.9999999999);}"},
	{0, 1481, "f_stress_prec10_limits_allbig_neg", f_stress_prec10_limits_allbig_neg, f_stress_prec10_limits_allbig_neg_bench, "{return test(\"%.10f\", -99.9999999999);}"},
	{0, 1482, "f_stress_prec10_limits_bigfpart_pos", f_stress_prec10_limits_bigfpart_pos, f_stress_prec10_limits_bigfpart_pos_bench, "{return test(\"%.10f\", 0.9999999999);}"},
	{0, 1483, "f_stress_prec10_limits_bigfpart_neg", f_stress_prec10_limits_bigfpart_neg, f_stress_prec10_limits_bigfpart_neg_bench, "{return test(\"%.10f\", -0.9999999999);}"},
	{0, 1484, "f_stress_prec11_rndu", f_stress_prec11_rndu, f_stress_prec11_rndu_bench, "{return test(\"%.11f\",        1.025978541236587568);}"},
	{0, 1485, "f_stress_prec11_rndd", f_stress_prec11_rndd, f_stress_prec11_rndd_bench, "{return test(\"%.11f\",        1.025978548534310421);}"},
	{0, 1486, "f_stress_prec11_limits_tiny", f_stress_prec11_limits_tiny, f_stress_prec11_limits_tiny_bench, "{return test(\"%.11f\", 0.000000000010000000);}"},
	{0, 1487, "f_stress_prec11_limits_big", f_stress_prec11_limits_big, f_stress_prec11_limits_big_bench, "{return test(\"%.11f\", 99.999999999990000000);}"},
	{0, 1488, "f_stress_prec12_rndu", f_stress_prec12_rndu, f_stress_prec12_rndu_bench, "{return test(\"%.12f\",        1.025978541236587568);}"},
	{0, 1489, "f_stress_prec12_rndd", f_stress_prec12_rndd, f_stress_prec12_rndd_bench, "{return test(\"%.12f\",        1.025978548534310421);}"},
	{0, 1490, "f_stress_prec12_limits_tiny", f_stress_prec12_limits_tiny, f_stress_prec12_limits_tiny_bench, "{return test(\"%.12f\", 0.000000000001000000);}"},
	{0, 1491, "f_stress_prec12_limits_big", f_stress_prec12_limits_big, f_stress_prec12_limits_big_bench, "{return test(\"%.12f\", 99.999999999999000000);}"},
	{0, 1492, "f_stress_prec13_rndu", f_stress_prec13_rndu, f_stress_prec13_rndu_bench, "{return test(\"%.13f\",        1.025978541136587568);}"},
	{0, 1493, "f_stress_prec13_rndd", f_stress_prec13_rndd, f_stress_prec13_rndd_bench, "{return test(\"%.13f\",        1.025978548534310421);}"},
	{0, 1494, "f_stress_prec13_limits_tiny", f_stress_prec13_limits_tiny, f_stress_prec13_limits_tiny_bench, "{return test(\"%.13f\", 0.000000000000100000);}"},
	{0, 1495, "f_stress_prec13_limits_big", f_stress_prec13_limits_big, f_stress_prec13_limits_big_bench, "{return test(\"%.13f\", 99.999999999999900000);}"},
	{0, 1496, "f_stress_prec14_rndu", f_stress_prec14_rndu, f_stress_prec14_rndu_bench, "{return test(\"%.14f\",        1.025978541436587568);}"},
	{0, 1497, "f_stress_prec14_rndd", f_stress_prec14_rndd, f_stress_prec14_rndd_bench, "{return test(\"%.14f\",        1.025978548534310421);}"},
	{0, 1498, "f_stress_prec14_limits_tiny", f_stress_prec14_limits_tiny, f_stress_prec14_limits_tiny_bench, "{return test(\"%.14f\", 0.000000000000010000);}"},
	{0, 1499, "f_stress_prec14_limits_big", f_stress_prec14_limits_big, f_stress_prec14_limits_big_bench, "{return test(\"%.14f\",  9.999999999999990000);}"},
	{0, 1500, "f_stress_prec15_rndu", f_stress_prec15_rndu, f_stress_prec15_rndu_bench, "{return test(\"%.15f\",        1.025978542436587568);}"},
	{0, 1501, "f_stress_prec15_rndd", f_stress_prec15_rndd, f_stress_prec15_rndd_bench, "{return test(\"%.15f\",        1.025978548534310421);}"},
	{0, 1502, "f_stress_prec15_limits_tiny", f_stress_prec15_limits_tiny, f_stress_prec15_limits_tiny_bench, "{return test(\"%.15f\", 0.000000000000001000);}"},
	{0, 1503, "f_stress_prec15_limits_big", f_stress_prec15_limits_big, f_stress_prec15_limits_big_bench, "{return test(\"%.15f\",  0.999999999999999000);}"},
	{0, 1504, "f_stress_prec16_rndu", f_stress_prec16_rndu, f_stress_prec16_rndu_bench, "{return test(\"%.16f\",        1.025978542436587568);}"},
	{0, 1505, "f_stress_prec16_rndd", f_stress_prec16_rndd, f_stress_prec16_rndd_bench, "{return test(\"%.16f\",        1.025978548534310421);}"},
	{0, 1506, "f_stress_prec16_limits_tiny", f_stress_prec16_limits_tiny, f_stress_prec16_limits_tiny_bench, "{return test(\"%.16f\", 0.000000000000000100);}"},
	...
	{0, 1508, "f_stress_prec17_rndu", f_stress_prec17_rndu, f_stress_prec17_rndu_bench, "{return test(\"%.17f\",        1.025978542436587568);}"},
	{0, 1509, "f_stress_prec17_rndd", f_stress_prec17_rndd, f_stress_prec17_rndd_bench, "{return test(\"%.17f\",        1.025978548534310421);}"},
	{0, 1510, "f_stress_prec17_limits_tiny", f_stress_prec17_limits_tiny, f_stress_prec17_limits_tiny_bench, "{return test(\"%.17f\", 0.000000000000000010);}"},
	{0, 1511, "f_stress_prec17_limits_big", f_stress_prec17_limits_big, f_stress_prec17_limits_big_bench, "{return test(\"%.17f\",  0.999999999999999990);}"},
	{0, 1512, "f_stress_prec18_rndu", f_stress_prec18_rndu, f_stress_prec18_rndu_bench, "{return test(\"%.18f\",        0.125978542436587568);}"},
	{0, 1513, "f_stress_prec18_rndd", f_stress_prec18_rndd, f_stress_prec18_rndd_bench, "{return test(\"%.18f\",        0.125978548534310421);}"},
	{0, 1514, "f_af_prec0p", f_af_prec0p, f_af_prec0p_bench, "{return test(\"%#.0f\", 7.4);}"},
	{0, 1515, "f_af_prec1p", f_af_prec1p, f_af_prec1p_bench, "{return test(\"%#.1f\", 7.3);}"},
	{0, 1516, "f_af_prec0n", f_af_prec0n, f_af_prec0n_bench, "{return test(\"%#.0f\", -7.4);}"},
	{0, 1517, "f_af_prec1n", f_af_prec1n, f_af_prec1n_bench, "{return test(\"%#.1f\", -7.3);}"},
	{0, 1518, "f_as_prec0p_as", f_as_prec0p_as, f_as_prec0p_as_bench, "{return test(\"%+.0f\", 7.4);}"},
	{0, 1519, "f_as_prec3p_as", f_as_prec3p_as, f_as_prec3p_as_bench, "{return test(\"%+.3f\", 7.3);}"},
	{0, 1520, "f_as_prec0n_as", f_as_prec0n_as, f_as_prec0n_as_bench, "{return test(\"%+.0f\", -7.4);}"},
	{0, 1521, "f_as_prec3n_as", f_as_prec3n_as, f_as_prec3n_as_bench, "{return test(\"%+.3f\", -7.3);}"},
	{0, 1522, "f_wprec0p", f_wprec0p, f_wprec0p_bench, "{return test(\"%5.0f\", 7.3);}"},
	{0, 1523, "f_wprec1p", f_wprec1p, f_wprec1p_bench, "{return test(\"%5.1f\", 7.3);}"},
	{0, 1524, "f_wprec3p", f_wprec3p, f_wprec3p_bench, "{return test(\"%5.3f\", 7.3);}"},
	{0, 1525, "f_wprec6p", f_wprec6p, f_wprec6p_bench, "{return test(\"%5.6f\", 7.3);}"},
	{0, 1526, "f_wprec0n", f_wprec0n, f_wprec0n_bench, "{return test(\"%5.0f\", -7.3);}"},
	{0, 1527, "f_wprec1n", f_wprec1n, f_wprec1n_bench, "{return test(\"%5.1f\", -7.3);}"},
	{0, 1528, "f_wprec3n", f_wprec3n, f_wprec3n_bench, "{return test(\"%5.3f\", -7.3);}"},
	{0, 1529, "f_wprec6n", f_wprec6n, f_wprec6n_bench, "{return test(\"%5.6f\", -7.3);}"},
	{0, 1530, "f_wzp_prec0p", f_wzp_prec0p, f_wzp_prec0p_bench, "{return test(\"%05.0f\", 7.3);}"},
	{0, 1531, "f_wzp_prec1p", f_wzp_prec1p, f_wzp_prec1p_bench, "{return test(\"%05.1f\", 7.3);}"},
	{0, 1532, "f_wzp_prec3p", f_wzp_prec3p, f_wzp_prec3p_bench, "{return test(\"%05.3f\", 7.3);}"},
	{0, 1533, "f_wzp_prec6p", f_wzp_prec6p, f_wzp_prec6p_bench, "{return test(\"%05.6f\", 7.3);}"},
	{0, 1534, "f_wzp_prec0n", f_wzp_prec0n, f_wzp_prec0n_bench, "{return test(\"%05.0f\", -7.3);}"},
	{0, 1535, "f_wzp_prec1n", f_wzp_prec1n, f_wzp_prec1n_bench, "{return test(\"%05.1f\", -7.3);}"},
	{0, 1536, "f_wzp_prec3n", f_wzp_prec3n, f_wzp_prec3n_bench, "{return test(\"%05.3f\", -7.3);}"},
	{0, 1537, "f_wzp_prec6n", f_wzp_prec6n, f_wzp_prec6n_bench, "{return test(\"%05.6f\", -7.3);}"},
	{0, 1538, "f_wlj_prec0p", f_wlj_prec0p, f_wlj_prec0p_bench, "{return test(\"%-5.0f\", 7.3);}"},
	{0, 1539, "f_wlj_prec1p", f_wlj_prec1p, f_wlj_prec1p_bench, "{return test(\"%-5.1f\", 7.3);}"},
	{0, 1540, "f_wlj_prec3p", f_wlj_prec3p, f_wlj_prec3p_bench, "{return test(\"%-5.3f\", 7.3);}"},
	{0, 1541, "f_wlj_prec6p", f_wlj_prec6p, f_wlj_prec6p_bench, "{return test(\"%-5.6f\", 7.3);}"},
	{0, 1542, "f_wlj_prec0n", f_wlj_prec0n, f_wlj_prec0n_bench, "{return test(\"%-5.0f\", -7.3);}"},
	{0, 1543, "f_wlj_prec1n", f_wlj_prec1n, f_wlj_prec1n_bench, "{return test(\"%-5.1f\", -7.3);}"},
	{0, 1544, "f_wlj_prec3n", f_wlj_prec3n, f_wlj_prec3n_bench, "{return test(\"%-5.3f\", -7.3);}"},
	{0, 1545, "f_wlj_prec6n", f_wlj_prec6n, f_wlj_prec6n_bench, "{return test(\"%-5.6f\", -7.3);}"},
	{0, 1546, "f_wzplj_prec0p_ignoreflag", f_wzplj_prec0p_ignoreflag, f_wzplj_prec0p_ignoreflag_bench, "{return test(\"%-05.0f\", 7.3);}"},
	{0, 1547, "f_wzplj_prec1p_ignoreflag", f_wzplj_prec1p_ignoreflag, f_wzplj_prec1p_ignoreflag_bench, "{return test(\"%-05.1f\", 7.3);}"},
	{0, 1548, "f_wzplj_prec3p_ignoreflag", f_wzplj_prec3p_ignoreflag, f_wzplj_prec3p_ignoreflag_bench, "{return test(\"%-05.3f\", 7.3);}"},
	{0, 1549, "f_wzplj_prec6p_ignoreflag", f_wzplj_prec6p_ignoreflag, f_wzplj_prec6p_ignoreflag_bench, "{return test(\"%-05.6f\", 7.3);}"},
	{0, 1550, "f_wzplj_prec0n_ignoreflag", f_wzplj_prec0n_ignoreflag, f_wzplj_prec0n_ignoreflag_bench, "{return test(\"%-05.0f\", -7.3);}"},
	{0, 1551, "f_wzplj_prec1n_ignoreflag", f_wzplj_prec1n_ignoreflag, f_wzplj_prec1n_ignoreflag_bench, "{return test(\"%-05.1f\", -7.3);}"},
	{0, 1552, "f_wzplj_prec3n_ignoreflag", f_wzplj_prec3n_ignoreflag, f_wzplj_prec3n_ignoreflag_bench, "{return test(\"%-05.3f\", -7.3);}"},
	{0, 1553, "f_wzplj_prec6n_ignoreflag", f_wzplj_prec6n_ignoreflag, f_wzplj_prec6n_ignoreflag_bench, "{return test(\"%-05.6f\", -7.3);}"},
	{0, 1554, "f_wzpljr_prec0p_ignoreflag", f_wzpljr_prec0p_ignoreflag, f_wzpljr_prec0p_ignoreflag_bench, "{return test(\"%0-5.0f\", 7.3);}"},
	{0, 1555, "f_wzpljr_prec1p_ignoreflag", f_wzpljr_prec1p_ignoreflag, f_wzpljr_prec1p_ignoreflag_bench, "{return test(\"%0-5.1f\", 7.3);}"},
	{0, 1556, "f_wzpljr_prec3p_ignoreflag", f_wzpljr_prec3p_ignoreflag, f_wzpljr_prec3p_ignoreflag_bench, "{return test(\"%0-5.3f\", 7.3);}"},
	{0, 1557, "f_wzpljr_prec6p_ignoreflag", f_wzpljr_prec6p_ignoreflag, f_wzpljr_prec6p_ignoreflag_bench, "{return test(\"%0-5.6f\", 7.3);}"},
	{0, 1558, "f_wzpljr_prec0n_ignoreflag", f_wzpljr_prec0n_ignoreflag, f_wzpljr_prec0n_ignoreflag_bench, "{return test(\"%0-5.0f\", -7.3);}"},
	{0, 1559, "f_wzpljr_prec1n_ignoreflag", f_wzpljr_prec1n_ignoreflag, f_wzpljr_prec1n_ignoreflag_bench, "{return test(\"%0-5.1f\", -7.3);}"},
	{0, 1560, "f_wzpljr_prec3n_ignoreflag", f_wzpljr_prec3n_ignoreflag, f_wzpljr_prec3n_ignoreflag_bench, "{return test(\"%0-5.3f\", -7.3);}"},
	{0, 1561, "f_wzpljr_prec6n_ignoreflag", f_wzpljr_prec6n_ignoreflag, f_wzpljr_prec6n_ignoreflag_bench, "{return test(\"%0-5.6f\", -7.3);}"},
	{0, 1562, "f_wzpljaf_prec0p", f_wzpljaf_prec0p, f_wzpljaf_prec0p_bench, "{return test(\"%#-5.0f\", 7.3);}"},
	{0, 1563, "f_wzpljaf_prec1p", f_wzpljaf_prec1p, f_wzpljaf_prec1p_bench, "{return test(\"%#-5.1f\", 7.3);}"},
	{0, 1564, "f_wzpljaf_prec3p", f_wzpljaf_prec3p, f_wzpljaf_prec3p_bench, "{return test(\"%#-5.3f\", 7.3);}"},
	{0, 1565, "f_wzpljaf_prec6p", f_wzpljaf_prec6p, f_wzpljaf_prec6p_bench, "{return test(\"%#-5.6f\", 7.3);}"},
	{0, 1566, "f_wzpljaf_prec0n", f_wzpljaf_prec0n, f_wzpljaf_prec0n_bench, "{return test(\"%#-5.0f\", -7.3);}"},
	{0, 1567, "f_wzpljaf_prec1n", f_wzpljaf_prec1n, f_wzpljaf_prec1n_bench, "{return test(\"%#-5.1f\", -7.3);}"},
	{0, 1568, "f_wzpljaf_prec3n", f_wzpljaf_prec3n, f_wzpljaf_prec3n_bench, "{return test(\"%#-5.3f\", -7.3);}"},
	{0, 1569, "f_wzpljaf_prec6n", f_wzpljaf_prec6n, f_wzpljaf_prec6n_bench, "{return test(\"%#-5.6f\", -7.3);}"},
	{0, 1570, "f_was_prec0p", f_was_prec0p, f_was_prec0p_bench, "{return test(\"%+5.0f\", 7.3);}"},
	{0, 1571, "f_was_prec1p", f_was_prec1p, f_was_prec1p_bench, "{return test(\"%+5.1f\", 7.3);}"},
	{0, 1572, "f_was_prec3p", f_was_prec3p, f_was_prec3p_bench, "{return test(\"%+5.3f\", 7.3);}"},
	{0, 1573, "f_was_prec6p", f_was_prec6p, f_was_prec6p_bench, "{return test(\"%+5.6f\", 7.3);}"},
	{0, 1574, "f_was_prec0n", f_was_prec0n, f_was_prec0n_bench, "{return test(\"%+5.0f\", -7.3);}"},
	{0, 1575, "f_was_prec1n", f_was_prec1n, f_was_prec1n_bench, "{return test(\"%+5.1f\", -7.3);}"},
	{0, 1576, "f_was_prec3n", f_was_prec3n, f_was_prec3n_bench, "{return test(\"%+5.3f\", -7.3);}"},
	{0, 1577, "f_was_prec6n", f_was_prec6n, f_was_prec6n_bench, "{return test(\"%+5.6f\", -7.3);}"},
	{0, 1578, "f_wzpas_prec0p", f_wzpas_prec0p, f_wzpas_prec0p_bench, "{return test(\"%+05.0f\", 7.3);}"},
	{0, 1579, "f_wzpas_prec1p", f_wzpas_prec1p, f_wzpas_prec1p_bench, "{return test(\"%+05.1f\", 7.3);}"},
	{0, 1580, "f_wzpas_prec3p", f_wzpas_prec3p, f_wzpas_prec3p_bench, "{return test(\"%+05.3f\", 7.3);}"},
	{0, 1581, "f_wzpas_prec6p", f_wzpas_prec6p, f_wzpas_prec6p_bench, "{return test(\"%+05.6f\", 7.3);}"},
	{0, 1582, "f_wzpas_prec0n", f_wzpas_prec0n, f_wzpas_prec0n_bench, "{return test(\"%+05.0f\", -7.3);}"},
	{0, 1583, "f_wzpas_prec1n", f_wzpas_prec1n, f_wzpas_prec1n_bench, "{return test(\"%+05.1f\", -7.3);}"},
	{0, 1584, "f_wzpas_prec3n", f_wzpas_prec3n, f_wzpas_prec3n_bench, "{return test(\"%+05.3f\", -7.3);}"},
	{0, 1585, "f_wzpas_prec6n", f_wzpas_prec6n, f_wzpas_prec6n_bench, "{return test(\"%+05.6f\", -7.3);}"},
	{0, 1586, "f_wljas_prec0p", f_wljas_prec0p, f_wljas_prec0p_bench, "{return test(\"%+-5.0f\", 7.3);}"},
	{0, 1587, "f_wljas_prec1p", f_wljas_prec1p, f_wljas_prec1p_bench, "{return test(\"%+-5.1f\", 7.3);}"},
	{0, 1588, "f_wljas_prec3p", f_wljas_prec3p, f_wljas_prec3p_bench, "{return test(\"%+-5.3f\", 7.3);}"},
	{0, 1589, "f_wljas_prec6p", f_wljas_prec6p, f_wljas_prec6p_bench, "{return test(\"%+-5.6f\", 7.3);}"},
	{0, 1590, "f_wljas_prec0n", f_wljas_prec0n, f_wljas_prec0n_bench, "{return test(\"%+-5.0f\", -7.3);}"},
	{0, 1591, "f_wljas_prec1n", f_wljas_prec1n, f_wljas_prec1n_bench, "{return test(\"%+-5.1f\", -7.3);}"},
	{0, 1592, "f_wljas_prec3n", f_wljas_prec3n, f_wljas_prec3n_bench, "{return test(\"%+-5.3f\", -7.3);}"},
	{0, 1593, "f_wljas_prec6n", f_wljas_prec6n, f_wljas_prec6n_bench, "{return test(\"%+-5.6f\", -7.3);}"},
	{0, 1594, "f_wzpljas_prec0p_ignoreflag", f_wzpljas_prec0p_ignoreflag, f_wzpljas_prec0p_ignoreflag_bench, "{return test(\"%+-05.0f\", 7.3);}"},
	{0, 1595, "f_wzpljas_prec1p_ignoreflag", f_wzpljas_prec1p_ignoreflag, f_wzpljas_prec1p_ignoreflag_bench, "{return test(\"%+-05.1f\", 7.3);}"},
	{0, 1596, "f_wzpljas_prec3p_ignoreflag", f_wzpljas_prec3p_ignoreflag, f_wzpljas_prec3p_ignoreflag_bench, "{return test(\"%+-05.3f\", 7.3);}"},
	{0, 1597, "f_wzpljas_prec6p_ignoreflag", f_wzpljas_prec6p_ignoreflag, f_wzpljas_prec6p_ignoreflag_bench, "{return test(\"%+-05.6f\", 7.3);}"},
	{0, 1598, "f_wzpljas_prec0n_ignoreflag", f_wzpljas_prec0n_ignoreflag, f_wzpljas_prec0n_ignoreflag_bench, "{return test(\"%+-05.0f\", -7.3);}"},
	{0, 1599, "f_wzpljas_prec1n_ignoreflag", f_wzpljas_prec1n_ignoreflag, f_wzpljas_prec1n_ignoreflag_bench, "{return test(\"%+-05.1f\", -7.3);}"},
	{0, 1600, "f_wzpljas_prec3n_ignoreflag", f_wzpljas_prec3n_ignoreflag, f_wzpljas_prec3n_ignoreflag_bench, "{return test(\"%+-05.3f\", -7.3);}"},
	{0, 1601, "f_wzpljas_prec6n_ignoreflag", f_wzpljas_prec6n_ignoreflag, f_wzpljas_prec6n_ignoreflag_bench, "{return test(\"%+-05.6f\", -7.3);}"},
	{0, 1602, "f_wzpljras_prec0p", f_wzpljras_prec0p, f_wzpljras_prec0p_bench, "{return test(\"%-+5.0f\", 7.3);}"},
	{0, 1603, "f_wzpljras_prec1p", f_wzpljras_prec1p, f_wzpljras_prec1p_bench, "{return test(\"%-+5.1f\", 7.3);}"},
	{0, 1604, "f_wzpljras_prec3p", f_wzpljras_prec3p, f_wzpljras_prec3p_bench, "{return test(\"%-+5.3f\", 7.3);}"},
	{0, 1605, "f_wzpljras_prec6p", f_wzpljras_prec6p, f_wzpljras_prec6p_bench, "{return test(\"%-+5.6f\", 7.3);}"},
	{0, 1606, "f_wzpljras_prec0n", f_wzpljras_prec0n, f_wzpljras_prec0n_bench, "{return test(\"%-+5.0f\", -7.3);}"},
	{0, 1607, "f_wzpljras_prec1n", f_wzpljras_prec1n, f_wzpljras_prec1n_bench, "{return test(\"%-+5.1f\", -7.3);}"},
	{0, 1608, "f_wzpljras_prec3n", f_wzpljras_prec3n, f_wzpljras_prec3n_bench, "{return test(\"%-+5.3f\", -7.3);}"},
	{0, 1609, "f_wzpljras_prec6n", f_wzpljras_prec6n, f_wzpljras_prec6n_bench, "{return test(\"%-+5.6f\", -7.3);}"},
	{0, 1610, "f_wzpljafas_prec0p", f_wzpljafas_prec0p, f_wzpljafas_prec0p_bench, "{return test(\"%+#-5.0f\", 7.3);}"},
	{0, 1611, "f_wzpljafas_prec1p", f_wzpljafas_prec1p, f_wzpljafas_prec1p_bench, "{return test(\"%+#-5.1f\", 7.3);}"},
	{0, 1612, "f_wzpljafas_prec3p", f_wzpljafas_prec3p, f_wzpljafas_prec3p_bench, "{return test(\"%+#-5.3f\", 7.3);}"},
	{0, 1613, "f_wzpljafas_prec6p", f_wzpljafas_prec6p, f_wzpljafas_prec6p_bench, "{return test(\"%+#-5.6f\", 7.3);}"},
	{0, 1614, "f_wzpljafas_prec0n", f_wzpljafas_prec0n, f_wzpljafas_prec0n_bench, "{return test(\"%+#-5.0f\", -7.3);}"},
	{0, 1615, "f_wzpljafas_prec1n", f_wzpljafas_prec1n, f_wzpljafas_prec1n_bench, "{return test(\"%+#-5.1f\", -7.3);}"},
	{0, 1616, "f_wzpljafas_prec3n", f_wzpljafas_prec3n, f_wzpljafas_prec3n_bench, "{return test(\"%+#-5.3f\", -7.3);}"},
	{0, 1617, "f_wzpljafas_prec6n", f_wzpljafas_prec6n, f_wzpljafas_prec6n_bench, "{return test(\"%+#-5.6f\", -7.3);}"},
	{0, 1618, "f_wsp_prec0p", f_wsp_prec0p, f_wsp_prec0p_bench, "{return test(\"% 5.0f\", 7.3);}"},
	{0, 1619, "f_wsp_prec1p", f_wsp_prec1p, f_wsp_prec1p_bench, "{return test(\"% 5.1f\", 7.3);}"},
	{0, 1620, "f_wsp_prec3p", f_wsp_prec3p, f_wsp_prec3p_bench, "{return test(\"% 5.3f\", 7.3);}"},
	{0, 1621, "f_wsp_prec6p", f_wsp_prec6p, f_wsp_prec6p_bench, "{return test(\"% 5.6f\", 7.3);}"},
	{0, 1622, "f_wsp_prec0n", f_wsp_prec0n, f_wsp_prec0n_bench, "{return test(\"% 5.0f\", -7.3);}"},
	{0, 1623, "f_wsp_prec1n", f_wsp_prec1n, f_wsp_prec1n_bench, "{return test(\"% 5.1f\", -7.3);}"},
	{0, 1624, "f_wsp_prec3n", f_wsp_prec3n, f_wsp_prec3n_bench, "{return test(\"% 5.3f\", -7.3);}"},
	{0, 1625, "f_wsp_prec6n", f_wsp_prec6n, f_wsp_prec6n_bench, "{return test(\"% 5.6f\", -7.3);}"},
	{0, 1626, "f_wzpsp_prec0p", f_wzpsp_prec0p, f_wzpsp_prec0p_bench, "{return test(\"% 05.0f\", 7.3);}"},
	{0, 1627, "f_wzpsp_prec1p", f_wzpsp_prec1p, f_wzpsp_prec1p_bench, "{return test(\"% 05.1f\", 7.3);}"},
	{0, 1628, "f_wzpsp_prec3p", f_wzpsp_prec3p, f_wzpsp_prec3p_bench, "{return test(\"% 05.3f\", 7.3);}"},
	{0, 1629, "f_wzpsp_prec6p", f_wzpsp_prec6p, f_wzpsp_prec6p_bench, "{return test(\"% 05.6f\", 7.3);}"},
	{0, 1630, "f_wzpsp_prec0n", f_wzpsp_prec0n, f_wzpsp_prec0n_bench, "{return test(\"% 05.0f\", -7.3);}"},
	{0, 1631, "f_wzpsp_prec1n", f_wzpsp_prec1n, f_wzpsp_prec1n_bench, "{return test(\"% 05.1f\", -7.3);}"},
	{0, 1632, "f_wzpsp_prec3n", f_wzpsp_prec3n, f_wzpsp_prec3n_bench, "{return test(\"% 05.3f\", -7.3);}"},
	{0, 1633, "f_wzpsp_prec6n", f_wzpsp_prec6n, f_wzpsp_prec6n_bench, "{return test(\"% 05.6f\", -7.3);}"},
	{0, 1634, "f_wljsp_prec0p", f_wljsp_prec0p, f_wljsp_prec0p_bench, "{return test(\"% -5.0f\", 7.3);}"},
	{0, 1635, "f_wljsp_prec1p", f_wljsp_prec1p, f_wljsp_prec1p_bench, "{return test(\"% -5.1f\", 7.3);}"},
	{0, 1636, "f_wljsp_prec3p", f_wljsp_prec3p, f_wljsp_prec3p_bench, "{return test(\"% -5.3f\", 7.3);}"},
	{0, 1637, "f_wljsp_prec6p", f_wljsp_prec6p, f_wljsp_prec6p_bench, "{return test(\"% -5.6f\", 7.3);}"},
	{0, 1638, "f_wljsp_prec0n", f_wljsp_prec0n, f_wljsp_prec0n_bench, "{return test(\"% -5.0f\", -7.3);}"},
	{0, 1639, "f_wljsp_prec1n", f_wljsp_prec1n, f_wljsp_prec1n_bench, "{return test(\"% -5.1f\", -7.3);}"},
	{0, 1640, "f_wljsp_prec3n", f_wljsp_prec3n, f_wljsp_prec3n_bench, "{return test(\"% -5.3f\", -7.3);}"},
	{0, 1641, "f_wljsp_prec6n", f_wljsp_prec6n, f_wljsp_prec6n_bench, "{return test(\"% -5.6f\", -7.3);}"},
	{0, 1642, "f_wzpljsp_prec0p_ignoreflag", f_wzpljsp_prec0p_ignoreflag, f_wzpljsp_prec0p_ignoreflag_bench, "{return test(\"% -05.0f\", 7.3);}"},
	{0, 1643, "f_wzpljsp_prec1p_ignoreflag", f_wzpljsp_prec1p_ignoreflag, f_wzpljsp_prec1p_ignoreflag_bench, "{return test(\"% -05.1f\", 7.3);}"},
	{0, 1644, "f_wzpljsp_prec3p_ignoreflag", f_wzpljsp_prec3p_ignoreflag, f_wzpljsp_prec3p_ignoreflag_bench, "{return test(\"% -05.3f\", 7.3);}"},
	{0, 1645, "f_wzpljsp_prec6p_ignoreflag", f_wzpljsp_prec6p_ignoreflag, f_wzpljsp_prec6p_ignoreflag_bench, "{return test(\"% -05.6f\", 7.3);}"},
	{0, 1646, "f_wzpljsp_prec0n_ignoreflag", f_wzpljsp_prec0n_ignoreflag, f_wzpljsp_prec0n_ignoreflag_bench, "{return test(\"% -05.0f\", -7.3);}"},
	{0, 1647, "f_wzpljsp_prec1n_ignoreflag", f_wzpljsp_prec1n_ignoreflag, f_wzpljsp_prec1n_ignoreflag_bench, "{return test(\"% -05.1f\", -7.3);}"},
	{0, 1648, "f_wzpljsp_prec3n_ignoreflag", f_wzpljsp_prec3n_ignoreflag, f_wzpljsp_prec3n_ignoreflag_bench, "{return test(\"% -05.3f\", -7.3);}"},
	{0, 1649, "f_wzpljsp_prec6n_ignoreflag", f_wzpljsp_prec6n_ignoreflag, f_wzpljsp_prec6n_ignoreflag_bench, "{return test(\"% -05.6f\", -7.3);}"},
	{0, 1650, "f_wzpljrsp_prec0p", f_wzpljrsp_prec0p, f_wzpljrsp_prec0p_bench, "{return test(\"%- 5.0f\", 7.3);}"},
	{0, 1651, "f_wzpljrsp_prec1p", f_wzpljrsp_prec1p, f_wzpljrsp_prec1p_bench, "{return test(\"%- 5.1f\", 7.3);}"},
	{0, 1652, "f_wzpljrsp_prec3p", f_wzpljrsp_prec3p, f_wzpljrsp_prec3p_bench, "{return test(\"%- 5.3f\", 7.3);}"},
	{0, 1653, "f_wzpljrsp_prec6p", f_wzpljrsp_prec6p, f_wzpljrsp_prec6p_bench, "{return test(\"%- 5.6f\", 7.3);}"},
	{0, 1654, "f_wzpljrsp_prec0n", f_wzpljrsp_prec0n, f_wzpljrsp_prec0n_bench, "{return test(\"%- 5.0f\", -7.3);}"},
	{0, 1655, "f_wzpljrsp_prec1n", f_wzpljrsp_prec1n, f_wzpljrsp_prec1n_bench, "{return test(\"%- 5.1f\", -7.3);}"},
	{0, 1656, "f_wzpljrsp_prec3n", f_wzpljrsp_prec3n, f_wzpljrsp_prec3n_bench, "{return test(\"%- 5.3f\", -7.3);}"},
	{0, 1657, "f_wzpljrsp_prec6n", f_wzpljrsp_prec6n, f_wzpljrsp_prec6n_bench, "{return test(\"%- 5.6f\", -7.3);}"},
	{0, 1658, "f_wzpljafsp_prec0p", f_wzpljafsp_prec0p, f_wzpljafsp_prec0p_bench, "{return test(\"% #-5.0f\", 7.3);}"},
	{0, 1659, "f_wzpljafsp_prec1p", f_wzpljafsp_prec1p, f_wzpljafsp_prec1p_bench, "{return test(\"% #-5.1f\", 7.3);}"},
	{0, 1660, "f_wzpljafsp_prec3p", f_wzpljafsp_prec3p, f_wzpljafsp_prec3p_bench, "{return test(\"% #-5.3f\", 7.3);}"},
	{0, 1661, "f_wzpljafsp_prec6p", f_wzpljafsp_prec6p, f_wzpljafsp_prec6p_bench, "{return test(\"% #-5.6f\", 7.3);}"},
	{0, 1662, "f_wzpljafsp_prec0n", f_wzpljafsp_prec0n, f_wzpljafsp_prec0n_bench, "{return test(\"% #-5.0f\", -7.3);}"},
	{0, 1663, "f_wzpljafsp_prec1n", f_wzpljafsp_prec1n, f_wzpljafsp_prec1n_bench, "{return test(\"% #-5.1f\", -7.3);}"},
	{0, 1664, "f_wzpljafsp_prec3n", f_wzpljafsp_prec3n, f_wzpljafsp_prec3n_bench, "{return test(\"% #-5.3f\", -7.3);}"},
	{0, 1665, "f_wzpljafsp_prec6n", f_wzpljafsp_prec6n, f_wzpljafsp_prec6n_bench, "{return test(\"% #-5.6f\", -7.3);}"},
	{0, 1666, "f_assp_prec0p_ignoreflag", f_assp_prec0p_ignoreflag, f_assp_prec0p_ignoreflag_bench, "{return test(\"%+ .0f\", 7.3);}"},
	{0, 1667, "f_assp_prec1p_ignoreflag", f_assp_prec1p_ignoreflag, f_assp_prec1p_ignoreflag_bench, "{return test(\"%+ .1f\", 7.3);}"},
	{0, 1668, "f_assp_prec3p_ignoreflag", f_assp_prec3p_ignoreflag, f_assp_prec3p_ignoreflag_bench, "{return test(\"%+ .3f\", 7.3);}"},
	{0, 1669, "f_assp_prec6p_ignoreflag", f_assp_prec6p_ignoreflag, f_assp_prec6p_ignoreflag_bench, "{return test(\"%+ .6f\", 7.3);}"},
	{0, 1670, "f_assp_prec0n_ignoreflag", f_assp_prec0n_ignoreflag, f_assp_prec0n_ignoreflag_bench, "{return test(\"%+ .0f\", -7.3);}"},
	{0, 1671, "f_assp_prec1n_ignoreflag", f_assp_prec1n_ignoreflag, f_assp_prec1n_ignoreflag_bench, "{return test(\"%+ .1f\", -7.3);}"},
	{0, 1672, "f_assp_prec3n_ignoreflag", f_assp_prec3n_ignoreflag, f_assp_prec3n_ignoreflag_bench, "{return test(\"%+ .3f\", -7.3);}"},
	{0, 1673, "f_assp_prec6n_ignoreflag", f_assp_prec6n_ignoreflag, f_assp_prec6n_ignoreflag_bench, "{return test(\"%+ .6f\", -7.3);}"},
	{0, 1674, "f_asspr_prec0p_ignoreflag", f_asspr_prec0p_ignoreflag, f_asspr_prec0p_ignoreflag_bench, "{return test(\"% +.0f\", 7.3);}"},
	{0, 1675, "f_asspr_prec1p_ignoreflag", f_asspr_prec1p_ignoreflag, f_asspr_prec1p_ignoreflag_bench, "{return test(\"% +.1f\", 7.3);}"},
	{0, 1676, "f_asspr_prec3p_ignoreflag", f_asspr_prec3p_ignoreflag, f_asspr_prec3p_ignoreflag_bench, "{return test(\"% +.3f\", 7.3);}"},
	{0, 1677, "f_asspr_prec6p_ignoreflag", f_asspr_prec6p_ignoreflag, f_asspr_prec6p_ignoreflag_bench, "{return test(\"% +.6f\", 7.3);}"},
	{0, 1678, "f_asspr_prec0n_ignoreflag", f_asspr_prec0n_ignoreflag, f_asspr_prec0n_ignoreflag_bench, "{return test(\"% +.0f\", -7.3);}"},
	{0, 1679, "f_asspr_prec1n_ignoreflag", f_asspr_prec1n_ignoreflag, f_asspr_prec1n_ignoreflag_bench, "{return test(\"% +.1f\", -7.3);}"},
	{0, 1680, "f_asspr_prec3n_ignoreflag", f_asspr_prec3n_ignoreflag, f_asspr_prec3n_ignoreflag_bench, "{return test(\"% +.3f\", -7.3);}"},
	{0, 1681, "f_asspr_prec6n_ignoreflag", f_asspr_prec6n_ignoreflag, f_asspr_prec6n_ignoreflag_bench, "{return test(\"% +.6f\", -7.3);}"},
	...
	{0, 1704, "f_limits_dblmin_prec0", f_limits_dblmin_prec0, f_limits_dblmin_prec0_bench, "{return test(\"%.0f\", DBL_MIN);}"},
	{0, 1705, "f_limits_dblmin_prec3", f_limits_dblmin_prec3, f_limits_dblmin_prec3_bench, "{return test(\"%.3f\", DBL_MIN);}"},
	{0, 1706, "f_limits_dblmin_precd", f_limits_dblmin_precd, f_limits_dblmin_precd_bench, "{return test(\"%f\", DBL_MIN);}"},
	{0, 1707, "f_limits_dblmin_prec8", f_limits_dblmin_prec8, f_limits_dblmin_prec8_bench, "{return test(\"%.8f\", DBL_MIN);}"},
	{0, 1708, "f_stress_limits_dblmin_prec12", f_stress_limits_dblmin_prec12, f_stress_limits_dblmin_prec12_bench, "{return test(\"%.12f\", DBL_MIN);}"},
	{0, 1709, "f_stress_limits_dblmin_prec16", f_stress_limits_dblmin_prec16, f_stress_limits_dblmin_prec16_bench, "{return test(\"%.16f\", DBL_MIN);}"},
	{0, 1710, "f_stress_limits_dblmin_prec18", f_stress_limits_dblmin_prec18, f_stress_limits_dblmin_prec18_bench, "{return test(\"%.18f\", DBL_MIN);}"},
	{0, 1711, "f_limits_ndblmin_prec0", f_limits_ndblmin_prec0, f_limits_ndblmin_prec0_bench, "{return test(\"%.0f\", -DBL_MIN);}"},
	{0, 1712, "f_limits_ndblmin_prec3", f_limits_ndblmin_prec3, f_limits_ndblmin_prec3_bench, "{return test(\"%.3f\", -DBL_MIN);}"},
	{0, 1713, "f_limits_ndblmin_precd", f_limits_ndblmin_precd, f_limits_ndblmin_precd_bench, "{return test(\"%f\", -DBL_MIN);}"},
	{0, 1714, "f_limits_ndblmin_prec8", f_limits_ndblmin_prec8, f_limits_ndblmin_prec8_bench, "{return test(\"%.8f\", -DBL_MIN);}"},
	{0, 1715, "f_stress_limits_ndblmin_prec12", f_stress_limits_ndblmin_prec12, f_stress_limits_ndblmin_prec12_bench, "{return test(\"%.12f\", -DBL_MIN);}"},
	{0, 1716, "f_stress_limits_ndblmin_prec16", f_stress_limits_ndblmin_prec16, f_stress_limits_ndblmin_prec16_bench, "{return test(\"%.16f\", -DBL_MIN);}"},
	{0, 1717, "f_stress_limits_ndblmin_prec18", f_stress_limits_ndblmin_prec18, f_stress_limits_ndblmin_prec18_bench, "{return test(\"%.18f\", -DBL_MIN);}"},
	...
	{0, 1758, "f_L_basic_1", f_L_basic_1, f_L_basic_1_bench, "{return test(\"this %Lf float\", 1.5l);}"},
	{0, 1759, "f_L_basic_fltonly", f_L_basic_fltonly, f_L_basic_fltonly_bench, "{return test(\"%Lf\", 7.5l);}"},
	{0, 1760, "f_L_basic_whole", f_L_basic_whole, f_L_basic_whole_bench, "{return test(\"%Lf\", 1.0l);}"},
	{0, 1761, "f_L_basic_negative", f_L_basic_negative, f_L_basic_negative_bench, "{return test(\"%Lf\", -3.85l);}"},
	{0, 1762, "f_L_basic_positive_3_3", f_L_basic_positive_3_3, f_L_basic_positive_3_3_bench, "{return test(\"%Lf\", 573.924l);}"},
	{0, 1763, "f_L_basic_negative_3_3", f_L_basic_negative_3_3, f_L_basic_negative_3_3_bench, "{return test(\"%Lf\", -958.125l);}"},
	{0, 1764, "f_L_basic_positive_smallfpart", f_L_basic_positive_smallfpart, f_L_basic_positive_smallfpart_bench, "{return test(\"%Lf\", 23.00041l);}"},
	{0, 1765, "f_L_basic_positive_allsmall", f_L_basic_positive_allsmall, f_L_basic_positive_allsmall_bench, "{return test(\"%Lf\", 0.000039l);}"},
	{0, 1766, "f_L_basic_negative_smallfpart", f_L_basic_negative_smallfpart, f_L_basic_negative_smallfpart_bench, "{return test(\"%Lf\", -7.00036l);}"},
	{0, 1767, "f_L_basic_negative_allsmall", f_L_basic_negative_allsmall, f_L_basic_negative_allsmall_bench, "{return test(\"%Lf\", -0.00032l);}"},
	{0, 1768, "f_L_basic_limits_allsmall_pos", f_L_basic_limits_allsmall_pos, f_L_basic_limits_allsmall_pos_bench, "{return test(\"%Lf\", 0.000001l);}"},
	{0, 1769, "f_L_basic_limits_allsmall_neg", f_L_basic_limits_allsmall_neg, f_L_basic_limits_allsmall_neg_bench, "{return test(\"%Lf\", -0.000001l);}"},
	{0, 1770, "f_L_basic_limits_smallfpart_pos", f_L_basic_limits_smallfpart_pos, f_L_basic_limits_smallfpart_pos_bench, "{return test(\"%Lf\", 9873.000001l);}"},
	{0, 1771, "f_L_basic_limits_smallfpart_neg", f_L_basic_limits_smallfpart_neg, f_L_basic_limits_smallfpart_neg_bench, "{return test(\"%Lf\", -875.000001l);}"},
	{0, 1772, "f_L_basic_limits_allbig_pos", f_L_basic_limits_allbig_pos, f_L_basic_limits_allbig_pos_bench, "{return test(\"%Lf\", 999.999999l);}"},
	{0, 1773, "f_L_basic_limits_allbig_neg", f_L_basic_limits_allbig_neg, f_L_basic_limits_allbig_neg_bench, "{return test(\"%Lf\", -99.999999l);}"},
	{0, 1774, "f_L_basic_limits_bigfpart_pos", f_L_basic_limits_bigfpart_pos, f_L_basic_limits_bigfpart_pos_bench, "{return test(\"%Lf\", 0.999999l);}"},
	{0, 1775, "f_L_basic_limits_bigfpart_neg", f_L_basic_limits_bigfpart_neg, f_L_basic_limits_bigfpart_neg_bench, "{return test(\"%Lf\", -0.999999l);}"},
	{0, 1776, "f_L_rndd_pos", f_L_rndd_pos, f_L_rndd_pos_bench, "{return test(\"%Lf\", 23.375094499l);}"},
	{0, 1777, "f_L_rndd_neg", f_L_rndd_neg, f_L_rndd_neg_bench, "{return test(\"%Lf\", -985.765426499l);}"},
	{0, 1778, "f_L_rndu_pos", f_L_rndu_pos, f_L_rndu_pos_bench, "{return test(\"%Lf\", 0.08942555l);}"},
	{0, 1779, "f_L_rndu_neg", f_L_rndu_neg, f_L_rndu_neg_bench, "{return test(\"%Lf\", -56.2012685l);}"},
	{0, 1780, "f_L_rndu_multidigit_pos", f_L_rndu_multidigit_pos, f_L_rndu_multidigit_pos_bench, "{return test(\"%Lf\", 43.4399999l);}"},
	{0, 1781, "f_L_rndu_multidigit_neg", f_L_rndu_multidigit_neg, f_L_rndu_multidigit_neg_bench, "{return test(\"%Lf\", -5.0299999l);}"},
	{0, 1782, "f_L_rndd_multidigit_pos", f_L_rndd_multidigit_pos, f_L_rndd_multidigit_pos_bench, "{return test(\"%Lf\", 43.43999949l);}"},
	{0, 1783, "f_L_rndd_multidigit_neg", f_L_rndd_multidigit_neg, f_L_rndd_multidigit_neg_bench, "{return test(\"%Lf\", -5.02999949l);}"},
	{0, 1784, "f_L_rndd_wholnobump_pos", f_L_rndd_wholnobump_pos, f_L_rndd_wholnobump_pos_bench, "{return test(\"%Lf\", 1.99999949l);}"},
	{0, 1785, "f_L_rndd_wholnobump_neg", f_L_rndd_wholnobump_neg, f_L_rndd_wholnobump_neg_bench, "{return test(\"%Lf\", -0.99999949l);}"},
	{0, 1786, "f_L_rndu_bumpwhole_pos", f_L_rndu_bumpwhole_pos, f_L_rndu_bumpwhole_pos_bench, "{return test(\"%Lf\", 3.9999999l);}"},
	{0, 1787, "f_L_rndu_bumpwhole_neg", f_L_rndu_bumpwhole_neg, f_L_rndu_bumpwhole_neg_bench, "{return test(\"%Lf\", -5.9999999l);}"},
	{0, 1788, "f_L_prec7_1", f_L_prec7_1, f_L_prec7_1_bench, "{return test(\"this %.7Lf float\", 1.5l);}"},
	{0, 1789, "f_L_prec7_fltonly", f_L_prec7_fltonly, f_L_prec7_fltonly_bench, "{return test(\"%.7Lf\", 7.5l);}"},
	{0, 1790, "f_L_prec7_whole", f_L_prec7_whole, f_L_prec7_whole_bench, "{return test(\"%.7Lf\", 1.0l);}"},
	{0, 1791, "f_L_prec7_negative", f_L_prec7_negative, f_L_prec7_negative_bench, "{return test(\"%.7Lf\", -3.85l);}"},
	{0, 1792, "f_L_prec7_positive_3_3", f_L_prec7_positive_3_3, f_L_prec7_positive_3_3_bench, "{return test(\"%.7Lf\", 573.924l);}"},
	{0, 1793, "f_L_prec7_negative_3_3", f_L_prec7_negative_3_3, f_L_prec7_negative_3_3_bench, "{return test(\"%.7Lf\", -958.125l);}"},
	{0, 1794, "f_L_prec7_positive_smallfpart", f_L_prec7_positive_smallfpart, f_L_prec7_positive_smallfpart_bench, "{return test(\"%.7Lf\", 23.00041l);}"},
	{0, 1795, "f_L_prec7_positive_allsmall", f_L_prec7_positive_allsmall, f_L_prec7_positive_allsmall_bench, "{return test(\"%.7Lf\", 0.0000039l);}"},
	{0, 1796, "f_L_prec7_negative_smallfpart", f_L_prec7_negative_smallfpart, f_L_prec7_negative_smallfpart_bench, "{return test(\"%.7Lf\", -7.00036l);}"},
	{0, 1797, "f_L_prec7_negative_allsmall", f_L_prec7_negative_allsmall, f_L_prec7_negative_allsmall_bench, "{return test(\"%.7Lf\", -0.000032l);}"},
	{0, 1798, "f_L_prec7_limits_allsmall_pos", f_L_prec7_limits_allsmall_pos, f_L_prec7_limits_allsmall_pos_bench, "{return test(\"%.7Lf\", 0.0000001l);}"},
	{0, 1799, "f_L_prec7_limits_allsmall_neg", f_L_prec7_limits_allsmall_neg, f_L_prec7_limits_allsmall_neg_bench, "{return test(\"%.7Lf\", -0.0000001l);}"},
	{0, 1800, "f_L_prec7_limits_smallfpart_pos", f_L_prec7_limits_smallfpart_pos, f_L_prec7_limits_smallfpart_pos_bench, "{return test(\"%.7Lf\", 9873.000001l);}"},
	{0, 1801, "f_L_prec7_limits_smallfpart_neg", f_L_prec7_limits_smallfpart_neg, f_L_prec7_limits_smallfpart_neg_bench, "{return test(\"%.7Lf\", -875.000001l);}"},
	{0, 1802, "f_L_prec7_limits_allbig_pos", f_L_prec7_limits_allbig_pos, f_L_prec7_limits_allbig_pos_bench, "{return test(\"%.7Lf\", 999.9999999l);}"},
	{0, 1803, "f_L_prec7_limits_allbig_neg", f_L_prec7_limits_allbig_neg, f_L_prec7_limits_allbig_neg_bench, "{return test(\"%.7Lf\", -99.9999999l);}"},
	{0, 1804, "f_L_prec7_limits_bigfpart_pos", f_L_prec7_limits_bigfpart_pos, f_L_prec7_limits_bigfpart_pos_bench, "{return test(\"%.7Lf\", 0.999999l);}"},
	{0, 1805, "f_L_prec7_limits_bigfpart_neg", f_L_prec7_limits_bigfpart_neg, f_L_prec7_limits_bigfpart_neg_bench, "{return test(\"%.7Lf\", -0.999999l);}"},
	{0, 1806, "f_L_rnd_prec7_rndd_pos", f_L_rnd_prec7_rndd_pos, f_L_rnd_prec7_rndd_pos_bench, "{return test(\"%.7Lf\", 23.375094499l);}"},
	{0, 1807, "f_L_rnd_prec7_rndd_neg", f_L_rnd_prec7_rndd_neg, f_L_rnd_prec7_rndd_neg_bench, "{return test(\"%.7Lf\", -985.765426499l);}"},
	{0, 1808, "f_L_rnd_prec7_rndu_pos", f_L_rnd_prec7_rndu_pos, f_L_rnd_prec7_rndu_pos_bench, "{return test(\"%.7Lf\", 0.0894255l);}"},
	{0, 1809, "f_L_rnd_prec7_rndu_neg", f_L_rnd_prec7_rndu_neg, f_L_rnd_prec7_rndu_neg_bench, "{return test(\"%.7Lf\", -56.2012685l);}"},
	{0, 1810, "f_L_rnd_prec7_rndu_multidigit_pos", f_L_rnd_prec7_rndu_multidigit_pos, f_L_rnd_prec7_rndu_multidigit_pos_bench, "{return test(\"%.7Lf\", 43.4399999l);}"},
	{0, 1811, "f_L_rnd_prec7_rndu_multidigit_neg", f_L_rnd_prec7_rndu_multidigit_neg, f_L_rnd_prec7_rndu_multidigit_neg_bench, "{return test(\"%.7Lf\", -5.0299999l);}"},
	{0, 1812, "f_L_rnd_prec7_rndd_multidigit_pos", f_L_rnd_prec7_rndd_multidigit_pos, f_L_rnd_prec7_rndd_multidigit_pos_bench, "{return test(\"%.7Lf\", 43.43999949l);}"},
	{0, 1813, "f_L_rnd_prec7_rndd_multidigit_neg", f_L_rnd_prec7_rndd_multidigit_neg, f_L_rnd_prec7_rndd_multidigit_neg_bench, "{return test(\"%.7Lf\", -5.02999949l);}"},
	{0, 1814, "f_L_rnd_prec7_rndd_wholnobump_pos", f_L_rnd_prec7_rndd_wholnobump_pos, f_L_rnd_prec7_rndd_wholnobump_pos_bench, "{return test(\"%.7Lf\", 1.99999949l);}"},
	{0, 1815, "f_L_rnd_prec7_rndd_wholnobump_neg", f_L_rnd_prec7_rndd_wholnobump_neg, f_L_rnd_prec7_rndd_wholnobump_neg_bench, "{return test(\"%.7Lf\", -0.99999949l);}"},
	{0, 1816, "f_L_rnd_prec7_rndu_bumpwhole_pos", f_L_rnd_prec7_rndu_bumpwhole_pos, f_L_rnd_prec7_rndu_bumpwhole_pos_bench, "{return test(\"%.7Lf\", 3.9999999l);}"},
	{0, 1817, "f_L_prec8_1", f_L_prec8_1, f_L_prec8_1_bench, "{return test(\"this %.8Lf float\", 1.5l);}"},
	{0, 1818, "f_L_prec8_fltonly", f_L_prec8_fltonly, f_L_prec8_fltonly_bench, "{return test(\"%.8Lf\", 7.5l);}"},
	{0, 1819, "f_L_prec8_whole", f_L_prec8_whole, f_L_prec8_whole_bench, "{return test(\"%.8Lf\", 1.0l);}"},
	{0, 1820, "f_L_prec8_negative", f_L_prec8_negative, f_L_prec8_negative_bench, "{return test(\"%.8Lf\", -3.85l);}"},
	{0, 1821, "f_L_prec8_positive_3_3", f_L_prec8_positive_3_3, f_L_prec8_positive_3_3_bench, "{return test(\"%.8Lf\", 573.924l);}"},
	{0, 1822, "f_L_prec8_negative_3_3", f_L_prec8_negative_3_3, f_L_prec8_negative_3_3_bench, "{return test(\"%.8Lf\", -958.125l);}"},
	{0, 1823, "f_L_prec8_positive_smallfpart", f_L_prec8_positive_smallfpart, f_L_prec8_positive_smallfpart_bench, "{return test(\"%.8Lf\", 23.00041l);}"},
	{0, 1824, "f_L_prec8_positive_allsmall", f_L_prec8_positive_allsmall, f_L_prec8_positive_allsmall_bench, "{return test(\"%.8Lf\", 0.00000039l);}"},
	{0, 1825, "f_L_prec8_negative_smallfpart", f_L_prec8_negative_smallfpart, f_L_prec8_negative_smallfpart_bench, "{return test(\"%.8Lf\", -7.00036l);}"},
	{0, 1826, "f_L_prec8_negative_allsmall", f_L_prec8_negative_allsmall, f_L_prec8_negative_allsmall_bench, "{return test(\"%.8Lf\", -0.0000032l);}"},
	{0, 1827, "f_L_prec8_limits_allsmall_pos", f_L_prec8_limits_allsmall_pos, f_L_prec8_limits_allsmall_pos_bench, "{return test(\"%.8Lf\", 0.00000001l);}"},
	{0, 1828, "f_L_prec8_limits_allsmall_neg", f_L_prec8_limits_allsmall_neg, f_L_prec8_limits_allsmall_neg_bench, "{return test(\"%.8Lf\", -0.00000001l);}"},
	{0, 1829, "f_L_prec8_limits_smallfpart_pos", f_L_prec8_limits_smallfpart_pos, f_L_prec8_limits_smallfpart_pos_bench, "{return test(\"%.8Lf\", 9873.000001l);}"},
	{0, 1830, "f_L_prec8_limits_smallfpart_neg", f_L_prec8_limits_smallfpart_neg, f_L_prec8_limits_smallfpart_neg_bench, "{return test(\"%.8Lf\", -875.000001l);}"},
	{0, 1831, "f_L_prec8_limits_allbig_pos", f_L_prec8_limits_allbig_pos, f_L_prec8_limits_allbig_pos_bench, "{return test(\"%.8Lf\", 999.9999999l);}"},
	{0, 1832, "f_L_prec8_limits_allbig_neg", f_L_prec8_limits_allbig_neg, f_L_prec8_limits_allbig_neg_bench, "{return test(\"%.8Lf\", -99.99999999l);}"},
	{0, 1833, "f_L_prec8_limits_bigfpart_pos", f_L_prec8_limits_bigfpart_pos, f_L_prec8_limits_bigfpart_pos_bench, "{return test(\"%.8Lf\", 0.999999l);}"},
	{0, 1834, "f_L_prec8_limits_bigfpart_neg", f_L_prec8_limits_bigfpart_neg, f_L_prec8_limits_bigfpart_neg_bench, "{return test(\"%.8Lf\", -0.999999l);}"},
	{0, 1835, "f_L_rnd_prec8_rndd_pos", f_L_rnd_prec8_rndd_pos, f_L_rnd_prec8_rndd_pos_bench, "{return test(\"%.8Lf\", 23.375094499l);}"},
	{0, 1836, "f_L_rnd_prec8_rndd_neg", f_L_rnd_prec8_rndd_neg, f_L_rnd_prec8_rndd_neg_bench, "{return test(\"%.8Lf\", -985.765426499l);}"},
	{0, 1837, "f_L_rnd_prec8_rndu_pos", f_L_rnd_prec8_rndu_pos, f_L_rnd_prec8_rndu_pos_bench, "{return test(\"%.8Lf\", 0.0894255l);}"},
	{0, 1838, "f_L_rnd_prec8_rndu_neg", f_L_rnd_prec8_rndu_neg, f_L_rnd_prec8_rndu_neg_bench, "{return test(\"%.8Lf\", -56.2012685l);}"},
	{0, 1839, "f_L_rnd_prec8_rndu_multidigit_pos", f_L_rnd_prec8_rndu_multidigit_pos, f_L_rnd_prec8_rndu_multidigit_pos_bench, "{return test(\"%.8Lf\", 43.4399999l);}"},
	{0, 1840, "f_L_rnd_prec8_rndu_multidigit_neg", f_L_rnd_prec8_rndu_multidigit_neg, f_L_rnd_prec8_rndu_multidigit_neg_bench, "{return test(\"%.8Lf\", -5.0299999l);}"},
	{0, 1841, "f_L_rnd_prec8_rndd_multidigit_pos", f_L_rnd_prec8_rndd_multidigit_pos, f_L_rnd_prec8_rndd_multidigit_pos_bench, "{return test(\"%.8Lf\", 43.43999949l);}"},
	{0, 1842, "f_L_rnd_prec8_rndd_multidigit_neg", f_L_rnd_prec8_rndd_multidigit_neg, f_L_rnd_prec8_rndd_multidigit_neg_bench, "{return test(\"%.8Lf\", -5.02999949l);}"},
	{0, 1843, "f_L_rnd_prec8_rndd_wholnobump_pos", f_L_rnd_prec8_rndd_wholnobump_pos, f_L_rnd_prec8_rndd_wholnobump_pos_bench, "{return test(\"%.8Lf\", 1.99999949l);}"},
	{0, 1844, "f_L_rnd_prec8_rndd_wholnobump_neg", f_L_rnd_prec8_rndd_wholnobump_neg, f_L_rnd_prec8_rndd_wholnobump_neg_bench, "{return test(\"%.8Lf\", -0.99999949l);}"},
	{0, 1845, "f_L_rnd_prec8_rndu_bumpwhole_pos", f_L_rnd_prec8_rndu_bumpwhole_pos, f_L_rnd_prec8_rndu_bumpwhole_pos_bench, "{return test(\"%.8Lf\", 3.9999999l);}"},
	{0, 1846, "f_L_prec9_1", f_L_prec9_1, f_L_prec9_1_bench, "{return test(\"this %.9Lf float\", 1.5l);}"},
	{0, 1847, "f_L_prec9_fltonly", f_L_prec9_fltonly, f_L_prec9_fltonly_bench, "{return test(\"%.9Lf\", 7.5l);}"},
	{0, 1848, "f_L_prec9_whole", f_L_prec9_whole, f_L_prec9_whole_bench, "{return test(\"%.9Lf\", 1.0l);}"},
	{0, 1849, "f_L_prec9_negative", f_L_prec9_negative, f_L_prec9_negative_bench, "{return test(\"%.9Lf\", -3.85l);}"},
	{0, 1850, "f_L_prec9_positive_3_3", f_L_prec9_positive_3_3, f_L_prec9_positive_3_3_bench, "{return test(\"%.9Lf\", 573.924l);}"},
	{0, 1851, "f_L_prec9_negative_3_3", f_L_prec9_negative_3_3, f_L_prec9_negative_3_3_bench, "{return test(\"%.9Lf\", -958.125l);}"},
	{0, 1852, "f_L_prec9_positive_smallfpart", f_L_prec9_positive_smallfpart, f_L_prec9_positive_smallfpart_bench, "{return test(\"%.9Lf\", 23.00041l);}"},
	{0, 1853, "f_L_prec9_positive_allsmall", f_L_prec9_positive_allsmall, f_L_prec9_positive_allsmall_bench, "{return test(\"%.9Lf\", 0.00000039l);}"},
	{0, 1854, "f_L_prec9_negative_smallfpart", f_L_prec9_negative_smallfpart, f_L_prec9_negative_smallfpart_bench, "{return test(\"%.9Lf\", -7.00036l);}"},
	{0, 1855, "f_L_prec9_negative_allsmall", f_L_prec9_negative_allsmall, f_L_prec9_negative_allsmall_bench, "{return test(\"%.9Lf\", -0.0000032l);}"},
	{0, 1856, "f_L_prec9_limits_allsmall_pos", f_L_prec9_limits_allsmall_pos, f_L_prec9_limits_allsmall_pos_bench, "{return test(\"%.9Lf\", 0.00000001l);}"},
	{0, 1857, "f_L_prec9_limits_allsmall_neg", f_L_prec9_limits_allsmall_neg, f_L_prec9_limits_allsmall_neg_bench, "{return test(\"%.9Lf\", -0.00000001l);}"},
	{0, 1858, "f_L_prec9_limits_smallfpart_pos", f_L_prec9_limits_smallfpart_pos, f_L_prec9_limits_smallfpart_pos_bench, "{return test(\"%.9Lf\", 9873.000001l);}"},
	{0, 1859, "f_L_prec9_limits_smallfpart_neg", f_L_prec9_limits_smallfpart_neg, f_L_prec9_limits_smallfpart_neg_bench, "{return test(\"%.9Lf\", -875.000001l);}"},
	{0, 1860, "f_L_prec9_limits_allbig_pos", f_L_prec9_limits_allbig_pos, f_L_prec9_limits_allbig_pos_bench, "{return test(\"%.9Lf\", 999.99999999l);}"},
	{0, 1861, "f_L_prec9_limits_allbig_neg", f_L_prec9_limits_allbig_neg, f_L_prec9_limits_allbig_neg_bench, "{return test(\"%.9Lf\", -99.99999999l);}"},
	{0, 1862, "f_L_prec9_limits_bigfpart_pos", f_L_prec9_limits_bigfpart_pos, f_L_prec9_limits_bigfpart_pos_bench, "{return test(\"%.9Lf\", 0.999999l);}"},
	{0, 1863, "f_L_prec9_limits_bigfpart_neg", f_L_prec9_limits_bigfpart_neg, f_L_prec9_limits_bigfpart_neg_bench, "{return test(\"%.9Lf\", -0.999999l);}"},
	{0, 1864, "f_L_rnd_prec9_rndd_pos", f_L_rnd_prec9_rndd_pos, f_L_rnd_prec9_rndd_pos_bench, "{return test(\"%.9Lf\", 23.375094499l);}"},
	{0, 1865, "f_L_rnd_prec9_rndd_neg", f_L_rnd_prec9_rndd_neg, f_L_rnd_prec9_rndd_neg_bench, "{return test(\"%.9Lf\", -985.765426499l);}"},
	{0, 1866, "f_L_rnd_prec9_rndu_pos", f_L_rnd_prec9_rndu_pos, f_L_rnd_prec9_rndu_pos_bench, "{return test(\"%.9Lf\", 0.0894255l);}"},
	{0, 1867, "f_L_rnd_prec9_rndu_neg", f_L_rnd_prec9_rndu_neg, f_L_rnd_prec9_rndu_neg_bench, "{return test(\"%.9Lf\", -56.2012685l);}"},
	{0, 1868, "f_L_rnd_prec9_rndu_multidigit_pos", f_L_rnd_prec9_rndu_multidigit_pos, f_L_rnd_prec9_rndu_multidigit_pos_bench, "{return test(\"%.9Lf\", 43.4399999l);}"},
	{0, 1869, "f_L_rnd_prec9_rndu_multidigit_neg", f_L_rnd_prec9_rndu_multidigit_neg, f_L_rnd_prec9_rndu_multidigit_neg_bench, "{return test(\"%.9Lf\", -5.0299999l);}"},
	{0, 1870, "f_L_rnd_prec9_rndd_multidigit_pos", f_L_rnd_prec9_rndd_multidigit_pos, f_L_rnd_prec9_rndd_multidigit_pos_bench, "{return test(\"%.9Lf\", 43.43999949l);}"},
	{0, 1871, "f_L_rnd_prec9_rndd_multidigit_neg", f_L_rnd_prec9_rndd_multidigit_neg, f_L_rnd_prec9_rndd_multidigit_neg_bench, "{return test(\"%.9Lf\", -5.02999949l);}"},
	{0, 1872, "f_L_rnd_prec9_rndd_wholnobump_pos", f_L_rnd_prec9_rndd_wholnobump_pos, f_L_rnd_prec9_rndd_wholnobump_pos_bench, "{return test(\"%.9Lf\", 1.99999949l);}"},
	{0, 1873, "f_L_rnd_prec9_rndd_wholnobump_neg", f_L_rnd_prec9_rndd_wholnobump_neg, f_L_rnd_prec9_rndd_wholnobump_neg_bench, "{return test(\"%.9Lf\", -0.99999949l);}"},
	{0, 1874, "f_L_rnd_prec9_rndu_bumpwhole_pos", f_L_rnd_prec9_rndu_bumpwhole_pos, f_L_rnd_prec9_rndu_bumpwhole_pos_bench, "{return test(\"%.9Lf\", 3.9999999l);}"},
	{0, 1875, "f_L_stress_prec10_1", f_L_stress_prec10_1, f_L_stress_prec10_1_bench, "{return test(\"this %.10Lf float\", 1.5l);}"},
	{0, 1876, "f_L_stress_prec10_fltonly", f_L_stress_prec10_fltonly, f_L_stress_prec10_fltonly_bench, "{return test(\"%.10Lf\", 7.5l);}"},
	{0, 1877, "f_L_stress_prec10_whole", f_L_stress_prec10_whole, f_L_stress_prec10_whole_bench, "{return test(\"%.10Lf\", 1.0l);}"},
	{0, 1878, "f_L_stress_prec10_negative", f_L_stress_prec10_negative, f_L_stress_prec10_negative_bench, "{return test(\"%.10Lf\", -3.85l);}"},
	{0, 1879, "f_L_stress_prec10_positive_3_10", f_L_stress_prec10_positive_3_10, f_L_stress_prec10_positive_3_10_bench, "{return test(\"%.10Lf\", 573.924l);}"},
	{0, 1880, "f_L_stress_prec10_negative_3_10", f_L_stress_prec10_negative_3_10, f_L_stress_prec10_negative_3_10_bench, "{return test(\"%.10Lf\", -958.125l);}"},
	{0, 1881, "f_L_stress_prec10_pos", f_L_stress_prec10_pos, f_L_stress_prec10_pos_bench, "{return test(\"%.10Lf\", 23.8341375094l);}"},
	{0, 1882, "f_L_stress_prec10_neg", f_L_stress_prec10_neg, f_L_stress_prec10_neg_bench, "{return test(\"%.10Lf\", -985.2459765426l);}"},
	{0, 1883, "f_L_stress_prec10_rndd_pos", f_L_stress_prec10_rndd_pos, f_L_stress_prec10_rndd_pos_bench, "{return test(\"%.10Lf\", 23.8341375094499l);}"},
	{0, 1884, "f_L_stress_prec10_rndd_neg", f_L_stress_prec10_rndd_neg, f_L_stress_prec10_rndd_neg_bench, "{return test(\"%.10Lf\", -985.2459765426499l);}"},
	{0, 1885, "f_L_stress_prec10_rndu_pos", f_L_stress_prec10_rndu_pos, f_L_stress_prec10_rndu_pos_bench, "{return test(\"%.10Lf\", 0.87650894255l);}"},
	{0, 1886, "f_L_stress_prec10_rndu_neg", f_L_stress_prec10_rndu_neg, f_L_stress_prec10_rndu_neg_bench, "{return test(\"%.10Lf\", -56.47852012685l);}"},
	{0, 1887, "f_L_stress_prec10_positive_smallfpart", f_L_stress_prec10_positive_smallfpart, f_L_stress_prec10_positive_smallfpart_bench, "{return test(\"%.10Lf\", 23.000000041l);}"},
	{0, 1888, "f_L_stress_prec10_positive_allsmall", f_L_stress_prec10_positive_allsmall, f_L_stress_prec10_positive_allsmall_bench, "{return test(\"%.10Lf\", 0.0000000039l);}"},
	{0, 1889, "f_L_stress_prec10_negative_smallfpart", f_L_stress_prec10_negative_smallfpart, f_L_stress_prec10_negative_smallfpart_bench, "{return test(\"%.10Lf\", -7.000000036l);}"},
	{0, 1890, "f_L_stress_prec10_negative_allsmall", f_L_stress_prec10_negative_allsmall, f_L_stress_prec10_negative_allsmall_bench, "{return test(\"%.10Lf\", -0.000000032l);}"},
	{0, 1891, "f_L_stress_prec10_limits_allsmall_pos", f_L_stress_prec10_limits_allsmall_pos, f_L_stress_prec10_limits_allsmall_pos_bench, "{return test(\"%.10Lf\", 0.0000000001l);}"},
	{0, 1892, "f_L_stress_prec10_limits_allsmall_neg", f_L_stress_prec10_limits_allsmall_neg, f_L_stress_prec10_limits_allsmall_neg_bench, "{return test(\"%.10Lf\", -0.0000000001l);}"},
	{0, 1893, "f_L_stress_prec10_limits_smallfpart_pos", f_L_stress_prec10_limits_smallfpart_pos, f_L_stress_prec10_limits_smallfpart_pos_bench, "{return test(\"%.10Lf\", 9873.0000000001l);}"},
	{0, 1894, "f_L_stress_prec10_limits_smallfpart_neg", f_L_stress_prec10_limits_smallfpart_neg, f_L_stress_prec10_limits_smallfpart_neg_bench, "{return test(\"%.10Lf\", -875.0000000001l);}"},
	{0, 1895, "f_L_stress_prec10_limits_allbig_pos", f_L_stress_prec10_limits_allbig_pos, f_L_stress_prec10_limits_allbig_pos_bench, "{return test(\"%.10Lf\", 999.9999999999l);}"},
	{0, 1896, "f_L_stress_prec10_limits_allbig_neg", f_L_stress_prec10_limits_allbig_neg, f_L_stress_prec10_limits_allbig_neg_bench, "{return test(\"%.10Lf\", -99.9999999999l);}"},
	{0, 1897, "f_L_stress_prec10_limits_bigfpart_pos", f_L_stress_prec10_limits_bigfpart_pos, f_L_stress_prec10_limits_bigfpart_pos_bench, "{return test(\"%.10Lf\", 0.9999999999l);}"},
	{0, 1898, "f_L_stress_prec10_limits_bigfpart_neg", f_L_stress_prec10_limits_bigfpart_neg, f_L_stress_prec10_limits_bigfpart_neg_bench, "{return test(\"%.10Lf\", -0.9999999999l);}"},
	{0, 1899, "f_L_stress_prec12_rndu", f_L_stress_prec12_rndu, f_L_stress_prec12_rndu_bench, "{return test(\"%.12f\",        1.025978542436587568678);}"},
	{0, 1900, "f_L_stress_prec12_rndd", f_L_stress_prec12_rndd, f_L_stress_prec12_rndd_bench, "{return test(\"%.12f\",        1.025978548534310421434);}"},
	{0, 1901, "f_L_stress_prec12_limits_tiny", f_L_stress_prec12_limits_tiny, f_L_stress_prec12_limits_tiny_bench, "{return test(\"%.12f\", 0.000000000001000000000);}"},
	{0, 1902, "f_L_stress_prec12_limits_big", f_L_stress_prec12_limits_big, f_L_stress_prec12_limits_big_bench, "{return test(\"%.12f\",  0.999999999999000000000);}"},
	{0, 1903, "f_L_stress_prec14_rndu", f_L_stress_prec14_rndu, f_L_stress_prec14_rndu_bench, "{return test(\"%.14f\",        1.025978542436587568678);}"},
	{0, 1904, "f_L_stress_prec14_rndd", f_L_stress_prec14_rndd, f_L_stress_prec14_rndd_bench, "{return test(\"%.14f\",        1.025978548534310421434);}"},
	{0, 1905, "f_L_stress_prec14_limits_tiny", f_L_stress_prec14_limits_tiny, f_L_stress_prec14_limits_tiny_bench, "{return test(\"%.14f\", 0.000000000000010000000);}"},
	{0, 1906, "f_L_stress_prec14_limits_big", f_L_stress_prec14_limits_big, f_L_stress_prec14_limits_big_bench, "{return test(\"%.14f\",  0.999999999999990000000);}"},
	{0, 1907, "f_L_stress_prec16_rndu", f_L_stress_prec16_rndu, f_L_stress_prec16_rndu_bench, "{return test(\"%.16f\",        1.025978542436587568678);}"},
	{0, 1908, "f_L_stress_prec16_rndd", f_L_stress_prec16_rndd, f_L_stress_prec16_rndd_bench, "{return test(\"%.16f\",        1.025978548534310421634);}"},
	{0, 1909, "f_L_stress_prec16_limits_tiny", f_L_stress_prec16_limits_tiny, f_L_stress_prec16_limits_tiny_bench, "{return test(\"%.16f\", 0.000000000000000100000);}"},
	...
	{0, 1911, "f_L_stress_prec17_rndu", f_L_stress_prec17_rndu, f_L_stress_prec17_rndu_bench, "{return test(\"%.17f\",        1.025978542436587568678);}"},
	{0, 1912, "f_L_stress_prec17_rndd", f_L_stress_prec17_rndd, f_L_stress_prec17_rndd_bench, "{return test(\"%.17f\",        1.025978548534310421734);}"},
	{0, 1913, "f_L_stress_prec17_limits_tiny", f_L_stress_prec17_limits_tiny, f_L_stress_prec17_limits_tiny_bench, "{return test(\"%.17f\", 0.000000000000000010000);}"},
	{0, 1914, "f_L_stress_prec17_limits_big", f_L_stress_prec17_limits_big, f_L_stress_prec17_limits_big_bench, "{return test(\"%.17f\",  0.999999999999999990000);}"},
	{0, 1915, "f_L_stress_prec18_rndu", f_L_stress_prec18_rndu, f_L_stress_prec18_rndu_bench, "{return test(\"%.18f\",        1.025978542436587568678);}"},
	{0, 1916, "f_L_stress_prec18_rndd", f_L_stress_prec18_rndd, f_L_stress_prec18_rndd_bench, "{return test(\"%.18f\",        1.025978548534310421834);}"},
	{0, 1917, "f_L_stress_prec18_limits_tiny", f_L_stress_prec18_limits_tiny, f_L_stress_prec18_limits_tiny_bench, "{return test(\"%.18f\", 0.000000000000000001000);}"},
	{0, 1918, "f_L_stress_prec18_limits_big", f_L_stress_prec18_limits_big, f_L_stress_prec18_limits_big_bench, "{return test(\"%.18f\",  0.999999999999999999000);}"},
	{0, 1919, "f_L_stress_prec19_rndu", f_L_stress_prec19_rndu, f_L_stress_prec19_rndu_bench, "{return test(\"%.19f\",        1.025978542436587568678);}"},
	{0, 1920, "f_L_stress_prec19_rndd", f_L_stress_prec19_rndd, f_L_stress_prec19_rndd_bench, "{return test(\"%.19f\",        1.025978548534310421934);}"},
	{0, 1921, "f_L_stress_prec19_limits_tiny", f_L_stress_prec19_limits_tiny, f_L_stress_prec19_limits_tiny_bench, "{return test(\"%.19f\", 0.000000000000000000100);}"},
	{0, 1922, "f_L_stress_prec19_limits_big", f_L_stress_prec19_limits_big, f_L_stress_prec19_limits_big_bench, "{return test(\"%.19f\",  0.999999999999999999900);}"},
	{0, 1923, "f_L_stress_prec20_rndu", f_L_stress_prec20_rndu, f_L_stress_prec20_rndu_bench, "{return test(\"%.20f\",        1.025978542436587568678);}"},
	{0, 1924, "f_L_stress_prec20_rndd", f_L_stress_prec20_rndd, f_L_stress_prec20_rndd_bench, "{return test(\"%.20f\",        1.025978548534310422034);}"},
	{0, 1925, "f_L_stress_prec20_limits_tiny", f_L_stress_prec20_limits_tiny, f_L_stress_prec20_limits_tiny_bench, "{return test(\"%.20f\", 0.000000000000000000010);}"},
	{0, 1926, "f_L_stress_prec20_limits_big", f_L_stress_prec20_limits_big, f_L_stress_prec20_limits_big_bench, "{return test(\"%.20f\",  0.999999999999999999990);}"},
	...
	{0, 1989, "f_L_limits_dblmin_prec0", f_L_limits_dblmin_prec0, f_L_limits_dblmin_prec0_bench, "{return test(\"%.0Lf\", LDBL_MIN);}"},
	{0, 1990, "f_L_limits_dblmin_prec3", f_L_limits_dblmin_prec3, f_L_limits_dblmin_prec3_bench, "{return test(\"%.3Lf\", LDBL_MIN);}"},
	{0, 1991, "f_L_limits_dblmin_precd", f_L_limits_dblmin_precd, f_L_limits_dblmin_precd_bench, "{return test(\"%Lf\", LDBL_MIN);}"},
	{0, 1992, "f_L_limits_dblmin_prec8", f_L_limits_dblmin_prec8, f_L_limits_dblmin_prec8_bench, "{return test(\"%.8Lf\", LDBL_MIN);}"},
	{0, 1993, "f_L_stress_limits_dblmin_prec12", f_L_stress_limits_dblmin_prec12, f_L_stress_limits_dblmin_prec12_bench, "{return test(\"%.12Lf\", LDBL_MIN);}"},
	{0, 1994, "f_L_stress_limits_dblmin_prec16", f_L_stress_limits_dblmin_prec16, f_L_stress_limits_dblmin_prec16_bench, "{return test(\"%.16Lf\", LDBL_MIN);}"},
	{0, 1995, "f_L_stress_limits_dblmin_prec18", f_L_stress_limits_dblmin_prec18, f_L_stress_limits_dblmin_prec18_bench, "{return test(\"%.18Lf\", LDBL_MIN);}"},
	{0, 1996, "f_L_limits_ndblmin_prec0", f_L_limits_ndblmin_prec0, f_L_limits_ndblmin_prec0_bench, "{return test(\"%.0Lf\", -LDBL_MIN);}"},
	{0, 1997, "f_L_limits_ndblmin_prec3", f_L_limits_ndblmin_prec3, f_L_limits_ndblmin_prec3_bench, "{return test(\"%.3Lf\", -LDBL_MIN);}"},
	{0, 1998, "f_L_limits_ndblmin_precd", f_L_limits_ndblmin_precd, f_L_limits_ndblmin_precd_bench, "{return test(\"%Lf\", -LDBL_MIN);}"},
	{0, 1999, "f_L_limits_ndblmin_prec8", f_L_limits_ndblmin_prec8, f_L_limits_ndblmin_prec8_bench, "{return test(\"%.8Lf\", -LDBL_MIN);}"},
	...
	{0, 2019, "mix_test_0", mix_test_0, mix_test_0_bench, "{return test("},
	{0, 2020, "mix_test_1", mix_test_1, mix_test_1_bench, "{return test("},
	{0, 2021, "mix_test_2", mix_test_2, mix_test_2_bench, "{return test("},
	{0, 2022, "mix_test_3", mix_test_3, mix_test_3_bench, "{return test("},
	{0, 2023, "mix_test_4", mix_test_4, mix_test_4_bench, "{return test("},
	{0, 2024, "mix_test_5", mix_test_5, mix_test_5_bench, "{return test("},
	{0, 2025, "mix_test_6", mix_test_6, mix_test_6_bench, "{return test("},
	{0, 2026, "mix_test_7", mix_test_7, mix_test_7_bench, "{return test("},
	{0, 2027, "mix_test_8", mix_test_8, mix_test_8_bench, "{return test("},
	{0, 2028, "mix_test_9", mix_test_9, mix_test_9_bench, "{return test("},
	{0, 2029, "mix_test_10", mix_test_10, mix_test_10_bench, "{return test("},
	{0, 2030, "mix_test_11", mix_test_11, mix_test_11_bench, "{return test("},
	{0, 2031, "mix_test_12", mix_test_12, mix_test_12_bench, "{return test("},
	{0, 2032, "mix_test_13", mix_test_13, mix_test_13_bench, "{return test("},
	{0, 2033, "mix_test_14", mix_test_14, mix_test_14_bench, "{return test("},
	{0, 2034, "mix_test_15", mix_test_15, mix_test_15_bench, "{return test("},
	{0, 2035, "mix_test_16", mix_test_16, mix_test_16_bench, "{return test("},
	{0, 2036, "mix_test_17", mix_test_17, mix_test_17_bench, "{return test("},
	{0, 2037, "mix_test_18", mix_test_18, mix_test_18_bench, "{return test("},
	{0, 2038, "mix_test_19", mix_test_19, mix_test_19_bench, "{return test("},
	{0, 2039, "mix_test_20", mix_test_20, mix_test_20_bench, "{return test("},
	{0, 2040, "mix_test_21", mix_test_21, mix_test_21_bench, "{return test("},
	{0, 2041, "mix_test_22", mix_test_22, mix_test_22_bench, "{return test("},
	{0, 2042, "mix_test_23", mix_test_23, mix_test_23_bench, "{return test("},
	{0, 2043, "mix_test_24", mix_test_24, mix_test_24_bench, "{return test("},
	{0, 2044, "mix_test_25", mix_test_25, mix_test_25_bench, "{return test("},
	{0, 2045, "mix_test_26", mix_test_26, mix_test_26_bench, "{return test("},
	{0, 2046, "mix_test_27", mix_test_27, mix_test_27_bench, "{return test("},
	{0, 2047, "mix_test_28", mix_test_28, mix_test_28_bench, "{return test("},
	{0, 2048, "mix_test_29", mix_test_29, mix_test_29_bench, "{return test("},
	{0, 2049, "mix_test_30", mix_test_30, mix_test_30_bench, "{return test("},
	{0, 2050, "mix_test_31", mix_test_31, mix_test_31_bench, "{return test("},
	{0, 2051, "mix_test_32", mix_test_32, mix_test_32_bench, "{return test("},
	{0, 2052, "mix_test_33", mix_test_33, mix_test_33_bench, "{return test("},
	{0, 2053, "mix_test_34", mix_test_34, mix_test_34_bench, "{return test("},
	{0, 2054, "mix_test_35", mix_test_35, mix_test_35_bench, "{return test("},
	{0, 2055, "mix_test_36", mix_test_36, mix_test_36_bench, "{return test("},
	{0, 2056, "mix_test_37", mix_test_37, mix_test_37_bench, "{return test("},
	{0, 2057, "mix_test_38", mix_test_38, mix_test_38_bench, "{return test("},
	{0, 2058, "mix_test_39", mix_test_39, mix_test_39_bench, "{return test("},
	{0, 2059, "mix_test_40", mix_test_40, mix_test_40_bench, "{return test("},
	{0, 2060, "mix_test_41", mix_test_41, mix_test_41_bench, "{return test("},
	{0, 2061, "mix_test_42", mix_test_42, mix_test_42_bench, "{return test("},
	{0, 2062, "mix_test_43", mix_test_43, mix_test_43_bench, "{return test("},
	{0, 2063, "mix_test_44", mix_test_44, mix_test_44_bench, "{return test("},
	{0, 2064, "mix_test_45", mix_test_45, mix_test_45_bench, "{return test("},
	{0, 2065, "mix_test_46", mix_test_46, mix_test_46_bench, "{return test("},
	{0, 2066, "mix_test_47", mix_test_47, mix_test_47_bench, "{return test("},
	{0, 2067, "mix_test_48", mix_test_48, mix_test_48_bench, "{return test("},
	{0, 2068, "mix_test_49", mix_test_49, mix_test_49_bench, "{return test("},
	{0, 2069, "mix_test_50", mix_test_50, mix_test_50_bench, "{return test("},
	{0, 2070, "mix_test_51", mix_test_51, mix_test_51_bench, "{return test("},
	{0, 2071, "mix_test_52", mix_test_52, mix_test_52_bench, "{return test("},
	{0, 2072, "mix_test_53", mix_test_53, mix_test_53_bench, "{return test("},
	{0, 2073, "mix_test_54", mix_test_54, mix_test_54_bench, "{return test("},
	{0, 2074, "mix_test_55", mix_test_55, mix_test_55_bench, "{return test("},
	{0, 2075, "mix_test_56", mix_test_56, mix_test_56_bench, "{return test("},
	{0, 2076, "mix_test_57", mix_test_57, mix_test_57_bench, "{return test("},
	{0, 2077, "mix_test_58", mix_test_58, mix_test_58_bench, "{return test("},
	{0, 2078, "mix_test_59", mix_test_59, mix_test_59_bench, "{return test("},
	{0, 2079, "mix_test_60", mix_test_60, mix_test_60_bench, "{return test("},
	{0, 2080, "mix_test_61", mix_test_61, mix_test_61_bench, "{return test("},
	{0, 2081, "mix_test_62", mix_test_62, mix_test_62_bench, "{return test("},
	{0, 2082, "mix_test_63", mix_test_63, mix_test_63_bench, "{return test("},
	{0, 2083, "mix_test_64", mix_test_64, mix_test_64_bench, "{return test("},
	{0, 2084, "mix_test_65", mix_test_65, mix_test_65_bench, "{return test("},
	{0, 2085, "mix_test_66", mix_test_66, mix_test_66_bench, "{return test("},
	{0, 2086, "mix_test_67", mix_test_67, mix_test_67_bench, "{return test("},
	{0, 2087, "mix_test_68", mix_test_68, mix_test_68_bench, "{return test("},
	{0, 2088, "mix_test_69", mix_test_69, mix_test_69_bench, "{return test("},
	{0, 2089, "mix_test_70", mix_test_70, mix_test_70_bench, "{return test("},
	{0, 2090, "mix_test_71", mix_test_71, mix_test_71_bench, "{return test("},
	{0, 2091, "mix_test_72", mix_test_72, mix_test_72_bench, "{return test("},
	{0, 2092, "mix_test_73", mix_test_73, mix_test_73_bench, "{return test("},
	{0, 2093, "mix_test_74", mix_test_74, mix_test_74_bench, "{return test("},
	{0, 2094, "mix_test_75", mix_test_75, mix_test_75_bench, "{return test("},
	{0, 2095, "mix_test_76", mix_test_76, mix_test_76_bench, "{return test("},
	{0, 2096, "mix_test_77", mix_test_77, mix_test_77_bench, "{return test("},
	{0, 2097, "mix_test_78", mix_test_78, mix_test_78_bench, "{return test("},
	{0, 2098, "mix_test_79", mix_test_79, mix_test_79_bench, "{return test("},
	{0, 2099, "mix_test_80", mix_test_80, mix_test_80_bench, "{return test("},
	{0, 2100, "mix_test_81", mix_test_81, mix_test_81_bench, "{return test("},
	{0, 2101, "mix_test_82", mix_test_82, mix_test_82_bench, "{return test("},
	{0, 2102, "mix_test_83", mix_test_83, mix_test_83_bench, "{return test("},
	{0, 2103, "mix_test_84", mix_test_84, mix_test_84_bench, "{return test("},
	{0, 2104, "mix_test_85", mix_test_85, mix_test_85_bench, "{return test("},
	{0, 2105, "mix_test_86", mix_test_86, mix_test_86_bench, "{return test("},
	{0, 2106, "mix_test_87", mix_test_87, mix_test_87_bench, "{return test("},
	{0, 2107, "mix_test_88", mix_test_88, mix_test_88_bench, "{return test("},
	{0, 2108, "mix_test_89", mix_test_89, mix_test_89_bench, "{return test("},
	{0, 2109, "mix_test_90", mix_test_90, mix_test_90_bench, "{return test("},
	{0, 2110, "mix_test_91", mix_test_91, mix_test_91_bench, "{return test("},
	{0, 2111, "mix_test_92", mix_test_92, mix_test_92_bench, "{return test("},
	{0, 2112, "mix_test_93", mix_test_93, mix_test_93_bench, "{return test("},
	{0, 2113, "mix_test_94", mix_test_94, mix_test_94_bench, "{return test("},
	{0, 2114, "mix_test_95", mix_test_95, mix_test_95_bench, "{return test("},
	{0, 2115, "mix_test_96", mix_test_96, mix_test_96_bench, "{return test("},
	{0, 2116, "mix_test_97", mix_test_97, mix_test_97_bench, "{return test("},
	{0, 2117, "mix_test_98", mix_test_98, mix_test_98_bench, "{return test("},
	{0, 2118, "mix_test_99", mix_test_99, mix_test_99_bench, "{return test("},
	{0, 2119, "mix_test_100", mix_test_100, mix_test_100_bench, "{return test("},
	{0, 2120, "mix_test_101", mix_test_101, mix_test_101_bench, "{return test("},
	{0, 2121, "mix_test_102", mix_test_102, mix_test_102_bench, "{return test("},
	{0, 2122, "mix_test_103", mix_test_103, mix_test_103_bench, "{return test("},
	{0, 2123, "mix_test_104", mix_test_104, mix_test_104_bench, "{return test("},
	{0, 2124, "mix_test_105", mix_test_105, mix_test_105_bench, "{return test("},
	{0, 2125, "mix_test_106", mix_test_106, mix_test_106_bench, "{return test("},
	{0, 2126, "mix_test_107", mix_test_107, mix_test_107_bench, "{return test("},
	{0, 2127, "mix_test_108", mix_test_108, mix_test_108_bench, "{return test("},
	{0, 2128, "mix_test_109", mix_test_109, mix_test_109_bench, "{return test("},
	{0, 2129, "mix_test_110", mix_test_110, mix_test_110_bench, "{return test("},
	{0, 2130, "mix_test_111", mix_test_111, mix_test_111_bench, "{return test("},
	{0, 2131, "mix_test_112", mix_test_112, mix_test_112_bench, "{return test("},
	{0, 2132, "mix_test_113", mix_test_113, mix_test_113_bench, "{return test("},
	{0, 2133, "mix_test_114", mix_test_114, mix_test_114_bench, "{return test("},
	{0, 2134, "mix_test_115", mix_test_115, mix_test_115_bench, "{return test("},
	{0, 2135, "mix_test_116", mix_test_116, mix_test_116_bench, "{return test("},
	{0, 2136, "mix_test_117", mix_test_117, mix_test_117_bench, "{return test("},
	{0, 2137, "mix_test_118", mix_test_118, mix_test_118_bench, "{return test("},
	{0, 2138, "mix_test_119", mix_test_119, mix_test_119_bench, "{return test("},
	{0, 2139, "mix_test_120", mix_test_120, mix_test_120_bench, "{return test("},
	{0, 2140, "mix_test_121", mix_test_121, mix_test_121_bench, "{return test("},
	{0, 2141, "mix_test_122", mix_test_122, mix_test_122_bench, "{return test("},
	{0, 2142, "mix_test_123", mix_test_123, mix_test_123_bench, "{return test("},
	{0, 2143, "mix_test_124", mix_test_124, mix_test_124_bench, "{return test("},
	{0, 2144, "mix_test_125", mix_test_125, mix_test_125_bench, "{return test("},
	{0, 2145, "mix_test_126", mix_test_126, mix_test_126_bench, "{return test("},
	{0, 2146, "mix_test_127", mix_test_127, mix_test_127_bench, "{return test("},
	{0, 2147, "mix_test_128", mix_test_128, mix_test_128_bench, "{return test("},
	{0, 2148, "mix_test_129", mix_test_129, mix_test_129_bench, "{return test("},
	{0, 2149, "mix_test_130", mix_test_130, mix_test_130_bench, "{return test("},
	{0, 2150, "mix_test_131", mix_test_131, mix_test_131_bench, "{return test("},
	{0, 2151, "mix_test_132", mix_test_132, mix_test_132_bench, "{return test("},
	{0, 2152, "mix_test_133", mix_test_133, mix_test_133_bench, "{return test("},
	{0, 2153, "mix_test_134", mix_test_134, mix_test_134_bench, "{return test("},
	{0, 2154, "mix_test_135", mix_test_135, mix_test_135_bench, "{return test("},
	{0, 2155, "mix_test_136", mix_test_136, mix_test_136_bench, "{return test("},
	{0, 2156, "mix_test_137", mix_test_137, mix_test_137_bench, "{return test("},
	{0, 2157, "mix_test_138", mix_test_138, mix_test_138_bench, "{return test("},
	{0, 2158, "mix_test_139", mix_test_139, mix_test_139_bench, "{return test("},
	{0, 2159, "mix_test_140", mix_test_140, mix_test_140_bench, "{return test("},
	{0, 2160, "mix_test_141", mix_test_141, mix_test_141_bench, "{return test("},
	{0, 2161, "mix_test_142", mix_test_142, mix_test_142_bench, "{return test("},
	{0, 2162, "mix_test_143", mix_test_143, mix_test_143_bench, "{return test("},
	{0, 2163, "mix_test_144", mix_test_144, mix_test_144_bench, "{return test("},
	{0, 2164, "mix_test_145", mix_test_145, mix_test_145_bench, "{return test("},
	{0, 2165, "mix_test_146", mix_test_146, mix_test_146_bench, "{return test("},
	{0, 2166, "mix_test_147", mix_test_147, mix_test_147_bench, "{return test("},
	{0, 2167, "mix_test_148", mix_test_148, mix_test_148_bench, "{return test("},
	{0, 2168, "mix_test_149", mix_test_149, mix_test_149_bench, "{return test("},
	{0, 2169, "mix_test_150", mix_test_150, mix_test_150_bench, "{return test("},
	{0, 2170, "mix_test_151", mix_test_151, mix_test_151_bench, "{return test("},
	{0, 2171, "mix_test_152", mix_test_152, mix_test_152_bench, "{return test("},
	{0, 2172, "mix_test_153", mix_test_153, mix_test_153_bench, "{return test("},
	{0, 2173, "mix_test_154", mix_test_154, mix_test_154_bench, "{return test("},
	{0, 2174, "mix_test_155", mix_test_155, mix_test_155_bench, "{return test("},
	{0, 2175, "mix_test_156", mix_test_156, mix_test_156_bench, "{return test("},
	{0, 2176, "mix_test_157", mix_test_157, mix_test_157_bench, "{return test("},
	{0, 2177, "mix_test_158", mix_test_158, mix_test_158_bench, "{return test("},
	{0, 2178, "mix_test_159", mix_test_159, mix_test_159_bench, "{return test("},
	{0, 2179, "mix_test_160", mix_test_160, mix_test_160_bench, "{return test("},
	{0, 2180, "mix_test_161", mix_test_161, mix_test_161_bench, "{return test("},
	{0, 2181, "mix_test_162", mix_test_162, mix_test_162_bench, "{return test("},
	{0, 2182, "mix_test_163", mix_test_163, mix_test_163_bench, "{return test("},
	{0, 2183, "mix_test_164", mix_test_164, mix_test_164_bench, "{return test("},
	{0, 2184, "mix_test_165", mix_test_165, mix_test_165_bench, "{return test("},
	{0, 2185, "mix_test_166", mix_test_166, mix_test_166_bench, "{return test("},
	{0, 2186, "mix_test_167", mix_test_167, mix_test_167_bench, "{return test("},
	{0, 2187, "mix_test_168", mix_test_168, mix_test_168_bench, "{return test("},
	{0, 2188, "mix_test_169", mix_test_169, mix_test_169_bench, "{return test("},
	{0, 2189, "mix_test_170", mix_test_170, mix_test_170_bench, "{return test("},
	{0, 2190, "mix_test_171", mix_test_171, mix_test_171_bench, "{return test("},
	{0, 2191, "mix_test_172", mix_test_172, mix_test_172_bench, "{return test("},
	{0, 2192, "mix_test_173", mix_test_173, mix_test_173_bench, "{return test("},
	{0, 2193, "mix_test_174", mix_test_174, mix_test_174_bench, "{return test("},
	{0, 2194, "mix_test_175", mix_test_175, mix_test_175_bench, "{return test("},
	{0, 2195, "mix_test_176", mix_test_176, mix_test_176_bench, "{return test("},
	{0, 2196, "mix_test_177", mix_test_177, mix_test_177_bench, "{return test("},
	{0, 2197, "mix_test_178", mix_test_178, mix_test_178_bench, "{return test("},
	{0, 2198, "mix_test_179", mix_test_179, mix_test_179_bench, "{return test("},
	{0, 2199, "mix_test_180", mix_test_180, mix_test_180_bench, "{return test("},
	{0, 2200, "mix_test_181", mix_test_181, mix_test_181_bench, "{return test("},
	{0, 2201, "mix_test_182", mix_test_182, mix_test_182_bench, "{return test("},
	{0, 2202, "mix_test_183", mix_test_183, mix_test_183_bench, "{return test("},
	{0, 2203, "mix_test_184", mix_test_184, mix_test_184_bench, "{return test("},
	{0, 2204, "mix_test_185", mix_test_185, mix_test_185_bench, "{return test("},
	{0, 2205, "mix_test_186", mix_test_186, mix_test_186_bench, "{return test("},
	{0, 2206, "mix_test_187", mix_test_187, mix_test_187_bench, "{return test("},
	{0, 2207, "mix_test_188", mix_test_188, mix_test_188_bench, "{return test("},
	{0, 2208, "mix_test_189", mix_test_189, mix_test_189_bench, "{return test("},
	{0, 2209, "mix_test_190", mix_test_190, mix_test_190_bench, "{return test("},
	{0, 2210, "mix_test_191", mix_test_191, mix_test_191_bench, "{return test("},
	{0, 2211, "mix_test_192", mix_test_192, mix_test_192_bench, "{return test("},
	{0, 2212, "mix_test_193", mix_test_193, mix_test_193_bench, "{return test("},
	{0, 2213, "mix_test_194", mix_test_194, mix_test_194_bench, "{return test("},
	{0, 2214, "mix_test_195", mix_test_195, mix_test_195_bench, "{return test("},
	{0, 2215, "mix_test_196", mix_test_196, mix_test_196_bench, "{return test("},
	{0, 2216, "mix_test_197", mix_test_197, mix_test_197_bench, "{return test("},
	{0, 2217, "mix_test_198", mix_test_198, mix_test_198_bench, "{return test("},
	{0, 2218, "mix_test_199", mix_test_199, mix_test_199_bench, "{return test("},
	{0, 2219, "mix_test_extra_1", mix_test_extra_1, mix_test_extra_1_bench, "{return test("},
	{0, 2220, "mix_test_extra_2", mix_test_extra_2, mix_test_extra_2_bench, "{return test("},
	{0, 2221, "mix_test_extra_3", mix_test_extra_3, mix_test_extra_3_bench, "{return test("},
	{0, 2222, "mix_test_extra_4", mix_test_extra_4, mix_test_extra_4_bench, "{return test("},
	{0, 2223, "mix_test_extra_5", mix_test_extra_5, mix_test_extra_5_bench, "{return test("},
	{0, 2224, "mix_test_extra_6", mix_test_extra_6, mix_test_extra_6_bench, "{return test("},
	{0, 2225, "mix_test_extra_7", mix_test_extra_7, mix_test_extra_7_bench, "{return test("},
	{0, 2226, "mix_test_extra_8", mix_test_extra_8, mix_test_extra_8_bench, "{return test("},
	{0, 2227, "mix_test_extra_9", mix_test_extra_9, mix_test_extra_9_bench, "{return test("},
	{0, 2228, "mix_test_extra_10", mix_test_extra_10, mix_test_extra_10_bench, "{return test("},
	{0, 2229, "mix_successive_0", mix_successive_0, mix_successive_0_bench, "{return ( test(\"%c\", mx_c) + test(\"%u\", mx_u));}"},
	{0, 2230, "mix_successive_1", mix_successive_1, mix_successive_1_bench, "{return ( test(\"%o\", mx_u) + test(\"%%\"));}"},
	{0, 2231, "mix_successive_2", mix_successive_2, mix_successive_2_bench, "{return ( test(\"%s\", mx_s) + test(\"%Lf\", mx_Lf));}"},
	{0, 2232, "mix_successive_3", mix_successive_3, mix_successive_3_bench, "{return ( test(\"%Lf\", mx_Lf) + test(\"%hhi\", mx_c));}"},
	{0, 2233, "mix_successive_4", mix_successive_4, mix_successive_4_bench, "{return ( test(\"%x\", mx_u) + test(\"%i\", mx_i));}"},
	{0, 2234, "mix_successive_5", mix_successive_5, mix_successive_5_bench, "{return ( test(\"%x\", mx_u) + test(\"%o\", mx_u));}"},
	{0, 2235, "mix_successive_6", mix_successive_6, mix_successive_6_bench, "{return ( test(\"%s\", mx_s) + test(\"%c\", mx_c));}"},
	{0, 2236, "mix_successive_7", mix_successive_7, mix_successive_7_bench, "{return ( test(\"%p\", &mx_i) + test(\"%hi\", mx_hi));}"},
	{0, 2237, "mix_successive_8", mix_successive_8, mix_successive_8_bench, "{return ( test(\"%f\", mx_f) + test(\"%p\", &mx_i));}"},
	{0, 2238, "mix_successive_9", mix_successive_9, mix_successive_9_bench, "{return ( test(\"%hi\", mx_hi) + test(\"%u\", mx_u));}"},
	{0, 2239, "mix_successive_10", mix_successive_10, mix_successive_10_bench, "{return ( test(\"%u\", mx_u) + test(\"%s\", mx_s));}"},
	{0, 2240, "mix_successive_11", mix_successive_11, mix_successive_11_bench, "{return ( test(\"%Lf\", mx_Lf) + test(\"%p\", &mx_i));}"},
	{0, 2241, "mix_successive_12", mix_successive_12, mix_successive_12_bench, "{return ( test(\"%f\", mx_f) + test(\"%hhi\", mx_c));}"},
	{0, 2242, "mix_successive_13", mix_successive_13, mix_successive_13_bench, "{return ( test(\"%X\", mx_u) + test(\"%hhi\", mx_c));}"},
	{0, 2243, "mix_successive_14", mix_successive_14, mix_successive_14_bench, "{return ( test(\"%X\", mx_u) + test(\"%f\", mx_f));}"},
	{0, 2244, "mix_successive_15", mix_successive_15, mix_successive_15_bench, "{return ( test(\"%hhi\", mx_c) + test(\"%X\", mx_u));}"},
	{0, 2245, "mix_successive_16", mix_successive_16, mix_successive_16_bench, "{return ( test(\"%s\", mx_s) + test(\"%x\", mx_u));}"},
	{0, 2246, "mix_successive_17", mix_successive_17, mix_successive_17_bench, "{return ( test(\"%lli\", mx_lli) + test(\"%i\", mx_i));}"},
	{0, 2247, "mix_successive_18", mix_successive_18, mix_successive_18_bench, "{return ( test(\"%s\", mx_s) + test(\"%o\", mx_u));}"},
	{0, 2248, "mix_successive_19", mix_successive_19, mix_successive_19_bench, "{return ( test(\"%hhi\", mx_c) + test(\"%X\", mx_u));}"},
	{0, 2249, "mix_successive_20", mix_successive_20, mix_successive_20_bench, "{return ( test(\"%p\", &mx_i) + test(\"%s\", mx_s));}"},
	{0, 2250, "mix_successive_21", mix_successive_21, mix_successive_21_bench, "{return ( test(\"%X\", mx_u) + test(\"%x\", mx_u));}"},
	{0, 2251, "mix_successive_22", mix_successive_22, mix_successive_22_bench, "{return ( test(\"%p\", &mx_i) + test(\"%lli\", mx_lli));}"},
	{0, 2252, "mix_successive_23", mix_successive_23, mix_successive_23_bench, "{return ( test(\"%s\", mx_s) + test(\"%f\", mx_f));}"},
	{0, 2253, "mix_successive_24", mix_successive_24, mix_successive_24_bench, "{return ( test(\"%c\", mx_c) + test(\"%hhi\", mx_c));}"},
	{0, 2254, "mix_successive_25", mix_successive_25, mix_successive_25_bench, "{return ( test(\"%x\", mx_u) + test(\"%f\", mx_f));}"},
	{0, 2255, "mix_successive_26", mix_successive_26, mix_successive_26_bench, "{return ( test(\"%s\", mx_s) + test(\"%li\", mx_li));}"},
	{0, 2256, "mix_successive_27", mix_successive_27, mix_successive_27_bench, "{return ( test(\"%f\", mx_f) + test(\"%Lf\", mx_Lf));}"},
	{0, 2257, "mix_successive_28", mix_successive_28, mix_successive_28_bench, "{return ( test(\"%i\", mx_i) + test(\"%u\", mx_u));}"},
	{0, 2258, "mix_successive_29", mix_successive_29, mix_successive_29_bench, "{return ( test(\"%o\", mx_u) + test(\"%li\", mx_li));}"},
	{0, 2259, "mix_successive_30", mix_successive_30, mix_successive_30_bench, "{return ( test(\"%s\", mx_s) + test(\"%u\", mx_u));}"},
	{0, 2260, "mix_successive_31", mix_successive_31, mix_successive_31_bench, "{return ( test(\"%X\", mx_u) + test(\"%c\", mx_c));}"},
	{0, 2261, "mix_successive_32", mix_successive_32, mix_successive_32_bench, "{return ( test(\"%x\", mx_u) + test(\"%u\", mx_u));}"},
	{0, 2262, "mix_successive_33", mix_successive_33, mix_successive_33_bench, "{return ( test(\"%Lf\", mx_Lf) + test(\"%s\", mx_s));}"},
	{0, 2263, "mix_successive_34", mix_successive_34, mix_successive_34_bench, "{return ( test(\"%hhi\", mx_c) + test(\"%u\", mx_u));}"},
	{0, 2264, "mix_successive_35", mix_successive_35, mix_successive_35_bench, "{return ( test(\"%p\", &mx_i) + test(\"%f\", mx_f));}"},
	{0, 2265, "mix_successive_36", mix_successive_36, mix_successive_36_bench, "{return ( test(\"%li\", mx_li) + test(\"%o\", mx_u));}"},
	{0, 2266, "mix_successive_37", mix_successive_37, mix_successive_37_bench, "{return ( test(\"%s\", mx_s) + test(\"%li\", mx_li));}"},
	{0, 2267, "mix_successive_38", mix_successive_38, mix_successive_38_bench, "{return ( test(\"%o\", mx_u) + test(\"%lli\", mx_lli));}"},
	{0, 2268, "mix_successive_39", mix_successive_39, mix_successive_39_bench, "{return ( test(\"%i\", mx_i) + test(\"%c\", mx_c));}"},
	{0, 2269, "mix_successive_40", mix_successive_40, mix_successive_40_bench, "{return ( test(\"%c\", mx_c) + test(\"%x\", mx_u));}"},
	{0, 2270, "mix_successive_41", mix_successive_41, mix_successive_41_bench, "{return ( test(\"%hhi\", mx_c) + test(\"%x\", mx_u));}"},
	{0, 2271, "mix_successive_42", mix_successive_42, mix_successive_42_bench, "{return ( test(\"%x\", mx_u) + test(\"%s\", mx_s));}"},
	{0, 2272, "mix_successive_43", mix_successive_43, mix_successive_43_bench, "{return ( test(\"%u\", mx_u) + test(\"%x\", mx_u));}"},
	{0, 2273, "mix_successive_44", mix_successive_44, mix_successive_44_bench, "{return ( test(\"%i\", mx_i) + test(\"%f\", mx_f));}"},
	{0, 2274, "mix_successive_45", mix_successive_45, mix_successive_45_bench, "{return ( test(\"%s\", mx_s) + test(\"%c\", mx_c));}"},
	{0, 2275, "mix_successive_46", mix_successive_46, mix_successive_46_bench, "{return ( test(\"%i\", mx_i) + test(\"%s\", mx_s));}"},
	{0, 2276, "mix_successive_47", mix_successive_47, mix_successive_47_bench, "{return ( test(\"%u\", mx_u) + test(\"%hhi\", mx_c));}"},
	{0, 2277, "mix_successive_48", mix_successive_48, mix_successive_48_bench, "{return ( test(\"%hi\", mx_hi) + test(\"%o\", mx_u));}"},
	{0, 2278, "mix_successive_49", mix_successive_49, mix_successive_49_bench, "{return ( test(\"%i\", mx_i) + test(\"%hi\", mx_hi));}"},
	{0, 2279, "mix_successive_50", mix_successive_50, mix_successive_50_bench, "{return ( test(\"%o\", mx_u) + test(\"%Lf\", mx_Lf));}"},
	{0, 2280, "mix_successive_51", mix_successive_51, mix_successive_51_bench, "{return ( test(\"%li\", mx_li) + test(\"%hhi\", mx_c));}"},
	{0, 2281, "mix_successive_52", mix_successive_52, mix_successive_52_bench, "{return ( test(\"%hi\", mx_hi) + test(\"%hhi\", mx_c));}"},
	{0, 2282, "mix_successive_53", mix_successive_53, mix_successive_53_bench, "{return ( test(\"%Lf\", mx_Lf) + test(\"%x\", mx_u));}"},
	{0, 2283, "mix_successive_54", mix_successive_54, mix_successive_54_bench, "{return ( test(\"%c\", mx_c) + test(\"%hi\", mx_hi));}"},
	{0, 2284, "mix_successive_55", mix_successive_55, mix_successive_55_bench, "{return ( test(\"%hi\", mx_hi) + test(\"%s\", mx_s));}"},
	{0, 2285, "mix_successive_56", mix_successive_56, mix_successive_56_bench, "{return ( test(\"%i\", mx_i) + test(\"%lli\", mx_lli));}"},
	{0, 2286, "mix_successive_57", mix_successive_57, mix_successive_57_bench, "{return ( test(\"%c\", mx_c) + test(\"%Lf\", mx_Lf));}"},
	{0, 2287, "mix_successive_58", mix_successive_58, mix_successive_58_bench, "{return ( test(\"%f\", mx_f) + test(\"%x\", mx_u));}"},
	{0, 2288, "mix_successive_59", mix_successive_59, mix_successive_59_bench, "{return ( test(\"%s\", mx_s) + test(\"%li\", mx_li));}"},
	{0, 2289, "mix_successive_60", mix_successive_60, mix_successive_60_bench, "{return ( test(\"%hhi\", mx_c) + test(\"%s\", mx_s));}"},
	{0, 2290, "mix_successive_61", mix_successive_61, mix_successive_61_bench, "{return ( test(\"%p\", &mx_i) + test(\"%c\", mx_c));}"},
	{0, 2291, "mix_successive_62", mix_successive_62, mix_successive_62_bench, "{return ( test(\"%lli\", mx_lli) + test(\"%u\", mx_u));}"},
	{0, 2292, "mix_successive_63", mix_successive_63, mix_successive_63_bench, "{return ( test(\"%x\", mx_u) + test(\"%o\", mx_u));}"},
	{0, 2293, "mix_successive_64", mix_successive_64, mix_successive_64_bench, "{return ( test(\"%s\", mx_s) + test(\"%c\", mx_c));}"},
	{0, 2294, "mix_successive_65", mix_successive_65, mix_successive_65_bench, "{return ( test(\"%i\", mx_i) + test(\"%lli\", mx_lli));}"},
	{0, 2295, "mix_successive_66", mix_successive_66, mix_successive_66_bench, "{return ( test(\"%li\", mx_li) + test(\"%Lf\", mx_Lf));}"},
	{0, 2296, "mix_successive_67", mix_successive_67, mix_successive_67_bench, "{return ( test(\"%hi\", mx_hi) + test(\"%x\", mx_u));}"},
	{0, 2297, "mix_successive_68", mix_successive_68, mix_successive_68_bench, "{return ( test(\"%i\", mx_i) + test(\"%hi\", mx_hi));}"},
	{0, 2298, "mix_successive_69", mix_successive_69, mix_successive_69_bench, "{return ( test(\"%Lf\", mx_Lf) + test(\"%li\", mx_li));}"},
	{0, 2299, "mix_successive_70", mix_successive_70, mix_successive_70_bench, "{return ( test(\"%o\", mx_u) + test(\"%li\", mx_li));}"},
	...
	{0, 2321, "nocrash_nullarg_1", nocrash_nullarg_1, nocrash_nullarg_1_bench, "{return test(\"%1$s\", NULL); }"},
	{0, 2322, "nocrash_nullarg_2", nocrash_nullarg_2, nocrash_nullarg_2_bench, "{return test(\"%0s\", NULL); }"},
	{0, 2323, "nocrash_nullarg_3", nocrash_nullarg_3, nocrash_nullarg_3_bench, "{return test(\"% s\", NULL); }"},
	{0, 2324, "nocrash_nullarg_4", nocrash_nullarg_4, nocrash_nullarg_4_bench, "{return test(\"%#s\", NULL); }"},
	{0, 2325, "nocrash_nullarg_5", nocrash_nullarg_5, nocrash_nullarg_5_bench, "{return test(\"%-s\", NULL); }"},
	{0, 2326, "nocrash_nullarg_6", nocrash_nullarg_6, nocrash_nullarg_6_bench, "{return test(\"%+s\", NULL); }"},
	{0, 2327, "nocrash_nullarg_9", nocrash_nullarg_9, nocrash_nullarg_9_bench, "{return test(\"%23s\", NULL); }"},
	{0, 2328, "nocrash_nullarg_10", nocrash_nullarg_10, nocrash_nullarg_10_bench, "{return test(\"%.s\", NULL); }"},
	{0, 2329, "nocrash_nullarg_11", nocrash_nullarg_11, nocrash_nullarg_11_bench, "{return test(\"%hhs\", NULL); }"},
	{0, 2330, "nocrash_nullarg_12", nocrash_nullarg_12, nocrash_nullarg_12_bench, "{return test(\"%hs\", NULL); }"},
	{0, 2331, "nocrash_nullarg_13", nocrash_nullarg_13, nocrash_nullarg_13_bench, "{return test(\"%lls\", NULL); }"},
	{0, 2332, "nocrash_nullarg_14", nocrash_nullarg_14, nocrash_nullarg_14_bench, "{return test(\"%ls\", NULL); }"},
	{0, 2333, "nocrash_nullarg_15", nocrash_nullarg_15, nocrash_nullarg_15_bench, "{return test(\"%Ls\", NULL); }"},
	{0, 2334, "nocrash_nullarg_16", nocrash_nullarg_16, nocrash_nullarg_16_bench, "{return test(\"%p\", NULL); }"},
	{0, 2335, "nocrash_nullarg_17", nocrash_nullarg_17, nocrash_nullarg_17_bench, "{return test(\"%d\", NULL); }"},
	{0, 2336, "nocrash_nullarg_18", nocrash_nullarg_18, nocrash_nullarg_18_bench, "{return test(\"%b\", NULL); }"},
	{0, 2337, "nocrash_nullarg_19", nocrash_nullarg_19, nocrash_nullarg_19_bench, "{return test(\"%u\", NULL); }"},
	{0, 2338, "nocrash_nullarg_20", nocrash_nullarg_20, nocrash_nullarg_20_bench, "{return test(\"%x\", NULL); }"},
	{0, 2339, "nocrash_nullarg_21", nocrash_nullarg_21, nocrash_nullarg_21_bench, "{return test(\"%X\", NULL); }"},
	{0, 2340, "nocrash_nullarg_22", nocrash_nullarg_22, nocrash_nullarg_22_bench, "{return test(\"%f\", NULL); }"},
	{0, 2341, "nocrash_nullarg_23", nocrash_nullarg_23, nocrash_nullarg_23_bench, "{return test(\"%s\", NULL); }"},
	{0, 2342, "nocrash_nullarg_24", nocrash_nullarg_24, nocrash_nullarg_24_bench, "{return test(\"%c\", NULL); }"},
	{0, 2343, "nocrash_nullarg_25", nocrash_nullarg_25, nocrash_nullarg_25_bench, "{return test(\"%o\", NULL); }"},
	{0, 2344, "nocrash_mandatory_wformat_undefbehav_01", nocrash_mandatory_wformat_undefbehav_01, nocrash_mandatory_wformat_undefbehav_01_bench, "{return test(\"%-021s\", \"abc\");}"},
	{0, 2345, "nocrash_mandatory_wformat_undefbehav_02", nocrash_mandatory_wformat_undefbehav_02, nocrash_mandatory_wformat_undefbehav_02_bench, "{return test(\"%-05s\", \"goes over\");}"},
	{0, 2346, "nocrash_mandatory_wformat_undefbehav_03", nocrash_mandatory_wformat_undefbehav_03, nocrash_mandatory_wformat_undefbehav_03_bench, "{return test(\"%04.3s%-7.4s\", \"hello\", \"world\");}"},
	{0, 2347, "nocrash_mandatory_wformat_undefbehav_04", nocrash_mandatory_wformat_undefbehav_04, nocrash_mandatory_wformat_undefbehav_04_bench, "{return test(\"%021s\", NULL);}"},
	{0, 2348, "nocrash_mandatory_wformat_undefbehav_05", nocrash_mandatory_wformat_undefbehav_05, nocrash_mandatory_wformat_undefbehav_05_bench, "{return test(\"%02s\", NULL);}"},
	{0, 2349, "nocrash_mandatory_wformat_undefbehav_06", nocrash_mandatory_wformat_undefbehav_06, nocrash_mandatory_wformat_undefbehav_06_bench, "{return test(\"%-021s\", NULL);}"},
	{0, 2350, "nocrash_mandatory_wformat_undefbehav_07", nocrash_mandatory_wformat_undefbehav_07, nocrash_mandatory_wformat_undefbehav_07_bench, "{return test(\"%-03s\", NULL);}"},
	{0, 2351, "nocrash_mandatory_wformat_undefbehav_08", nocrash_mandatory_wformat_undefbehav_08, nocrash_mandatory_wformat_undefbehav_08_bench, "{return test(\"%+u\", 5);}"},
	{0, 2352, "nocrash_mandatory_wformat_undefbehav_09", nocrash_mandatory_wformat_undefbehav_09, nocrash_mandatory_wformat_undefbehav_09_bench, "{return test(\"%+u\", 5);}"},
	{0, 2353, "nocrash_mandatory_wformat_undefbehav_10", nocrash_mandatory_wformat_undefbehav_10, nocrash_mandatory_wformat_undefbehav_10_bench, "{return test(\"%+u\", 4294967295);}"},
	{0, 2354, "nocrash_mandatory_wformat_undefbehav_11", nocrash_mandatory_wformat_undefbehav_11, nocrash_mandatory_wformat_undefbehav_11_bench, "{return test(\"%+5u\", 35);}"},
	{0, 2355, "nocrash_mandatory_wformat_undefbehav_12", nocrash_mandatory_wformat_undefbehav_12, nocrash_mandatory_wformat_undefbehav_12_bench, "{return test(\"%+7u\", 0);}"},
	{0, 2356, "nocrash_mandatory_wformat_undefbehav_13", nocrash_mandatory_wformat_undefbehav_13, nocrash_mandatory_wformat_undefbehav_13_bench, "{return test(\"%+24u\", 4294967295);}"},
	{0, 2357, "nocrash_mandatory_wformat_undefbehav_14", nocrash_mandatory_wformat_undefbehav_14, nocrash_mandatory_wformat_undefbehav_14_bench, "{return test(\"%+.7u\", 234);}"},
	{0, 2358, "nocrash_mandatory_wformat_undefbehav_15", nocrash_mandatory_wformat_undefbehav_15, nocrash_mandatory_wformat_undefbehav_15_bench, "{return test(\"%+.3u\", 3723);}"},
	{0, 2359, "nocrash_mandatory_wformat_undefbehav_16", nocrash_mandatory_wformat_undefbehav_16, nocrash_mandatory_wformat_undefbehav_16_bench, "{return test(\"%+05u\", 432);}"},
	{0, 2360, "nocrash_mandatory_wformat_undefbehav_17", nocrash_mandatory_wformat_undefbehav_17, nocrash_mandatory_wformat_undefbehav_17_bench, "{return test(\"%+04u\", 0);}"},
	{0, 2361, "nocrash_mandatory_wformat_undefbehav_18", nocrash_mandatory_wformat_undefbehav_18, nocrash_mandatory_wformat_undefbehav_18_bench, "{return test(\"%+8.5u\", 34);}"},
	{0, 2362, "nocrash_mandatory_wformat_undefbehav_19", nocrash_mandatory_wformat_undefbehav_19, nocrash_mandatory_wformat_undefbehav_19_bench, "{return test(\"%+8.5u\", 0);}"},
	{0, 2363, "nocrash_mandatory_wformat_undefbehav_20", nocrash_mandatory_wformat_undefbehav_20, nocrash_mandatory_wformat_undefbehav_20_bench, "{return test(\"%+8.3u\", 8375);}"},
	{0, 2364, "nocrash_mandatory_wformat_undefbehav_21", nocrash_mandatory_wformat_undefbehav_21, nocrash_mandatory_wformat_undefbehav_21_bench, "{return test(\"%+3.7u\", 3267);}"},
	{0, 2365, "nocrash_mandatory_wformat_undefbehav_22", nocrash_mandatory_wformat_undefbehav_22, nocrash_mandatory_wformat_undefbehav_22_bench, "{return test(\"%+3.3u\", 6983);}"},
	{0, 2366, "nocrash_mandatory_wformat_undefbehav_23", nocrash_mandatory_wformat_undefbehav_23, nocrash_mandatory_wformat_undefbehav_23_bench, "{return test(\"%+-8.5u\", 34);}"},
	{0, 2367, "nocrash_mandatory_wformat_undefbehav_24", nocrash_mandatory_wformat_undefbehav_24, nocrash_mandatory_wformat_undefbehav_24_bench, "{return test(\"%+-8.5u\", 0);}"},
	{0, 2368, "nocrash_mandatory_wformat_undefbehav_25", nocrash_mandatory_wformat_undefbehav_25, nocrash_mandatory_wformat_undefbehav_25_bench, "{return test(\"%+-8.3u\", 8375);}"},
	{0, 2369, "nocrash_mandatory_wformat_undefbehav_26", nocrash_mandatory_wformat_undefbehav_26, nocrash_mandatory_wformat_undefbehav_26_bench, "{return test(\"%+-3.7u\", 3267);}"},
	{0, 2370, "nocrash_mandatory_wformat_undefbehav_27", nocrash_mandatory_wformat_undefbehav_27, nocrash_mandatory_wformat_undefbehav_27_bench, "{return test(\"%+-3.3u\", 6983);}"},
	{0, 2371, "nocrash_mandatory_wformat_undefbehav_28", nocrash_mandatory_wformat_undefbehav_28, nocrash_mandatory_wformat_undefbehav_28_bench, "{return test(\"%0+8.5u\", 34);}"},
	{0, 2372, "nocrash_mandatory_wformat_undefbehav_29", nocrash_mandatory_wformat_undefbehav_29, nocrash_mandatory_wformat_undefbehav_29_bench, "{return test(\"%0+8.5u\", 0);}"},
	{0, 2373, "nocrash_mandatory_wformat_undefbehav_30", nocrash_mandatory_wformat_undefbehav_30, nocrash_mandatory_wformat_undefbehav_30_bench, "{return test(\"%0+8.3u\", 8375);}"},
	{0, 2374, "nocrash_mandatory_wformat_undefbehav_31", nocrash_mandatory_wformat_undefbehav_31, nocrash_mandatory_wformat_undefbehav_31_bench, "{return test(\"%0+3.7u\", 3267);}"},
	{0, 2375, "nocrash_mandatory_wformat_undefbehav_32", nocrash_mandatory_wformat_undefbehav_32, nocrash_mandatory_wformat_undefbehav_32_bench, "{return test(\"%0+3.3u\", 6983);}"},
	{0, 2376, "nocrash_mandatory_wformat_undefbehav_33", nocrash_mandatory_wformat_undefbehav_33, nocrash_mandatory_wformat_undefbehav_33_bench, "{return test(\"%0+-8.5u\", 34);}"},
	{0, 2377, "nocrash_mandatory_wformat_undefbehav_34", nocrash_mandatory_wformat_undefbehav_34, nocrash_mandatory_wformat_undefbehav_34_bench, "{return test(\"%0+-8.5u\", 0);}"},
	{0, 2378, "nocrash_mandatory_wformat_undefbehav_35", nocrash_mandatory_wformat_undefbehav_35, nocrash_mandatory_wformat_undefbehav_35_bench, "{return test(\"%0+-8.3u\", 8375);}"},
	{0, 2379, "nocrash_mandatory_wformat_undefbehav_36", nocrash_mandatory_wformat_undefbehav_36, nocrash_mandatory_wformat_undefbehav_36_bench, "{return test(\"%0+-3.7u\", 3267);}"},
	{0, 2380, "nocrash_mandatory_wformat_undefbehav_37", nocrash_mandatory_wformat_undefbehav_37, nocrash_mandatory_wformat_undefbehav_37_bench, "{return test(\"%0+-3.3u\", 6983);}"},
	{0, 2381, "nocrash_mandatory_wformat_undefbehav_38", nocrash_mandatory_wformat_undefbehav_38, nocrash_mandatory_wformat_undefbehav_38_bench, "{return test(\"%05c\", '\0');}"},
	{0, 2382, "nocrash_mandatory_wformat_undefbehav_39", nocrash_mandatory_wformat_undefbehav_39, nocrash_mandatory_wformat_undefbehav_39_bench, "{return test(\"%-05c\", '\0');}"},
	{0, 2383, "nocrash_mandatory_wformat_undefbehav_40", nocrash_mandatory_wformat_undefbehav_40, nocrash_mandatory_wformat_undefbehav_40_bench, "{return test(\"%+lu\", 22337203685477);}"},
	{0, 2384, "nocrash_mandatory_dupflag_d_asas", nocrash_mandatory_dupflag_d_asas, nocrash_mandatory_dupflag_d_asas_bench, "{return test(\"%++d\", 42);}"},
	{0, 2385, "nocrash_mandatory_dupflag_d_spsp", nocrash_mandatory_dupflag_d_spsp, nocrash_mandatory_dupflag_d_spsp_bench, "{return test(\"%  d\", 42);}"},
	{0, 2386, "nocrash_mandatory_dupflag_d_spassp", nocrash_mandatory_dupflag_d_spassp, nocrash_mandatory_dupflag_d_spassp_bench, "{return test(\"% + d\", 42);}"},
	{0, 2387, "nocrash_mandatory_dupflag_d_ljljw", nocrash_mandatory_dupflag_d_ljljw, nocrash_mandatory_dupflag_d_ljljw_bench, "{return test(\"%--5d\", 42);}"},
	{0, 2388, "nocrash_mandatory_dupflag_d_ljasljw", nocrash_mandatory_dupflag_d_ljasljw, nocrash_mandatory_dupflag_d_ljasljw_bench, "{return test(\"%-+-5d\", 42);}"},
	{0, 2389, "nocrash_mandatory_dupflag_x_afaf", nocrash_mandatory_dupflag_x_afaf, nocrash_mandatory_dupflag_x_afaf_bench, "{return test(\"%##x\", 42);}"},
	{0, 2390, "nocrash_mandatory_dupflag_x_afasasafljw", nocrash_mandatory_dupflag_x_afasasafljw, nocrash_mandatory_dupflag_x_afasasafljw_bench, "{return test(\"%#++#-5x\", 42);}"},
	{0, 2391, "nocrash_mandatory_c_prec_1", nocrash_mandatory_c_prec_1, nocrash_mandatory_c_prec_1_bench, "{return test(\"%.4c\", 'a');}"},
	{0, 2392, "nocrash_mandatory_c_prec_2", nocrash_mandatory_c_prec_2, nocrash_mandatory_c_prec_2_bench, "{return test(\"%.c\", 'a');}"},
	{0, 2393, "nocrash_mandatory_c_af", nocrash_mandatory_c_af, nocrash_mandatory_c_af_bench, "{return test(\"%#c\", 'a');}"},
	{0, 2394, "nocrash_mandatory_c_zp_1", nocrash_mandatory_c_zp_1, nocrash_mandatory_c_zp_1_bench, "{return test(\"%05c\", 'a');}"},
	{0, 2395, "nocrash_mandatory_c_zp_2", nocrash_mandatory_c_zp_2, nocrash_mandatory_c_zp_2_bench, "{return test(\"%0c\", 'a');}"},
	{0, 2396, "nocrash_mandatory_c_as_1", nocrash_mandatory_c_as_1, nocrash_mandatory_c_as_1_bench, "{return test(\"%+c\", 'a');}"},
	{0, 2397, "nocrash_mandatory_c_as_2", nocrash_mandatory_c_as_2, nocrash_mandatory_c_as_2_bench, "{return test(\"%+c\", -42);}"},
	{0, 2398, "nocrash_mandatory_c_sp_1", nocrash_mandatory_c_sp_1, nocrash_mandatory_c_sp_1_bench, "{return test(\"% c\", 'a');}"},
	{0, 2399, "nocrash_mandatory_c_sp_2", nocrash_mandatory_c_sp_2, nocrash_mandatory_c_sp_2_bench, "{return test(\"% c\", -42);}"},
	{0, 2400, "nocrash_mandatory_c_size_hh", nocrash_mandatory_c_size_hh, nocrash_mandatory_c_size_hh_bench, "{return test(\"%hhc\", 'a');}"},
	{0, 2401, "nocrash_mandatory_c_size_h", nocrash_mandatory_c_size_h, nocrash_mandatory_c_size_h_bench, "{return test(\"%hc\", 'a');}"},
	{0, 2402, "nocrash_mandatory_c_size_l", nocrash_mandatory_c_size_l, nocrash_mandatory_c_size_l_bench, "{return test(\"%lc\", L'a');}"},
	{0, 2403, "nocrash_mandatory_c_size_ll", nocrash_mandatory_c_size_ll, nocrash_mandatory_c_size_ll_bench, "{return test(\"%llc\", L'a');}"},
	{0, 2404, "nocrash_mandatory_c_size_L", nocrash_mandatory_c_size_L, nocrash_mandatory_c_size_L_bench, "{return test(\"%Lc\", L'a');}"},
	{0, 2405, "nocrash_mandatory_c_lj_nowidth", nocrash_mandatory_c_lj_nowidth, nocrash_mandatory_c_lj_nowidth_bench, "{return test(\"%-c\", 'a');}"},
	{0, 2406, "nocrash_mandatory_s_af", nocrash_mandatory_s_af, nocrash_mandatory_s_af_bench, "{return test(\"%#s\", \"hello\");}"},
	{0, 2407, "nocrash_mandatory_s_zp_1", nocrash_mandatory_s_zp_1, nocrash_mandatory_s_zp_1_bench, "{return test(\"%05s\", \"hello\");}"},
	{0, 2408, "nocrash_mandatory_s_zp_2", nocrash_mandatory_s_zp_2, nocrash_mandatory_s_zp_2_bench, "{return test(\"%0s\", \"hello\");}"},
	{0, 2409, "nocrash_mandatory_s_as_1", nocrash_mandatory_s_as_1, nocrash_mandatory_s_as_1_bench, "{return test(\"%+s\", \"hello\");}"},
	{0, 2410, "nocrash_mandatory_s_sp_1", nocrash_mandatory_s_sp_1, nocrash_mandatory_s_sp_1_bench, "{return test(\"% s\", \"hello\");}"},
	{0, 2411, "nocrash_mandatory_s_size_hh", nocrash_mandatory_s_size_hh, nocrash_mandatory_s_size_hh_bench, "{return test(\"%hhs\", \"hello\");}"},
	{0, 2412, "nocrash_mandatory_s_size_h", nocrash_mandatory_s_size_h, nocrash_mandatory_s_size_h_bench, "{return test(\"%hs\", \"hello\");}"},
	{0, 2413, "nocrash_mandatory_s_size_l", nocrash_mandatory_s_size_l, nocrash_mandatory_s_size_l_bench, "{return test(\"%ls\", L\"hello\");}"},
	{0, 2414, "nocrash_mandatory_s_size_ll", nocrash_mandatory_s_size_ll, nocrash_mandatory_s_size_ll_bench, "{return test(\"%lls\", L\"hello\");}"},
	{0, 2415, "nocrash_mandatory_s_size_L", nocrash_mandatory_s_size_L, nocrash_mandatory_s_size_L_bench, "{return test(\"%Ls\", L\"hello\");}"},
	{0, 2416, "nocrash_mandatory_s_lj_nowidth", nocrash_mandatory_s_lj_nowidth, nocrash_mandatory_s_lj_nowidth_bench, "{return test(\"%-s\", \"hello\");}"},
	{0, 2417, "nocrash_mandatory_p_prec_1", nocrash_mandatory_p_prec_1, nocrash_mandatory_p_prec_1_bench, "{return test(\"%.4p\", &ncm_p);}"},
	{0, 2418, "nocrash_mandatory_p_prec_2", nocrash_mandatory_p_prec_2, nocrash_mandatory_p_prec_2_bench, "{return test(\"%.p\", &ncm_p);}"},
	{0, 2419, "nocrash_mandatory_p_af", nocrash_mandatory_p_af, nocrash_mandatory_p_af_bench, "{return test(\"%#p\", &ncm_p);}"},
	{0, 2420, "nocrash_mandatory_p_zp_1", nocrash_mandatory_p_zp_1, nocrash_mandatory_p_zp_1_bench, "{return test(\"%05p\", &ncm_p);}"},
	{0, 2421, "nocrash_mandatory_p_zp_2", nocrash_mandatory_p_zp_2, nocrash_mandatory_p_zp_2_bench, "{return test(\"%0p\", &ncm_p);}"},
	{0, 2422, "nocrash_mandatory_p_as_1", nocrash_mandatory_p_as_1, nocrash_mandatory_p_as_1_bench, "{return test(\"%+p\", &ncm_p);}"},
	{0, 2423, "nocrash_mandatory_p_as_2", nocrash_mandatory_p_as_2, nocrash_mandatory_p_as_2_bench, "{return test(\"%+p\", &ncm_p);}"},
	{0, 2424, "nocrash_mandatory_p_sp_1", nocrash_mandatory_p_sp_1, nocrash_mandatory_p_sp_1_bench, "{return test(\"% p\", &ncm_p);}"},
	{0, 2425, "nocrash_mandatory_p_sp_2", nocrash_mandatory_p_sp_2, nocrash_mandatory_p_sp_2_bench, "{return test(\"% p\", &ncm_p);}"},
	{0, 2426, "nocrash_mandatory_p_size_hh", nocrash_mandatory_p_size_hh, nocrash_mandatory_p_size_hh_bench, "{return test(\"%hhp\", &ncm_p);}"},
	{0, 2427, "nocrash_mandatory_p_size_h", nocrash_mandatory_p_size_h, nocrash_mandatory_p_size_h_bench, "{return test(\"%hp\", &ncm_p);}"},
	{0, 2428, "nocrash_mandatory_p_size_l", nocrash_mandatory_p_size_l, nocrash_mandatory_p_size_l_bench, "{return test(\"%lp\", &ncm_p);}"},
	{0, 2429, "nocrash_mandatory_p_size_ll", nocrash_mandatory_p_size_ll, nocrash_mandatory_p_size_ll_bench, "{return test(\"%llp\", &ncm_p);}"},
	{0, 2430, "nocrash_mandatory_p_size_L", nocrash_mandatory_p_size_L, nocrash_mandatory_p_size_L_bench, "{return test(\"%Lp\", &ncm_p);}"},
	{0, 2431, "nocrash_mandatory_p_lj_nowidth", nocrash_mandatory_p_lj_nowidth, nocrash_mandatory_p_lj_nowidth_bench, "{return test(\"%-p\", &ncm_p);}"},
	{0, 2432, "nocrash_mandatory_d_size_L", nocrash_mandatory_d_size_L, nocrash_mandatory_d_size_L_bench, "{return test(\"%Ld\", 42);}"},
	{0, 2433, "nocrash_mandatory_d_af", nocrash_mandatory_d_af, nocrash_mandatory_d_af_bench, "{return test(\"%#d\", 42);}"},
	{0, 2434, "nocrash_mandatory_d_size_hhh", nocrash_mandatory_d_size_hhh, nocrash_mandatory_d_size_hhh_bench, "{return test(\"%hhhd\", 42);}"},
	{0, 2435, "nocrash_mandatory_d_size_hhhh", nocrash_mandatory_d_size_hhhh, nocrash_mandatory_d_size_hhhh_bench, "{return test(\"%hhhhd\", 42);}"},
	{0, 2436, "nocrash_mandatory_d_size_hhl", nocrash_mandatory_d_size_hhl, nocrash_mandatory_d_size_hhl_bench, "{return test(\"%hhld\", 42);}"},
	{0, 2437, "nocrash_mandatory_d_size_hhll", nocrash_mandatory_d_size_hhll, nocrash_mandatory_d_size_hhll_bench, "{return test(\"%hhlld\", 42);}"},
	{0, 2438, "nocrash_mandatory_d_size_llh", nocrash_mandatory_d_size_llh, nocrash_mandatory_d_size_llh_bench, "{return test(\"%llhd\", 42);}"},
	{0, 2439, "nocrash_mandatory_d_size_lll", nocrash_mandatory_d_size_lll, nocrash_mandatory_d_size_lll_bench, "{return test(\"%llld\", 42);}"},
	{0, 2440, "nocrash_mandatory_i_size_L", nocrash_mandatory_i_size_L, nocrash_mandatory_i_size_L_bench, "{return test(\"%Li\", 42);}"},
	{0, 2441, "nocrash_mandatory_i_af", nocrash_mandatory_i_af, nocrash_mandatory_i_af_bench, "{return test(\"%#i\", 42);}"},
	{0, 2442, "nocrash_mandatory_i_size_hhh", nocrash_mandatory_i_size_hhh, nocrash_mandatory_i_size_hhh_bench, "{return test(\"%hhhi\", 42);}"},
	{0, 2443, "nocrash_mandatory_i_lj_nowidth", nocrash_mandatory_i_lj_nowidth, nocrash_mandatory_i_lj_nowidth_bench, "{return test(\"%-i\", 42);}"},
	{0, 2444, "nocrash_mandatory_o_as", nocrash_mandatory_o_as, nocrash_mandatory_o_as_bench, "{return test(\"%+o\", 42);}"},
	{0, 2445, "nocrash_mandatory_o_sp", nocrash_mandatory_o_sp, nocrash_mandatory_o_sp_bench, "{return test(\"% o\", 42);}"},
	{0, 2446, "nocrash_mandatory_o_size_L", nocrash_mandatory_o_size_L, nocrash_mandatory_o_size_L_bench, "{return test(\"%Lo\", 42);}"},
	{0, 2447, "nocrash_mandatory_o_size_hhh", nocrash_mandatory_o_size_hhh, nocrash_mandatory_o_size_hhh_bench, "{return test(\"%hhho\", 42);}"},
	{0, 2448, "nocrash_mandatory_o_size_hhhh", nocrash_mandatory_o_size_hhhh, nocrash_mandatory_o_size_hhhh_bench, "{return test(\"%hhhho\", 42);}"},
	{0, 2449, "nocrash_mandatory_o_size_hhl", nocrash_mandatory_o_size_hhl, nocrash_mandatory_o_size_hhl_bench, "{return test(\"%hhlo\", 42);}"},
	{0, 2450, "nocrash_mandatory_o_size_hhll", nocrash_mandatory_o_size_hhll, nocrash_mandatory_o_size_hhll_bench, "{return test(\"%hhllo\", 42);}"},
	{0, 2451, "nocrash_mandatory_o_size_llh", nocrash_mandatory_o_size_llh, nocrash_mandatory_o_size_llh_bench, "{return test(\"%llho\", 42);}"},
	{0, 2452, "nocrash_mandatory_o_size_lll", nocrash_mandatory_o_size_lll, nocrash_mandatory_o_size_lll_bench, "{return test(\"%lllo\", 42);}"},
	{0, 2453, "nocrash_mandatory_o_lj_nowidth", nocrash_mandatory_o_lj_nowidth, nocrash_mandatory_o_lj_nowidth_bench, "{return test(\"%-o\", 42);}"},
	{0, 2454, "nocrash_mandatory_u_size_L", nocrash_mandatory_u_size_L, nocrash_mandatory_u_size_L_bench, "{return test(\"%Lu\", 42);}"},
	{0, 2455, "nocrash_mandatory_u_af", nocrash_mandatory_u_af, nocrash_mandatory_u_af_bench, "{return test(\"%#u\", 42);}"},
	{0, 2456, "nocrash_mandatory_u_as", nocrash_mandatory_u_as, nocrash_mandatory_u_as_bench, "{return test(\"%+u\", 42);}"},
	{0, 2457, "nocrash_mandatory_u_sp", nocrash_mandatory_u_sp, nocrash_mandatory_u_sp_bench, "{return test(\"% u\", 42);}"},
	{0, 2458, "nocrash_mandatory_u_size_hhh", nocrash_mandatory_u_size_hhh, nocrash_mandatory_u_size_hhh_bench, "{return test(\"%hhhu\", 42);}"},
	{0, 2459, "nocrash_mandatory_u_size_hhhh", nocrash_mandatory_u_size_hhhh, nocrash_mandatory_u_size_hhhh_bench, "{return test(\"%hhhhu\", 42);}"},
	{0, 2460, "nocrash_mandatory_u_size_hhl", nocrash_mandatory_u_size_hhl, nocrash_mandatory_u_size_hhl_bench, "{return test(\"%hhlu\", 42);}"},
	{0, 2461, "nocrash_mandatory_u_size_hhll", nocrash_mandatory_u_size_hhll, nocrash_mandatory_u_size_hhll_bench, "{return test(\"%hhllu\", 42);}"},
	{0, 2462, "nocrash_mandatory_u_size_llh", nocrash_mandatory_u_size_llh, nocrash_mandatory_u_size_llh_bench, "{return test(\"%llhu\", 42);}"},
	{0, 2463, "nocrash_mandatory_u_size_lll", nocrash_mandatory_u_size_lll, nocrash_mandatory_u_size_lll_bench, "{return test(\"%lllu\", 42);}"},
	{0, 2464, "nocrash_mandatory_u_lj_nowidth", nocrash_mandatory_u_lj_nowidth, nocrash_mandatory_u_lj_nowidth_bench, "{return test(\"%-u\", 42);}"},
	{0, 2465, "nocrash_mandatory_x_size_L", nocrash_mandatory_x_size_L, nocrash_mandatory_x_size_L_bench, "{return test(\"%Lx\", 42);}"},
	{0, 2466, "nocrash_mandatory_x_as", nocrash_mandatory_x_as, nocrash_mandatory_x_as_bench, "{return test(\"%+x\", 42);}"},
	{0, 2467, "nocrash_mandatory_x_sp", nocrash_mandatory_x_sp, nocrash_mandatory_x_sp_bench, "{return test(\"% x\", 42);}"},
	{0, 2468, "nocrash_mandatory_x_size_hhh", nocrash_mandatory_x_size_hhh, nocrash_mandatory_x_size_hhh_bench, "{return test(\"%hhhx\", 42);}"},
	{0, 2469, "nocrash_mandatory_x_size_hhhh", nocrash_mandatory_x_size_hhhh, nocrash_mandatory_x_size_hhhh_bench, "{return test(\"%hhhhx\", 42);}"},
	{0, 2470, "nocrash_mandatory_x_size_hhl", nocrash_mandatory_x_size_hhl, nocrash_mandatory_x_size_hhl_bench, "{return test(\"%hhlx\", 42);}"},
	{0, 2471, "nocrash_mandatory_x_size_hhll", nocrash_mandatory_x_size_hhll, nocrash_mandatory_x_size_hhll_bench, "{return test(\"%hhllx\", 42);}"},
	{0, 2472, "nocrash_mandatory_x_size_llh", nocrash_mandatory_x_size_llh, nocrash_mandatory_x_size_llh_bench, "{return test(\"%llhx\", 42);}"},
	{0, 2473, "nocrash_mandatory_x_size_lll", nocrash_mandatory_x_size_lll, nocrash_mandatory_x_size_lll_bench, "{return test(\"%lllx\", 42);}"},
	{0, 2474, "nocrash_mandatory_X_size_L", nocrash_mandatory_X_size_L, nocrash_mandatory_X_size_L_bench, "{return test(\"%LX\", 42);}"},
	{0, 2475, "nocrash_mandatory_X_as", nocrash_mandatory_X_as, nocrash_mandatory_X_as_bench, "{return test(\"%+X\", 42);}"},
	{0, 2476, "nocrash_mandatory_X_sp", nocrash_mandatory_X_sp, nocrash_mandatory_X_sp_bench, "{return test(\"% X\", 42);}"},
	{0, 2477, "nocrash_mandatory_X_size_hhh", nocrash_mandatory_X_size_hhh, nocrash_mandatory_X_size_hhh_bench, "{return test(\"%hhhX\", 42);}"},
	{0, 2478, "nocrash_mandatory_X_size_llh", nocrash_mandatory_X_size_llh, nocrash_mandatory_X_size_llh_bench, "{return test(\"%llhX\", 42);}"},
	{0, 2479, "nocrash_mandatory_x_lj_nowidth", nocrash_mandatory_x_lj_nowidth, nocrash_mandatory_x_lj_nowidth_bench, "{return test(\"%-x\", 42);}"},
	{0, 2480, "nocrash_mandatory_f_size_hh", nocrash_mandatory_f_size_hh, nocrash_mandatory_f_size_hh_bench, "{return test(\"%hhf\", 42.5);}"},
	{0, 2481, "nocrash_mandatory_f_size_h", nocrash_mandatory_f_size_h, nocrash_mandatory_f_size_h_bench, "{return test(\"%hf\", 42.5);}"},
	{0, 2482, "nocrash_mandatory_f_size_ll", nocrash_mandatory_f_size_ll, nocrash_mandatory_f_size_ll_bench, "{return test(\"%llf\", 42.5);}"},
	{0, 2483, "nocrash_mandatory_f_size_lll", nocrash_mandatory_f_size_lll, nocrash_mandatory_f_size_lll_bench, "{return test(\"%lllf\", 42.5);}"},
	{0, 2484, "nocrash_mandatory_f_size_llll", nocrash_mandatory_f_size_llll, nocrash_mandatory_f_size_llll_bench, "{return test(\"%llllf\", 42.5);}"},
	{0, 2485, "nocrash_mandatory_f_size_LL", nocrash_mandatory_f_size_LL, nocrash_mandatory_f_size_LL_bench, "{return test(\"%LLf\", 42.5);}"},
	{0, 2486, "nocrash_mandatory_f_size_Ll", nocrash_mandatory_f_size_Ll, nocrash_mandatory_f_size_Ll_bench, "{return test(\"%Llf\", 42.5);}"},
	{0, 2487, "nocrash_mandatory_f_size_lL", nocrash_mandatory_f_size_lL, nocrash_mandatory_f_size_lL_bench, "{return test(\"%lLf\", 42.5);}"},
	{0, 2488, "nocrash_mandatory_f_lj_nowidth", nocrash_mandatory_f_lj_nowidth, nocrash_mandatory_f_lj_nowidth_bench, "{return test(\"%-f\", 42.5);}"},
	{0, 2489, "moul_s_1", moul_s_1, moul_s_1_bench, "{return test(\" pouet %s !!\", \"camembert\");}"},
	{0, 2490, "moul_s_2", moul_s_2, moul_s_2_bench, "{return test(\"%s !\", \"Ceci n'est pas un \0 exercice !\");}"},
	{0, 2491, "moul_s_3", moul_s_3, moul_s_3_bench, "{return test(\"%s!\", \"Ceci n'est toujours pas un exercice !\");}"},
	{0, 2492, "moul_s_4", moul_s_4, moul_s_4_bench, "{char *str = NULL; return test(\"%s!\", str);}"},
	{0, 2493, "moul_s_5_this_ones_a_doozy", moul_s_5_this_ones_a_doozy, moul_s_5_this_ones_a_doozy_bench, "{return test(\"%s\", "},
	{0, 2494, "moul_d_1", moul_d_1, moul_d_1_bench, "{return test(\"%d\", 42);}"},
	{0, 2495, "moul_d_2", moul_d_2, moul_d_2_bench, "{return test(\"Kashim a %d histoires à raconter\", 1001);}"},
	{0, 2496, "moul_d_3", moul_d_3, moul_d_3_bench, "{return test(\"Il fait au moins %d\n\", -8000);}"},
	{0, 2497, "moul_d_4", moul_d_4, moul_d_4_bench, "{return test(\"%d\", -0);}"},
	{0, 2498, "moul_d_5", moul_d_5, moul_d_5_bench, "{return test(\"%d\", 0);}"},
	{0, 2499, "moul_d_6", moul_d_6, moul_d_6_bench, "{return test(\"%d\", INT_MAX);}"},
	{0, 2500, "moul_d_7", moul_d_7, moul_d_7_bench, "{return test(\"%d\", INT_MIN);}"},
	{0, 2501, "moul_d_8", moul_d_8, moul_d_8_bench, "{return test(\"%d\", INT_MIN - 1);}"},
	{0, 2502, "moul_d_9", moul_d_9, moul_d_9_bench, "{return test(\"%d\", INT_MAX + 1);}"},
	{0, 2503, "moul_d_10", moul_d_10, moul_d_10_bench, "{return test(\"%%d 0000042 == |%d|\n\", 0000042);}"},
	{0, 2504, "moul_d_11", moul_d_11, moul_d_11_bench, "{return test(\"%%d \t == |%d|\n\", '\t');}"},
	{0, 2505, "moul_d_12", moul_d_12, moul_d_12_bench, "{return test(\"%%d Lydie == |%d|\n\", 'L'+'y'+'d'+'i'+'e');}"},
	{0, 2506, "moul_mix_1", moul_mix_1, moul_mix_1_bench, "{int r00 = 0; return test(\"Lalalala, %d%% des gens qui parlent à Ly adorent %s. Ou Presque. %p\", 100, \"Ly\", &r00);}"},
	{0, 2507, "moul_c_1", moul_c_1, moul_c_1_bench, "{return test(\"%c\", 42);}"},
	{0, 2508, "moul_c_2", moul_c_2, moul_c_2_bench, "{return test(\"Kashim a %c histoires à raconter\", 1001);}"},
	{0, 2509, "moul_c_3", moul_c_3, moul_c_3_bench, "{return test(\"Il fait au moins %c\n\", -8000);}"},
	{0, 2510, "moul_c_4", moul_c_4, moul_c_4_bench, "{return test(\"%c\", -0);}"},
	{0, 2511, "moul_c_5", moul_c_5, moul_c_5_bench, "{return test(\"%c\", 0);}"},
	{0, 2512, "moul_c_5b", moul_c_5b, moul_c_5b_bench, "{return test(\"%c\n\", INT_MAX);}"},
	{0, 2513, "moul_c_6", moul_c_6, moul_c_6_bench, "{return test(\"%c\n\", 'c');}"},
	{0, 2514, "moul_c_7", moul_c_7, moul_c_7_bench, "{return test(\"%c\n\", '\n');}"},
	{0, 2515, "moul_c_8", moul_c_8, moul_c_8_bench, "{return test(\"%c\", 'l');}"},
	{0, 2516, "moul_c_9", moul_c_9, moul_c_9_bench, "{return test(\"%c\", 'y');}"},
	{0, 2517, "moul_c_10", moul_c_10, moul_c_10_bench, "{return test(\"%c\", ' ');}"},
	{0, 2518, "moul_c_11", moul_c_11, moul_c_11_bench, "{return test(\"%c\", 'e');}"},
	{0, 2519, "moul_c_12", moul_c_12, moul_c_12_bench, "{return test(\"%c\", 's');}"},
	{0, 2520, "moul_c_13", moul_c_13, moul_c_13_bench, "{return test(\"%c\", 't');}"},
	{0, 2521, "moul_c_14", moul_c_14, moul_c_14_bench, "{return test(\"%c\", ' ');}"},
	{0, 2522, "moul_c_15", moul_c_15, moul_c_15_bench, "{return test(\"%c\", 'f');}"},
	{0, 2523, "moul_c_16", moul_c_16, moul_c_16_bench, "{return test(\"%c\", 'a');}"},
	{0, 2524, "moul_c_17", moul_c_17, moul_c_17_bench, "{return test(\"%c\", 'n');}"},
	{0, 2525, "moul_c_18", moul_c_18, moul_c_18_bench, "{return test(\"%c\", 't');}"},
	{0, 2526, "moul_c_19", moul_c_19, moul_c_19_bench, "{return test(\"%c\", 'a');}"},
	{0, 2527, "moul_c_20", moul_c_20, moul_c_20_bench, "{return test(\"%c\", 's');}"},
	{0, 2528, "moul_c_21", moul_c_21, moul_c_21_bench, "{return test(\"%c\", 't');}"},
	{0, 2529, "moul_c_22", moul_c_22, moul_c_22_bench, "{return test(\"%c\", 'i');}"},
	{0, 2530, "moul_c_23", moul_c_23, moul_c_23_bench, "{return test(\"%c\", 'q');}"},
	{0, 2531, "moul_c_24", moul_c_24, moul_c_24_bench, "{return test(\"%c\", 'u');}"},
	{0, 2532, "moul_c_25", moul_c_25, moul_c_25_bench, "{return test(\"%c\", 'e');}"},
	{0, 2533, "moul_c_26", moul_c_26, moul_c_26_bench, "{return test(\"%c\n\", '!');}"},
	{0, 2534, "moul_c_27", moul_c_27, moul_c_27_bench, "{return test(\"%c\n\", '\r');}"},
	{0, 2535, "moul_c_28", moul_c_28, moul_c_28_bench, "{return test(\"%c\n\", '\t');}"},
	{0, 2536, "moul_ld_1_throwswarning", moul_ld_1_throwswarning, moul_ld_1_throwswarning_bench, "{return test(\"%ld\", 42);}"},
	{0, 2537, "moul_ld_2_throwswarning", moul_ld_2_throwswarning, moul_ld_2_throwswarning_bench, "{return test(\"Kashim a %ld histoires à raconter\", 1001);}"},
	{0, 2538, "moul_ld_3_throwswarning", moul_ld_3_throwswarning, moul_ld_3_throwswarning_bench, "{return test(\"Il fait au moins %ld\n\", -8000);}"},
	{0, 2539, "moul_ld_4_throwswarning", moul_ld_4_throwswarning, moul_ld_4_throwswarning_bench, "{return test(\"%ld\", -0);}"},
	{0, 2540, "moul_ld_5_throwswarning", moul_ld_5_throwswarning, moul_ld_5_throwswarning_bench, "{return test(\"%ld\", 0);}"},
	{0, 2541, "moul_ld_6_throwswarning", moul_ld_6_throwswarning, moul_ld_6_throwswarning_bench, "{return test(\"%ld\", INT_MAX);}"},
	{0, 2542, "moul_ld_7_throwswarning", moul_ld_7_throwswarning, moul_ld_7_throwswarning_bench, "{return test(\"%ld\", INT_MIN);}"},
	{0, 2543, "moul_ld_8_throwswarning", moul_ld_8_throwswarning, moul_ld_8_throwswarning_bench, "{return test(\"%ld\", INT_MIN - 1);}"},
	{0, 2544, "moul_ld_9_throwswarning", moul_ld_9_throwswarning, moul_ld_9_throwswarning_bench, "{return test(\"%ld\", INT_MAX + 1);}"},
	{0, 2545, "moul_ld_10_throwswarning", moul_ld_10_throwswarning, moul_ld_10_throwswarning_bench, "{return test(\"%%ld 0000042 == |%ld|\n\", 0000042);}"},
	{0, 2546, "moul_ld_11_throwswarning", moul_ld_11_throwswarning, moul_ld_11_throwswarning_bench, "{return test(\"%%ld \t == |%ld|\n\", '\t');}"},
	{0, 2547, "moul_ld_12_throwswarning", moul_ld_12_throwswarning, moul_ld_12_throwswarning_bench, "{return test(\"%%ld Lydie == |%ld|\n\", 'L'+'y'+'d'+'i'+'e');}"},
	...
	{0, 2560, "moul_i_1", moul_i_1, moul_i_1_bench, "{return test(\"%i\", 42);}"},
	{0, 2561, "moul_i_2", moul_i_2, moul_i_2_bench, "{return test(\"Kashim a %i histoires à raconter\", 1001);}"},
	{0, 2562, "moul_i_3", moul_i_3, moul_i_3_bench, "{return test(\"Il fait au moins %i\n\", -8000);}"},
	{0, 2563, "moul_i_4", moul_i_4, moul_i_4_bench, "{return test(\"%i\", -0);}"},
	{0, 2564, "moul_i_5", moul_i_5, moul_i_5_bench, "{return test(\"%i\", 0);}"},
	{0, 2565, "moul_i_6", moul_i_6, moul_i_6_bench, "{return test(\"%i\", INT_MAX);}"},
	{0, 2566, "moul_i_7", moul_i_7, moul_i_7_bench, "{return test(\"%i\", INT_MIN);}"},
	{0, 2567, "moul_i_8", moul_i_8, moul_i_8_bench, "{return test(\"%i\", INT_MIN - 1);}"},
	{0, 2568, "moul_i_9", moul_i_9, moul_i_9_bench, "{return test(\"%i\", INT_MAX + 1);}"},
	{0, 2569, "moul_i_10", moul_i_10, moul_i_10_bench, "{return test(\"%%i 0000042 == |%i|\n\", 0000042);}"},
	{0, 2570, "moul_i_11", moul_i_11, moul_i_11_bench, "{return test(\"%%i \t == |%i|\n\", '\t');}"},
	{0, 2571, "moul_i_12", moul_i_12, moul_i_12_bench, "{return test(\"%%i Lydie == |%i|\n\", 'L'+'y'+'d'+'i'+'e');}"},
	{0, 2572, "moul_f_1", moul_f_1, moul_f_1_bench, "{return test(\"%f\", (double)42);}"},
	{0, 2573, "moul_f_2", moul_f_2, moul_f_2_bench, "{return test(\"Kashim a %f histoires à raconter\", (double)1001);}"},
	{0, 2574, "moul_f_3", moul_f_3, moul_f_3_bench, "{return test(\"Il fait au moins %f\n\", (double)-8000);}"},
	{0, 2575, "moul_f_4", moul_f_4, moul_f_4_bench, "{return test(\"%f\", (double)-0);}"},
	{0, 2576, "moul_f_5", moul_f_5, moul_f_5_bench, "{return test(\"%f\", (double)0);}"},
	{0, 2577, "moul_f_6", moul_f_6, moul_f_6_bench, "{return test(\"%f\", (double)INT_MAX);}"},
	{0, 2578, "moul_f_7", moul_f_7, moul_f_7_bench, "{return test(\"%f\", (double)INT_MIN);}"},
	{0, 2579, "moul_f_7b", moul_f_7b, moul_f_7b_bench, "{return test(\"%f\", (double)INT_MIN - 1);}"},
	{0, 2580, "moul_f_8", moul_f_8, moul_f_8_bench, "{return test(\"%f\", (double)INT_MAX + 1);}"},
	{0, 2581, "moul_f_9", moul_f_9, moul_f_9_bench, "{return test(\"%%f 0000042 == |%f|\n\", (double)0000042);}"},
	{0, 2582, "moul_f_10", moul_f_10, moul_f_10_bench, "{return test(\"%%f \t == |%f|\n\", (double)'\t');}"},
	{0, 2583, "moul_f_11", moul_f_11, moul_f_11_bench, "{return test(\"%%f Lydie == |%f|\n\", (double)'L'+'y'+'d'+'i'+'e');}"},
	{0, 2584, "moul_f_12", moul_f_12, moul_f_12_bench, "{return test(\"%%f 42.42 == |%f|\n\", 42.42);}"},
	...
	{0, 2599, "moul_o_1", moul_o_1, moul_o_1_bench, "{return test(\"%o\", 42);}"},
	{0, 2600, "moul_o_2", moul_o_2, moul_o_2_bench, "{return test(\"Kashim a %o histoires à raconter\", 1001);}"},
	{0, 2601, "moul_o_3", moul_o_3, moul_o_3_bench, "{return test(\"Il fait au moins %o\n\", -8000);}"},
	{0, 2602, "moul_o_4", moul_o_4, moul_o_4_bench, "{return test(\"%o\", -0);}"},
	{0, 2603, "moul_o_5", moul_o_5, moul_o_5_bench, "{return test(\"%o\", 0);}"},
	{0, 2604, "moul_o_6", moul_o_6, moul_o_6_bench, "{return test(\"%o\", INT_MAX);}"},
	{0, 2605, "moul_o_7", moul_o_7, moul_o_7_bench, "{return test(\"%o\", INT_MIN);}"},
	{0, 2606, "moul_o_8", moul_o_8, moul_o_8_bench, "{return test(\"%o\", INT_MIN - 1);}"},
	{0, 2607, "moul_o_9", moul_o_9, moul_o_9_bench, "{return test(\"%o\", INT_MAX + 1);}"},
	{0, 2608, "moul_o_10", moul_o_10, moul_o_10_bench, "{return test(\"%%o 0000042 == |%o|\n\", 0000042);}"},
	{0, 2609, "moul_o_11", moul_o_11, moul_o_11_bench, "{return test(\"%%o \t == |%o|\n\", '\t');}"},
	{0, 2610, "moul_o_12", moul_o_12, moul_o_12_bench, "{return test(\"%%o Lydie == |%o|\n\", 'L'+'y'+'d'+'i'+'e');}"},
	{0, 2611, "moul_u_1", moul_u_1, moul_u_1_bench, "{return test(\"%u\", 42);}"},
	{0, 2612, "moul_u_2", moul_u_2, moul_u_2_bench, "{return test(\"Kashim a %u histoires à raconter\", 1001);}"},
	{0, 2613, "moul_u_3", moul_u_3, moul_u_3_bench, "{return test(\"Il fait au moins %u\n\", -8000);}"},
	{0, 2614, "moul_u_4", moul_u_4, moul_u_4_bench, "{return test(\"%u\", -0);}"},
	{0, 2615, "moul_u_5", moul_u_5, moul_u_5_bench, "{return test(\"%u\", 0);}"},
	{0, 2616, "moul_u_6", moul_u_6, moul_u_6_bench, "{return test(\"%u\", INT_MAX);}"},
	{0, 2617, "moul_u_7", moul_u_7, moul_u_7_bench, "{return test(\"%u\", INT_MIN);}"},
	{0, 2618, "moul_u_8", moul_u_8, moul_u_8_bench, "{return test(\"%u\", INT_MIN - 1);}"},
	{0, 2619, "moul_u_9", moul_u_9, moul_u_9_bench, "{return test(\"%u\", INT_MAX + 1);}"},
	{0, 2620, "moul_u_10", moul_u_10, moul_u_10_bench, "{return test(\"%%u 0000042 == |%u|\n\", 0000042);}"},
	{0, 2621, "moul_u_11", moul_u_11, moul_u_11_bench, "{return test(\"%%u \t == |%u|\n\", '\t');}"},
	{0, 2622, "moul_u_12", moul_u_12, moul_u_12_bench, "{return test(\"%%u Lydie == |%u|\n\", 'L'+'y'+'d'+'i'+'e');}"},
	{0, 2623, "moul_x_1", moul_x_1, moul_x_1_bench, "{return test(\"%x\", 42);}"},
	{0, 2624, "moul_x_2", moul_x_2, moul_x_2_bench, "{return test(\"Kashim a %x histoires à raconter\", 1001);}"},
	{0, 2625, "moul_x_3", moul_x_3, moul_x_3_bench, "{return test(\"Il fait au moins %x\n\", -8000);}"},
	{0, 2626, "moul_x_4", moul_x_4, moul_x_4_bench, "{return test(\"%x\", -0);}"},
	{0, 2627, "moul_x_5", moul_x_5, moul_x_5_bench, "{return test(\"%x\", 0);}"},
	{0, 2628, "moul_x_6", moul_x_6, moul_x_6_bench, "{return test(\"%x\", INT_MAX);}"},
	{0, 2629, "moul_x_7", moul_x_7, moul_x_7_bench, "{return test(\"%x\", INT_MIN);}"},
	{0, 2630, "moul_x_8", moul_x_8, moul_x_8_bench, "{return test(\"%x\", INT_MIN - 1);}"},
	{0, 2631, "moul_x_9", moul_x_9, moul_x_9_bench, "{return test(\"%x\", INT_MAX + 1);}"},
	{0, 2632, "moul_x_10", moul_x_10, moul_x_10_bench, "{return test(\"%%x 0000042 == |%x|\n\", 0000042);}"},
	{0, 2633, "moul_x_11", moul_x_11, moul_x_11_bench, "{return test(\"%%x \t == |%x|\n\", '\t');}"},
	{0, 2634, "moul_x_12", moul_x_12, moul_x_12_bench, "{return test(\"%%x Lydie == |%x|\n\", 'L'+'y'+'d'+'i'+'e');}"},
	{0, 2635, "moul_hash_1", moul_hash_1, moul_hash_1_bench, "{return test(\"%%#X 42 ==  %#X\n\", 42);}"},
	{0, 2636, "moul_hash_2", moul_hash_2, moul_hash_2_bench, "{return test(\"%%X 42 ==  %X\n\", 42);}"},
	{0, 2637, "moul_hash_3", moul_hash_3, moul_hash_3_bench, "{return test(\"%%#o 0 ==  %#o\n\", 0);}"},
	{0, 2638, "moul_hash_4", moul_hash_4, moul_hash_4_bench, "{return test(\"%%o 0 ==  %o\n\", 0);}"},
	{0, 2639, "moul_hash_5", moul_hash_5, moul_hash_5_bench, "{return test(\"%%#o INT_MAX ==  %#o\n\", INT_MAX);}"},
	{0, 2640, "moul_hash_6", moul_hash_6, moul_hash_6_bench, "{return test(\"%%o INT_MAX ==  %o\n\", INT_MAX);}"},
	{0, 2641, "moul_hash_7", moul_hash_7, moul_hash_7_bench, "{return test(\"%%#o INT_MIN ==  %#o\n\", INT_MIN);}"},
	{0, 2642, "moul_hash_8", moul_hash_8, moul_hash_8_bench, "{return test(\"%%o INT_MIN ==  %o\n\", INT_MIN);}"},
	{0, 2643, "moul_hash_9", moul_hash_9, moul_hash_9_bench, "{return test(\"%%#X INT_MIN ==  %#X\n\", INT_MIN);}"},
	{0, 2644, "moul_hash_10", moul_hash_10, moul_hash_10_bench, "{return test(\"%%X INT_MIN ==  %X\n\", INT_MIN);}"},
	{0, 2645, "moul_hash_11", moul_hash_11, moul_hash_11_bench, "{return test(\"%%#X INT_MAX ==  %#X\n\", INT_MAX);}"},
	{0, 2646, "moul_hash_12", moul_hash_12, moul_hash_12_bench, "{return test(\"%%X INT_MAX ==  %X\n\", INT_MAX);}"},
	{0, 2647, "moul_prec_1", moul_prec_1, moul_prec_1_bench, "{return test(\"%%-5.3s LYDI == |%-5.3s|\n\", \"LYDI\");}"},
	{0, 2648, "moul_prec_2", moul_prec_2, moul_prec_2_bench, "{return test(\"%% 4.5i 42 == |% 4.5i|\n\", 42);}"},
	{0, 2649, "moul_prec_3", moul_prec_3, moul_prec_3_bench, "{return test(\"%%04.5i 42 == |%04.5i|\n\", 42);}"},
	{0, 2650, "moul_prec_4", moul_prec_4, moul_prec_4_bench, "{return test(\"%%04.3i 42 == |%04.3i|\n\", 42);}"},
	{0, 2651, "moul_prec_5", moul_prec_5, moul_prec_5_bench, "{return test(\"%%04.2i 42 == |%04.2i|\n\", 42);}"},
	{0, 2652, "moul_zeropad_1", moul_zeropad_1, moul_zeropad_1_bench, "{return test(\"%%04i 42 == |%04i|\n\", 42);}"},
	{0, 2653, "moul_zeropad_2", moul_zeropad_2, moul_zeropad_2_bench, "{return test(\"%%05i 42 == |%05i|\n\", 42);}"},
	{0, 2654, "moul_zeropad_3", moul_zeropad_3, moul_zeropad_3_bench, "{return test(\"%%0i 42 == |%0i|\n\", 42);}"},
	{0, 2655, "moul_zeropad_4", moul_zeropad_4, moul_zeropad_4_bench, "{return test(\"%%0d 0000042 == |%0d|\n\", 0000042);}"},
	{0, 2656, "moul_leftjusty_1", moul_leftjusty_1, moul_leftjusty_1_bench, "{return test(\"%%-i 42 == %-i\n\", 42);}"},
	{0, 2657, "moul_leftjusty_2", moul_leftjusty_2, moul_leftjusty_2_bench, "{return test(\"%%-d 42 == %-d\n\", INT_MIN);}"},
	{0, 2658, "moul_leftjusty_3", moul_leftjusty_3, moul_leftjusty_3_bench, "{return test(\"%%-i -42 == %-i\n\", -42);}"},
	{0, 2659, "moul_leftjusty_4", moul_leftjusty_4, moul_leftjusty_4_bench, "{return test(\"%%-4d 42 == |%-4d|\n\", 42);}"},
	{0, 2660, "moul_leftjusty_5", moul_leftjusty_5, moul_leftjusty_5_bench, "{return test(\"%%-5d -42 == |%-5d|\n\", -42);}"},
	{0, 2661, "moul_leftjusty_6", moul_leftjusty_6, moul_leftjusty_6_bench, "{return test(\"|%3i|%-3i|\n\", 42, 42);}"},
	{0, 2662, "moul_leftjusty_7", moul_leftjusty_7, moul_leftjusty_7_bench, "{return test(\"%%-4i 42 == |%-4i|\n\", 42);}"},
	{0, 2663, "moul_as_1", moul_as_1, moul_as_1_bench, "{return test(\"%%+i 42 == %+i\n\", 42);}"},
	{0, 2664, "moul_as_2", moul_as_2, moul_as_2_bench, "{return test(\"%%+d 42 == %+d\n\", INT_MAX);}"},
	{0, 2665, "moul_as_3", moul_as_3, moul_as_3_bench, "{return test(\"%%+i -42 == %+i\n\", -42);}"},
	{0, 2666, "moul_as_4", moul_as_4, moul_as_4_bench, "{return test(\"%%+04d 42 == %0+04d\n\", 42);}"},
	{0, 2667, "moul_sp_1", moul_sp_1, moul_sp_1_bench, "{return test(\"%%      i 42 == |%      i|\n\", 42);}"},
	{0, 2668, "moul_sp_2", moul_sp_2, moul_sp_2_bench, "{return test(\"%% i -42 == |% i|\n\", -42);}"},
	{0, 2669, "moul_sp_3", moul_sp_3, moul_sp_3_bench, "{return test(\"%% 4i 42 == |% 4i|\n\", 42);}"},
